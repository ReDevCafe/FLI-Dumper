...
static_assert(sizeof(FFieldCollection) == 0x00B0); // 176 bytes (0x0000B0 - 0x0000B0)
...
static_assert(sizeof(FChaosSolverConfiguration) == 0x006C); // 108 bytes (0x000000 - 0x00006C)
...
static_assert(offsetof(FChaosSolverConfiguration, ClusterUnionConnectionType) == 0x0024);
static_assert(offsetof(FChaosSolverConfiguration, CollisionFilterSettings) == 0x0028);
static_assert(offsetof(FChaosSolverConfiguration, BreakingFilterSettings) == 0x003C);
static_assert(offsetof(FChaosSolverConfiguration, TrailingFilterSettings) == 0x0050);
