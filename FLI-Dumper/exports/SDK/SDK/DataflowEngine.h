...
public:
	...
	// void EvaluateTerminalNodeByName(class UDataflow* Dataflow, FName TerminalNodeName, class UObject* ResultAsset);          // [0x4febb00] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
static_assert(sizeof(UDataflowContextObject) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(UDataflowBaseContent) == 0x0080); // 128 bytes (0x000048 - 0x000080)
static_assert(sizeof(UDataflowSkeletalContent) == 0x00A8); // 168 bytes (0x000080 - 0x0000A8)
...
static_assert(offsetof(UDataflowBaseContent, DataflowAsset) == 0x0048);
static_assert(offsetof(UDataflowBaseContent, DataflowTerminal) == 0x0050);
static_assert(offsetof(UDataflowSkeletalContent, SkeletalMesh) == 0x0080);
static_assert(offsetof(UDataflowSkeletalContent, AnimationAsset) == 0x0088);
static_assert(offsetof(UDataflowSkeletalContent, Skeleton) == 0x0090);
