...
public:
	...
	// bool SetValueVector2D(FVector2D& InVector2D);                                                                            // [0x7a48720] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueVector
	// bool SetValueVector(FVector& InVector);                                                                                  // [0x7a487c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueUint64
	// bool SetValueUint64(uint64_t InUInt64);                                                                                  // [0x7a48680] Final|Native|Public  
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueUInt32
	// bool SetValueUInt32(uint32_t InUInt32);                                                                                  // [0x7a48540] Final|Native|Public  
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueUint16
	// bool SetValueUint16(uint16_t InUInt16);                                                                                  // [0x7a485e0] Final|Native|Public  
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueText
	// bool SetValueText(FText& InTextValue);                                                                                   // [0x7a48480] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueString
	// bool SetValueString(FString InStringValue);                                                                              // [0x7a483d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueRotator
	// bool SetValueRotator(FRotator& InRotator);                                                                               // [0x7a48330] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueNumericInteger
	// bool SetValueNumericInteger(int64_t InInt64Value);                                                                       // [0x7a48290] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueName
	// bool SetValueName(FName& InNameValue);                                                                                   // [0x7a481e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueLinearColor
	// bool SetValueLinearColor(FLinearColor& InLinearColor);                                                                   // [0x7a48140] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueInt8
	// bool SetValueInt8(int8_t InInt8);                                                                                        // [0x7a480b0] Final|Native|Public  
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueInt64
	// bool SetValueInt64(int64_t InInt64);                                                                                     // [0x7a48010] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueInt32
	// bool SetValueInt32(int32_t InInt32);                                                                                     // [0x7a47f70] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueInt16
	// bool SetValueInt16(int16_t InInt16);                                                                                     // [0x7a47ed0] Final|Native|Public  
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueFloat
	// bool SetValueFloat(float InFloat);                                                                                       // [0x7a47e40] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueDouble
	// bool SetValueDouble(double InDouble);                                                                                    // [0x7a47db0] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueColor
	// bool SetValueColor(FColor& InColor);                                                                                     // [0x7a47d10] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueByte
	// bool SetValueByte(char InByte);                                                                                          // [0x7a47c80] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.SetValueBool
	// bool SetValueBool(bool InBoolValue);                                                                                     // [0x7a47be0] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueVector2D
	// bool GetValueVector2D(FVector2D& OutVector2D);                                                                           // [0x7a47a20] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueVector
	// bool GetValueVector(FVector& OutVector);                                                                                 // [0x7a47ac0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueUint64
	// bool GetValueUint64(uint64_t& OuyUInt64);                                                                                // [0x7a47970] Final|Native|Public|HasOutParms|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueUInt32
	// bool GetValueUInt32(uint32_t& OutUInt32);                                                                                // [0x7a47810] Final|Native|Public|HasOutParms|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueUint16
	// bool GetValueUint16(uint16_t& OutUInt16);                                                                                // [0x7a478c0] Final|Native|Public|HasOutParms|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueText
	// bool GetValueText(FText& OutTextValue);                                                                                  // [0x7a47750] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueString
	// bool GetValueString(FString& OutStringValue);                                                                            // [0x7a47690] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueRotator
	// bool GetValueRotator(FRotator& OutRotator);                                                                              // [0x7a475f0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueObject
	// class UObject* GetValueObject();                                                                                         // [0x7a475c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueNumericInteger
	// bool GetValueNumericInteger(int64_t& OutInt64Value);                                                                     // [0x7a47510] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueName
	// bool GetValueName(FName& OutNameValue);                                                                                  // [0x7a47460] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueLinearColor
	// bool GetValueLinearColor(FLinearColor& OutLinearColor);                                                                  // [0x7a473c0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueInt8
	// bool GetValueInt8(int8_t& OutInt8);                                                                                      // [0x7a47310] Final|Native|Public|HasOutParms|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueInt64
	// bool GetValueInt64(int64_t& OuyInt64);                                                                                   // [0x7a47260] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueInt32
	// bool GetValueInt32(int32_t& OutInt32);                                                                                   // [0x7a471b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueInt16
	// bool GetValueInt16(int16_t& OutInt16);                                                                                   // [0x7a47100] Final|Native|Public|HasOutParms|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueFloat
	// bool GetValueFloat(float& OutFloat);                                                                                     // [0x7a47050] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueDouble
	// bool GetValueDouble(double& OutDouble);                                                                                  // [0x7a46fa0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueColor
	// bool GetValueColor(FColor& OutColor);                                                                                    // [0x7a46f00] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueByte
	// bool GetValueByte(char& OutByte);                                                                                        // [0x7a46e50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetValueBool
	// bool GetValueBool(bool& OutBoolValue);                                                                                   // [0x7a46da0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetPropertyName
	// FName GetPropertyName();                                                                                                 // [0x7a46d60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/RemoteControl.RCVirtualPropertyBase.GetDisplayValueAsString
	// FString GetDisplayValueAsString();                                                                                       // [0x7a46cc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1192) /* TSet<URCVirtualPropertyBase*> */ __um(VirtualProperties);                            // 0x0038   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,1193) /* TMap<FSoftObjectPath, TWeakObjectPtr<UObject*>> */ __um(BoundObjectMapByPath);       // 0x0058   (0x0050)  
	SDK_UNDEFINED(80,1194) /* TMap<FSoftObjectPath, TWeakObjectPtr<ULevel*>> */ __um(SubLevelSelectionMapByPath);  // 0x00A8   (0x0050)  
...
public:
	...
	// void SetInt32WithSetterValue(int32_t NewValue);                                                                          // [0x7a47b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RemoteControlDeltaAPITestObject.GetInt32WithSetterValue
	// int32_t GetInt32WithSetterValue();                                                                                       // [0x7a46d40] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
{ 
public:
	SDK_UNDEFINED(80,1195) /* TSet<FRCEntityWrapper> */ __um(ExposedEntities);                                     // 0x0028   (0x0050)  
	TMap<FName, FGuid>                                 LabelToIdCache;                                             // 0x0078   (0x0050)  
	SDK_UNDEFINED(80,1196) /* TSet<UScriptStruct*> */  __um(ExposedTypes);                                         // 0x00C8   (0x0050)  
};
...
public:
	...
	// bool ExposeProperty(class URemoteControlPreset* Preset, class UObject* SourceObject, FString Property, FRemoteControlOptionalExposeArgs args); // [0x7a59ce0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RemoteControlFunctionLibrary.ExposeFunction
	// bool ExposeFunction(class URemoteControlPreset* Preset, class UObject* SourceObject, FString Function, FRemoteControlOptionalExposeArgs args); // [0x7a59ae0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RemoteControlFunctionLibrary.ExposeActor
	// bool ExposeActor(class URemoteControlPreset* Preset, class AActor* Actor, FRemoteControlOptionalExposeArgs args);        // [0x7a59930] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/RemoteControl.RemoteControlFunctionLibrary.ApplyColorWheelDelta
	// bool ApplyColorWheelDelta(class UObject* targetObject, FString PropertyName, FColorWheelColor& DeltaValue, FColorWheelColor& ReferenceColor, bool bIsInteractive); // [0x7a59740] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/RemoteControl.RemoteControlFunctionLibrary.ApplyColorGradingWheelDelta
	// bool ApplyColorGradingWheelDelta(class UObject* targetObject, FString PropertyName, FColorGradingWheelColor& DeltaValue, FColorGradingWheelColor& ReferenceColor, bool bIsInteractive, float MinValue, float MaxValue); // [0x7a594d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// FRemoteControlInterceptionFunctionParamStruct TestFunction(FRemoteControlInterceptionFunctionParamStruct& InStruct, int32_t InTestFactor); // [0x7a59ee0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(80,1197) /* TSet<FRemoteControlTestStructInner> */ __um(StructInnerSet);                         // 0x0008   (0x0050)  
...
{ 
public:
	SDK_UNDEFINED(80,1199) /* TSet<FRCPropertyIdWrapper> */ __um(IdentifiedFields);                                // 0x0028   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,1200) /* TSet<int32_t> */         __um(IntSet);                                               // 0x0058   (0x0050)  
	TMap<int32_t, int32_t>                             IntMap;                                                     // 0x00A8   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(16,1201) /* TArray<TWeakObjectPtr<URemoteControlBinding*>> */ __um(Bindings);                    // 0x0058   (0x0010)  
...
{ 
	...
	SDK_UNDEFINED(80,1202) /* TSet<FRemoteControlProtocolBinding> */ __um(ProtocolBindings);                       // 0x00C8   (0x0050)  
...
{ 
	...
	SDK_UNDEFINED(80,1203) /* TSet<FRemoteControlProtocolMapping> */ __um(Mappings);                               // 0x0028   (0x0050)  
...
static_assert(sizeof(URCVirtualPropertyBase) == 0x00C0); // 192 bytes (0x000028 - 0x0000C0)
...
static_assert(sizeof(URCVirtualPropertyContainerBase) == 0x00F8); // 248 bytes (0x000028 - 0x0000F8)
static_assert(sizeof(URemoteControlBinding) == 0x0058); // 88 bytes (0x000028 - 0x000058)
static_assert(sizeof(URemoteControlLevelIndependantBinding) == 0x0080); // 128 bytes (0x000058 - 0x000080)
static_assert(sizeof(FRemoteControlInitialBindingContext) == 0x0070); // 112 bytes (0x000000 - 0x000070)
static_assert(sizeof(URemoteControlLevelDependantBinding) == 0x0190); // 400 bytes (0x000058 - 0x000190)
static_assert(sizeof(FRemoteControlDeltaAPITestStruct) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(URemoteControlDeltaAPITestObject) == 0x0070); // 112 bytes (0x000028 - 0x000070)
static_assert(sizeof(URemoteControlExposeRegistry) == 0x0118); // 280 bytes (0x000028 - 0x000118)
static_assert(sizeof(URemoteControlFunctionLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(URemoteControlInterceptionTestObject) == 0x0058); // 88 bytes (0x000028 - 0x000058)
static_assert(sizeof(FRemoteControlPresetGroup) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FRemoteControlPresetLayout) == 0x00D0); // 208 bytes (0x000000 - 0x0000D0)
static_assert(sizeof(FRCCachedFieldData) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(URemoteControlPreset) == 0x05B0); // 1456 bytes (0x000028 - 0x0005B0)
static_assert(sizeof(ARemoteControlPresetActor) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
...
static_assert(sizeof(URemoteControlAPITestObject) == 0x02B8); // 696 bytes (0x000028 - 0x0002B8)
static_assert(sizeof(URemoteControlPropertyIdRegistry) == 0x0090); // 144 bytes (0x000028 - 0x000090)
static_assert(sizeof(FRemoteControlTestInnerStruct) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(URemoteControlTestObject) == 0x0198); // 408 bytes (0x000028 - 0x000198)
static_assert(sizeof(FRemoteControlEntity) == 0x0098); // 152 bytes (0x000000 - 0x000098)
static_assert(sizeof(FRemoteControlActor) == 0x00B8); // 184 bytes (0x000098 - 0x0000B8)
...
static_assert(sizeof(FRemoteControlField) == 0x0140); // 320 bytes (0x000098 - 0x000140)
static_assert(sizeof(FRemoteControlProtocolBinding) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(FRemoteControlProperty) == 0x0148); // 328 bytes (0x000140 - 0x000148)
static_assert(sizeof(FRemoteControlFunction) == 0x0180); // 384 bytes (0x000140 - 0x000180)
...
static_assert(sizeof(FRCMetadata_FName) == 0x0010); // 16 bytes (0x000008 - 0x000010)
static_assert(sizeof(FRCMetadata_UObject) == 0x0030); // 48 bytes (0x000008 - 0x000030)
static_assert(sizeof(FRCMetadata_UClass) == 0x0030); // 48 bytes (0x000008 - 0x000030)
static_assert(sizeof(FRCMetadata_UScriptStruct) == 0x0030); // 48 bytes (0x000008 - 0x000030)
...
static_assert(sizeof(FRemoteControlInstanceMaterial) == 0x0198); // 408 bytes (0x000148 - 0x000198)
static_assert(sizeof(FRCPropertyIdWrapper) == 0x0028); // 40 bytes (0x000000 - 0x000028)
...
static_assert(offsetof(URCVirtualPropertyBase, PropertyName) == 0x0028);
static_assert(offsetof(URCVirtualPropertyBase, ID) == 0x0030);
static_assert(offsetof(URCVirtualPropertyBase, FieldId) == 0x0040);
static_assert(offsetof(URCVirtualPropertyBase, PresetWeakPtr) == 0x0048);
static_assert(offsetof(URCVirtualPropertyBase, DisplayName) == 0x0050);
static_assert(offsetof(URCVirtualPropertyBase, Description) == 0x0058);
...
static_assert(offsetof(URCVirtualPropertyContainerBase, BAG) == 0x0028);
static_assert(offsetof(URCVirtualPropertyContainerBase, PresetWeakPtr) == 0x0088);
static_assert(offsetof(URCVirtualPropertyContainerBase, ControllerLabelToIdCache) == 0x00A8);
static_assert(offsetof(URemoteControlBinding, Name) == 0x0028);
static_assert(offsetof(URemoteControlBinding, LastBoundObjectPath) == 0x0038);
static_assert(offsetof(URemoteControlLevelIndependantBinding, BoundObject) == 0x0058);
static_assert(offsetof(FRemoteControlInitialBindingContext, SupportedClass) == 0x0000);
static_assert(offsetof(FRemoteControlInitialBindingContext, ComponentName) == 0x0028);
static_assert(offsetof(FRemoteControlInitialBindingContext, SubObjectPath) == 0x0030);
static_assert(offsetof(FRemoteControlInitialBindingContext, OwnerActorClass) == 0x0040);
static_assert(offsetof(FRemoteControlInitialBindingContext, OwnerActorName) == 0x0068);
static_assert(offsetof(URemoteControlLevelDependantBinding, LevelWithLastSuccessfulResolve) == 0x00F8);
static_assert(offsetof(URemoteControlLevelDependantBinding, BindingContext) == 0x0120);
static_assert(offsetof(FRemoteControlDeltaAPITestStruct, ColorValue) == 0x0000);
static_assert(offsetof(URemoteControlDeltaAPITestObject, VectorValue) == 0x0030);
static_assert(offsetof(URemoteControlDeltaAPITestObject, ColorValue) == 0x0048);
static_assert(offsetof(URemoteControlDeltaAPITestObject, StructValue) == 0x0058);
static_assert(offsetof(URemoteControlExposeRegistry, LabelToIdCache) == 0x0078);
...
static_assert(offsetof(URemoteControlInterceptionTestObject, CustomStruct) == 0x0028);
static_assert(offsetof(URemoteControlInterceptionTestObject, FunctionParamStruct) == 0x0030);
static_assert(offsetof(FRemoteControlPresetGroup, Name) == 0x0000);
static_assert(offsetof(FRemoteControlPresetGroup, ID) == 0x0008);
static_assert(offsetof(FRemoteControlPresetGroup, TagColor) == 0x0018);
static_assert(offsetof(FRemoteControlPresetGroup, Fields) == 0x0028);
static_assert(offsetof(FRemoteControlPresetLayout, DefaultGroupOrder) == 0x0000);
static_assert(offsetof(FRemoteControlPresetLayout, Groups) == 0x0010);
static_assert(offsetof(FRemoteControlPresetLayout, Owner) == 0x0020);
...
static_assert(offsetof(URemoteControlPreset, MetaData) == 0x00F8);
static_assert(offsetof(URemoteControlPreset, Bindings) == 0x0148);
static_assert(offsetof(URemoteControlPreset, ControllerContainer) == 0x0158);
static_assert(offsetof(URemoteControlPreset, PresetId) == 0x0160);
static_assert(offsetof(URemoteControlPreset, FieldCache) == 0x0170);
static_assert(offsetof(URemoteControlPreset, NameToGuidMap) == 0x01C0);
static_assert(offsetof(URemoteControlPreset, Registry) == 0x0210);
static_assert(offsetof(URemoteControlPreset, PropertyIdRegistry) == 0x0218);
static_assert(offsetof(ARemoteControlPresetActor, Preset) == 0x0290);
...
static_assert(offsetof(URemoteControlAPITestObject, IntArray) == 0x0038);
static_assert(offsetof(URemoteControlAPITestObject, StructOuterArray) == 0x0048);
static_assert(offsetof(URemoteControlAPITestObject, IntMap) == 0x00A8);
static_assert(offsetof(URemoteControlAPITestObject, StructOuterMap) == 0x00F8);
static_assert(offsetof(URemoteControlAPITestObject, StringColorMap) == 0x0148);
static_assert(offsetof(URemoteControlAPITestObject, ArrayOfVectors) == 0x0198);
static_assert(offsetof(URemoteControlAPITestObject, StaticMeshComponent) == 0x01A8);
static_assert(offsetof(URemoteControlAPITestObject, RemoteControlTestStructOuter) == 0x01C8);
static_assert(offsetof(URemoteControlAPITestObject, StringValue) == 0x0240);
static_assert(offsetof(URemoteControlAPITestObject, NameValue) == 0x0250);
static_assert(offsetof(URemoteControlAPITestObject, TextValue) == 0x0258);
static_assert(offsetof(URemoteControlAPITestObject, RemoteControlEnumByteValue) == 0x026A);
static_assert(offsetof(URemoteControlAPITestObject, RemoteControlEnumValue) == 0x026B);
static_assert(offsetof(URemoteControlAPITestObject, VectorValue) == 0x0270);
static_assert(offsetof(URemoteControlAPITestObject, RotatorValue) == 0x0288);
static_assert(offsetof(URemoteControlAPITestObject, ColorValue) == 0x02A0);
static_assert(offsetof(URemoteControlAPITestObject, LinearColorValue) == 0x02A4);
...
static_assert(offsetof(URemoteControlTestObject, IntArray) == 0x0038);
static_assert(offsetof(URemoteControlTestObject, FloatArray) == 0x0048);
static_assert(offsetof(URemoteControlTestObject, IntMap) == 0x00A8);
static_assert(offsetof(URemoteControlTestObject, IntInnerStructMap) == 0x00F8);
static_assert(offsetof(URemoteControlTestObject, StringColorMap) == 0x0148);
...
static_assert(offsetof(FRemoteControlEntity, ID) == 0x0078);
static_assert(offsetof(FRemoteControlActor, Path) == 0x0098);
...
static_assert(offsetof(FRemoteControlField, FieldType) == 0x0098);
static_assert(offsetof(FRemoteControlField, FieldName) == 0x009C);
static_assert(offsetof(FRemoteControlField, PropertyID) == 0x00A4);
...
static_assert(offsetof(FRemoteControlProtocolBinding, PropertyID) == 0x0018);
static_assert(offsetof(FRemoteControlProtocolBinding, MappingPropertyName) == 0x0028);
static_assert(offsetof(FRemoteControlFunction, FunctionPath) == 0x0158);
...
static_assert(offsetof(FRemoteControlInstanceMaterial, OriginalClass) == 0x0148);
static_assert(offsetof(FRemoteControlInstanceMaterial, ParameterInfo) == 0x0150);
static_assert(offsetof(FRemoteControlInstanceMaterial, OriginalFieldPathInfo) == 0x0160);
static_assert(offsetof(FRemoteControlInstanceMaterial, InstancePath) == 0x0178);
static_assert(offsetof(FRCPropertyIdWrapper, EntityID) == 0x0000);
static_assert(offsetof(FRCPropertyIdWrapper, PropertyID) == 0x0010);
static_assert(offsetof(FRCPropertyIdWrapper, SuperType) == 0x0018);
static_assert(offsetof(FRCPropertyIdWrapper, SubType) == 0x0020);
