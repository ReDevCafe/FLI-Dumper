...
public:
	...
	// class USlateRHIPostBufferProcessor* GetSlatePostProcessor(ESlatePostRT InPostBufferBit);                                 // [0x4ee5890] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FSlatePostSettings GetSlatePostSetting(ESlatePostRT InPostBufferBit);                                                    // [0x4ee5920] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/SlateRHIRenderer.SlateRHIRendererSettings.GetMutableSlatePostSetting
	// FSlatePostSettings GetMutableSlatePostSetting(ESlatePostRT InPostBufferBit);                                             // [0x4ee57a0] Final|Native|Public|BlueprintCallable 
};

#pragma pack(pop)


static_assert(sizeof(USlateFXSubsystem) == 0x00D0); // 208 bytes (0x000030 - 0x0000D0)
static_assert(sizeof(USlateRHIPostBufferProcessor) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(USlatePostBufferBlur) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(FSlatePostSettings) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(USlateRHIRendererSettings) == 0x0088); // 136 bytes (0x000038 - 0x000088)
static_assert(offsetof(USlateFXSubsystem, SlatePostBufferProcessors) == 0x0030);
static_assert(offsetof(FSlatePostSettings, PostProcessorClass) == 0x0008);
static_assert(offsetof(FSlatePostSettings, PathToSlatePostRT) == 0x0010);
static_assert(offsetof(FSlatePostSettings, CachedSlatePostRT) == 0x0020);
static_assert(offsetof(USlateRHIRendererSettings, SlatePostSettings) == 0x0038);
