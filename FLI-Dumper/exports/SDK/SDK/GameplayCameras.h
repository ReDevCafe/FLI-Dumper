...
public:
	...
	// class ULegacyCameraShake* StartLegacyCameraShakeFromSource(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, class UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot); // [0x661a470] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayCameras.LegacyCameraShake.StartLegacyCameraShake
	// class ULegacyCameraShake* StartLegacyCameraShake(class APlayerCameraManager* PlayerCameraManager, class UClass* ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot); // [0x661a230] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayCameras.LegacyCameraShake.ReceiveStopShake
	// void ReceiveStopShake(bool bImmediately);                                                                                // [0x3618b30] Event|Public|BlueprintEvent 
	// Function /Script/GameplayCameras.LegacyCameraShake.ReceivePlayShake
	// void ReceivePlayShake(float Scale);                                                                                      // [0x3618b30] Event|Public|BlueprintEvent 
	// Function /Script/GameplayCameras.LegacyCameraShake.ReceiveIsFinished
	// bool ReceiveIsFinished();                                                                                                // [0x59a6fe0] Native|Event|Public|BlueprintEvent|Const 
	// Function /Script/GameplayCameras.LegacyCameraShake.BlueprintUpdateCameraShake
	// void BlueprintUpdateCameraShake(float DeltaTime, float Alpha, FMinimalViewInfo& POV, FMinimalViewInfo& ModifiedPOV);     // [0x3618b30] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// class ULegacyCameraShake* Conv_LegacyCameraShake(class UCameraShakeBase* CameraShake);                                   // [0x6619230] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void StopCameraAnimation(FCameraAnimationHandle& Handle, bool bImmediate);                                               // [0x661ab70] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.StopAllCameraAnimationsOf
	// void StopAllCameraAnimationsOf(class UCameraAnimationSequence* Sequence, bool bImmediate);                               // [0x661a8a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.StopAllCameraAnimations
	// void StopAllCameraAnimations(bool bImmediate);                                                                           // [0x661a6e0] Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.PlayCameraAnimation
	// FCameraAnimationHandle PlayCameraAnimation(class UCameraAnimationSequence* Sequence, FCameraAnimationParams Params);     // [0x6619820] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.IsCameraAnimationActive
	// bool IsCameraAnimationActive(FCameraAnimationHandle& Handle);                                                            // [0x66195b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.GetCameraAnimationCameraModifierFromPlayerController
	// class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifierFromPlayerController(class APlayerController* PlayerController); // [0x66194d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.GetCameraAnimationCameraModifierFromID
	// class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifierFromID(class UObject* WorldContextObject, int32_t ControllerId); // [0x66193c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/GameplayCameras.CameraAnimationCameraModifier.GetCameraAnimationCameraModifier
	// class UCameraAnimationCameraModifier* GetCameraAnimationCameraModifier(class UObject* WorldContextObject, int32_t playerIndex); // [0x66192b0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// ECameraShakePlaySpace Conv_CameraShakePlaySpace(ECameraAnimationPlaySpace CameraAnimationPlaySpace);                     // [0x6619180] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/GameplayCameras.GameplayCamerasFunctionLibrary.Conv_CameraAnimationPlaySpace
	// ECameraAnimationPlaySpace Conv_CameraAnimationPlaySpace(ECameraShakePlaySpace CameraShakePlaySpace);                     // [0x6619180] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/GameplayCameras.GameplayCamerasFunctionLibrary.Conv_CameraAnimationCameraModifier
	// class UCameraAnimationCameraModifier* Conv_CameraAnimationCameraModifier(class APlayerCameraManager* PlayerCameraManager); // [0x6619080] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class USceneComponent* GetSceneComponent();                                                                              // [0x4fd2b50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayCameras.GameplayCameraActor.GetCameraComponent
	// class UGameplayCameraComponent* GetCameraComponent();                                                                    // [0x54855c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ActivateCamera(int32_t playerIndex);                                                                                // [0x6618ec0] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UGameplayCameraSystemComponent* GetCameraSystemComponent();                                                        // [0x4fd2b50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GameplayCameras.GameplayCameraSystemActor.ActivateForPlayer
	// void ActivateForPlayer(int32_t playerIndex);                                                                             // [0x6618fb0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UCameraSystemEvaluator* GetCameraSystemEvaluator();                                                                // [0x581b9f0] Final|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void StopCameraAnimation(class APlayerController* PlayerController, FCameraAnimationHandle& Handle, bool bImmediate);    // [0x661ac50] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GameplayCameras.GameplayCamerasSubsystem.StopAllCameraAnimationsOf
	// void StopAllCameraAnimationsOf(class APlayerController* PlayerController, class UCameraAnimationSequence* Sequence, bool bImmediate); // [0x661a9c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.GameplayCamerasSubsystem.StopAllCameraAnimations
	// void StopAllCameraAnimations(class APlayerController* PlayerController, bool bImmediate);                                // [0x661a770] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.GameplayCamerasSubsystem.PlayCameraAnimation
	// FCameraAnimationHandle PlayCameraAnimation(class APlayerController* PlayerController, class UCameraAnimationSequence* Sequence, FCameraAnimationParams Params); // [0x6619cd0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GameplayCameras.GameplayCamerasSubsystem.IsCameraAnimationActive
	// bool IsCameraAnimationActive(class APlayerController* PlayerController, FCameraAnimationHandle& Handle);                 // [0x66196a0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(UCameraInstantiableObject) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UCameraNode) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UBlendCameraNode) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UBlendStackCameraNode) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(UBlendStackRootCameraNode) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(FCameraModeTransition) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(UCameraAsset) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UCameraDirector) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UCameraEvaluationContext) == 0x00A8); // 168 bytes (0x000028 - 0x0000A8)
static_assert(sizeof(UCameraMode) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UCameraModeTransitionCondition) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UCameraSystemEvaluator) == 0x0188); // 392 bytes (0x000028 - 0x000188)
static_assert(sizeof(URootCameraNode) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UDefaultRootCameraNode) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(USingleCameraDirector) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(AGameplayCameraActor) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
static_assert(sizeof(UGameplayCameraComponent) == 0x0240); // 576 bytes (0x000230 - 0x000240)
static_assert(sizeof(UGameplayCameraComponentEvaluationContext) == 0x00A8); // 168 bytes (0x0000A8 - 0x0000A8)
static_assert(sizeof(AGameplayCameraSystemActor) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
static_assert(sizeof(UGameplayCameraSystemComponent) == 0x0240); // 576 bytes (0x000230 - 0x000240)
static_assert(sizeof(UGameplayCamerasSubsystem) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(USimpleBlendCameraNode) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(USimpleFixedTimeBlendCameraNode) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(ULinearBlendCameraNode) == 0x0040); // 64 bytes (0x000040 - 0x000040)
static_assert(sizeof(UPopBlendCameraNode) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(USmoothBlendCameraNode) == 0x0048); // 72 bytes (0x000040 - 0x000048)
static_assert(sizeof(UArrayCameraNode) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UOffsetCameraNode) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(UCompositeCameraShakePattern) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UDefaultCameraShakeBase) == 0x00E0); // 224 bytes (0x0000D8 - 0x0000E0)
static_assert(sizeof(USimpleCameraShakePattern) == 0x0058); // 88 bytes (0x000028 - 0x000058)
static_assert(sizeof(FPerlinNoiseShaker) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(UPerlinNoiseCameraShakePattern) == 0x00D8); // 216 bytes (0x000058 - 0x0000D8)
static_assert(sizeof(FWaveOscillator) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(UWaveOscillatorCameraShakePattern) == 0x00F8); // 248 bytes (0x000058 - 0x0000F8)
static_assert(sizeof(UTestCameraShake) == 0x00E0); // 224 bytes (0x0000D8 - 0x0000E0)
static_assert(sizeof(UConstantCameraShakePattern) == 0x0088); // 136 bytes (0x000058 - 0x000088)
static_assert(sizeof(FCameraPose) == 0x0070); // 112 bytes (0x000000 - 0x000070)
...
static_assert(offsetof(ULegacyCameraShake, SequenceShakePattern) == 0x01D8);
...
static_assert(offsetof(UBlendStackRootCameraNode, Blend) == 0x0030);
static_assert(offsetof(UBlendStackRootCameraNode, RootNode) == 0x0038);
static_assert(offsetof(FCameraModeTransition, Conditions) == 0x0000);
static_assert(offsetof(FCameraModeTransition, Blend) == 0x0010);
static_assert(offsetof(UCameraAsset, CameraDirector) == 0x0028);
static_assert(offsetof(UCameraAsset, EnterTransitions) == 0x0030);
static_assert(offsetof(UCameraAsset, ExitTransitions) == 0x0040);
static_assert(offsetof(UCameraEvaluationContext, CameraAsset) == 0x0028);
static_assert(offsetof(UCameraMode, RootNode) == 0x0028);
static_assert(offsetof(UCameraMode, EnterTransitions) == 0x0030);
static_assert(offsetof(UCameraMode, ExitTransitions) == 0x0040);
static_assert(offsetof(UCameraSystemEvaluator, RootNode) == 0x0028);
static_assert(offsetof(UDefaultRootCameraNode, BaseLayer) == 0x0030);
static_assert(offsetof(UDefaultRootCameraNode, MainLayer) == 0x0038);
static_assert(offsetof(UDefaultRootCameraNode, GlobalLayer) == 0x0040);
static_assert(offsetof(UDefaultRootCameraNode, VisualLayer) == 0x0048);
static_assert(offsetof(USingleCameraDirector, CameraMode) == 0x0028);
static_assert(offsetof(AGameplayCameraActor, SceneComponent) == 0x0290);
static_assert(offsetof(AGameplayCameraActor, CameraComponent) == 0x0298);
static_assert(offsetof(UGameplayCameraComponent, Camera) == 0x0230);
static_assert(offsetof(UGameplayCameraComponent, EvaluationContext) == 0x0238);
static_assert(offsetof(AGameplayCameraSystemActor, CameraSystemComponent) == 0x0290);
static_assert(offsetof(AGameplayCameraSystemActor, AutoActivateForPlayer) == 0x0298);
static_assert(offsetof(UGameplayCameraSystemComponent, Evaluator) == 0x0230);
static_assert(offsetof(USmoothBlendCameraNode, BlendType) == 0x0040);
static_assert(offsetof(UArrayCameraNode, Children) == 0x0030);
static_assert(offsetof(UOffsetCameraNode, Offset) == 0x0030);
static_assert(offsetof(UCompositeCameraShakePattern, ChildPatterns) == 0x0028);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, X) == 0x0060);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Y) == 0x0068);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Z) == 0x0070);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Pitch) == 0x0080);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Yaw) == 0x0088);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, Roll) == 0x0090);
static_assert(offsetof(UPerlinNoiseCameraShakePattern, FOV) == 0x0098);
static_assert(offsetof(FWaveOscillator, InitialOffsetType) == 0x0008);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, X) == 0x0060);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Y) == 0x006C);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Z) == 0x0078);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Pitch) == 0x008C);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Yaw) == 0x0098);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, Roll) == 0x00A4);
static_assert(offsetof(UWaveOscillatorCameraShakePattern, FOV) == 0x00B0);
static_assert(offsetof(UConstantCameraShakePattern, LocationOffset) == 0x0058);
static_assert(offsetof(UConstantCameraShakePattern, RotationOffset) == 0x0070);
static_assert(offsetof(FCameraPose, Location) == 0x0000);
static_assert(offsetof(FCameraPose, Rotation) == 0x0018);
