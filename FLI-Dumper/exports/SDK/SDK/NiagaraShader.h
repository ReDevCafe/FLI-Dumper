...
static_assert(sizeof(FSimulationStageMetaData) == 0x00A8); // 168 bytes (0x000000 - 0x0000A8)
static_assert(sizeof(FNiagaraCompileEvent) == 0x0060); // 96 bytes (0x000000 - 0x000060)
static_assert(sizeof(FNiagaraDataInterfaceGeneratedFunction) == 0x0050); // 80 bytes (0x000000 - 0x000050)
...
static_assert(offsetof(FSimulationStageMetaData, ElementCount) == 0x0010);
static_assert(offsetof(FSimulationStageMetaData, ElementCountXBinding) == 0x001C);
static_assert(offsetof(FSimulationStageMetaData, ElementCountYBinding) == 0x0024);
static_assert(offsetof(FSimulationStageMetaData, ElementCountZBinding) == 0x002C);
static_assert(offsetof(FSimulationStageMetaData, IterationSourceType) == 0x0034);
static_assert(offsetof(FSimulationStageMetaData, IterationDataInterface) == 0x0038);
static_assert(offsetof(FSimulationStageMetaData, IterationDirectBinding) == 0x0040);
static_assert(offsetof(FSimulationStageMetaData, ExecuteBehavior) == 0x0048);
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateBinding) == 0x0050);
static_assert(offsetof(FSimulationStageMetaData, ParticleIterationStateRange) == 0x005C);
static_assert(offsetof(FSimulationStageMetaData, OutputDestinations) == 0x0068);
static_assert(offsetof(FSimulationStageMetaData, InputDataInterfaces) == 0x0078);
static_assert(offsetof(FSimulationStageMetaData, NumIterationsBinding) == 0x008C);
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchType) == 0x0094);
static_assert(offsetof(FSimulationStageMetaData, GpuDirectDispatchElementType) == 0x0095);
static_assert(offsetof(FSimulationStageMetaData, GpuDispatchNumThreads) == 0x0098);
...
static_assert(offsetof(FNiagaraCompileEvent, NodeGuid) == 0x0028);
static_assert(offsetof(FNiagaraCompileEvent, PinGuid) == 0x0038);
static_assert(offsetof(FNiagaraCompileEvent, StackGuids) == 0x0048);
static_assert(offsetof(FNiagaraCompileEvent, Source) == 0x0058);
static_assert(offsetof(FNiagaraDataInterfaceGeneratedFunction, VariadicInputs) == 0x0030);
static_assert(offsetof(FNiagaraDataInterfaceGeneratedFunction, VariadicOutputs) == 0x0040);
