...
static_assert(sizeof(UNetObjectFilterConfig) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UFilterOutNetObjectFilterConfig) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNetObjectFilter) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UFilterOutNetObjectFilter) == 0x0050); // 80 bytes (0x000050 - 0x000050)
...
static_assert(sizeof(UNetObjectConnectionFilterConfig) == 0x0038); // 56 bytes (0x000030 - 0x000038)
static_assert(sizeof(UNetObjectConnectionFilter) == 0x00A0); // 160 bytes (0x000050 - 0x0000A0)
...
static_assert(sizeof(FNetObjectGridFilterProfile) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(UNetObjectGridFilterConfig) == 0x0090); // 144 bytes (0x000030 - 0x000090)
static_assert(sizeof(UNetObjectGridFilter) == 0x0100); // 256 bytes (0x000050 - 0x000100)
static_assert(sizeof(UNetObjectGridWorldLocFilter) == 0x0108); // 264 bytes (0x000100 - 0x000108)
static_assert(sizeof(UNetObjectGridFragmentLocFilter) == 0x0150); // 336 bytes (0x000100 - 0x000150)
...
static_assert(sizeof(UNopNetObjectFilterConfig) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UNopNetObjectFilter) == 0x0050); // 80 bytes (0x000050 - 0x000050)
static_assert(sizeof(UReplicationBridge) == 0x0110); // 272 bytes (0x000028 - 0x000110)
static_assert(sizeof(UObjectReplicationBridge) == 0x0550); // 1360 bytes (0x000110 - 0x000550)
static_assert(sizeof(FObjectReplicationBridgePollConfig) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FObjectReplicationBridgeFilterConfig) == 0x001C); // 28 bytes (0x000000 - 0x00001C)
static_assert(sizeof(FObjectReplicationBridgePrioritizerConfig) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(FObjectReplicationBridgeDeltaCompressionConfig) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FObjectReplicatedBridgeCriticalClassConfig) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FObjectReplicationBridgeTypeStatsConfig) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(UObjectReplicationBridgeConfig) == 0x00B0); // 176 bytes (0x000028 - 0x0000B0)
static_assert(sizeof(USequentialPartialNetBlobHandlerConfig) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UPartialNetObjectAttachmentHandlerConfig) == 0x0040); // 64 bytes (0x000030 - 0x000040)
...
static_assert(sizeof(UReplicationSystem) == 0x0058); // 88 bytes (0x000028 - 0x000058)
...
static_assert(sizeof(FLastResortPropertyNetSerializerConfig) == 0x0038); // 56 bytes (0x000010 - 0x000038)
...
static_assert(sizeof(FIrisFastArraySerializer) == 0x0120); // 288 bytes (0x000108 - 0x000120)
...
static_assert(sizeof(FPackedInt64NetSerializerConfig) == 0x0010); // 16 bytes (0x000010 - 0x000010)
static_assert(sizeof(FPackedUint64NetSerializerConfig) == 0x0010); // 16 bytes (0x000010 - 0x000010)
...
static_assert(sizeof(FRotator3fNetSerializerConfig) == 0x0010); // 16 bytes (0x000010 - 0x000010)
static_assert(sizeof(FRotator3dNetSerializerConfig) == 0x0010); // 16 bytes (0x000010 - 0x000010)
...
static_assert(offsetof(UNetObjectFilterConfig, filterType) == 0x0028);
...
static_assert(offsetof(FNetObjectGridFilterProfile, FilterProfileName) == 0x0000);
static_assert(offsetof(UNetObjectGridFilterConfig, MinPos) == 0x0048);
static_assert(offsetof(UNetObjectGridFilterConfig, MaxPos) == 0x0060);
static_assert(offsetof(UNetObjectGridFilterConfig, FilterProfiles) == 0x0080);
...
static_assert(offsetof(FObjectReplicationBridgeFilterConfig, FilterProfile) == 0x0010);
...
static_assert(offsetof(FObjectReplicatedBridgeCriticalClassConfig, ClassName) == 0x0000);
static_assert(offsetof(FObjectReplicationBridgeTypeStatsConfig, ClassName) == 0x0000);
static_assert(offsetof(FObjectReplicationBridgeTypeStatsConfig, TypeStatsName) == 0x0008);
...
static_assert(offsetof(UObjectReplicationBridgeConfig, CriticalClassConfigs) == 0x0068);
static_assert(offsetof(UObjectReplicationBridgeConfig, TypeStatsConfigs) == 0x0080);
static_assert(offsetof(UObjectReplicationBridgeConfig, DefaultSpatialFilterName) == 0x0090);
static_assert(offsetof(UObjectReplicationBridgeConfig, RequiredNetDriverChannelClassName) == 0x0098);
static_assert(offsetof(UObjectReplicationBridgeConfig, CriticalActorClasses) == 0x00A0);
