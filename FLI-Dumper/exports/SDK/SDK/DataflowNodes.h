...
static_assert(sizeof(FDataflowCollectionAddScalarVertexPropertyNode) == 0x01B8); // 440 bytes (0x0000E8 - 0x0001B8)
...
static_assert(offsetof(FDataflowCollectionAddScalarVertexPropertyNode, Collection) == 0x00E8);
static_assert(offsetof(FDataflowCollectionAddScalarVertexPropertyNode, Name) == 0x0198);
static_assert(offsetof(FDataflowCollectionAddScalarVertexPropertyNode, VertexWeights) == 0x01A8);
