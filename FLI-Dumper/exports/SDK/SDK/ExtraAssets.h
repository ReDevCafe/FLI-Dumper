...
public:
	...
	// void ImportCSV();                                                                                                        // [0x6748130] Final|Native|Public  
	// Function /Script/ExtraAssets.GameDataAsset.ExportCSV
	// void ExportCSV();                                                                                                        // [0x6748110] Final|Native|Public|Const 
};
...
static_assert(sizeof(UGameDataAsset) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UTextAsset) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(FGDAuto) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FGDId) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(offsetof(UGameDataAsset, m_autoBin) == 0x0030);
static_assert(offsetof(UGameDataAsset, m_autoStr) == 0x0040);
static_assert(offsetof(UTextAsset, myString) == 0x0028);
static_assert(offsetof(FGDAuto, m_pAsset) == 0x0008);
static_assert(offsetof(FGDId, Name) == 0x0004);
