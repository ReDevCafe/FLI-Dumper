...
static_assert(sizeof(FStyleColorList) == 0x07A0); // 1952 bytes (0x000000 - 0x0007A0)
static_assert(sizeof(USlateThemeManager) == 0x07D8); // 2008 bytes (0x000028 - 0x0007D8)
...
static_assert(sizeof(FFontSdfSettings) == 0x0004); // 4 bytes (0x000000 - 0x000004)
...
static_assert(sizeof(FCompositeFont) == 0x0040); // 64 bytes (0x000000 - 0x000040)
...
static_assert(sizeof(FStyleTheme) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(FToolBarStyle) == 0x3E90); // 16016 bytes (0x000008 - 0x003E90)
...
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x007C);
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x0084);
static_assert(offsetof(FTextBlockStyle, SelectedBackgroundColor) == 0x0094);
static_assert(offsetof(FTextBlockStyle, HighlightColor) == 0x00A8);
...
static_assert(offsetof(FToolBarStyle, IconPadding) == 0x3DDC);
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x3DEC);
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x3DFC);
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x3E0C);
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x3E1C);
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x3E2C);
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x3E3C);
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x3E4C);
static_assert(offsetof(FToolBarStyle, IconSize) == 0x3E5C);
static_assert(offsetof(FToolBarStyle, IconPaddingWithVisibleLabel) == 0x3E70);
static_assert(offsetof(FToolBarStyle, IconPaddingWithCollapsedLabel) == 0x3E80);
