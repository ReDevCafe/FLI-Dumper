...
static_assert(sizeof(UDisplayTextListWidget) == 0x0360); // 864 bytes (0x0002E0 - 0x000360)
static_assert(sizeof(UDisplayTextUMGSettings) == 0x0068); // 104 bytes (0x000038 - 0x000068)
static_assert(sizeof(UDisplayTextUMGSubsystem) == 0x00A8); // 168 bytes (0x000030 - 0x0000A8)
static_assert(offsetof(UDisplayTextUMGSettings, DisplayTextListWidgetPath) == 0x0038);
static_assert(offsetof(UDisplayTextUMGSubsystem, m_widget) == 0x0030);
