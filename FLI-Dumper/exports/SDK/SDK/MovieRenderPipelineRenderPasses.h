...
static_assert(sizeof(UMovieGraphImagePassBaseNode) == 0x00B8); // 184 bytes (0x000098 - 0x0000B8)
static_assert(sizeof(FMoviePipelinePostProcessPass) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(UMovieGraphDeferredRenderPassNode) == 0x00D8); // 216 bytes (0x0000B8 - 0x0000D8)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode) == 0x01C8); // 456 bytes (0x0000B0 - 0x0001C8)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_EXR) == 0x01D0); // 464 bytes (0x0001C8 - 0x0001D0)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_MultiLayerEXR) == 0x01D0); // 464 bytes (0x0001D0 - 0x0001D0)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_BMP) == 0x01C8); // 456 bytes (0x0001C8 - 0x0001C8)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_JPG) == 0x01C8); // 456 bytes (0x0001C8 - 0x0001C8)
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_PNG) == 0x01C8); // 456 bytes (0x0001C8 - 0x0001C8)
static_assert(sizeof(UMovieGraphPathTracerRenderPassNode) == 0x00E0); // 224 bytes (0x0000B8 - 0x0000E0)
static_assert(sizeof(UMoviePipelineImagePassBase) == 0x0178); // 376 bytes (0x000048 - 0x000178)
static_assert(sizeof(UMoviePipelineDeferredPassBase) == 0x0238); // 568 bytes (0x000178 - 0x000238)
static_assert(sizeof(UMoviePipelineDeferredPass_Unlit) == 0x0238); // 568 bytes (0x000238 - 0x000238)
static_assert(sizeof(UMoviePipelineDeferredPass_DetailLighting) == 0x0238); // 568 bytes (0x000238 - 0x000238)
static_assert(sizeof(UMoviePipelineDeferredPass_LightingOnly) == 0x0238); // 568 bytes (0x000238 - 0x000238)
static_assert(sizeof(UMoviePipelineDeferredPass_ReflectionsOnly) == 0x0238); // 568 bytes (0x000238 - 0x000238)
static_assert(sizeof(UMoviePipelineDeferredPass_PathTracer) == 0x0240); // 576 bytes (0x000238 - 0x000240)
...
static_assert(sizeof(UMoviePipelineImageSequenceOutput_PNG) == 0x0070); // 112 bytes (0x000068 - 0x000070)
...
static_assert(offsetof(UMovieGraphImagePassBaseNode, ShowFlags) == 0x00A0);
static_assert(offsetof(FMoviePipelinePostProcessPass, Material) == 0x0008);
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, AntiAliasingMethod) == 0x00C0);
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, ViewModeIndex) == 0x00C4);
static_assert(offsetof(UMovieGraphDeferredRenderPassNode, AdditionalPostProcessMaterials) == 0x00C8);
static_assert(offsetof(UMovieGraphImageSequenceOutputNode, OCIOConfiguration) == 0x00B8);
static_assert(offsetof(UMovieGraphImageSequenceOutputNode, OCIOContext) == 0x0158);
static_assert(offsetof(UMovieGraphImageSequenceOutputNode_EXR, Compression) == 0x01C9);
static_assert(offsetof(UMovieGraphPathTracerRenderPassNode, AdditionalPostProcessMaterials) == 0x00C8);
static_assert(offsetof(UMoviePipelineDeferredPassBase, AdditionalPostProcessMaterials) == 0x0180);
static_assert(offsetof(UMoviePipelineDeferredPassBase, ActorLayers) == 0x0198);
static_assert(offsetof(UMoviePipelineDeferredPassBase, DataLayers) == 0x01B8);
static_assert(offsetof(UMoviePipelineDeferredPassBase, ActivePostProcessMaterials) == 0x01C8);
static_assert(offsetof(UMoviePipelineDeferredPassBase, StencilLayerMaterial) == 0x01D8);
