...
public:
	...
	// FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision);                             // [0x4fdee60] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetSolverActive(bool bActive);                                                                                      // [0x4fdf130] RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosSolverEngine.ChaosSolverActor.SetAsCurrentWorldSolver
	// void SetAsCurrentWorldSolver();                                                                                          // [0x4fdf110] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UChaosGameplayEventDispatcher) == 0x02B8); // 696 bytes (0x0000A8 - 0x0002B8)
...
static_assert(sizeof(AChaosSolverActor) == 0x0390); // 912 bytes (0x000290 - 0x000390)
...
static_assert(offsetof(UChaosGameplayEventDispatcher, CollisionEventRegistrations) == 0x0168);
static_assert(offsetof(UChaosGameplayEventDispatcher, BreakEventRegistrations) == 0x01B8);
static_assert(offsetof(UChaosGameplayEventDispatcher, RemovalEventRegistrations) == 0x0208);
static_assert(offsetof(UChaosGameplayEventDispatcher, CrumblingEventRegistrations) == 0x0258);
static_assert(offsetof(AChaosSolverActor, Properties) == 0x0290);
static_assert(offsetof(AChaosSolverActor, ClusterUnionConnectionType) == 0x0310);
static_assert(offsetof(AChaosSolverActor, CollisionFilterSettings) == 0x0314);
static_assert(offsetof(AChaosSolverActor, BreakingFilterSettings) == 0x0328);
static_assert(offsetof(AChaosSolverActor, TrailingFilterSettings) == 0x033C);
static_assert(offsetof(AChaosSolverActor, ChaosDebugSubstepControl) == 0x0358);
static_assert(offsetof(AChaosSolverActor, SpriteComponent) == 0x0360);
static_assert(offsetof(AChaosSolverActor, GameplayEventDispatcherComponent) == 0x0380);
