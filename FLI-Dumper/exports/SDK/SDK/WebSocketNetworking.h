...
static_assert(sizeof(UWebSocketConnection) == 0x1E10); // 7696 bytes (0x001E00 - 0x001E10)
static_assert(sizeof(UWebSocketNetDriver) == 0x08D8); // 2264 bytes (0x0008C8 - 0x0008D8)
