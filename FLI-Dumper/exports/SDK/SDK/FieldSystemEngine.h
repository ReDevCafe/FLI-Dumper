...
public:
	...
	// void ResetFieldSystem();                                                                                                 // [0x4fe7b50] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.RemovePersistentFields
	// void RemovePersistentFields();                                                                                           // [0x4fe7b30] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyUniformVectorFalloffForce
	// void ApplyUniformVectorFalloffForce(bool Enabled, FVector Position, FVector Direction, float Radius, float Magnitude);   // [0x4fe77f0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStrainField
	// void ApplyStrainField(bool Enabled, FVector Position, float Radius, float Magnitude, int32_t Iterations);                // [0x4fe7560] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyStayDynamicField
	// void ApplyStayDynamicField(bool Enabled, FVector Position, float Radius);                                                // [0x4fe7350] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialVectorFalloffForce
	// void ApplyRadialVectorFalloffForce(bool Enabled, FVector Position, float Radius, float Magnitude);                       // [0x4fe7060] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyRadialForce
	// void ApplyRadialForce(bool Enabled, FVector Position, float Magnitude);                                                  // [0x4fe6e60] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyPhysicsField
	// void ApplyPhysicsField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x4fe6d00] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.ApplyLinearForce
	// void ApplyLinearForce(bool Enabled, FVector Direction, float Magnitude);                                                 // [0x4fe6b00] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddPersistentField
	// void AddPersistentField(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x4fe69a0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/FieldSystemEngine.FieldSystemComponent.AddFieldCommand
	// void AddFieldCommand(bool Enabled, TEnumAsByte<EFieldPhysicsType> Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x4fe6840] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// class UFieldSystemMetaDataIteration* SetMetaDataIteration(int32_t Iterations);                                           // [0x4fe8140] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataProcessingResolution* SetMetaDataaProcessingResolutionType(TEnumAsByte<EFieldResolutionType> ResolutionType); // [0x4fe81e0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UFieldSystemMetaDataFilter* SetMetaDataFilterType(TEnumAsByte<EFieldFilterType> filterType, TEnumAsByte<EFieldObjectType> ObjectType, TEnumAsByte<EFieldPositionType> PositionType); // [0x4fe8030] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformInteger* SetUniformInteger(int32_t Magnitude);                                                             // [0x4fe8140] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialIntMask* SetRadialIntMask(float Radius, FVector Position, int32_t InteriorValue, int32_t ExteriorValue, TEnumAsByte<ESetMaskConditionType> SetMaskConditionIn); // [0x4fe8ad0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformScalar* SetUniformScalar(float Magnitude);                                                                 // [0x4fe8d90] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UWaveScalar* SetWaveScalar(float Magnitude, FVector Position, float Wavelength, float Period, float Time, TEnumAsByte<EWaveFunctionType> Function, TEnumAsByte<EFieldFalloffType> Falloff); // [0x4fe8ef0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialFalloff* SetRadialFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Radius, FVector Position, TEnumAsByte<EFieldFalloffType> Falloff); // [0x4fe8880] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UPlaneFalloff* SetPlaneFalloff(float Magnitude, float MinRange, float MaxRange, float Default, float Distance, FVector Position, FVector Normal, TEnumAsByte<EFieldFalloffType> Falloff); // [0x4fe85e0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UBoxFalloff* SetBoxFalloff(float Magnitude, float MinRange, float MaxRange, float Default, FTransform Transform, TEnumAsByte<EFieldFalloffType> Falloff); // [0x4fe7c40] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UNoiseField* SetNoiseField(float MinRange, float MaxRange, FTransform Transform);                                  // [0x4fe8270] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UUniformVector* SetUniformVector(float Magnitude, FVector Direction);                                              // [0x4fe8ca0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URadialVector* SetRadialVector(float Magnitude, FVector Position);                                                 // [0x4fe8ca0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class URandomVector* SetRandomVector(float Magnitude);                                                                   // [0x4fe8d90] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UOperatorField* SetOperatorField(float Magnitude, class UFieldNodeBase* LeftField, class UFieldNodeBase* RightField, TEnumAsByte<EFieldOperationType> Operation); // [0x4fe8440] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToIntegerField* SetToIntegerField(class UFieldNodeFloat* FloatField);                                             // [0x4fe8e40] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UToFloatField* SetToFloatField(class UFieldNodeInt* IntegerField);                                                 // [0x4fe8e40] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UCullingField* SetCullingField(class UFieldNodeBase* Culling, class UFieldNodeBase* Field, TEnumAsByte<EFieldCullingOperationType> Operation); // [0x4fe7ee0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UReturnResultsTerminal* SetReturnResultsTerminal();                                                                // [0x4fe8e20] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UFieldSystemComponent) == 0x05F0); // 1520 bytes (0x000518 - 0x0005F0)
...
static_assert(offsetof(UFieldSystemComponent, FieldSystem) == 0x0518);
static_assert(offsetof(UFieldSystemComponent, ConstructionCommands) == 0x0538);
static_assert(offsetof(UFieldSystemComponent, BufferCommands) == 0x0568);
