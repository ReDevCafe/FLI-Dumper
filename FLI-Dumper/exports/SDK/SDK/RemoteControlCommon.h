...
public:
	...
	SDK_UNDEFINED(80,1190) /* TSet<FRCNetworkAddressRange> */ __um(AllowlistedClients);                            // 0x0088   (0x0050)  
	...
	SDK_UNDEFINED(80,1191) /* TSet<FName> */           __um(EntitiesListHiddenColumns);                            // 0x0108   (0x0050)  
...
static_assert(sizeof(URCPropertyContainerBase) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(FRCPropertyContainerKey) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(URCPropertyContainerRegistry) == 0x0080); // 128 bytes (0x000030 - 0x000080)
static_assert(sizeof(UPropertyContainerTestObject) == 0x00B0); // 176 bytes (0x000028 - 0x0000B0)
static_assert(sizeof(FRCPassphrase) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(URemoteControlSettings) == 0x0168); // 360 bytes (0x000038 - 0x000168)
...
static_assert(offsetof(URCPropertyContainerRegistry, CachedContainerClasses) == 0x0030);
static_assert(offsetof(UPropertyContainerTestObject, SomeVector) == 0x0038);
static_assert(offsetof(UPropertyContainerTestObject, SomeRotator) == 0x0050);
static_assert(offsetof(UPropertyContainerTestObject, SomeString) == 0x0080);
static_assert(offsetof(UPropertyContainerTestObject, SomeText) == 0x0090);
static_assert(offsetof(UPropertyContainerTestObject, SomeFloatArray) == 0x00A0);
static_assert(offsetof(FRCPassphrase, Identifier) == 0x0000);
static_assert(offsetof(FRCPassphrase, Passphrase) == 0x0010);
static_assert(offsetof(URemoteControlSettings, RemoteControlWebInterfaceBindAddress) == 0x0040);
static_assert(offsetof(URemoteControlSettings, RemoteControlWebsocketServerBindAddress) == 0x0060);
static_assert(offsetof(URemoteControlSettings, AllowedOrigin) == 0x00D8);
static_assert(offsetof(URemoteControlSettings, Passphrases) == 0x00F0);
static_assert(offsetof(URemoteControlSettings, DefaultPanelMode) == 0x0158);
