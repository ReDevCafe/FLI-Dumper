...
static_assert(sizeof(FRigUnit_FullbodyIK) == 0x0450); // 1104 bytes (0x0001D0 - 0x000450)
...
static_assert(offsetof(FRigUnit_FullbodyIK, Root) == 0x01D0);
static_assert(offsetof(FRigUnit_FullbodyIK, Effectors) == 0x01E0);
static_assert(offsetof(FRigUnit_FullbodyIK, Constraints) == 0x01F0);
static_assert(offsetof(FRigUnit_FullbodyIK, SolverProperty) == 0x0200);
static_assert(offsetof(FRigUnit_FullbodyIK, MotionProperty) == 0x0224);
static_assert(offsetof(FRigUnit_FullbodyIK, DebugOption) == 0x0230);
static_assert(offsetof(FRigUnit_FullbodyIK, WorkData) == 0x02B0);
