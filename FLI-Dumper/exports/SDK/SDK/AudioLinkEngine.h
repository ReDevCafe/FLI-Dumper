...
public:
	...
	// void StopLink();                                                                                                         // [0x53b7ad0] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.SetLinkSound
	// void SetLinkSound(class USoundBase* NewSound);                                                                           // [0x53b7a40] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.PlayLink
	// void PlayLink(float StartTime);                                                                                          // [0x53b79c0] Native|Public|BlueprintCallable 
	// Function /Script/AudioLinkEngine.AudioLinkBlueprintInterface.IsLinkPlaying
	// bool IsLinkPlaying();                                                                                                    // [0x53b7990] Native|Public|BlueprintCallable|BlueprintPure|Const 
};

#pragma pack(pop)


static_assert(sizeof(UAudioLinkBlueprintInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
