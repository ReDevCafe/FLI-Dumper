...
static_assert(sizeof(UCsvActorCountMetric) == 0x0088); // 136 bytes (0x000028 - 0x000088)
static_assert(sizeof(UCsvMetricsSubsystem) == 0x0060); // 96 bytes (0x000030 - 0x000060)
static_assert(offsetof(UCsvMetricsSubsystem, MetricClasses) == 0x0030);
