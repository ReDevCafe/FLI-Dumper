...
static_assert(sizeof(FMovieSceneGeometryCollectionParams) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(UMovieSceneGeometryCollectionSection) == 0x0128); // 296 bytes (0x0000F0 - 0x000128)
static_assert(sizeof(UMovieSceneGeometryCollectionTrack) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(FMovieSceneGeometryCollectionSectionTemplateParameters) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(FMovieSceneGeometryCollectionSectionTemplate) == 0x0060); // 96 bytes (0x000020 - 0x000060)
static_assert(offsetof(FMovieSceneGeometryCollectionParams, GeometryCollectionCache) == 0x0008);
static_assert(offsetof(FMovieSceneGeometryCollectionParams, StartFrameOffset) == 0x0028);
static_assert(offsetof(FMovieSceneGeometryCollectionParams, EndFrameOffset) == 0x002C);
...
static_assert(offsetof(FMovieSceneGeometryCollectionSectionTemplateParameters, SectionStartTime) == 0x0038);
static_assert(offsetof(FMovieSceneGeometryCollectionSectionTemplateParameters, SectionEndTime) == 0x003C);
