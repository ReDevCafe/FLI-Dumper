...
public:
	...
	// class UGeometryCacheComponent* GetGeometryCacheComponent();                                                              // [0x4fd2b50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void TickAtThisTime(float Time, bool bInIsRunning, bool bInBackwards, bool bInIsLooping);                                // [0x8b7ac20] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.Stop
	// void Stop();                                                                                                             // [0x8b7ac00] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetWireframeOverrideColor
	// void SetWireframeOverrideColor(FLinearColor Color);                                                                      // [0x8b7ab80] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetStartTimeOffset
	// void SetStartTimeOffset(float NewStartTimeOffset);                                                                       // [0x8b7aad0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetPlaybackSpeed
	// void SetPlaybackSpeed(float NewPlaybackSpeed);                                                                           // [0x8b7aa30] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetOverrideWireframeColor
	// void SetOverrideWireframeColor(bool bOverride);                                                                          // [0x8b7a9a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetMotionVectorScale
	// void SetMotionVectorScale(float NewMotionVectorScale);                                                                   // [0x8b7a900] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetLooping
	// void SetLooping(bool bNewLooping);                                                                                       // [0x8b7a600] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetGeometryCache
	// bool SetGeometryCache(class UGeometryCache* NewGeomCache);                                                               // [0x8b7a560] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.SetExtrapolateFrames
	// void SetExtrapolateFrames(bool bNewExtrapolating);                                                                       // [0x8b7a4d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.PlayReversedFromEnd
	// void PlayReversedFromEnd();                                                                                              // [0x8b7a470] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.PlayReversed
	// void PlayReversed();                                                                                                     // [0x8b7a420] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.PlayFromStart
	// void PlayFromStart();                                                                                                    // [0x8b7a3c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.Play
	// void Play();                                                                                                             // [0x8b7a370] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.Pause
	// void Pause();                                                                                                            // [0x8b7a340] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCache.GeometryCacheComponent.IsPlayingReversed
	// bool IsPlayingReversed();                                                                                                // [0x8b7a300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x8b7a2e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.IsLooping
	// bool IsLooping();                                                                                                        // [0x8b7a2c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.IsExtrapolatingFrames
	// bool IsExtrapolatingFrames();                                                                                            // [0x8b7a2a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetWireframeOverrideColor
	// FLinearColor GetWireframeOverrideColor();                                                                                // [0x8b7a270] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetStartTimeOffset
	// float GetStartTimeOffset();                                                                                              // [0x8b7a250] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetPlaybackSpeed
	// float GetPlaybackSpeed();                                                                                                // [0x8b7a210] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetPlaybackDirection
	// float GetPlaybackDirection();                                                                                            // [0x8b7a1f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetOverrideWireframeColor
	// bool GetOverrideWireframeColor();                                                                                        // [0x8b7a1d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetNumberOfFrames
	// int32_t GetNumberOfFrames();                                                                                             // [0x8b7a190] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetMotionVectorScale
	// float GetMotionVectorScale();                                                                                            // [0x8b7a150] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetDuration
	// float GetDuration();                                                                                                     // [0x8b7a130] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCache.GeometryCacheComponent.GetAnimationTime
	// float GetAnimationTime();                                                                                                // [0x8b7a0f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void AddMeshSample(FGeometryCacheMeshData& MeshData, float SampleTime);                                                  // [0x8b79de0] Final|Native|Public|HasOutParms 
};
...
public:
	...
	// void SetMesh(FGeometryCacheMeshData& NewMeshData);                                                                       // [0x8b7a690] Final|Native|Public|HasOutParms 
};
...
static_assert(sizeof(UGeometryCache) == 0x0088); // 136 bytes (0x000028 - 0x000088)
...
static_assert(sizeof(UGeometryCacheComponent) == 0x05E0); // 1504 bytes (0x000550 - 0x0005E0)
...
static_assert(sizeof(FNiagaraGeometryCacheMICOverride) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FNiagaraGeometryCacheReference) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(sizeof(UNiagaraGeometryCacheRendererProperties) == 0x02E8); // 744 bytes (0x0000C0 - 0x0002E8)
...
static_assert(offsetof(UGeometryCache, MaterialSlotNames) == 0x0040);
static_assert(offsetof(UGeometryCache, Tracks) == 0x0050);
static_assert(offsetof(UGeometryCache, AssetUserData) == 0x0060);
...
static_assert(offsetof(UGeometryCacheComponent, GeometryCache) == 0x0550);
static_assert(offsetof(UGeometryCacheComponent, WireframeOverrideColor) == 0x05C4);
static_assert(offsetof(UGeometryCacheTrackStreamable, Codec) == 0x0058);
static_assert(offsetof(FNiagaraGeometryCacheMICOverride, OriginalMaterial) == 0x0000);
static_assert(offsetof(FNiagaraGeometryCacheMICOverride, ReplacementMaterial) == 0x0008);
...
static_assert(offsetof(FNiagaraGeometryCacheReference, MICOverrideMaterials) == 0x0038);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, GeometryCaches) == 0x00C0);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, SourceMode) == 0x00D0);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, PositionBinding) == 0x00D8);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, RotationBinding) == 0x0110);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ScaleBinding) == 0x0148);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ElapsedTimeBinding) == 0x0180);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, EnabledBinding) == 0x01B8);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, ArrayIndexBinding) == 0x01F0);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, RendererVisibilityTagBinding) == 0x0228);
static_assert(offsetof(UNiagaraGeometryCacheRendererProperties, MaterialParameters) == 0x0268);
