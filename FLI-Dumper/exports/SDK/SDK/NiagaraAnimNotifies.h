...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* meshComp);                                              // [0x7a12270] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* meshComp);                                                                 // [0x7a121d0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0x57a1110] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
