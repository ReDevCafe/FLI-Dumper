...
public:
	...
	// void ProcessActorState(int32_t& OutState, class AActor* InActor, char currentState, char OnDemandState, bool& bShouldProcess); // [0x8758f10] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum
	// class UEnum* GetAnimationStateEnum();                                                                                    // [0x8758d50] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x8758d80] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RegisterActorWithSkeletonBP(class AActor* InActor, class USkeleton* SharingSkeleton);                               // [0x87590d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	// class UAnimationSharingManager* GetAnimationSharingManager(class UObject* WorldContextObject);                           // [0x8758bf0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager
	// bool CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharingSetup* Setup);              // [0x8758af0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.AnimationSharingEnabled
	// bool AnimationSharingEnabled();                                                                                          // [0x8758ac0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UAnimSharingStateInstance) == 0x0390); // 912 bytes (0x000368 - 0x000390)
static_assert(sizeof(UAnimSharingTransitionInstance) == 0x0380); // 896 bytes (0x000368 - 0x000380)
static_assert(sizeof(UAnimSharingAdditiveInstance) == 0x0380); // 896 bytes (0x000368 - 0x000380)
...
static_assert(offsetof(UAnimSharingStateInstance, AnimationToPlay) == 0x0368);
static_assert(offsetof(UAnimSharingStateInstance, Instance) == 0x0380);
static_assert(offsetof(UAnimSharingTransitionInstance, FromComponent) == 0x0368);
static_assert(offsetof(UAnimSharingTransitionInstance, ToComponent) == 0x0370);
static_assert(offsetof(UAnimSharingAdditiveInstance, BaseComponent) == 0x0368);
static_assert(offsetof(UAnimSharingAdditiveInstance, AdditiveAnimation) == 0x0370);
