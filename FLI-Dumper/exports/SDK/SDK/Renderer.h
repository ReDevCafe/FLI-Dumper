...
static_assert(sizeof(USparseVolumeTextureViewerComponent) == 0x0550); // 1360 bytes (0x000518 - 0x000550)
static_assert(sizeof(ASparseVolumeTextureViewer) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(offsetof(USparseVolumeTextureViewerComponent, SparseVolumeTexturePreview) == 0x0518);
static_assert(offsetof(USparseVolumeTextureViewerComponent, PreviewAttribute) == 0x0530);
