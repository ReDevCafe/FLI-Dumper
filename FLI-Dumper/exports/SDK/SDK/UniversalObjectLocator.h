...
static_assert(sizeof(FDirectPathObjectLocator) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FLocatorSpawnedCacheResolveParameter) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FSubObjectLocator) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FUniversalObjectLocatorFragment) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FUniversalObjectLocator) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FUniversalObjectLocatorEmptyPayload) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(offsetof(FDirectPathObjectLocator, Path) == 0x0000);
static_assert(offsetof(FSubObjectLocator, PathWithinContext) == 0x0000);
static_assert(offsetof(FUniversalObjectLocator, Fragments) == 0x0000);
