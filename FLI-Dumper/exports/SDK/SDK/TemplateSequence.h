...
public:
	...
	// void SetSequence(class UTemplateSequence* InSequence);                                                                   // [0x660c560] Final|Native|Public|BlueprintCallable 
	// Function /Script/TemplateSequence.TemplateSequenceActor.SetBinding
	// void SetBinding(class AActor* Actor, bool bOverridesDefault);                                                            // [0x660c3a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/TemplateSequence.TemplateSequenceActor.LoadSequence
	// class UTemplateSequence* LoadSequence();                                                                                 // [0x660c320] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TemplateSequence.TemplateSequenceActor.GetSequencePlayer
	// class UTemplateSequencePlayer* GetSequencePlayer();                                                                      // [0x660c2b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/TemplateSequence.TemplateSequenceActor.GetSequence
	// class UTemplateSequence* GetSequence();                                                                                  // [0x660c230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// class UTemplateSequencePlayer* CreateTemplateSequencePlayer(class UObject* WorldContextObject, class UTemplateSequence* TemplateSequence, FMovieSceneSequencePlaybackSettings Settings, class ATemplateSequenceActor*& OutActor); // [0x660ba70] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool GetPostProcessBlendCache(class APlayerController* PlayerController, int32_t PPIndex, FPostProcessSettings& OutPPSettings, float& OutPPBlendWeight); // [0x660c030] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/TemplateSequence.SequenceCameraShakeTestUtil.GetLastFrameCameraCachePOV
	// FMinimalViewInfo GetLastFrameCameraCachePOV(class APlayerController* PlayerController);                                  // [0x660bf30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/TemplateSequence.SequenceCameraShakeTestUtil.GetCameraCachePOV
	// FMinimalViewInfo GetCameraCachePOV(class APlayerController* PlayerController);                                           // [0x660be30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UTemplateSequence) == 0x00E8); // 232 bytes (0x000068 - 0x0000E8)
static_assert(sizeof(UCameraAnimationSequence) == 0x00E8); // 232 bytes (0x0000E8 - 0x0000E8)
static_assert(sizeof(UCameraAnimationSequenceCameraStandIn) == 0x0840); // 2112 bytes (0x000028 - 0x000840)
static_assert(sizeof(UCameraAnimationSequencePlayer) == 0x0328); // 808 bytes (0x000028 - 0x000328)
...
static_assert(sizeof(UCameraAnimationEntitySystemLinker) == 0x0750); // 1872 bytes (0x000750 - 0x000750)
...
static_assert(sizeof(USequenceCameraShakePattern) == 0x0078); // 120 bytes (0x000028 - 0x000078)
...
static_assert(sizeof(ATemplateSequenceActor) == 0x02F8); // 760 bytes (0x000290 - 0x0002F8)
static_assert(sizeof(UTemplateSequencePlayer) == 0x0468); // 1128 bytes (0x000460 - 0x000468)
...
static_assert(offsetof(UTemplateSequence, BoundActorComponents) == 0x0098);
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, PostProcessSettings) == 0x0040);
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, Filmback) == 0x0734);
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, LensSettings) == 0x0740);
static_assert(offsetof(UCameraAnimationSequenceCameraStandIn, FocusSettings) == 0x0760);
static_assert(offsetof(UCameraAnimationSequencePlayer, BoundObjectOverride) == 0x0288);
static_assert(offsetof(UCameraAnimationSequencePlayer, Sequence) == 0x0290);
static_assert(offsetof(UCameraAnimationSequencePlayer, RootTemplateInstance) == 0x0298);
...
static_assert(offsetof(ATemplateSequenceActor, SequencePlayer) == 0x02C0);
static_assert(offsetof(ATemplateSequenceActor, TemplateSequence) == 0x02C8);
static_assert(offsetof(ATemplateSequenceActor, BindingOverride) == 0x02E8);
