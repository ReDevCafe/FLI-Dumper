...
public:
	...
	// void TogglePromotePropertyToPin(FName& PropertyName);                                                                    // [0x7ed7180] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetOutputPin
	// class UMovieGraphPin* GetOutputPin(FName& InPinLabel);                                                                   // [0x7ed6900] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetInputPin
	// class UMovieGraphPin* GetInputPin(FName& InPinLabel, EMovieGraphPinQueryRequirement PinRequirement);                     // [0x7ed66d0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphNode.GetExposedProperties
	// TArray<FMovieGraphPropertyInfo> GetExposedProperties();                                                                  // [0x60b83c0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1131) /* TScriptInterface<Class> */ __um(ConsoleVariablePreset);                              // 0x00A0   (0x0010)  
};
...
public:
	...
	// int32_t ResolveVersionNumber(FMovieGraphFilenameResolveParams InParams, bool bGetNextVersion);                           // [0x7ed1990] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.ResolveFilenameFormatArguments
	// FString ResolveFilenameFormatArguments(FString InFormatString, FMovieGraphFilenameResolveParams& InParams, FMovieGraphResolveArgs& OutMergedFormatArgs); // [0x7ed1700] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.NamedResolutionFromSize
	// FMovieGraphNamedResolution NamedResolutionFromSize(int32_t InResX, int32_t InResY);                                      // [0x7ed0fe0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.NamedResolutionFromProfile
	// FMovieGraphNamedResolution NamedResolutionFromProfile(FName& InResolutionProfileName);                                   // [0x7ed0f30] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.IsNamedResolutionValid
	// bool IsNamedResolutionValid(FName& InResolutionProfileName);                                                             // [0x7ed0e90] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetRootTimecode
	// FTimecode GetRootTimecode(class UMovieGraphPipeline* InMovieGraphPipeline);                                              // [0x7ed0980] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetRootFrameNumber
	// FFrameNumber GetRootFrameNumber(class UMovieGraphPipeline* InMovieGraphPipeline);                                        // [0x7ed08f0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState(class UMovieGraphPipeline* InMovieGraphPipeline);                             // [0x7ed0860] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetOverallSegmentCounts
	// void GetOverallSegmentCounts(class UMovieGraphPipeline* InMovieGraphPipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount); // [0x7ed0730] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetOverallOutputFrames
	// void GetOverallOutputFrames(class UMovieGraphPipeline* InMovieGraphPipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount); // [0x7ed0600] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobName
	// FText GetJobName(class UMovieGraphPipeline* InMovieGraphPipeline);                                                       // [0x7ed0410] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobInitializationTime
	// FDateTime GetJobInitializationTime(class UMovieGraphPipeline* InMovieGraphPipeline);                                     // [0x7ed0380] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetJobAuthor
	// FText GetJobAuthor(class UMovieGraphPipeline* InMovieGraphPipeline);                                                     // [0x7ed02d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEstimatedTimeRemaining
	// bool GetEstimatedTimeRemaining(class UMovieGraphPipeline* InMovieGraphPipeline, FTimespan& OutEstimate);                 // [0x7ed0130] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEffectiveOutputResolution
	// FIntPoint GetEffectiveOutputResolution(class UMovieGraphEvaluatedConfig* InEvaluatedGraph);                              // [0x7ed00a0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetEffectiveFrameRate
	// FFrameRate GetEffectiveFrameRate(class UMovieGraphGlobalOutputSettingNode* InNode, FFrameRate& InDefaultRate);           // [0x7ecffc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentShotTimecode
	// FTimecode GetCurrentShotTimecode(class UMovieGraphPipeline* InMovieGraphPipeline);                                       // [0x7ecff20] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentShotFrameNumber
	// FFrameNumber GetCurrentShotFrameNumber(class UMovieGraphPipeline* InMovieGraphPipeline);                                 // [0x7ecfe90] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentWorkMetrics
	// FMoviePipelineSegmentWorkMetrics GetCurrentSegmentWorkMetrics(class UMovieGraphPipeline* InMovieGraphPipeline);          // [0x7ecfda0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentState
	// EMovieRenderShotState GetCurrentSegmentState(class UMovieGraphPipeline* InMovieGraphPipeline);                           // [0x7ecfd10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentSegmentName
	// void GetCurrentSegmentName(class UMovieGraphPipeline* InMovieGraphPipeline, FText& OutOuterName, FText& OutInnerName);   // [0x7ecfbc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentFocusDistance
	// float GetCurrentFocusDistance(class UMovieGraphPipeline* InMovieGraphPipeline);                                          // [0x7ecfb30] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentFocalLength
	// float GetCurrentFocalLength(class UMovieGraphPipeline* InMovieGraphPipeline);                                            // [0x7ecfaa0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentCineCamera
	// class UCineCameraComponent* GetCurrentCineCamera(class UMovieGraphPipeline* InMovieGraphPipeline);                       // [0x7ecfa10] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCurrentAperture
	// float GetCurrentAperture(class UMovieGraphPipeline* InMovieGraphPipeline);                                               // [0x7ecf980] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MovieGraphBlueprintLibrary.GetCompletionPercentage
	// float GetCompletionPercentage(class UMovieGraphPipeline* InPipeline);                                                    // [0x7ecf8f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void UpdateForGraph(class UMovieGraphPipeline* InGraphPipeline, class UMovieGraphEvaluatedConfig* InEvaluatedConfig);    // [0x3618b30] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void SetValueTypeObject(class UObject* ValueTypeObject);                                                                 // [0x7ee26f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueType
	// void SetValueType(EMovieGraphValueType valueType, class UObject* InValueTypeObject);                                     // [0x7ee2620] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueText
	// bool SetValueText(FText& InValue);                                                                                       // [0x7ee2460] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueString
	// bool SetValueString(FString InValue);                                                                                    // [0x7ee22c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueSerializedString
	// bool SetValueSerializedString(FString NewValue);                                                                         // [0x7ee2120] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueObject
	// bool SetValueObject(class UObject* InValue);                                                                             // [0x7ee1640] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueName
	// bool SetValueName(FName InValue);                                                                                        // [0x7ee1fb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueInt64
	// bool SetValueInt64(int64_t InValue);                                                                                     // [0x7ee1e40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueInt32
	// bool SetValueInt32(int32_t InValue);                                                                                     // [0x7ee1cd0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueFloat
	// bool SetValueFloat(float InValue);                                                                                       // [0x7ee1b70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueEnum
	// bool SetValueEnum(char InValue, class UEnum* Enum);                                                                      // [0x7ee1990] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueDouble
	// bool SetValueDouble(double InValue);                                                                                     // [0x7ee1830] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueContainerType
	// void SetValueContainerType(EMovieGraphContainerType ContainerType);                                                      // [0x7ee17b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueClass
	// bool SetValueClass(class UClass* InValue);                                                                               // [0x7ee1640] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueByte
	// bool SetValueByte(char InValue);                                                                                         // [0x7ee14e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.SetValueBool
	// bool SetValueBool(bool bInValue);                                                                                        // [0x7ee1370] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueTypeObject
	// class UObject* GetValueTypeObject();                                                                                     // [0x7ee1020] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueType
	// EMovieGraphValueType GetValueType();                                                                                     // [0x7ee0f50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueText
	// bool GetValueText(FText& OutValue);                                                                                      // [0x7ee0d90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueString
	// bool GetValueString(FString& OutValue);                                                                                  // [0x7ee0bd0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueSerializedString
	// FString GetValueSerializedString();                                                                                      // [0x7ee0a70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueObject
	// bool GetValueObject(class UObject* OutValue, class UClass* RequestedClass);                                              // [0x7ee0890] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueName
	// bool GetValueName(FName& OutValue);                                                                                      // [0x7ee0700] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueInt64
	// bool GetValueInt64(int64_t& OutValue);                                                                                   // [0x7ee0570] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueInt32
	// bool GetValueInt32(int32_t& OutValue);                                                                                   // [0x7ee03e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueFloat
	// bool GetValueFloat(float& OutValue);                                                                                     // [0x7ee0250] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueEnum
	// bool GetValueEnum(char& OutValue, class UEnum* RequestedEnum);                                                           // [0x7ee0040] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueDouble
	// bool GetValueDouble(double& OutValue);                                                                                   // [0x7edfeb0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueContainerType
	// EMovieGraphContainerType GetValueContainerType();                                                                        // [0x7edfde0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueClass
	// bool GetValueClass(class UClass*& OutValue);                                                                             // [0x7edfc50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueByte
	// bool GetValueByte(char& OutValue);                                                                                       // [0x7edfac0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphValueContainer.GetValueBool
	// bool GetValueBool(bool& bOutValue);                                                                                      // [0x7edf930] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetMemberName(FString InNewName);                                                                                   // [0x7ed1ab0] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMember.GetMemberName
	// FString GetMemberName();                                                                                                 // [0x7ed04c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMember.GetGuid
	// FGuid GetGuid();                                                                                                         // [0x7ed0210] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<UMovieGraphSettingNode*> GetSettingsForBranch(class UClass* InClass, FName InBranchName, bool bIncludeCDOs, bool bExactMatch); // [0x7ed0be0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphEvaluatedConfig.GetSettingForBranch
	// class UMovieGraphSettingNode* GetSettingForBranch(class UClass* InClass, FName InBranchName, bool bIncludeCDOs, bool bExactMatch); // [0x7ed0a20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphEvaluatedConfig.GetBranchNames
	// TArray<FName> GetBranchNames();                                                                                          // [0x7ecf830] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateGlobalVariableValues(class UMovieGraphPipeline* InPipeline);                                                  // [0x7ed1b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveOutboundEdges
	// bool RemoveOutboundEdges(class UMovieGraphNode* InNode, FName& InPinName);                                               // [0x7ed1620] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveNodes
	// bool RemoveNodes(TArray<UMovieGraphNode*> InNodes);                                                                      // [0x7ed1520] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveNode
	// bool RemoveNode(class UMovieGraphNode* InNode);                                                                          // [0x7ed1480] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveLabeledEdge
	// bool RemoveLabeledEdge(class UMovieGraphNode* FromNode, FName& FromPinName, class UMovieGraphNode* ToNode, FName& ToPinName); // [0x7ed12f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveInboundEdges
	// bool RemoveInboundEdges(class UMovieGraphNode* InNode, FName& InPinName);                                                // [0x7ed1210] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveAllOutboundEdges
	// bool RemoveAllOutboundEdges(class UMovieGraphNode* InNode);                                                              // [0x7ed1170] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.RemoveAllInboundEdges
	// bool RemoveAllInboundEdges(class UMovieGraphNode* InNode);                                                               // [0x7ed10d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetVariables
	// TArray<UMovieGraphVariable*> GetVariables(bool bIncludeGlobal);                                                          // [0x7ed0db0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetOutputs
	// TArray<UMovieGraphOutput*> GetOutputs();                                                                                 // [0x7ed0580] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetOutputNode
	// class UMovieGraphNode* GetOutputNode();                                                                                  // [0x4fd2660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetInputs
	// TArray<UMovieGraphInput*> GetInputs();                                                                                   // [0x7ed0250] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.GetInputNode
	// class UMovieGraphNode* GetInputNode();                                                                                   // [0x7ed0230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.DeleteMember
	// bool DeleteMember(class UMovieGraphMember* MemberToDelete);                                                              // [0x7ecf790] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.CreateNodeByClass
	// class UMovieGraphNode* CreateNodeByClass(class UClass* InClass);                                                         // [0x7ecf550] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.CreateFlattenedGraph
	// class UMovieGraphEvaluatedConfig* CreateFlattenedGraph(FMovieGraphTraversalContext& InContext, FString& OutError);       // [0x7ecf390] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddVariable
	// class UMovieGraphVariable* AddVariable(FName InCustomBaseName);                                                          // [0x7ecf2f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddOutput
	// class UMovieGraphOutput* AddOutput();                                                                                    // [0x7ecf2c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddLabeledEdge
	// bool AddLabeledEdge(class UMovieGraphNode* FromNode, FName& FromPinLabel, class UMovieGraphNode* ToNode, FName& ToPinLabel); // [0x7ecf130] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConfig.AddInput
	// class UMovieGraphInput* AddInput();                                                                                      // [0x7ecf100] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FMovieGraphTimeStepData GetCalculatedTimeData();                                                                         // [0x7ed6550] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<FMovieGraphImagePreviewData> GetPreviewData();                                                                    // [0x7ed69b0] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnShotStart(class UMoviePipelineExecutorJob* InJobCopy, class UMoviePipelineExecutorShot* InShotCopy);              // [0x7ed6f50] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnShotFinished
	// void OnShotFinished(class UMoviePipelineExecutorJob* InJobCopy, class UMoviePipelineExecutorShot* InShotCopy, FMoviePipelineOutputData& OutputData); // [0x7ed6d50] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnJobStart
	// void OnJobStart(class UMoviePipelineExecutorJob* InJobCopy);                                                             // [0x7ed6cc0] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.OnJobFinished
	// void OnJobFinished(class UMoviePipelineExecutorJob* InJobCopy, FMoviePipelineOutputData& InOutputData);                  // [0x7ed6af0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MovieGraphScriptBase.IsPerShotCallbackNeeded
	// bool IsPerShotCallbackNeeded();                                                                                          // [0x5490910] Native|Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// bool RemoveModifier(class UClass* ModifierType);                                                                         // [0x7ed70d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.RemoveCollection
	// bool RemoveCollection(FName& InCollectionName);                                                                          // [0x7ed7020] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetModifiers
	// TArray<UMovieGraphCollectionModifier*> GetModifiers();                                                                   // [0x7ed6870] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetModifier
	// class UMovieGraphCollectionModifier* GetModifier(class UClass* ModifierType);                                            // [0x7ed67c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.GetCollections
	// TArray<FName> GetCollections();                                                                                          // [0x7ed6640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.AddModifier
	// class UMovieGraphCollectionModifier* AddModifier(class UClass* ModifierType);                                            // [0x7ed64a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphModifierNode.AddCollection
	// void AddCollection(FName& InCollectionName);                                                                             // [0x7ed6400] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// TArray<UMovieGraphNode*> GetConnectedNodes();                                                                            // [0x7edbcc0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,1132) /* FMulticastInlineDelegate */ __um(OnMoviePipelineWorkFinishedDelegate);               // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,1133) /* FMulticastInlineDelegate */ __um(OnMoviePipelineShotWorkFinishedDelegate);           // 0x0038   (0x0010)  
	...
	// void Shutdown(bool bIsError);                                                                                            // [0x536f060] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.RequestShutdown
	// void RequestShutdown(bool bIsError);                                                                                     // [0x5a04360] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.IsShutdownRequested
	// bool IsShutdownRequested();                                                                                              // [0x5a04bf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBase.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState();                                                                            // [0x5369410] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1134) /* TSet<UMovieGraphFileOutputNode*> */ __um(OutputNodesDataSentTo);                     // 0x00F8   (0x0050)  
	...
	// void SetInitializationTime(FDateTime& InDateTime);                                                                       // [0x7edcb90] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.OnMoviePipelineFinishedImpl
	// void OnMoviePipelineFinishedImpl();                                                                                      // [0x57a1250] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.Initialize
	// void Initialize(class UMoviePipelineExecutorJob* InJob, FMovieGraphInitConfig& InitConfig);                              // [0x7edc150] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetTimeStepInstance
	// class UMovieGraphTimeStepBase* GetTimeStepInstance();                                                                    // [0x7edc120] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetRendererInstance
	// class UMovieGraphRendererBase* GetRendererInstance();                                                                    // [0x7edc100] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetInitializationTimeOffset
	// FTimespan GetInitializationTimeOffset();                                                                                 // [0x581bd30] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetInitializationTime
	// FDateTime GetInitializationTime();                                                                                       // [0x57d70d0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetCurrentTraversalContext
	// FMovieGraphTraversalContext GetCurrentTraversalContext(bool bForShot);                                                   // [0x7edbd40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphPipeline.GetCurrentJob
	// class UMoviePipelineExecutorJob* GetCurrentJob();                                                                        // [0x5d00f30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool ShouldHidePropertyNames();                                                                                          // [0x5475ac0] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.SetOperationType
	// void SetOperationType(EMovieGraphConditionGroupQueryOpType OperationType);                                               // [0x7edcdf0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.SetEnabled
	// void SetEnabled(bool bEnabled);                                                                                          // [0x7edca70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsFirstConditionGroupQuery
	// bool IsFirstConditionGroupQuery();                                                                                       // [0x7edc290] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x7edc230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.IsEditorOnlyQuery
	// bool IsEditorOnlyQuery();                                                                                                // [0x5490910] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.GetOperationType
	// EMovieGraphConditionGroupQueryOpType GetOperationType();                                                                 // [0x7edbfb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroupQueryBase.Evaluate
	// void Evaluate(TArray<AActor*>& InActorsToQuery, class UWorld* InWorld, TSet<AActor*>& OutMatchingActors);                // [0x7edb880] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
{ 
public:
	SDK_UNDEFINED(16,1135) /* TArray<TWeakObjectPtr<AActor*>> */ __um(ActorsToMatch);                              // 0x0030   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,1136) /* TArray<TWeakObjectPtr<UWorld*>> */ __um(Sublevels);                                  // 0x0030   (0x0010)  
};
...
public:
	...
	SDK_UNDEFINED(80,1137) /* TSet<AActor*> */         __um(QueryResult);                                          // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,1138) /* TSet<AActor*> */         __um(EvaluationResult);                                     // 0x00A0   (0x0050)  


	/// Functions
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.SetOperationType
	// void SetOperationType(EMovieGraphConditionGroupOpType OperationType);                                                    // [0x7edcd70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.RemoveQuery
	// bool RemoveQuery(class UMovieGraphConditionGroupQueryBase* InQuery);                                                     // [0x7edc5c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.MoveQueryToIndex
	// bool MoveQueryToIndex(class UMovieGraphConditionGroupQueryBase* InQuery, int32_t NewIndex);                              // [0x7edc3c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.IsFirstConditionGroup
	// bool IsFirstConditionGroup();                                                                                            // [0x7edc260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.GetQueries
	// TArray<UMovieGraphConditionGroupQueryBase*> GetQueries();                                                                // [0x7edbfe0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.GetOperationType
	// EMovieGraphConditionGroupOpType GetOperationType();                                                                      // [0x7edbf80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.Evaluate
	// TSet<AActor*> Evaluate(class UWorld* InWorld);                                                                           // [0x7edb760] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphConditionGroup.AddQuery
	// class UMovieGraphConditionGroupQueryBase* AddQuery(class UClass*& InQueryType, int32_t InsertIndex);                     // [0x7edb400] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void SetCollectionName(FString InName);                                                                                  // [0x7edc870] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.RemoveConditionGroup
	// bool RemoveConditionGroup(class UMovieGraphConditionGroup* InConditionGroup);                                            // [0x7edc490] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.MoveConditionGroupToIndex
	// bool MoveConditionGroupToIndex(class UMovieGraphConditionGroup* InConditionGroup, int32_t NewIndex);                     // [0x7edc2f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.GetConditionGroups
	// TArray<UMovieGraphConditionGroup*> GetConditionGroups();                                                                 // [0x7edbc30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.GetCollectionName
	// FString GetCollectionName();                                                                                             // [0x7edbb30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.Evaluate
	// TSet<AActor*> Evaluate(class UWorld* InWorld);                                                                           // [0x7edb640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollection.AddConditionGroup
	// class UMovieGraphConditionGroup* AddConditionGroup();                                                                    // [0x7edb340] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetCollections(TArray<UMovieGraphCollection*> InCollections);                                                       // [0x7edc910] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollectionModifier.GetCollections
	// TArray<UMovieGraphCollection*> GetCollections();                                                                         // [0x7edbb70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphCollectionModifier.AddCollection
	// void AddCollection(class UMovieGraphCollection* Collection);                                                             // [0x7edb2b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UndoModifier();                                                                                                     // [0x5490d50] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMaterialModifier.SetMaterial
	// void SetMaterial(TWeakObjectPtr<UMaterialInterface*> InMaterial);                                                        // [0x7edcc30] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphMaterialModifier.ApplyModifier
	// void ApplyModifier(class UWorld* World);                                                                                 // [0x7ed6cc0] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetHidden(bool bInIsHidden);                                                                                        // [0x7edcb00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderPropertyModifier.IsHidden
	// bool IsHidden();                                                                                                         // [0x7edc2c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
...
public:
	...
	// void SetRenderLayerName(FName& NewName);                                                                                 // [0x7edce70] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.Revert
	// void Revert();                                                                                                           // [0x7edc720] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.RemoveModifier
	// void RemoveModifier(class UMovieGraphCollectionModifier* Modifier);                                                      // [0x7edc530] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetRenderLayerName
	// FName GetRenderLayerName();                                                                                              // [0x60b8170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetModifiers
	// TArray<UMovieGraphCollectionModifier*> GetModifiers();                                                                   // [0x7edbec0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.GetCollectionByName
	// class UMovieGraphCollection* GetCollectionByName(FString Name);                                                          // [0x7edba80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.Apply
	// void Apply(class UWorld* World);                                                                                         // [0x7edb590] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayer.AddModifier
	// void AddModifier(class UMovieGraphCollectionModifier* Modifier);                                                         // [0x7edb370] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetActiveRenderLayerByObj(class UMovieGraphRenderLayer* RenderLayer);                                               // [0x7edc7e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.SetActiveRenderLayerByName
	// void SetActiveRenderLayerByName(FName& RenderLayerName);                                                                 // [0x7edc740] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.Reset
	// void Reset();                                                                                                            // [0x7edc700] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.RemoveRenderLayer
	// void RemoveRenderLayer(FString RenderLayerName);                                                                         // [0x7edc660] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetRenderLayers
	// TArray<UMovieGraphRenderLayer*> GetRenderLayers();                                                                       // [0x7edc070] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetFromWorld
	// class UMovieGraphRenderLayerSubsystem* GetFromWorld(class UWorld* World);                                                // [0x7edbe30] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.GetActiveRenderLayer
	// class UMovieGraphRenderLayer* GetActiveRenderLayer();                                                                    // [0x4fd2660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.ClearActiveRenderLayer
	// void ClearActiveRenderLayer();                                                                                           // [0x7edb620] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphRenderLayerSubsystem.AddRenderLayer
	// bool AddRenderLayer(class UMovieGraphRenderLayer* RenderLayer);                                                          // [0x7edb4f0] Final|Native|Public|BlueprintCallable 
};
...
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0028   (0x0008)  MISSED
	SDK_UNDEFINED(80,1139) /* TSet<uint32_t> */        __um(OverriddenShowFlags);                                  // 0x0030   (0x0050)  
...
public:
	...
	// void SetSubGraphAsset(TWeakObjectPtr<UMovieGraphConfig*>& InSubgraphAsset);                                              // [0x7ee12a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphSubgraphNode.GetSubgraphAsset
	// class UMovieGraphConfig* GetSubgraphAsset();                                                                             // [0x7edf900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetVariable(class UMovieGraphVariable* InVariable);                                                                 // [0x7ee2780] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieGraphVariableNode.GetVariable
	// class UMovieGraphVariable* GetVariable();                                                                                // [0x7edc100] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool SetVariableAssignmentEnableState(class UMovieGraphVariable* InGraphVariable, bool bIsEnabled);                      // [0x7ee2810] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueText
	// bool SetValueText(class UMovieGraphVariable* InGraphVariable, FText& InValue);                                           // [0x7ee2520] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueString
	// bool SetValueString(class UMovieGraphVariable* InGraphVariable, FString InValue);                                        // [0x7ee2370] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueSerializedString
	// bool SetValueSerializedString(class UMovieGraphVariable* InGraphVariable, FString NewValue);                             // [0x7ee21d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueObject
	// bool SetValueObject(class UMovieGraphVariable* InGraphVariable, class UObject* InValue);                                 // [0x7ee16e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueName
	// bool SetValueName(class UMovieGraphVariable* InGraphVariable, FName InValue);                                            // [0x7ee2050] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueInt64
	// bool SetValueInt64(class UMovieGraphVariable* InGraphVariable, int64_t InValue);                                         // [0x7ee1ee0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueInt32
	// bool SetValueInt32(class UMovieGraphVariable* InGraphVariable, int32_t InValue);                                         // [0x7ee1d70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueFloat
	// bool SetValueFloat(class UMovieGraphVariable* InGraphVariable, float InValue);                                           // [0x7ee1c00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueEnum
	// bool SetValueEnum(class UMovieGraphVariable* InGraphVariable, char InValue, class UEnum* Enum);                          // [0x7ee1a60] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueDouble
	// bool SetValueDouble(class UMovieGraphVariable* InGraphVariable, double InValue);                                         // [0x7ee18c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueClass
	// bool SetValueClass(class UMovieGraphVariable* InGraphVariable, class UClass* InValue);                                   // [0x7ee16e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueByte
	// bool SetValueByte(class UMovieGraphVariable* InGraphVariable, char InValue);                                             // [0x7ee1570] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetValueBool
	// bool SetValueBool(class UMovieGraphVariable* InGraphVariable, bool bInValue);                                            // [0x7ee1410] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.SetGraphConfig
	// void SetGraphConfig(TWeakObjectPtr<UMovieGraphConfig*>& InGraphConfig);                                                  // [0x7ee11d0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetVariableAssignmentEnableState
	// bool GetVariableAssignmentEnableState(class UMovieGraphVariable* InGraphVariable, bool& bOutIsEnabled);                  // [0x7ee10f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueTypeObject
	// class UObject* GetValueTypeObject(class UMovieGraphVariable* InGraphVariable);                                           // [0x7ee1050] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueType
	// EMovieGraphValueType GetValueType(class UMovieGraphVariable* InGraphVariable);                                           // [0x7ee0f80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueText
	// bool GetValueText(class UMovieGraphVariable* InGraphVariable, FText& OutValue);                                          // [0x7ee0e50] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueString
	// bool GetValueString(class UMovieGraphVariable* InGraphVariable, FString& OutValue);                                      // [0x7ee0c90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueSerializedString
	// FString GetValueSerializedString(class UMovieGraphVariable* InGraphVariable);                                            // [0x7ee0af0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueObject
	// bool GetValueObject(class UMovieGraphVariable* InGraphVariable, class UObject* OutValue, class UClass* RequestedClass);  // [0x7ee0960] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueName
	// bool GetValueName(class UMovieGraphVariable* InGraphVariable, FName& OutValue);                                          // [0x7ee07b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueInt64
	// bool GetValueInt64(class UMovieGraphVariable* InGraphVariable, int64_t& OutValue);                                       // [0x7ee0620] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueInt32
	// bool GetValueInt32(class UMovieGraphVariable* InGraphVariable, int32_t& OutValue);                                       // [0x7ee0490] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueFloat
	// bool GetValueFloat(class UMovieGraphVariable* InGraphVariable, float& OutValue);                                         // [0x7ee0300] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueEnum
	// bool GetValueEnum(class UMovieGraphVariable* InGraphVariable, char& OutValue, class UEnum* RequestedEnum);               // [0x7ee0130] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueDouble
	// bool GetValueDouble(class UMovieGraphVariable* InGraphVariable, double& OutValue);                                       // [0x7edff60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueContainerType
	// EMovieGraphContainerType GetValueContainerType(class UMovieGraphVariable* InGraphVariable);                              // [0x7edfe10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueClass
	// bool GetValueClass(class UMovieGraphVariable* InGraphVariable, class UClass*& OutValue);                                 // [0x7edfd00] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueByte
	// bool GetValueByte(class UMovieGraphVariable* InGraphVariable, char& OutValue);                                           // [0x7edfb70] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MovieJobVariableAssignmentContainer.GetValueBool
	// bool GetValueBool(class UMovieGraphVariable* InGraphVariable, bool& bOutValue);                                          // [0x7edf9e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetIsEnabled(bool bInEnabled);                                                                                      // [0x7f67ea0] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x5441430] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.BuildNewProcessCommandLineArgs
	// void BuildNewProcessCommandLineArgs(TArray<FString>& InOutUnrealURLParams, TArray<FString>& InOutCommandLineArgs, TArray<FString>& InOutDeviceProfileCvars, TArray<FString>& InOutExecCmds); // [0x7f65440] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting.BuildNewProcessCommandLine
	// void BuildNewProcessCommandLine(FString& InOutUnrealURLParams, FString& InOutCommandLineArgs);                           // [0x7f65320] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReceiveTeardownForPipelineImpl(class UMoviePipeline* InPipeline);                                                   // [0x3618b30] Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.ReceiveSetupForPipelineImpl
	// void ReceiveSetupForPipelineImpl(class UMoviePipeline* InPipeline);                                                      // [0x3618b30] Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.ReceiveGetFormatArguments
	// FMoviePipelineFormatArgs ReceiveGetFormatArguments(FMoviePipelineFormatArgs& InOutFormatArgs);                           // [0x7f08970] Native|Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineSetting_BlueprintBase.OnEngineTickBeginFrame
	// void OnEngineTickBeginFrame();                                                                                           // [0x3618b30] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnInitializedForPipeline(class UMoviePipeline* ForPipeline);                                                        // [0x3618b30] Event|Public|BlueprintEvent 
};
...
public:
	...
	// void OnInitializedForPipeline(class UMovieGraphPipeline* InPipeline);                                                    // [0x3618b30] Event|Public|BlueprintEvent 
};
...
{ 
public:
	SDK_UNDEFINED(16,1140) /* FMulticastInlineDelegate */ __um(OnMoviePipelineFinishedDelegate);                   // 0x0078   (0x0010)  
	...
	// void SetInitializationTime(FDateTime& InDateTime);                                                                       // [0x7f3d9f0] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	...
	// void Initialize(class UMoviePipelineExecutorJob* InJob);                                                                 // [0x7f3d230] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPreviewTexture
	// class UTexture* GetPreviewTexture();                                                                                     // [0x5d00f30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPipelinePrimaryConfig
	// class UMoviePipelinePrimaryConfig* GetPipelinePrimaryConfig();                                                           // [0x7f3d160] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetPipelineMasterConfig
	// class UMoviePipelinePrimaryConfig* GetPipelineMasterConfig();                                                            // [0x7f3d160] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetInitializationTimeOffset
	// FTimespan GetInitializationTimeOffset();                                                                                 // [0x7f3c720] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetInitializationTime
	// FDateTime GetInitializationTime();                                                                                       // [0x7f3c700] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipeline.GetCurrentJob
	// class UMoviePipelineExecutorJob* GetCurrentJob();                                                                        // [0x7f3bc60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateJobShotListFromSequence(class ULevelSequence* InSequence, class UMoviePipelineExecutorJob* InJob, bool& bShotsChanged); // [0x7f3da90] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.ResolveVersionNumber
	// int32_t ResolveVersionNumber(FMoviePipelineFilenameResolveParams InParams, bool bGetNextVersion);                        // [0x7f3d760] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.ResolveFilenameFormatArguments
	// void ResolveFilenameFormatArguments(FString InFormatString, FMoviePipelineFilenameResolveParams& InParams, FString& OutFinalPath, FMoviePipelineFormatArgs& OutMergedFormatArgs); // [0x7f3d360] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.LoadManifestFileFromString
	// class UMoviePipelineQueue* LoadManifestFileFromString(FString InManifestFilePath);                                       // [0x7f3d2c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetRootTimecode
	// FTimecode GetRootTimecode(class UMoviePipeline* InMoviePipeline);                                                        // [0x7f3cc20] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetRootFrameNumber
	// FFrameNumber GetRootFrameNumber(class UMoviePipeline* InMoviePipeline);                                                  // [0x7f3cb10] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetPipelineState
	// EMovieRenderPipelineState GetPipelineState(class UMoviePipeline* InPipeline);                                            // [0x7f3d190] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetOverallSegmentCounts
	// void GetOverallSegmentCounts(class UMoviePipeline* InMoviePipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount);   // [0x7f3d030] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetOverallOutputFrames
	// void GetOverallOutputFrames(class UMoviePipeline* InMoviePipeline, int32_t& OutCurrentIndex, int32_t& OutTotalCount);    // [0x7f3cec0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMoviePipelineEngineChangelistLabel
	// FText GetMoviePipelineEngineChangelistLabel(class UMoviePipeline* InMoviePipeline);                                      // [0x7f3ccd0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMasterTimecode
	// FTimecode GetMasterTimecode(class UMoviePipeline* InMoviePipeline);                                                      // [0x7f3cc20] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMasterFrameNumber
	// FFrameNumber GetMasterFrameNumber(class UMoviePipeline* InMoviePipeline);                                                // [0x7f3cb10] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetMapPackageName
	// FString GetMapPackageName(class UMoviePipelineExecutorJob* InJob);                                                       // [0x7f3c980] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobName
	// FText GetJobName(class UMoviePipeline* InMoviePipeline);                                                                 // [0x7f3c8c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobInitializationTime
	// FDateTime GetJobInitializationTime(class UMoviePipeline* InMoviePipeline);                                               // [0x7f3c820] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetJobAuthor
	// FText GetJobAuthor(class UMoviePipeline* InMoviePipeline);                                                               // [0x7f3c740] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetEstimatedTimeRemaining
	// bool GetEstimatedTimeRemaining(class UMoviePipeline* InPipeline, FTimespan& OutEstimate);                                // [0x7f3c570] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetEffectiveOutputResolution
	// FIntPoint GetEffectiveOutputResolution(class UMoviePipelinePrimaryConfig* InPrimaryConfig, class UMoviePipelineExecutorShot* InPipelineExecutorShot); // [0x7f3c280] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentShotTimecode
	// FTimecode GetCurrentShotTimecode(class UMoviePipeline* InMoviePipeline);                                                 // [0x7f3c1d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentShotFrameNumber
	// FFrameNumber GetCurrentShotFrameNumber(class UMoviePipeline* InMoviePipeline);                                           // [0x7f3c0e0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSequence
	// class ULevelSequence* GetCurrentSequence(class UMoviePipeline* InMoviePipeline);                                         // [0x7f3c040] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentWorkMetrics
	// FMoviePipelineSegmentWorkMetrics GetCurrentSegmentWorkMetrics(class UMoviePipeline* InMoviePipeline);                    // [0x7f3bf20] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentState
	// EMovieRenderShotState GetCurrentSegmentState(class UMoviePipeline* InMoviePipeline);                                     // [0x7f3be60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentSegmentName
	// void GetCurrentSegmentName(class UMoviePipeline* InMoviePipeline, FText& OutOuterName, FText& OutInnerName);             // [0x7f3bc80] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentFocusDistance
	// float GetCurrentFocusDistance(class UMoviePipeline* InMoviePipeline);                                                    // [0x7f3bb50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentFocalLength
	// float GetCurrentFocalLength(class UMoviePipeline* InMoviePipeline);                                                      // [0x7f3ba40] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentExecutorShot
	// class UMoviePipelineExecutorShot* GetCurrentExecutorShot(class UMoviePipeline* InMoviePipeline);                         // [0x7f3b990] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCurrentAperture
	// float GetCurrentAperture(class UMoviePipeline* InMoviePipeline);                                                         // [0x7f3b890] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.GetCompletionPercentage
	// float GetCompletionPercentage(class UMoviePipeline* InPipeline);                                                         // [0x7f3b790] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.FindOrGetDefaultSettingForShot
	// class UMoviePipelineSetting* FindOrGetDefaultSettingForShot(class UClass* InSettingType, class UMoviePipelinePrimaryConfig* InPrimaryConfig, class UMoviePipelineExecutorShot* InShot); // [0x7f3b510] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineBlueprintLibrary.DuplicateSequence
	// class UMovieSceneSequence* DuplicateSequence(class UObject* Outer, class UMovieSceneSequence* InSequence);               // [0x7f3b1d0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void SetConfigOrigin(class UMoviePipelineConfigBase* InConfig);                                                          // [0x7f67940] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.RemoveSetting
	// void RemoveSetting(class UMoviePipelineSetting* InSetting);                                                              // [0x7ed6cc0] Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.GetUserSettings
	// TArray<UMoviePipelineSetting*> GetUserSettings();                                                                        // [0x7f66a70] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.GetConfigOrigin
	// class UMoviePipelineConfigBase* GetConfigOrigin();                                                                       // [0x7f663a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindSettingsByClass
	// TArray<UMoviePipelineSetting*> FindSettingsByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x7f65f80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindSettingByClass
	// class UMoviePipelineSetting* FindSettingByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x7f65e40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.FindOrAddSettingByClass
	// class UMoviePipelineSetting* FindOrAddSettingByClass(class UClass* InClass, bool bIncludeDisabledSettings, bool bExactMatch); // [0x7f65d00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineConfigBase.CopyFrom
	// void CopyFrom(class UMoviePipelineConfigBase* InConfig);                                                                 // [0x7f657c0] Native|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1141) /* FMulticastInlineDelegate */ __um(OnExecutorFinishedDelegate);                        // 0x0028   (0x0010)  
	unsigned char                                      UnknownData00_6[0x18];                                      // 0x0038   (0x0018)  MISSED
	SDK_UNDEFINED(16,1142) /* FMulticastInlineDelegate */ __um(OnExecutorErroredDelegate);                         // 0x0050   (0x0010)  
	unsigned char                                      UnknownData01_6[0x20];                                      // 0x0060   (0x0020)  MISSED
	SDK_UNDEFINED(16,1143) /* FMulticastInlineDelegate */ __um(SocketMessageRecievedDelegate);                     // 0x0080   (0x0010)  
	SDK_UNDEFINED(16,1144) /* FMulticastInlineDelegate */ __um(HTTPResponseRecievedDelegate);                      // 0x0090   (0x0010)  
	...
	// void SetStatusProgress(float InProgress);                                                                                // [0x7f68920] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SetStatusMessage
	// void SetStatusMessage(FString InStatus);                                                                                 // [0x7f687e0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SetMoviePipelineClass
	// void SetMoviePipelineClass(class UClass* InPipelineClass);                                                               // [0x7f68170] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SendSocketMessage
	// bool SendSocketMessage(FString InMessage);                                                                               // [0x7f677b0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.SendHTTPRequest
	// int32_t SendHTTPRequest(FString InURL, FString InVerb, FString InMessage, TMap<FString, FString>& InHeaders);            // [0x7f675a0] Final|Native|Protected|HasOutParms|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnExecutorFinishedImpl
	// void OnExecutorFinishedImpl();                                                                                           // [0x5490d30] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnExecutorErroredImpl
	// void OnExecutorErroredImpl(class UMoviePipeline* ErroredPipeline, bool bFatal, FText ErrorReason);                       // [0x7f66e90] Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.OnBeginFrame
	// void OnBeginFrame();                                                                                                     // [0x536a460] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.IsSocketConnected
	// bool IsSocketConnected();                                                                                                // [0x7f66d20] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.IsRendering
	// bool IsRendering();                                                                                                      // [0x5369410] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x7a23570] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x59a1560] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.Execute
	// void Execute(class UMoviePipelineQueue* InPipelineQueue);                                                                // [0x7a19eb0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.DisconnectSocket
	// void DisconnectSocket();                                                                                                 // [0x7f65a80] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.ConnectSocket
	// bool ConnectSocket(FString InHostName, int32_t InPort);                                                                  // [0x7f656d0] Final|Native|Protected|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.CancelCurrentJob
	// void CancelCurrentJob();                                                                                                 // [0x57328e0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorBase.CancelAllJobs
	// void CancelAllJobs();                                                                                                    // [0x5a04d20] Native|Event|Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void InitializeTransientSettings();                                                                                      // [0x7f66c40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetTransientSettings
	// TArray<UMoviePipelineSetting*> GetTransientSettings();                                                                   // [0x7f66b70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetEffectiveFrameRate
	// FFrameRate GetEffectiveFrameRate(class ULevelSequence* InSequence);                                                      // [0x7f66440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePrimaryConfig.GetAllSettings
	// TArray<UMoviePipelineSetting*> GetAllSettings(bool bIncludeDisabledSettings, bool bIncludeTransientSettings);            // [0x7f66130] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void OnMapLoad(class UWorld* InWorld);                                                                                   // [0x7f66fe0] Native|Event|Public|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePythonHostExecutor.GetLastLoadedWorld
	// class UWorld* GetLastLoadedWorld();                                                                                      // [0x7f66610] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelinePythonHostExecutor.ExecuteDelayed
	// void ExecuteDelayed(class UMoviePipelineQueue* InPipelineQueue);                                                         // [0x7f65c70] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// bool ShouldRender();                                                                                                     // [0x5a04d00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetStatusProgress
	// void SetStatusProgress(float InProgress);                                                                                // [0x7f689b0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetStatusMessage
	// void SetStatusMessage(FString InStatus);                                                                                 // [0x7f68880] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetShotOverridePresetOrigin
	// void SetShotOverridePresetOrigin(class UMoviePipelineShotConfig* InPreset);                                              // [0x7f68630] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetShotOverrideConfiguration
	// void SetShotOverrideConfiguration(class UMoviePipelineShotConfig* InPreset);                                             // [0x7f68520] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.SetGraphPreset
	// void SetGraphPreset(class UMovieGraphConfig* InGraphPreset, bool bUpdateVariableAssignments);                            // [0x7f67d40] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.IsUsingGraphConfiguration
	// bool IsUsingGraphConfiguration();                                                                                        // [0x7f66de0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x7f66b30] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x7f66a70] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetShotOverridePresetOrigin
	// class UMoviePipelineShotConfig* GetShotOverridePresetOrigin();                                                           // [0x7f66910] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetShotOverrideConfiguration
	// class UMoviePipelineShotConfig* GetShotOverrideConfiguration();                                                          // [0x5b180b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetOrCreateJobVariableAssignmentsForGraph
	// class UMovieJobVariableAssignmentContainer* GetOrCreateJobVariableAssignmentsForGraph(class UMovieGraphConfig* InGraph, bool bIsForPrimaryOverrides); // [0x7f666f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetGraphPreset
	// class UMovieGraphConfig* GetGraphPreset();                                                                               // [0x7f66590] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.GetCameraName
	// FString GetCameraName(int32_t InCameraIndex);                                                                            // [0x7f66260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorShot.AllocateNewShotOverrideConfig
	// class UMoviePipelineShotConfig* AllocateNewShotOverrideConfig(class UClass* InConfigType);                               // [0x7f65270] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetSequence(FSoftObjectPath InSequence);                                                                            // [0x7f68420] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetPresetOrigin
	// void SetPresetOrigin(class UMoviePipelinePrimaryConfig* InPreset);                                                       // [0x7f68210] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetIsEnabled
	// void SetIsEnabled(bool bInEnabled);                                                                                      // [0x7f67e10] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetGraphPreset
	// void SetGraphPreset(class UMovieGraphConfig* InGraphPreset, bool bUpdateVariableAssignments);                            // [0x7f67c70] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetConsumed
	// void SetConsumed(bool bInConsumed);                                                                                      // [0x7f67be0] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.SetConfiguration
	// void SetConfiguration(class UMoviePipelinePrimaryConfig* InPreset);                                                      // [0x7f67a20] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.OnDuplicated
	// void OnDuplicated();                                                                                                     // [0x4312c10] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsUsingGraphConfiguration
	// bool IsUsingGraphConfiguration();                                                                                        // [0x7f66d70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsEnabled
	// bool IsEnabled();                                                                                                        // [0x7f66c60] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.IsConsumed
	// bool IsConsumed();                                                                                                       // [0x5553ae0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetStatusProgress
	// float GetStatusProgress();                                                                                               // [0x7f66af0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetStatusMessage
	// FString GetStatusMessage();                                                                                              // [0x7f669f0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetPresetOrigin
	// class UMoviePipelinePrimaryConfig* GetPresetOrigin();                                                                    // [0x7f667f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetOrCreateJobVariableAssignmentsForGraph
	// class UMovieJobVariableAssignmentContainer* GetOrCreateJobVariableAssignmentsForGraph(class UMovieGraphConfig* InGraph); // [0x7f66630] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetGraphPreset
	// class UMovieGraphConfig* GetGraphPreset();                                                                               // [0x7f66510] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineExecutorJob.GetConfiguration
	// class UMoviePipelinePrimaryConfig* GetConfiguration();                                                                   // [0x7f66420] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetQueueOrigin(class UMoviePipelineQueue* InConfig);                                                                // [0x7f68340] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.SetJobIndex
	// void SetJobIndex(class UMoviePipelineExecutorJob* InJob, int32_t Index);                                                 // [0x7f67f30] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.GetQueueOrigin
	// class UMoviePipelineQueue* GetQueueOrigin();                                                                             // [0x7f66890] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.GetJobs
	// TArray<UMoviePipelineExecutorJob*> GetJobs();                                                                            // [0x7edbb70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DuplicateJob
	// class UMoviePipelineExecutorJob* DuplicateJob(class UMoviePipelineExecutorJob* InJob);                                   // [0x7f65ac0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DeleteJob
	// void DeleteJob(class UMoviePipelineExecutorJob* InJob);                                                                  // [0x7f659d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.DeleteAllJobs
	// void DeleteAllJobs();                                                                                                    // [0x7f65990] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.CopyFrom
	// void CopyFrom(class UMoviePipelineQueue* InQueue);                                                                       // [0x7f65850] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueue.AllocateNewJob
	// class UMoviePipelineExecutorJob* AllocateNewJob(class UClass* InJobType);                                                // [0x7f651c0] Final|Native|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1145) /* FMulticastInlineDelegate */ __um(OnRenderFinished);                                  // 0x0030   (0x0010)  
	...
	// void SetConfiguration(class UClass* InProgressWidgetClass, bool bRenderPlayerViewport);                                  // [0x7f67ae0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderQueueWithExecutorInstance
	// void RenderQueueWithExecutorInstance(class UMoviePipelineExecutorBase* InExecutor);                                      // [0x7f673e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderQueueWithExecutor
	// class UMoviePipelineExecutorBase* RenderQueueWithExecutor(class UClass* InExecutorType);                                 // [0x7f67270] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.RenderJob
	// void RenderJob(class UMoviePipelineExecutorJob* InJob);                                                                  // [0x7f67070] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.IsRendering
	// bool IsRendering();                                                                                                      // [0x7f66c90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.GetQueue
	// class UMoviePipelineQueue* GetQueue();                                                                                   // [0x7f66870] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.GetActiveExecutor
	// class UMoviePipelineExecutorBase* GetActiveExecutor();                                                                   // [0x4fd2660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineCore.MoviePipelineQueueEngineSubsystem.AllocateJob
	// class UMoviePipelineExecutorJob* AllocateJob(class ULevelSequence* InSequence);                                          // [0x7f64f00] Final|Native|Public|BlueprintCallable 
};
...
{ 
	SDK_UNDEFINED(80,1146) /* TSet<UMovieGraphNode*> */ __um(VisitedNodes);                                        // 0x0000   (0x0050)  
};
...
static_assert(sizeof(FMovieGraphPropertyInfo) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(UMovieGraphNode) == 0x0098); // 152 bytes (0x000028 - 0x000098)
static_assert(sizeof(UMovieGraphSettingNode) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(UMovieGraphApplyCVarPresetNode) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(UMovieGraphFileOutputNode) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(UMovieGraphAudioOutputNode) == 0x00C0); // 192 bytes (0x0000B0 - 0x0000C0)
static_assert(sizeof(UMovieGraphBlueprintLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphBranchNode) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(UMovieGraphRenderPassNode) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(UMovieGraphWidgetRendererBaseNode) == 0x0110); // 272 bytes (0x000098 - 0x000110)
static_assert(sizeof(UMovieGraphBurnInNode) == 0x0188); // 392 bytes (0x000110 - 0x000188)
static_assert(sizeof(UMovieGraphBurnInWidget) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UMovieGraphCameraSettingNode) == 0x00A0); // 160 bytes (0x000098 - 0x0000A0)
static_assert(sizeof(UMovieGraphCollectionNode) == 0x00A8); // 168 bytes (0x000098 - 0x0000A8)
static_assert(sizeof(UMovieGraphCommandLineEncoderNode) == 0x0138); // 312 bytes (0x000098 - 0x000138)
static_assert(sizeof(UMovieGraphValueContainer) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(UMovieGraphMember) == 0x0078); // 120 bytes (0x000040 - 0x000078)
static_assert(sizeof(UMovieGraphVariable) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphGlobalVariable) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphGlobalVariable_ShotName) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphGlobalVariable_SequenceName) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphGlobalVariable_FrameNumber) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphGlobalVariable_CameraName) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMovieGraphInterfaceBase) == 0x0080); // 128 bytes (0x000078 - 0x000080)
static_assert(sizeof(UMovieGraphInput) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(UMovieGraphOutput) == 0x0080); // 128 bytes (0x000080 - 0x000080)
static_assert(sizeof(FMovieGraphEvaluatedSettingsStack) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FMovieGraphEvaluatedBranchConfig) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(UMovieGraphEvaluatedConfig) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(UMovieGraphTraversableObject) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphConfig) == 0x0088); // 136 bytes (0x000028 - 0x000088)
static_assert(sizeof(UMovieGraphTimeStepBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FMovieGraphTimeStepData) == 0x0068); // 104 bytes (0x000000 - 0x000068)
static_assert(sizeof(UMovieGraphCoreTimeStep) == 0x0170); // 368 bytes (0x000028 - 0x000170)
static_assert(sizeof(UMovieGraphEngineTimeStep) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(UMovieGraphRendererBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphDataSourceBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphAudioRendererBase) == 0x0058); // 88 bytes (0x000028 - 0x000058)
static_assert(sizeof(UMovieGraphDebugSettingNode) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(UMovieGraphDefaultAudioRenderer) == 0x0058); // 88 bytes (0x000058 - 0x000058)
static_assert(sizeof(UMovieGraphDefaultRenderer) == 0x01B8); // 440 bytes (0x000028 - 0x0001B8)
static_assert(sizeof(UMovieGraphEdge) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UMovieGraphScriptBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphExecuteScriptNode) == 0x00C0); // 192 bytes (0x000098 - 0x0000C0)
static_assert(sizeof(UMovieGraphGlobalGameOverridesNode) == 0x0150); // 336 bytes (0x000098 - 0x000150)
static_assert(sizeof(FMovieGraphNamedResolution) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FMovieGraphVersioningSettings) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(UMovieGraphGlobalOutputSettingNode) == 0x0100); // 256 bytes (0x000098 - 0x000100)
static_assert(sizeof(UMovieGraphInputNode) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(UMovieGraphLinearTimeStep) == 0x0170); // 368 bytes (0x000170 - 0x000170)
static_assert(sizeof(UMovieGraphMergeableModifierContainer) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(UMovieGraphModifierNode) == 0x00D0); // 208 bytes (0x000098 - 0x0000D0)
static_assert(sizeof(UMovieGraphPostRenderNode) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UMovieGraphOutputNode) == 0x0098); // 152 bytes (0x000098 - 0x000098)
static_assert(sizeof(FMovieGraphPinProperties) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(UMovieGraphPin) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(UMoviePipelineBase) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(UMovieGraphPipeline) == 0x01C8); // 456 bytes (0x000078 - 0x0001C8)
static_assert(sizeof(UMovieGraphProjectSettings) == 0x0048); // 72 bytes (0x000038 - 0x000048)
static_assert(sizeof(UMovieGraphRemoveRenderSettingNode) == 0x00A0); // 160 bytes (0x000098 - 0x0000A0)
static_assert(sizeof(UMovieGraphRenderLayerNode) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(UMovieGraphConditionGroupQueryBase) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UMovieGraphConditionGroupQuery_Actor) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroupQuery_ActorTagName) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroupQuery_ActorName) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroupQuery_ActorType) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UMovieGraphConditionGroupQuery_ComponentTagName) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroupQuery_ComponentType) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UMovieGraphConditionGroupQuery_EditorFolder) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroupQuery_Sublevel) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UMovieGraphConditionGroup) == 0x00F0); // 240 bytes (0x000028 - 0x0000F0)
static_assert(sizeof(UMovieGraphCollection) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(UMovieGraphCollectionModifier) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UMovieGraphMaterialModifier) == 0x00B8); // 184 bytes (0x000038 - 0x0000B8)
static_assert(sizeof(UMovieGraphRenderPropertyModifier) == 0x0050); // 80 bytes (0x000038 - 0x000050)
static_assert(sizeof(UMovieGraphRenderLayer) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(UMovieGraphRenderLayerSubsystem) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(UMovieGraphSamplingMethodNode) == 0x00C8); // 200 bytes (0x000098 - 0x0000C8)
static_assert(sizeof(UMovieGraphSelectNode) == 0x00A8); // 168 bytes (0x000098 - 0x0000A8)
static_assert(sizeof(UMovieGraphSequenceDataSource) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UMovieGraphSetCVarValueNode) == 0x00B8); // 184 bytes (0x000098 - 0x0000B8)
static_assert(sizeof(UMovieGraphShowFlags) == 0x0100); // 256 bytes (0x000028 - 0x000100)
static_assert(sizeof(UMovieGraphSubgraphNode) == 0x00C0); // 192 bytes (0x000098 - 0x0000C0)
static_assert(sizeof(UMovieGraphUIRendererNode) == 0x0110); // 272 bytes (0x000110 - 0x000110)
static_assert(sizeof(UMovieGraphVariableNode) == 0x00C0); // 192 bytes (0x000098 - 0x0000C0)
static_assert(sizeof(UMovieGraphWarmUpSettingNode) == 0x00A8); // 168 bytes (0x000098 - 0x0000A8)
static_assert(sizeof(UMovieJobVariableAssignmentContainer) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(UMoviePipelineSetting) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(UMoviePipelineCameraSetting) == 0x0058); // 88 bytes (0x000048 - 0x000058)
static_assert(sizeof(AMoviePipelineGameMode) == 0x0328); // 808 bytes (0x000328 - 0x000328)
...
static_assert(sizeof(UMoviePipelineSetting_BlueprintBase) == 0x0060); // 96 bytes (0x000048 - 0x000060)
static_assert(sizeof(UMoviePipelineViewFamilySetting) == 0x0048); // 72 bytes (0x000048 - 0x000048)
static_assert(sizeof(UMovieRenderDebugWidget) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UMovieGraphRenderPreviewWidget) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UMoviePipeline) == 0x0420); // 1056 bytes (0x000078 - 0x000420)
static_assert(sizeof(UMoviePipelineCustomTimeStep) == 0x0038); // 56 bytes (0x000028 - 0x000038)
...
static_assert(sizeof(UMoviePipelineColorSetting) == 0x00F0); // 240 bytes (0x000048 - 0x0000F0)
static_assert(sizeof(UMoviePipelineCommandLineEncoder) == 0x0088); // 136 bytes (0x000048 - 0x000088)
static_assert(sizeof(UMoviePipelineCommandLineEncoderSettings) == 0x00F8); // 248 bytes (0x000038 - 0x0000F8)
static_assert(sizeof(UMoviePipelineConfigBase) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(UMoviePipelineDebugSettings) == 0x0058); // 88 bytes (0x000048 - 0x000058)
static_assert(sizeof(UMoviePipelineExecutorBase) == 0x0118); // 280 bytes (0x000028 - 0x000118)
static_assert(sizeof(UMoviePipelineFCPXMLExporter) == 0x0080); // 128 bytes (0x000048 - 0x000080)
static_assert(sizeof(UMoviePipelineGameOverrideSetting) == 0x0130); // 304 bytes (0x000048 - 0x000130)
static_assert(sizeof(UMoviePipelineLinearExecutorBase) == 0x0140); // 320 bytes (0x000118 - 0x000140)
static_assert(sizeof(UMoviePipelineInProcessExecutor) == 0x0188); // 392 bytes (0x000140 - 0x000188)
static_assert(sizeof(UMoviePipelineOutputSetting) == 0x00B0); // 176 bytes (0x000048 - 0x0000B0)
static_assert(sizeof(UMoviePipelinePrimaryConfig) == 0x00E0); // 224 bytes (0x000078 - 0x0000E0)
static_assert(sizeof(UMoviePipelinePythonHostExecutor) == 0x0130); // 304 bytes (0x000118 - 0x000130)
static_assert(sizeof(FMoviePipelineSidecarCamera) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(UMoviePipelineExecutorShot) == 0x01D0); // 464 bytes (0x000028 - 0x0001D0)
static_assert(sizeof(UMoviePipelineExecutorJob) == 0x0158); // 344 bytes (0x000028 - 0x000158)
static_assert(sizeof(UMoviePipelineQueue) == 0x0068); // 104 bytes (0x000028 - 0x000068)
static_assert(sizeof(UMoviePipelineQueueEngineSubsystem) == 0x00A0); // 160 bytes (0x000030 - 0x0000A0)
static_assert(sizeof(UMoviePipelineRenderPass) == 0x0048); // 72 bytes (0x000048 - 0x000048)
static_assert(sizeof(UMoviePipelineShotConfig) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UMoviePipelineVideoOutputBase) == 0x0090); // 144 bytes (0x000048 - 0x000090)
static_assert(sizeof(FMoviePipelinePassIdentifier) == 0x0020); // 32 bytes (0x000000 - 0x000020)
...
static_assert(sizeof(FMovieGraphRenderDataIdentifier) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(sizeof(FMovieGraphRenderLayerOutputData) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FMovieGraphRenderOutputData) == 0x0058); // 88 bytes (0x000000 - 0x000058)
static_assert(sizeof(FMoviePipelineOutputData) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FMovieGraphEvaluationContext_VisitedNodeInfo) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(FMovieGraphTraversalContext) == 0x00D0); // 208 bytes (0x000000 - 0x0000D0)
static_assert(sizeof(FMovieGraphEvaluationContext) == 0x0160); // 352 bytes (0x000000 - 0x000160)
static_assert(sizeof(FMovieGraphImagePreviewData) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(FMovieGraphInitConfig) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FMovieGraphResolveArgs) == 0x00A0); // 160 bytes (0x000000 - 0x0000A0)
static_assert(sizeof(FMovieGraphFilenameResolveParams) == 0x0158); // 344 bytes (0x000000 - 0x000158)
static_assert(sizeof(FMovieGraphBranch) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FMoviePipelineSegmentWorkMetrics) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FMoviePipelineCameraCutInfo) == 0x00C8); // 200 bytes (0x000000 - 0x0000C8)
static_assert(sizeof(FMoviePipelineFormatArgs) == 0x00A8); // 168 bytes (0x000000 - 0x0000A8)
static_assert(sizeof(FMoviePipelineFilenameResolveParams) == 0x0120); // 288 bytes (0x000000 - 0x000120)
static_assert(offsetof(FMovieGraphPropertyInfo, Name) == 0x0000);
static_assert(offsetof(FMovieGraphPropertyInfo, valueType) == 0x0009);
static_assert(offsetof(FMovieGraphPropertyInfo, ValueTypeObject) == 0x0010);
static_assert(offsetof(UMovieGraphNode, InputPins) == 0x0040);
static_assert(offsetof(UMovieGraphNode, OutputPins) == 0x0050);
static_assert(offsetof(UMovieGraphNode, DynamicProperties) == 0x0060);
static_assert(offsetof(UMovieGraphNode, ExposedPropertyInfo) == 0x0070);
static_assert(offsetof(UMovieGraphNode, Guid) == 0x0084);
static_assert(offsetof(UMovieGraphFileOutputNode, FileNameFormat) == 0x00A0);
static_assert(offsetof(UMovieGraphBurnInNode, BurnInClass) == 0x0118);
static_assert(offsetof(UMovieGraphBurnInNode, BurnInWidgetInstances) == 0x0138);
static_assert(offsetof(UMovieGraphCameraSettingNode, ShutterTiming) == 0x0099);
static_assert(offsetof(UMovieGraphCollectionNode, Collection) == 0x00A0);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, FileNameFormat) == 0x00A8);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, VideoCodec) == 0x00C0);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, AudioCodec) == 0x00D0);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, OutputFileExtension) == 0x00E0);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, CommandLineFormat) == 0x00F0);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, VideoInputStringFormat) == 0x0100);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, AudioInputStringFormat) == 0x0110);
static_assert(offsetof(UMovieGraphCommandLineEncoderNode, EncodeSettings) == 0x0120);
static_assert(offsetof(UMovieGraphValueContainer, PropertyName) == 0x0028);
static_assert(offsetof(UMovieGraphValueContainer, Value) == 0x0030);
static_assert(offsetof(UMovieGraphMember, Description) == 0x0040);
static_assert(offsetof(UMovieGraphMember, Name) == 0x0050);
static_assert(offsetof(UMovieGraphMember, Guid) == 0x0060);
static_assert(offsetof(FMovieGraphEvaluatedSettingsStack, NodeInstances) == 0x0000);
static_assert(offsetof(FMovieGraphEvaluatedBranchConfig, NamedNodes) == 0x0000);
static_assert(offsetof(UMovieGraphEvaluatedConfig, BranchConfigMapping) == 0x0028);
static_assert(offsetof(UMovieGraphConfig, AllNodes) == 0x0028);
static_assert(offsetof(UMovieGraphConfig, InputNode) == 0x0038);
static_assert(offsetof(UMovieGraphConfig, OutputNode) == 0x0040);
static_assert(offsetof(UMovieGraphConfig, Variables) == 0x0048);
static_assert(offsetof(UMovieGraphConfig, GlobalVariables) == 0x0058);
static_assert(offsetof(UMovieGraphConfig, Inputs) == 0x0068);
static_assert(offsetof(UMovieGraphConfig, Outputs) == 0x0078);
static_assert(offsetof(FMovieGraphTimeStepData, FrameRate) == 0x001C);
static_assert(offsetof(FMovieGraphTimeStepData, EvaluatedConfig) == 0x0030);
static_assert(offsetof(FMovieGraphTimeStepData, RootTimeCode) == 0x0038);
static_assert(offsetof(FMovieGraphTimeStepData, RootFrameNumber) == 0x004C);
static_assert(offsetof(FMovieGraphTimeStepData, ShotTimeCode) == 0x0050);
static_assert(offsetof(FMovieGraphTimeStepData, ShotFrameNumber) == 0x0064);
static_assert(offsetof(UMovieGraphCoreTimeStep, CurrentTimeStepData) == 0x0028);
static_assert(offsetof(UMovieGraphDebugSettingNode, UnrealInsightsTraceFileNameFormat) == 0x00A0);
static_assert(offsetof(UMovieGraphDefaultRenderer, RenderPassesInUse) == 0x0028);
static_assert(offsetof(UMovieGraphEdge, InputPin) == 0x0028);
static_assert(offsetof(UMovieGraphEdge, OutputPin) == 0x0030);
static_assert(offsetof(UMovieGraphExecuteScriptNode, Script) == 0x00A0);
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, GameModeOverride) == 0x00A0);
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, ScalabilityQualityLevel) == 0x00A8);
static_assert(offsetof(FMovieGraphNamedResolution, ProfileName) == 0x0000);
static_assert(offsetof(FMovieGraphNamedResolution, Resolution) == 0x0008);
static_assert(offsetof(FMovieGraphNamedResolution, Description) == 0x0010);
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputDirectory) == 0x00A0);
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputResolution) == 0x00B0);
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, OutputFrameRate) == 0x00D0);
static_assert(offsetof(UMovieGraphGlobalOutputSettingNode, VersioningSettings) == 0x00F0);
static_assert(offsetof(UMovieGraphMergeableModifierContainer, Modifiers) == 0x0030);
static_assert(offsetof(UMovieGraphModifierNode, ModifierName) == 0x00A0);
static_assert(offsetof(UMovieGraphModifierNode, Collections) == 0x00B8);
static_assert(offsetof(UMovieGraphModifierNode, ModifiersContainer) == 0x00C8);
static_assert(offsetof(FMovieGraphPinProperties, Label) == 0x0000);
static_assert(offsetof(FMovieGraphPinProperties, Type) == 0x0008);
static_assert(offsetof(FMovieGraphPinProperties, TypeObject) == 0x0010);
static_assert(offsetof(UMovieGraphPin, Node) == 0x0028);
static_assert(offsetof(UMovieGraphPin, Properties) == 0x0030);
static_assert(offsetof(UMovieGraphPin, Edges) == 0x0050);
static_assert(offsetof(UMovieGraphPipeline, GraphTimeStepInstances) == 0x0078);
static_assert(offsetof(UMovieGraphPipeline, PendingTimeStepInstance) == 0x0088);
static_assert(offsetof(UMovieGraphPipeline, GraphTimeStepInstance) == 0x0090);
static_assert(offsetof(UMovieGraphPipeline, GraphRendererInstance) == 0x0098);
static_assert(offsetof(UMovieGraphPipeline, GraphDataSourceInstance) == 0x00A0);
static_assert(offsetof(UMovieGraphPipeline, GraphAudioRendererInstance) == 0x00A8);
static_assert(offsetof(UMovieGraphPipeline, PostRenderEvaluatedGraph) == 0x00B0);
static_assert(offsetof(UMovieGraphPipeline, CurrentJob) == 0x00B8);
static_assert(offsetof(UMovieGraphPipeline, CurrentJobDuplicate) == 0x00C0);
static_assert(offsetof(UMovieGraphPipeline, ActiveShotList) == 0x00C8);
static_assert(offsetof(UMovieGraphPipeline, PreviewWidgetClassToUse) == 0x00D8);
static_assert(offsetof(UMovieGraphPipeline, PreviewWidget) == 0x00E0);
static_assert(offsetof(UMovieGraphPipeline, CurrentScriptInstances) == 0x00E8);
static_assert(offsetof(UMovieGraphPipeline, CustomEngineTimeStep) == 0x01B8);
static_assert(offsetof(UMovieGraphPipeline, PrevCustomEngineTimeStep) == 0x01C0);
static_assert(offsetof(UMovieGraphProjectSettings, DefaultNamedResolutions) == 0x0038);
static_assert(offsetof(UMovieGraphRemoveRenderSettingNode, NodeType) == 0x0098);
static_assert(offsetof(UMovieGraphRenderLayerNode, LayerName) == 0x00A0);
static_assert(offsetof(UMovieGraphConditionGroupQueryBase, OpType) == 0x0028);
static_assert(offsetof(UMovieGraphConditionGroupQuery_ActorTagName, TagsToMatch) == 0x0030);
static_assert(offsetof(UMovieGraphConditionGroupQuery_ActorName, WildcardSearch) == 0x0030);
static_assert(offsetof(UMovieGraphConditionGroupQuery_ActorType, ActorTypes) == 0x0030);
static_assert(offsetof(UMovieGraphConditionGroupQuery_ComponentTagName, TagsToMatch) == 0x0030);
static_assert(offsetof(UMovieGraphConditionGroupQuery_ComponentType, ComponentTypes) == 0x0040);
static_assert(offsetof(UMovieGraphConditionGroupQuery_EditorFolder, FolderPaths) == 0x0030);
static_assert(offsetof(UMovieGraphConditionGroup, ID) == 0x0028);
static_assert(offsetof(UMovieGraphConditionGroup, OpType) == 0x0038);
static_assert(offsetof(UMovieGraphConditionGroup, Queries) == 0x0040);
static_assert(offsetof(UMovieGraphCollection, CollectionName) == 0x0028);
static_assert(offsetof(UMovieGraphCollection, ConditionGroups) == 0x0038);
static_assert(offsetof(UMovieGraphCollectionModifier, Collections) == 0x0028);
static_assert(offsetof(UMovieGraphMaterialModifier, Material) == 0x0090);
static_assert(offsetof(UMovieGraphRenderLayer, RenderLayerName) == 0x0028);
static_assert(offsetof(UMovieGraphRenderLayer, Modifiers) == 0x0030);
static_assert(offsetof(UMovieGraphRenderLayerSubsystem, RenderLayers) == 0x0030);
static_assert(offsetof(UMovieGraphRenderLayerSubsystem, ActiveRenderLayer) == 0x0040);
static_assert(offsetof(UMovieGraphSamplingMethodNode, SamplingMethodClass) == 0x00A0);
static_assert(offsetof(UMovieGraphSelectNode, SelectOptions) == 0x0098);
static_assert(offsetof(UMovieGraphSelectNode, SelectedOption) == 0x00A0);
static_assert(offsetof(UMovieGraphSequenceDataSource, LevelSequenceActor) == 0x0028);
static_assert(offsetof(UMovieGraphSetCVarValueNode, Name) == 0x00A0);
static_assert(offsetof(UMovieGraphShowFlags, ShowFlagEnableState) == 0x0080);
static_assert(offsetof(UMovieGraphSubgraphNode, SubgraphAsset) == 0x0098);
static_assert(offsetof(UMovieGraphVariableNode, GraphVariable) == 0x0098);
static_assert(offsetof(UMovieGraphVariableNode, OutputPin) == 0x00A0);
static_assert(offsetof(UMovieJobVariableAssignmentContainer, Value) == 0x0028);
static_assert(offsetof(UMovieJobVariableAssignmentContainer, GraphPreset) == 0x0038);
...
static_assert(offsetof(UMoviePipelineSetting_BlueprintBase, CategoryText) == 0x0048);
static_assert(offsetof(UMoviePipeline, CustomTimeStep) == 0x0088);
static_assert(offsetof(UMoviePipeline, CachedPrevCustomTimeStep) == 0x00A0);
static_assert(offsetof(UMoviePipeline, TargetSequence) == 0x00A8);
static_assert(offsetof(UMoviePipeline, LevelSequenceActor) == 0x00B0);
static_assert(offsetof(UMoviePipeline, DebugWidget) == 0x00B8);
static_assert(offsetof(UMoviePipeline, PreviewTexture) == 0x00C0);
static_assert(offsetof(UMoviePipeline, DebugWidgetClass) == 0x0328);
static_assert(offsetof(UMoviePipeline, CurrentJob) == 0x0338);
...
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, VideoCodec) == 0x0058);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, AudioCodec) == 0x0068);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, OutputFileExtension) == 0x0078);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, CommandLineFormat) == 0x0088);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, VideoInputStringFormat) == 0x0098);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, AudioInputStringFormat) == 0x00A8);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, EncodeSettings_Low) == 0x00B8);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, EncodeSettings_Med) == 0x00C8);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, EncodeSettings_High) == 0x00D8);
static_assert(offsetof(UMoviePipelineCommandLineEncoderSettings, EncodeSettings_Epic) == 0x00E8);
...
static_assert(offsetof(UMoviePipelineConfigBase, ConfigOrigin) == 0x0048);
static_assert(offsetof(UMoviePipelineExecutorBase, DebugWidgetClass) == 0x00A0);
static_assert(offsetof(UMoviePipelineExecutorBase, UserData) == 0x00B8);
static_assert(offsetof(UMoviePipelineExecutorBase, TargetPipelineClass) == 0x00C8);
...
static_assert(offsetof(UMoviePipelineLinearExecutorBase, Queue) == 0x0118);
static_assert(offsetof(UMoviePipelineLinearExecutorBase, ActiveMoviePipeline) == 0x0120);
...
static_assert(offsetof(UMoviePipelinePrimaryConfig, PerShotConfigMapping) == 0x0078);
static_assert(offsetof(UMoviePipelinePrimaryConfig, OutputSetting) == 0x00C8);
static_assert(offsetof(UMoviePipelinePrimaryConfig, TransientSettings) == 0x00D0);
static_assert(offsetof(UMoviePipelinePythonHostExecutor, ExecutorClass) == 0x0118);
static_assert(offsetof(UMoviePipelinePythonHostExecutor, PipelineQueue) == 0x0120);
static_assert(offsetof(UMoviePipelinePythonHostExecutor, LastLoadedWorld) == 0x0128);
static_assert(offsetof(FMoviePipelineSidecarCamera, BindingID) == 0x0000);
static_assert(offsetof(FMoviePipelineSidecarCamera, Name) == 0x0018);
...
static_assert(offsetof(UMoviePipelineExecutorShot, SidecarCameras) == 0x0050);
static_assert(offsetof(UMoviePipelineExecutorShot, StatusMessage) == 0x0148);
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverrideConfig) == 0x0158);
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverridePresetOrigin) == 0x0160);
static_assert(offsetof(UMoviePipelineExecutorShot, GraphPreset) == 0x0188);
static_assert(offsetof(UMoviePipelineExecutorShot, GraphVariableAssignments) == 0x01B0);
static_assert(offsetof(UMoviePipelineExecutorShot, PrimaryGraphVariableAssignments) == 0x01C0);
...
static_assert(offsetof(UMoviePipelineExecutorJob, author) == 0x0078);
static_assert(offsetof(UMoviePipelineExecutorJob, Comment) == 0x0088);
static_assert(offsetof(UMoviePipelineExecutorJob, ShotInfo) == 0x0098);
static_assert(offsetof(UMoviePipelineExecutorJob, UserData) == 0x00A8);
static_assert(offsetof(UMoviePipelineExecutorJob, StatusMessage) == 0x00D0);
static_assert(offsetof(UMoviePipelineExecutorJob, Configuration) == 0x00E8);
static_assert(offsetof(UMoviePipelineExecutorJob, PresetOrigin) == 0x00F0);
static_assert(offsetof(UMoviePipelineExecutorJob, GraphPreset) == 0x0120);
static_assert(offsetof(UMoviePipelineExecutorJob, GraphVariableAssignments) == 0x0148);
static_assert(offsetof(UMoviePipelineQueue, Jobs) == 0x0028);
static_assert(offsetof(UMoviePipelineQueue, QueueOrigin) == 0x0038);
static_assert(offsetof(UMoviePipelineQueueEngineSubsystem, ActiveExecutor) == 0x0040);
static_assert(offsetof(UMoviePipelineQueueEngineSubsystem, CurrentQueue) == 0x0048);
static_assert(offsetof(FMoviePipelinePassIdentifier, Name) == 0x0000);
static_assert(offsetof(FMoviePipelinePassIdentifier, CameraName) == 0x0010);
...
static_assert(offsetof(FMovieGraphRenderDataIdentifier, RootBranchName) == 0x0000);
static_assert(offsetof(FMovieGraphRenderDataIdentifier, LayerName) == 0x0008);
static_assert(offsetof(FMovieGraphRenderDataIdentifier, RendererName) == 0x0018);
static_assert(offsetof(FMovieGraphRenderDataIdentifier, SubResourceName) == 0x0028);
static_assert(offsetof(FMovieGraphRenderDataIdentifier, CameraName) == 0x0038);
static_assert(offsetof(FMovieGraphRenderLayerOutputData, FilePaths) == 0x0000);
static_assert(offsetof(FMovieGraphRenderOutputData, Shot) == 0x0000);
static_assert(offsetof(FMovieGraphRenderOutputData, RenderLayerData) == 0x0008);
...
static_assert(offsetof(FMoviePipelineOutputData, GraphData) == 0x0028);
static_assert(offsetof(FMovieGraphTraversalContext, Job) == 0x0008);
static_assert(offsetof(FMovieGraphTraversalContext, Shot) == 0x0010);
static_assert(offsetof(FMovieGraphTraversalContext, RootGraph) == 0x0018);
static_assert(offsetof(FMovieGraphTraversalContext, RenderDataIdentifier) == 0x0020);
static_assert(offsetof(FMovieGraphTraversalContext, Time) == 0x0068);
static_assert(offsetof(FMovieGraphEvaluationContext, UserContext) == 0x0000);
static_assert(offsetof(FMovieGraphEvaluationContext, VisitedNodesByOwningGraph) == 0x00D0);
static_assert(offsetof(FMovieGraphEvaluationContext, PinBeingFollowed) == 0x0120);
static_assert(offsetof(FMovieGraphEvaluationContext, SubgraphStack) == 0x0128);
static_assert(offsetof(FMovieGraphEvaluationContext, TraversalError) == 0x0140);
static_assert(offsetof(FMovieGraphImagePreviewData, Texture) == 0x0000);
static_assert(offsetof(FMovieGraphImagePreviewData, Identifier) == 0x0008);
static_assert(offsetof(FMovieGraphInitConfig, RendererClass) == 0x0000);
static_assert(offsetof(FMovieGraphInitConfig, DataSourceClass) == 0x0008);
static_assert(offsetof(FMovieGraphInitConfig, AudioRendererClass) == 0x0010);
static_assert(offsetof(FMovieGraphResolveArgs, FilenameArguments) == 0x0000);
static_assert(offsetof(FMovieGraphResolveArgs, FileMetadata) == 0x0050);
static_assert(offsetof(FMovieGraphFilenameResolveParams, RenderDataIdentifier) == 0x0000);
static_assert(offsetof(FMovieGraphFilenameResolveParams, FileMetadata) == 0x0058);
static_assert(offsetof(FMovieGraphFilenameResolveParams, FileNameOverride) == 0x00B0);
static_assert(offsetof(FMovieGraphFilenameResolveParams, InitializationTime) == 0x00C8);
static_assert(offsetof(FMovieGraphFilenameResolveParams, InitializationTimeOffset) == 0x00D0);
static_assert(offsetof(FMovieGraphFilenameResolveParams, FileNameFormatOverrides) == 0x00E0);
static_assert(offsetof(FMovieGraphFilenameResolveParams, Job) == 0x0130);
static_assert(offsetof(FMovieGraphFilenameResolveParams, Shot) == 0x0138);
static_assert(offsetof(FMovieGraphFilenameResolveParams, EvaluatedConfig) == 0x0140);
static_assert(offsetof(FMovieGraphFilenameResolveParams, DefaultFrameRate) == 0x014C);
static_assert(offsetof(FMovieGraphBranch, BranchName) == 0x0000);
...
static_assert(offsetof(FMoviePipelineFilenameResolveParams, FileNameOverride) == 0x0038);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, FileNameFormatOverrides) == 0x0048);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, FileMetadata) == 0x0098);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, InitializationTime) == 0x00E8);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, InitializationTimeOffset) == 0x00F0);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, Job) == 0x0100);
static_assert(offsetof(FMoviePipelineFilenameResolveParams, ShotOverride) == 0x0110);
