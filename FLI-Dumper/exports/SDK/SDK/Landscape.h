...
public:
	...
	// void SetVirtualTextureRenderPassType(ERuntimeVirtualTextureMainPassType InType);                                         // [0x4e9bd60] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialVectorParameterValue
	// void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value);                                  // [0x4e9bc90] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue
	// void SetLandscapeMaterialTextureParameterValue(FName ParameterName, class UTexture* Value);                              // [0x4e9bbc0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue
	// void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value);                                         // [0x4e9baf0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget
	// bool LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // [0x4e9b9d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.GetLandscapeActor
	// class ALandscape* GetLandscapeActor();                                                                                   // [0x4e9b9a0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorSetLandscapeMaterial
	// void EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial);                                         // [0x4e9b910] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorApplySpline
	// void EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName); // [0x4e9b580] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeLODDistanceFactor
	// void ChangeLODDistanceFactor(float InLODDistanceFactor);                                                                 // [0x4e9b4f0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections
	// void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections);                             // [0x4e9b460] Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool RenderWeightmaps(FTransform InWorldTransform, FBox2D InExtents, TArray<FName>& InWeightmapLayerNames, class UTextureRenderTarget* OutRenderTarget); // [0x4e43210] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.Landscape.RenderWeightmap
	// bool RenderWeightmap(FTransform InWorldTransform, FBox2D InExtents, FName InWeightmapLayerName, class UTextureRenderTarget2D* OutRenderTarget); // [0x4e43000] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.Landscape.RenderHeightmap
	// bool RenderHeightmap(FTransform InWorldTransform, FBox2D InExtents, class UTextureRenderTarget2D* OutRenderTarget);      // [0x4e42e40] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.Landscape.GetTargetLayerNames
	// TArray<FName> GetTargetLayerNames(bool bInIncludeVisibilityLayer);                                                       // [0x4e42d60] Final|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// void SetLODBias(int32_t InLODBias);                                                                                      // [0x4e434e0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.SetForcedLOD
	// void SetForcedLOD(int32_t InForcedLOD);                                                                                  // [0x4e43450] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.GetMaterialInstanceDynamic
	// class UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex);                                             // [0x4e42c90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation
	// float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName);                            // [0x4e42ba0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation
	// float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer);             // [0x4e42ab0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// class ULandscapeComponent* GetRenderComponent();                                                                         // [0x4e42d30] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x4e538a0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(80,1125) /* TSet<FName> */           __um(OverriddenSharedProperties);                           // 0x0788   (0x0050)  
};
...
public:
	...
	// void RequestLandscapeUpdate(bool bInUserTriggered);                                                                      // [0x4e60a70] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.RenderLayer
	// class UTextureRenderTarget2D* RenderLayer(FLandscapeBrushParameters& InParameters);                                      // [0x4e609c0] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Render
	// class UTextureRenderTarget2D* Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName); // [0x4e60890] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Initialize
	// void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize);   // [0x4e606d0] RequiredAPI|Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0x3618b30] RequiredAPI|Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	SDK_UNDEFINED(16,1126) /* TArray<TWeakObjectPtr<ALandscapeStreamingProxy*>> */ __um(StreamingProxies);         // 0x0118   (0x0010)  
...
static_assert(sizeof(UControlPointMeshComponent) == 0x05E0); // 1504 bytes (0x0005D8 - 0x0005E0)
...
static_assert(sizeof(ALandscapeProxy) == 0x0760); // 1888 bytes (0x000290 - 0x000760)
static_assert(sizeof(ALandscape) == 0x0760); // 1888 bytes (0x000760 - 0x000760)
...
static_assert(sizeof(ULandscapeComponent) == 0x0750); // 1872 bytes (0x000518 - 0x000750)
...
static_assert(sizeof(ULandscapeGizmoRenderComponent) == 0x0520); // 1312 bytes (0x000518 - 0x000520)
static_assert(sizeof(FGrassVariety) == 0x01B0); // 432 bytes (0x000000 - 0x0001B0)
static_assert(sizeof(ULandscapeGrassType) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x0618); // 1560 bytes (0x000518 - 0x000618)
...
static_assert(sizeof(ULandscapeMaterialInstanceConstant) == 0x0280); // 640 bytes (0x000268 - 0x000280)
...
static_assert(sizeof(ULandscapeMeshProxyComponent) == 0x0650); // 1616 bytes (0x0005D8 - 0x000650)
static_assert(sizeof(ULandscapeSettings) == 0x00B0); // 176 bytes (0x000038 - 0x0000B0)
static_assert(sizeof(ULandscapeSplinesComponent) == 0x0550); // 1360 bytes (0x000518 - 0x000550)
...
static_assert(sizeof(ALandscapeStreamingProxy) == 0x07D8); // 2008 bytes (0x000760 - 0x0007D8)
...
static_assert(sizeof(ULandscapeNaniteComponent) == 0x0600); // 1536 bytes (0x0005D8 - 0x000600)
...
static_assert(sizeof(ULandscapeSubsystem) == 0x0088); // 136 bytes (0x000040 - 0x000088)
static_assert(sizeof(ULandscapeTextureStorageProviderFactory) == 0x0060); // 96 bytes (0x000028 - 0x000060)
...
static_assert(sizeof(FLandscapeBrushParameters) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(sizeof(FLandscapeTexture2DMipMap) == 0x0038); // 56 bytes (0x000000 - 0x000038)
...
static_assert(offsetof(ALandscapeProxy, PerLODOverrideMaterials) == 0x02C8);
static_assert(offsetof(ALandscapeProxy, LandscapeSectionOffset) == 0x02DC);
static_assert(offsetof(ALandscapeProxy, ScalableLOD0ScreenSize) == 0x0300);
static_assert(offsetof(ALandscapeProxy, ScalableLOD0DistributionSetting) == 0x0368);
static_assert(offsetof(ALandscapeProxy, ScalableLODDistributionSetting) == 0x03D0);
static_assert(offsetof(ALandscapeProxy, DefaultPhysMaterial) == 0x0448);
static_assert(offsetof(ALandscapeProxy, LandscapeMaterial) == 0x0458);
static_assert(offsetof(ALandscapeProxy, LandscapeHoleMaterial) == 0x0460);
static_assert(offsetof(ALandscapeProxy, RuntimeVirtualTextures) == 0x0468);
static_assert(offsetof(ALandscapeProxy, VirtualTextureRenderPassType) == 0x0484);
static_assert(offsetof(ALandscapeProxy, LandscapeComponents) == 0x0490);
static_assert(offsetof(ALandscapeProxy, CollisionComponents) == 0x04A0);
static_assert(offsetof(ALandscapeProxy, FoliageComponents) == 0x04B0);
static_assert(offsetof(ALandscapeProxy, NaniteComponent) == 0x04C0);
static_assert(offsetof(ALandscapeProxy, NaniteComponents) == 0x04C8);
static_assert(offsetof(ALandscapeProxy, ShadowCacheInvalidationBehavior) == 0x0555);
static_assert(offsetof(ALandscapeProxy, LightingChannels) == 0x0565);
static_assert(offsetof(ALandscapeProxy, CustomDepthStencilWriteMask) == 0x057C);
static_assert(offsetof(ALandscapeProxy, LightmassSettings) == 0x0588);
static_assert(offsetof(ALandscapeProxy, BodyInstance) == 0x05A8);
static_assert(offsetof(ALandscapeProxy, NavigationGeometryGatheringMode) == 0x0754);
static_assert(offsetof(FWeightmapLayerAllocationInfo, LayerInfo) == 0x0000);
static_assert(offsetof(ULandscapeComponent, OverrideMaterial) == 0x0530);
static_assert(offsetof(ULandscapeComponent, OverrideHoleMaterial) == 0x0538);
static_assert(offsetof(ULandscapeComponent, MaterialInstances) == 0x0540);
static_assert(offsetof(ULandscapeComponent, MaterialInstancesDynamic) == 0x0550);
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x0560);
...
static_assert(offsetof(ULandscapeComponent, HeightmapScaleBias) == 0x05B0);
static_assert(offsetof(ULandscapeComponent, CachedLocalBox) == 0x05D0);
static_assert(offsetof(ULandscapeComponent, MipToMipMaxDeltas) == 0x0608);
static_assert(offsetof(ULandscapeComponent, CollisionComponentRef) == 0x0618);
...
static_assert(offsetof(ULandscapeComponent, PerLODOverrideMaterials) == 0x0650);
static_assert(offsetof(ULandscapeComponent, GrassTypes) == 0x0660);
static_assert(offsetof(ULandscapeComponent, MapBuildDataId) == 0x0680);
static_assert(offsetof(ULandscapeComponent, StateId) == 0x06AC);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterface) == 0x06E0);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterfaces) == 0x06E8);
static_assert(offsetof(ULandscapeComponent, MobileWeightmapTextures) == 0x06F8);
static_assert(offsetof(ULandscapeComponent, MobileWeightmapTextureArray) == 0x0708);
static_assert(offsetof(ULandscapeComponent, MobileWeightmapLayerAllocations) == 0x0710);
...
static_assert(offsetof(FGrassVariety, LightingChannels) == 0x019B);
static_assert(offsetof(FGrassVariety, ShadowCacheInvalidationBehavior) == 0x01A8);
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, ComponentLayerInfos) == 0x0518);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CollisionQuadFlags) == 0x0540);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, HeightfieldGuid) == 0x0550);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CachedLocalBox) == 0x0560);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponentRef) == 0x0598);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CookedPhysicalMaterials) == 0x05B8);
...
static_assert(offsetof(ULandscapeMaterialInstanceConstant, TextureStreamingInfo) == 0x0268);
...
static_assert(offsetof(ULandscapeMeshProxyComponent, LandscapeGuid) == 0x05D8);
static_assert(offsetof(ULandscapeMeshProxyComponent, ProxyComponentBases) == 0x05E8);
static_assert(offsetof(ULandscapeMeshProxyComponent, ProxyComponentCentersObjectSpace) == 0x05F8);
static_assert(offsetof(ULandscapeMeshProxyComponent, ComponentXVectorObjectSpace) == 0x0608);
static_assert(offsetof(ULandscapeMeshProxyComponent, ComponentYVectorObjectSpace) == 0x0620);
static_assert(offsetof(ULandscapeSettings, LandscapeDirtyingMode) == 0x0049);
static_assert(offsetof(ULandscapeSettings, DefaultLandscapeMaterial) == 0x0050);
static_assert(offsetof(ULandscapeSettings, DefaultLayerInfoObject) == 0x0078);
static_assert(offsetof(ULandscapeSplinesComponent, ControlPoints) == 0x0518);
static_assert(offsetof(ULandscapeSplinesComponent, Segments) == 0x0528);
static_assert(offsetof(ULandscapeSplinesComponent, CookedForeignMeshComponents) == 0x0538);
...
static_assert(offsetof(ALandscapeStreamingProxy, LandscapeActorRef) == 0x0760);
...
static_assert(offsetof(ULandscapeNaniteComponent, ProxyContentId) == 0x05D8);
static_assert(offsetof(ULandscapeNaniteComponent, SourceLandscapeComponents) == 0x05F0);
...
static_assert(offsetof(FLandscapeBrushParameters, LayerType) == 0x0000);
static_assert(offsetof(FLandscapeBrushParameters, CombinedResult) == 0x0008);
static_assert(offsetof(FLandscapeBrushParameters, WeightmapLayerName) == 0x0010);
