...
static_assert(sizeof(UBodySetupCore) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UChaosPhysicalMaterial) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(FPhysicalMaterialStrength) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FPhysicalMaterialDamageModifier) == 0x0004); // 4 bytes (0x000000 - 0x000004)
static_assert(sizeof(UPhysicalMaterial) == 0x0098); // 152 bytes (0x000028 - 0x000098)
static_assert(sizeof(UPhysicsSettingsCore) == 0x00E8); // 232 bytes (0x000038 - 0x0000E8)
...
static_assert(offsetof(UPhysicalMaterial, Strength) == 0x0064);
static_assert(offsetof(UPhysicalMaterial, DamageModifier) == 0x0070);
static_assert(offsetof(UPhysicalMaterial, SoftCollisionMode) == 0x0075);
