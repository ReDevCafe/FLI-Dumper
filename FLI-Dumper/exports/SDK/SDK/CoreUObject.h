...
public:
	...
	// void ExecuteUbergraph(int32_t EntryPoint);                                                                               // [0x3618b30] Event|Public|BlueprintEvent 
};
...
static_assert(sizeof(UEditorPathObjectInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UGCObjectReferencer) == 0x0038); // 56 bytes (0x000028 - 0x000038)
...
static_assert(sizeof(UPackage) == 0x0080); // 128 bytes (0x000028 - 0x000080)
static_assert(sizeof(UClass) == 0x0200); // 512 bytes (0x0000B0 - 0x000200)
...
static_assert(sizeof(FObjectCookedMetaDataStore) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(UEnumCookedMetaData) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(FFieldCookedMetaDataStore) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(FStructCookedMetaDataStore) == 0x00A0); // 160 bytes (0x000000 - 0x0000A0)
static_assert(sizeof(UStructCookedMetaData) == 0x00C8); // 200 bytes (0x000028 - 0x0000C8)
static_assert(sizeof(UClassCookedMetaData) == 0x0118); // 280 bytes (0x000028 - 0x000118)
static_assert(sizeof(UPackageMap) == 0x00E0); // 224 bytes (0x000028 - 0x0000E0)
static_assert(sizeof(UObjectReachabilityStressData) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UInstanceDataObjectStruct) == 0x00D0); // 208 bytes (0x0000C0 - 0x0000D0)
static_assert(sizeof(ULinkerPlaceholderClass) == 0x03C0); // 960 bytes (0x000200 - 0x0003C0)
...
static_assert(sizeof(FPolyglotTextData) == 0x00B0); // 176 bytes (0x000000 - 0x0000B0)
...
static_assert(sizeof(FTestUndeclaredScriptStructObjectReferencesTest) == 0x0058); // 88 bytes (0x000000 - 0x000058)
...
static_assert(sizeof(FOverriddenPropertyNodeID) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FOverriddenPropertyNode) == 0x0068); // 104 bytes (0x000000 - 0x000068)
static_assert(sizeof(FOverriddenPropertySet) == 0x0060); // 96 bytes (0x000000 - 0x000060)
...
static_assert(offsetof(FObjectCookedMetaDataStore, ObjectMetaData) == 0x0000);
static_assert(offsetof(UEnumCookedMetaData, EnumMetaData) == 0x0028);
static_assert(offsetof(FFieldCookedMetaDataStore, FieldMetaData) == 0x0000);
static_assert(offsetof(FStructCookedMetaDataStore, ObjectMetaData) == 0x0000);
static_assert(offsetof(FStructCookedMetaDataStore, PropertiesMetaData) == 0x0050);
static_assert(offsetof(UStructCookedMetaData, StructMetaData) == 0x0028);
static_assert(offsetof(UClassCookedMetaData, ClassMetaData) == 0x0028);
static_assert(offsetof(UClassCookedMetaData, FunctionsMetaData) == 0x00C8);
...
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, StrongObjectPointer) == 0x0000);
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, SoftObjectPointer) == 0x0008);
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, SoftObjectPath) == 0x0030);
static_assert(offsetof(FTestUndeclaredScriptStructObjectReferencesTest, WeakObjectPointer) == 0x0050);
...
static_assert(offsetof(FOverriddenPropertyNodeID, Path) == 0x0000);
static_assert(offsetof(FOverriddenPropertyNodeID, Object) == 0x0008);
static_assert(offsetof(FOverriddenPropertyNode, NodeID) == 0x0000);
static_assert(offsetof(FOverriddenPropertyNode, Operation) == 0x0010);
static_assert(offsetof(FOverriddenPropertyNode, SubPropertyNodeKeys) == 0x0018);
static_assert(offsetof(FOverriddenPropertySet, Owner) == 0x0000);
