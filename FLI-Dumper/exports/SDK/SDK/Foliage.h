...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x4e3f580] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxTransforms
	// void FoliageOverlappingBoxTransforms(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box, TArray<FTransform>& OutTransforms); // [0x4e3f3f0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x4e3f290] Final|RequiredAPI|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x4e3ef00] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                         // [0x4e3f700] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x0B50); // 2896 bytes (0x000B10 - 0x000B50)
...
static_assert(sizeof(UFoliageType) == 0x04C8); // 1224 bytes (0x000028 - 0x0004C8)
static_assert(sizeof(UFoliageType_Actor) == 0x04E0); // 1248 bytes (0x0004C8 - 0x0004E0)
static_assert(sizeof(UFoliageType_InstancedStaticMesh) == 0x04F8); // 1272 bytes (0x0004C8 - 0x0004F8)
static_assert(sizeof(AInstancedFoliageActor) == 0x02F0); // 752 bytes (0x0002A0 - 0x0002F0)
static_assert(sizeof(UInteractiveFoliageComponent) == 0x05E0); // 1504 bytes (0x0005D8 - 0x0005E0)
static_assert(sizeof(UFoliageStatistics) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UGrassInstancedStaticMeshComponent) == 0x0B10); // 2832 bytes (0x000B10 - 0x000B10)
...
static_assert(sizeof(UProceduralFoliageSpawner) == 0x0080); // 128 bytes (0x000028 - 0x000080)
...
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, GenerationGuid) == 0x0B34);
...
static_assert(offsetof(UFoliageType, ShadowCacheInvalidationBehavior) == 0x0190);
static_assert(offsetof(UFoliageType, LightmapType) == 0x0198);
static_assert(offsetof(UFoliageType, BodyInstance) == 0x01A8);
static_assert(offsetof(UFoliageType, CustomNavigableGeometry) == 0x0340);
static_assert(offsetof(UFoliageType, LightingChannels) == 0x0341);
static_assert(offsetof(UFoliageType, CustomDepthStencilWriteMask) == 0x0348);
static_assert(offsetof(UFoliageType, ProceduralScale) == 0x0388);
static_assert(offsetof(UFoliageType, ScaleCurve) == 0x0390);
static_assert(offsetof(UFoliageType, DensityFalloff) == 0x0418);
static_assert(offsetof(UFoliageType, RuntimeVirtualTextures) == 0x04B0);
static_assert(offsetof(UFoliageType, VirtualTextureRenderPassType) == 0x04C4);
static_assert(offsetof(UFoliageType_Actor, ActorClass) == 0x04C8);
static_assert(offsetof(UFoliageType_Actor, StaticMeshOnlyComponentClass) == 0x04D8);
static_assert(offsetof(UFoliageType_InstancedStaticMesh, Mesh) == 0x04C8);
static_assert(offsetof(UFoliageType_InstancedStaticMesh, OverrideMaterials) == 0x04D0);
static_assert(offsetof(UFoliageType_InstancedStaticMesh, NaniteOverrideMaterials) == 0x04E0);
static_assert(offsetof(UFoliageType_InstancedStaticMesh, ComponentClass) == 0x04F0);
