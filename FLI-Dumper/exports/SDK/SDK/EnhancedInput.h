...
public:
	...
	// FString ToString();                                                                                                      // [0x7f66a70] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.SetDisplayName
	// void SetDisplayName(FText& NewDisplayName);                                                                              // [0x87898c0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.ResetToDefault
	// void ResetToDefault();                                                                                                   // [0x57a1270] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.ResetMappingToDefault
	// void ResetMappingToDefault(FName InMappingName);                                                                         // [0x8789830] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.QueryPlayerMappedKeys
	// int32_t QueryPlayerMappedKeys(FPlayerMappableKeyQueryOptions& OPTIONS, TArray<FKey>& OutKeys);                           // [0x8788b00] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.K2_FindKeyMapping
	// void K2_FindKeyMapping(FPlayerKeyMapping& OutKeyMapping, FMapPlayerKeyArgs& InArgs);                                     // [0x8787840] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.GetProfileIdentifer
	// FGameplayTag GetProfileIdentifer();                                                                                      // [0x60b8170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.GetProfileDisplayName
	// FText GetProfileDisplayName();                                                                                           // [0x8785de0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.GetPlayerMappingRows
	// TMap<FName, FKeyMappingRow> GetPlayerMappingRows();                                                                      // [0x8786930] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.GetMappingNamesForKey
	// int32_t GetMappingNamesForKey(FKey& InKey, TArray<FName>& OutMappingNames);                                              // [0x8786510] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.GetMappedKeysInRow
	// int32_t GetMappedKeysInRow(FName MappingName, TArray<FKey>& OutKeys);                                                    // [0x87860b0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.DumpProfileToLog
	// void DumpProfileToLog();                                                                                                 // [0x5490d50] Native|Public|BlueprintCallable|Const 
	// Function /Script/EnhancedInput.EnhancedPlayerMappableKeyProfile.DoesMappingPassQueryOptions
	// bool DoesMappingPassQueryOptions(FPlayerKeyMapping& PlayerMapping, FPlayerMappableKeyQueryOptions& OPTIONS);             // [0x8785550] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool UnregisterInputMappingContexts(TSet<UInputMappingContext*>& MappingContexts);                                       // [0x878a440] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.UnregisterInputMappingContext
	// bool UnregisterInputMappingContext(class UInputMappingContext* IMC);                                                     // [0x878a3a0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.UnMapPlayerKey
	// void UnMapPlayerKey(FMapPlayerKeyArgs& InArgs, FGameplayTagContainer& FailureReason);                                    // [0x8789ee0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.SetKeyProfile
	// bool SetKeyProfile(FGameplayTag& InProfileId);                                                                           // [0x8789970] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.SaveSettings
	// void SaveSettings();                                                                                                     // [0x4312ef0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.ResetKeyProfileToDefault
	// void ResetKeyProfileToDefault(FGameplayTag& ProfileId, FGameplayTagContainer& FailureReason);                            // [0x8789700] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.ResetAllPlayerKeysInRow
	// void ResetAllPlayerKeysInRow(FMapPlayerKeyArgs& InArgs, FGameplayTagContainer& FailureReason);                           // [0x8789550] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.RegisterInputMappingContexts
	// bool RegisterInputMappingContexts(TSet<UInputMappingContext*>& MappingContexts);                                         // [0x8788d90] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.RegisterInputMappingContext
	// bool RegisterInputMappingContext(class UInputMappingContext* IMC);                                                       // [0x8788cf0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.MapPlayerKey
	// void MapPlayerKey(FMapPlayerKeyArgs& InArgs, FGameplayTagContainer& FailureReason);                                      // [0x8788150] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.MappingContextRegisteredWithSettings__DelegateSignature
	// void MappingContextRegisteredWithSettings__DelegateSignature(class UInputMappingContext* IMC);                           // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.MappableKeyProfileChanged__DelegateSignature
	// void MappableKeyProfileChanged__DelegateSignature(class UEnhancedPlayerMappableKeyProfile* NewProfile);                  // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.IsMappingContextRegistered
	// bool IsMappingContextRegistered(class UInputMappingContext* IMC);                                                        // [0x8787550] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.GetKeyProfileWithIdentifier
	// class UEnhancedPlayerMappableKeyProfile* GetKeyProfileWithIdentifier(FGameplayTag& ProfileId);                           // [0x8785ea0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.GetCurrentKeyProfileIdentifier
	// FGameplayTag GetCurrentKeyProfileIdentifier();                                                                           // [0x8785da0] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.GetCurrentKeyProfile
	// class UEnhancedPlayerMappableKeyProfile* GetCurrentKeyProfile();                                                         // [0x8785d60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.FindMappingsInRow
	// TSet<FPlayerKeyMapping> FindMappingsInRow(FName MappingName);                                                            // [0x87856f0] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.EnhancedInputUserSettingsChanged__DelegateSignature
	// void EnhancedInputUserSettingsChanged__DelegateSignature(class UEnhancedInputUserSettings* Settings);                    // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.EnhancedInputUserSettingsApplied__DelegateSignature
	// void EnhancedInputUserSettingsApplied__DelegateSignature();                                                              // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.CreateNewKeyProfile
	// class UEnhancedPlayerMappableKeyProfile* CreateNewKeyProfile(FPlayerMappableKeyProfileCreationArgs& InArgs);             // [0x8785490] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.AsyncSaveSettings
	// void AsyncSaveSettings();                                                                                                // [0x4312bf0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputUserSettings.ApplySettings
	// void ApplySettings();                                                                                                    // [0x5490d50] Native|Public|BlueprintCallable 
};
...
public:
	...
	// FInputActionValue GetBoundActionValue(class UInputAction* Action);                                                       // [0x87858a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void RequestRebuildControlMappingsUsingContext(class UInputMappingContext* Context, bool bForceImmediately);             // [0x8789470] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.MakeInputActionValueOfType
	// FInputActionValue MakeInputActionValueOfType(double X, double Y, double Z, EInputActionValueType valueType);             // [0x8787e50] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.MakeInputActionValue
	// FInputActionValue MakeInputActionValue(double X, double Y, double Z, FInputActionValue& MatchValueType);                 // [0x8787c70] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.IsActionKeyMappingPlayerMappable
	// bool IsActionKeyMappingPlayerMappable(FEnhancedActionKeyMapping& ActionKeyMapping);                                      // [0x87872d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetThirdPlayerMappableKeySlot
	// FPlayerMappableKeySlot GetThirdPlayerMappableKeySlot();                                                                  // [0x8786980] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetSecondPlayerMappableKeySlot
	// FPlayerMappableKeySlot GetSecondPlayerMappableKeySlot();                                                                 // [0x8786960] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetPlayerMappableKeySettings
	// class UPlayerMappableKeySettings* GetPlayerMappableKeySettings(FEnhancedActionKeyMapping& ActionKeyMapping);             // [0x8786690] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetMappingName
	// FName GetMappingName(FEnhancedActionKeyMapping& ActionKeyMapping);                                                       // [0x8786350] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetFourthPlayerMappableKeySlot
	// FPlayerMappableKeySlot GetFourthPlayerMappableKeySlot();                                                                 // [0x8785e80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetFirstPlayerMappableKeySlot
	// FPlayerMappableKeySlot GetFirstPlayerMappableKeySlot();                                                                  // [0x8785e60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.GetBoundActionValue
	// FInputActionValue GetBoundActionValue(class AActor* Actor, class UInputAction* Action);                                  // [0x87859d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.Conv_InputActionValueToString
	// FString Conv_InputActionValueToString(FInputActionValue ActionValue);                                                    // [0x87852c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.Conv_InputActionValueToBool
	// bool Conv_InputActionValueToBool(FInputActionValue InValue);                                                             // [0x8785200] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.Conv_InputActionValueToAxis3D
	// FVector Conv_InputActionValueToAxis3D(FInputActionValue ActionValue);                                                    // [0x8785160] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.Conv_InputActionValueToAxis2D
	// FVector2D Conv_InputActionValueToAxis2D(FInputActionValue InValue);                                                      // [0x87850d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.Conv_InputActionValueToAxis1D
	// double Conv_InputActionValueToAxis1D(FInputActionValue InValue);                                                         // [0x8785030] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/EnhancedInput.EnhancedInputLibrary.BreakInputActionValue
	// void BreakInputActionValue(FInputActionValue InActionValue, double& X, double& Y, double& Z, EInputActionValueType& Type); // [0x8784e00] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// class UInputMappingContext* GetContextRedirect(class UInputMappingContext* InContext);                                   // [0x8785c10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void UpdateValueOfContinuousInputInjectionForPlayerMapping(FName MappingName, FInputActionValue RawValue);               // [0x878a7f0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.UpdateValueOfContinuousInputInjectionForAction
	// void UpdateValueOfContinuousInputInjectionForAction(class UInputAction* Action, FInputActionValue RawValue);             // [0x878a6f0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.StopContinuousInputInjectionForPlayerMapping
	// void StopContinuousInputInjectionForPlayerMapping(FName MappingName);                                                    // [0x8789e50] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.StopContinuousInputInjectionForAction
	// void StopContinuousInputInjectionForAction(class UInputAction* Action);                                                  // [0x8789dc0] Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.StartContinuousInputInjectionForPlayerMapping
	// void StartContinuousInputInjectionForPlayerMapping(FName MappingName, FInputActionValue RawValue, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8789bf0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.StartContinuousInputInjectionForAction
	// void StartContinuousInputInjectionForAction(class UInputAction* Action, FInputActionValue RawValue, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8789a20] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.RequestRebuildControlMappings
	// void RequestRebuildControlMappings(FModifyContextOptions& OPTIONS, EInputMappingRebuildType RebuildType);                // [0x8789380] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.RemovePlayerMappableConfig
	// void RemovePlayerMappableConfig(class UPlayerMappableInputConfig* Config, FModifyContextOptions& OPTIONS);               // [0x8789290] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.RemoveMappingContext
	// void RemoveMappingContext(class UInputMappingContext* MappingContext, FModifyContextOptions& OPTIONS);                   // [0x87891a0] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.RemoveAllPlayerMappedKeysForMapping
	// int32_t RemoveAllPlayerMappedKeysForMapping(FName MappingName, FModifyContextOptions& OPTIONS);                          // [0x87890b0] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.RemoveAllPlayerMappedKeys
	// void RemoveAllPlayerMappedKeys(FModifyContextOptions& OPTIONS);                                                          // [0x8789010] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	...
	// EMappingQueryResult QueryMapKeyInActiveContextSet(class UInputMappingContext* InputContext, class UInputAction* Action, FKey Key, TArray<FMappingQueryIssue>& OutIssues, EMappingQueryIssue BlockingIssues); // [0x8788650] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.QueryKeysMappedToAction
	// TArray<FKey> QueryKeysMappedToAction(class UInputAction* Action);                                                        // [0x87885a0] BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.OnUserSettingsChanged
	// void OnUserSettingsChanged(class UEnhancedInputUserSettings* Settings);                                                  // [0x8788510] Native|Protected     
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.OnUserKeyProfileChanged
	// void OnUserKeyProfileChanged(class UEnhancedPlayerMappableKeyProfile* InNewProfile);                                     // [0x8788480] Native|Protected     
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.K2_RemovePlayerMappedKeyInSlot
	// int32_t K2_RemovePlayerMappedKeyInSlot(FName MappingName, FPlayerMappableKeySlot& KeySlot, FModifyContextOptions& OPTIONS); // [0x8787b30] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.K2_GetPlayerMappedKeyInSlot
	// FKey K2_GetPlayerMappedKeyInSlot(FName MappingName, FPlayerMappableKeySlot& KeySlot);                                    // [0x87879f0] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.K2_AddPlayerMappedKeyInSlot
	// int32_t K2_AddPlayerMappedKeyInSlot(FName MappingName, FKey NewKey, FPlayerMappableKeySlot& KeySlot, FModifyContextOptions& OPTIONS); // [0x8787650] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.InjectInputVectorForPlayerMapping
	// void InjectInputVectorForPlayerMapping(FName MappingName, FVector Value, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8787120] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.InjectInputVectorForAction
	// void InjectInputVectorForAction(class UInputAction* Action, FVector Value, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8786f70] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.InjectInputForPlayerMapping
	// void InjectInputForPlayerMapping(FName MappingName, FInputActionValue RawValue, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8786da0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.InjectInputForAction
	// void InjectInputForAction(class UInputAction* Action, FInputActionValue RawValue, TArray<UInputModifier*>& Modifiers, TArray<UInputTrigger*>& Triggers); // [0x8786bd0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.HasMappingContext
	// bool HasMappingContext(class UInputMappingContext* MappingContext, int32_t& OutFoundPriority);                           // [0x8786af0] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.GetUserSettings
	// class UEnhancedInputUserSettings* GetUserSettings();                                                                     // [0x5733340] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.GetAllPlayerMappedKeys
	// TArray<FKey> GetAllPlayerMappedKeys(FName MappingName);                                                                  // [0x87857f0] BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.GetAllPlayerMappableActionKeyMappings
	// TArray<FEnhancedActionKeyMapping> GetAllPlayerMappableActionKeyMappings();                                               // [0x87857a0] BlueprintCosmetic|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.ClearAllMappings
	// void ClearAllMappings();                                                                                                 // [0x8785010] BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.AddPlayerMappableConfig
	// void AddPlayerMappableConfig(class UPlayerMappableInputConfig* Config, FModifyContextOptions& OPTIONS);                  // [0x8784d10] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputSubsystemInterface.AddMappingContext
	// void AddMappingContext(class UInputMappingContext* MappingContext, int32_t Priority, FModifyContextOptions& OPTIONS);    // [0x8784bf0] BlueprintCosmetic|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnControlMappingsRebuilt__DelegateSignature();                                                                      // [0x3618b30] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	// bool RemoveActorInputComponent(class AActor* Actor);                                                                     // [0x8788ee0] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.EnhancedInputWorldSubsystem.AddActorInputComponent
	// void AddActorInputComponent(class AActor* Actor);                                                                        // [0x87849a0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void UnmapKey(class UInputAction* Action, FKey Key);                                                                     // [0x878a190] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.InputMappingContext.UnmapAllKeysFromAction
	// void UnmapAllKeysFromAction(class UInputAction* Action);                                                                 // [0x878a090] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.InputMappingContext.UnmapAll
	// void UnmapAll();                                                                                                         // [0x878a120] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.InputMappingContext.UnmapAction
	// void UnmapAction(class UInputAction* Action);                                                                            // [0x878a090] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.InputMappingContext.MapKey
	// FEnhancedActionKeyMapping MapKey(class UInputAction* Action, FKey ToKey);                                                // [0x8788000] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// FInputActionValue ModifyRaw(class UEnhancedPlayerInput* PlayerInput, FInputActionValue CurrentValue, float DeltaTime);   // [0x8788300] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/EnhancedInput.InputModifier.GetVisualizationColor
	// FLinearColor GetVisualizationColor(FInputActionValue SampleValue, FInputActionValue FinalValue);                         // [0x87869a0] Native|Event|Public|HasDefaults|BlueprintEvent|Const 
};
...
public:
	...
	// ETriggerState UpdateState(class UEnhancedPlayerInput* PlayerInput, FInputActionValue ModifiedValue, float DeltaTime);    // [0x878a590] Native|Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Script/EnhancedInput.InputTrigger.IsActuated
	// bool IsActuated(FInputActionValue& ForValue);                                                                            // [0x8787460] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.InputTrigger.GetTriggerType
	// ETriggerType GetTriggerType();                                                                                           // [0x59a6fe0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0x53693a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.IsDeprecated
	// bool IsDeprecated();                                                                                                     // [0x8787530] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetPlayerMappableKeys
	// TArray<FEnhancedActionKeyMapping> GetPlayerMappableKeys();                                                               // [0x8786820] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetMetadata
	// class UObject* GetMetadata();                                                                                            // [0x8786670] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetMappingContexts
	// TMap<UInputMappingContext*, int32_t> GetMappingContexts();                                                               // [0x8786320] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetMappingByName
	// FEnhancedActionKeyMapping GetMappingByName(FName MappingName);                                                           // [0x8786210] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetKeysBoundToAction
	// TArray<FEnhancedActionKeyMapping> GetKeysBoundToAction(class UInputAction* InAction);                                    // [0x8785f50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetDisplayName
	// FText GetDisplayName();                                                                                                  // [0x8785de0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/EnhancedInput.PlayerMappableInputConfig.GetConfigName
	// FName GetConfigName();                                                                                                   // [0x5733370] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(FKeyMappingRow) == 0x0050); // 80 bytes (0x000000 - 0x000050)
static_assert(sizeof(UEnhancedPlayerMappableKeyProfile) == 0x0098); // 152 bytes (0x000028 - 0x000098)
static_assert(sizeof(UEnhancedInputUserSettings) == 0x0120); // 288 bytes (0x000028 - 0x000120)
...
static_assert(sizeof(FDefaultContextSetting) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(UEnhancedInputDeveloperSettings) == 0x00E8); // 232 bytes (0x000038 - 0x0000E8)
...
static_assert(sizeof(FInjectedInput) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(UEnhancedInputLocalPlayerSubsystem) == 0x01E8); // 488 bytes (0x000030 - 0x0001E8)
static_assert(sizeof(UEnhancedInputWorldSubsystem) == 0x01F8); // 504 bytes (0x000030 - 0x0001F8)
static_assert(sizeof(FKeyConsumptionOptions) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FEnhancedActionKeyMapping) == 0x0050); // 80 bytes (0x000000 - 0x000050)
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x07F0); // 2032 bytes (0x000498 - 0x0007F0)
...
static_assert(sizeof(UInputMappingContext) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UInputModifier) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UInputModifierSmoothDelta) == 0x0068); // 104 bytes (0x000028 - 0x000068)
...
static_assert(sizeof(UPlayerMappableInputConfig) == 0x00A8); // 168 bytes (0x000030 - 0x0000A8)
static_assert(sizeof(UPlayerMappableKeySettings) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(FPlayerMappableKeyProfileCreationArgs) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FPlayerKeyMapping) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(sizeof(FMapPlayerKeyArgs) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(FPlayerMappableKeyQueryOptions) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FMappingQueryIssue) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FPlayerMappableKeySlot) == 0x0004); // 4 bytes (0x000000 - 0x000004)
static_assert(sizeof(FPlayerMappableKeyOptions) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FModifyContextOptions) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(offsetof(UEnhancedPlayerMappableKeyProfile, ProfileIdentifier) == 0x0028);
static_assert(offsetof(UEnhancedPlayerMappableKeyProfile, OwningUserId) == 0x0030);
static_assert(offsetof(UEnhancedPlayerMappableKeyProfile, DisplayName) == 0x0038);
static_assert(offsetof(UEnhancedPlayerMappableKeyProfile, PlayerMappedKeys) == 0x0048);
static_assert(offsetof(UEnhancedInputUserSettings, CurrentProfileIdentifier) == 0x0070);
static_assert(offsetof(UEnhancedInputUserSettings, SavedKeyProfiles) == 0x0078);
static_assert(offsetof(UEnhancedInputUserSettings, OwningLocalPlayer) == 0x00C8);
...
static_assert(offsetof(UEnhancedInputDeveloperSettings, PlatformSettings) == 0x0058);
static_assert(offsetof(UEnhancedInputDeveloperSettings, UserSettingsClass) == 0x0068);
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultPlayerMappableKeyProfileClass) == 0x0090);
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultWorldInputClass) == 0x00B8);
...
static_assert(offsetof(FInjectedInput, Triggers) == 0x0020);
static_assert(offsetof(FInjectedInput, Modifiers) == 0x0030);
static_assert(offsetof(UEnhancedInputLocalPlayerSubsystem, UserSettings) == 0x0190);
static_assert(offsetof(UEnhancedInputLocalPlayerSubsystem, ContinuouslyInjectedInputs) == 0x0198);
static_assert(offsetof(UEnhancedInputWorldSubsystem, PlayerInput) == 0x0180);
static_assert(offsetof(UEnhancedInputWorldSubsystem, ContinuouslyInjectedInputs) == 0x01A8);
static_assert(offsetof(FEnhancedActionKeyMapping, Triggers) == 0x0000);
static_assert(offsetof(FEnhancedActionKeyMapping, Modifiers) == 0x0010);
static_assert(offsetof(FEnhancedActionKeyMapping, Action) == 0x0020);
static_assert(offsetof(FEnhancedActionKeyMapping, Key) == 0x0028);
static_assert(offsetof(FEnhancedActionKeyMapping, SettingBehavior) == 0x0041);
static_assert(offsetof(FEnhancedActionKeyMapping, PlayerMappableKeySettings) == 0x0048);
...
static_assert(offsetof(FInjectedInputArray, Injected) == 0x0000);
static_assert(offsetof(UEnhancedPlayerInput, KeyConsumptionData) == 0x0498);
static_assert(offsetof(UEnhancedPlayerInput, AppliedInputContexts) == 0x04E8);
static_assert(offsetof(UEnhancedPlayerInput, EnhancedActionMappings) == 0x0538);
static_assert(offsetof(UEnhancedPlayerInput, ActionInstanceData) == 0x0598);
static_assert(offsetof(UEnhancedPlayerInput, KeysPressedThisTick) == 0x0688);
static_assert(offsetof(UEnhancedPlayerInput, InputsInjectedThisTick) == 0x06D8);
static_assert(offsetof(UInputAction, ActionDescription) == 0x0030);
static_assert(offsetof(UInputAction, valueType) == 0x0048);
static_assert(offsetof(UInputAction, AccumulationBehavior) == 0x0049);
...
static_assert(offsetof(UInputModifierSmoothDelta, SmoothingMethod) == 0x0028);
...
static_assert(offsetof(UPlayerMappableInputConfig, MetaData) == 0x0050);
static_assert(offsetof(UPlayerMappableInputConfig, Contexts) == 0x0058);
...
static_assert(offsetof(UPlayerMappableKeySettings, DisplayCategory) == 0x0048);
static_assert(offsetof(UPlayerMappableKeySettings, SupportedKeyProfiles) == 0x0058);
static_assert(offsetof(FPlayerMappableKeyProfileCreationArgs, ProfileType) == 0x0000);
static_assert(offsetof(FPlayerMappableKeyProfileCreationArgs, ProfileIdentifier) == 0x0008);
static_assert(offsetof(FPlayerMappableKeyProfileCreationArgs, UserId) == 0x0010);
static_assert(offsetof(FPlayerMappableKeyProfileCreationArgs, DisplayName) == 0x0018);
static_assert(offsetof(FPlayerKeyMapping, MappingName) == 0x0000);
static_assert(offsetof(FPlayerKeyMapping, DisplayName) == 0x0008);
static_assert(offsetof(FPlayerKeyMapping, DisplayCategory) == 0x0018);
static_assert(offsetof(FPlayerKeyMapping, Slot) == 0x0028);
static_assert(offsetof(FPlayerKeyMapping, DefaultKey) == 0x0030);
static_assert(offsetof(FPlayerKeyMapping, CurrentKey) == 0x0048);
static_assert(offsetof(FPlayerKeyMapping, HardwareDeviceId) == 0x0060);
static_assert(offsetof(FPlayerKeyMapping, AssociatedInputAction) == 0x0078);
static_assert(offsetof(FMapPlayerKeyArgs, MappingName) == 0x0000);
static_assert(offsetof(FMapPlayerKeyArgs, Slot) == 0x0008);
static_assert(offsetof(FMapPlayerKeyArgs, NewKey) == 0x0010);
static_assert(offsetof(FMapPlayerKeyArgs, HardwareDeviceId) == 0x0028);
static_assert(offsetof(FMapPlayerKeyArgs, ProfileId) == 0x0030);
static_assert(offsetof(FPlayerMappableKeyQueryOptions, MappingName) == 0x0000);
static_assert(offsetof(FPlayerMappableKeyQueryOptions, KeyToMatch) == 0x0008);
static_assert(offsetof(FPlayerMappableKeyQueryOptions, SlotToMatch) == 0x0020);
static_assert(offsetof(FPlayerMappableKeyQueryOptions, RequiredDeviceType) == 0x0022);
...
static_assert(offsetof(FPlayerMappableKeyOptions, DisplayCategory) == 0x0020);
