...
static_assert(sizeof(UWorldMetricsSubsystem) == 0x2880); // 10368 bytes (0x000030 - 0x002880)
static_assert(sizeof(UWorldMetricInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UWorldMetricsActorTrackerSubscriber) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UWorldMetricsExtension) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UWorldMetricsActorTracker) == 0x00D0); // 208 bytes (0x000028 - 0x0000D0)
static_assert(offsetof(UWorldMetricsSubsystem, Metrics) == 0x0040);
static_assert(offsetof(UWorldMetricsSubsystem, Extensions) == 0x0050);
