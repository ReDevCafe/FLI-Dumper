...
public:
	...
	// void SetCharaLightParamToMPC(class UMaterialParameterCollection* MatParam);                                              // [0x3618b30] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/chara/_bluePrints/_test/BP_CharaLight.BP_CharaLight_C.UserConstructionScript
	// void UserConstructionScript();                                                                                           // [0x3618b30] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/chara/_bluePrints/_test/BP_CharaLight.BP_CharaLight_C.Þ0Ã0×0é0¤
	// void _0_0_0_0_();                                                                                                        // [0x3618b30] BlueprintCallable|BlueprintEvent 
	...
	// void TransformUpdated();                                                                                                 // [0x3618b30] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/chara/_bluePrints/_test/BP_CharaLight.BP_CharaLight_C.UpdateColorAndBrightness
	// void UpdateColorAndBrightness();                                                                                         // [0x3618b30] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/chara/_bluePrints/_test/BP_CharaLight.BP_CharaLight_C.ForceUpdateAllLightParameter
	// void ForceUpdateAllLightParameter();                                                                                     // [0x3618b30] Event|Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/chara/_bluePrints/_test/BP_CharaLight.BP_CharaLight_C.ExecuteUbergraph_BP_CharaLight
	// void ExecuteUbergraph_BP_CharaLight(int32_t EntryPoint);                                                                 // [0x3618b30] Final                
};
