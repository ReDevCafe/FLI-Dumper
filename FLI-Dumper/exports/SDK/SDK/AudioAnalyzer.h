...
public:
	...
	// void StopAnalyzing(class UObject* WorldContextObject);                                                                   // [0x8c6d5d0] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
	// Function /Script/AudioAnalyzer.AudioAnalyzer.StartAnalyzing
	// void StartAnalyzing(class UObject* WorldContextObject, class UAudioBus* AudioBusToAnalyze);                              // [0x8c6d140] Final|RequiredAPI|BlueprintCosmetic|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UAudioAnalyzer) == 0x00A0); // 160 bytes (0x000028 - 0x0000A0)
