...
public:
	...
	// void SetContext(FInterchangePipelineMeshesUtilitiesContext& Context);                                                    // [0x8946aa0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.IsValidMeshInstanceUid
	// bool IsValidMeshInstanceUid(FString MeshInstanceUid);                                                                    // [0x89469c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.IsValidMeshGeometryUid
	// bool IsValidMeshGeometryUid(FString MeshGeometryUid);                                                                    // [0x89468e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetMeshInstanceSkeletonRootUid
	// FString GetMeshInstanceSkeletonRootUid(FString MeshInstanceUid);                                                         // [0x8946730] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetMeshInstanceByUid
	// FInterchangeMeshInstance GetMeshInstanceByUid(FString MeshInstanceUid);                                                  // [0x8946640] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetMeshGeometrySkeletonRootUid
	// FString GetMeshGeometrySkeletonRootUid(FString MeshGeometryUid);                                                         // [0x8946550] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetMeshGeometryByUid
	// FInterchangeMeshGeometry GetMeshGeometryByUid(FString MeshGeometryUid);                                                  // [0x8946420] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllStaticMeshInstance
	// void GetAllStaticMeshInstance(TArray<FString>& MeshInstanceUids);                                                        // [0x8946350] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllStaticMeshGeometry
	// void GetAllStaticMeshGeometry(TArray<FString>& MeshGeometryUids);                                                        // [0x8946280] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllSkinnedMeshInstance
	// void GetAllSkinnedMeshInstance(TArray<FString>& MeshInstanceUids);                                                       // [0x89461b0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllSkinnedMeshGeometry
	// void GetAllSkinnedMeshGeometry(TArray<FString>& MeshGeometryUids);                                                       // [0x89460e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllMeshInstanceUidsUsingMeshGeometryUid
	// void GetAllMeshInstanceUidsUsingMeshGeometryUid(FString MeshGeometryUid, TArray<FString>& MeshInstanceUids);             // [0x8945f60] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllMeshInstanceUids
	// void GetAllMeshInstanceUids(TArray<FString>& MeshInstanceUids);                                                          // [0x8945e90] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllMeshGeometryNotInstanced
	// void GetAllMeshGeometryNotInstanced(TArray<FString>& MeshGeometryUids);                                                  // [0x8945dc0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.GetAllMeshGeometry
	// void GetAllMeshGeometry(TArray<FString>& MeshGeometryUids);                                                              // [0x8945cf0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangePipelines.InterchangePipelineMeshesUtilities.CreateInterchangePipelineMeshesUtilities
	// class UInterchangePipelineMeshesUtilities* CreateInterchangePipelineMeshesUtilities(class UInterchangeBaseNodeContainer* BaseNodeContainer); // [0x8945c60] Final|Native|Static|Public|BlueprintCallable 
};
...
static_assert(sizeof(UInterchangeGenericCommonMeshesProperties) == 0x0120); // 288 bytes (0x000108 - 0x000120)
static_assert(sizeof(UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties) == 0x0118); // 280 bytes (0x000108 - 0x000118)
static_assert(sizeof(UGLTFPipelineSettings) == 0x0090); // 144 bytes (0x000038 - 0x000090)
static_assert(sizeof(UInterchangeGLTFPipeline) == 0x0110); // 272 bytes (0x000108 - 0x000110)
static_assert(sizeof(UMaterialXPipelineSettings) == 0x0178); // 376 bytes (0x000038 - 0x000178)
static_assert(sizeof(UInterchangeMaterialXPipeline) == 0x0110); // 272 bytes (0x000108 - 0x000110)
static_assert(sizeof(UInterchangeGenericAnimationPipeline) == 0x0178); // 376 bytes (0x000108 - 0x000178)
static_assert(sizeof(UInterchangeGenericAssetsPipeline) == 0x0268); // 616 bytes (0x000108 - 0x000268)
static_assert(sizeof(UInterchangeGenericMaterialPipeline) == 0x01B8); // 440 bytes (0x000108 - 0x0001B8)
static_assert(sizeof(UInterchangeGenericMeshPipeline) == 0x01D8); // 472 bytes (0x000108 - 0x0001D8)
static_assert(sizeof(UInterchangeGenericLevelPipeline) == 0x0128); // 296 bytes (0x000108 - 0x000128)
static_assert(sizeof(UInterchangeGenericTexturePipeline) == 0x0170); // 368 bytes (0x000108 - 0x000170)
static_assert(sizeof(UInterchangePipelineMeshesUtilities) == 0x0128); // 296 bytes (0x000028 - 0x000128)
...
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, ForceAllMeshAsType) == 0x0108);
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, VertexColorImportOption) == 0x010D);
static_assert(offsetof(UInterchangeGenericCommonMeshesProperties, VertexOverrideColor) == 0x0110);
static_assert(offsetof(UInterchangeGenericCommonSkeletalMeshesAndAnimationsProperties, Skeleton) == 0x010C);
static_assert(offsetof(UGLTFPipelineSettings, MaterialParents) == 0x0038);
static_assert(offsetof(UMaterialXPipelineSettings, PredefinedSurfaceShaders) == 0x0038);
static_assert(offsetof(UMaterialXPipelineSettings, PredefinedBSDF) == 0x0088);
static_assert(offsetof(UMaterialXPipelineSettings, PredefinedEDF) == 0x00D8);
static_assert(offsetof(UMaterialXPipelineSettings, PredefinedVDF) == 0x0128);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, CommonSkeletalMeshesAndAnimationsProperties) == 0x0108);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, CommonMeshesProperties) == 0x0110);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, AnimationRange) == 0x011A);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, FrameImportRange) == 0x011C);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, MaterialCurveSuffixes) == 0x0130);
static_assert(offsetof(UInterchangeGenericAnimationPipeline, SourceAnimationName) == 0x0148);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, PipelineDisplayName) == 0x0108);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ReimportStrategy) == 0x0118);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, AssetName) == 0x0120);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ImportOffsetTranslation) == 0x0130);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, ImportOffsetRotation) == 0x0148);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, CommonMeshesProperties) == 0x0168);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, CommonSkeletalMeshesAndAnimationsProperties) == 0x0170);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, MeshPipeline) == 0x0178);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, AnimationPipeline) == 0x0180);
static_assert(offsetof(UInterchangeGenericAssetsPipeline, MaterialPipeline) == 0x0188);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, PipelineDisplayName) == 0x0108);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, SearchLocation) == 0x0119);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, AssetName) == 0x0120);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, MaterialImport) == 0x0130);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, ParentMaterial) == 0x0138);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, TexturePipeline) == 0x0158);
static_assert(offsetof(UInterchangeGenericMaterialPipeline, BaseNodeContainer) == 0x0160);
static_assert(offsetof(UInterchangeGenericMeshPipeline, CommonMeshesProperties) == 0x0108);
static_assert(offsetof(UInterchangeGenericMeshPipeline, CommonSkeletalMeshesAndAnimationsProperties) == 0x0110);
static_assert(offsetof(UInterchangeGenericMeshPipeline, LODGroup) == 0x011C);
static_assert(offsetof(UInterchangeGenericMeshPipeline, BuildScale3D) == 0x0138);
static_assert(offsetof(UInterchangeGenericMeshPipeline, DistanceFieldReplacementMesh) == 0x0154);
static_assert(offsetof(UInterchangeGenericMeshPipeline, SkeletalMeshImportContentType) == 0x0161);
static_assert(offsetof(UInterchangeGenericMeshPipeline, LastSkeletalMeshImportContentType) == 0x0162);
static_assert(offsetof(UInterchangeGenericMeshPipeline, PhysicsAsset) == 0x0168);
static_assert(offsetof(UInterchangeGenericLevelPipeline, PipelineDisplayName) == 0x0108);
static_assert(offsetof(UInterchangeGenericLevelPipeline, ReimportPropertyStrategy) == 0x0118);
static_assert(offsetof(UInterchangeGenericTexturePipeline, PipelineDisplayName) == 0x0108);
static_assert(offsetof(UInterchangeGenericTexturePipeline, AssetName) == 0x0120);
static_assert(offsetof(UInterchangeGenericTexturePipeline, BaseNodeContainer) == 0x0138);
