...
public:
	...
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                             // [0x8a05a80] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.BakeInputMeshProperties.GetSourceUVLayerNamesFunc
	// TArray<FString> GetSourceUVLayerNamesFunc();                                                                             // [0x8a05a50] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetUVLayerNamesFunc();                                                                                   // [0x8a05ab0] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetUVLayerNamesFunc();                                                                                   // [0x842b140] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1128) /* TSet<UPrimitiveComponent*> */ __um(AllComponents);                                   // 0x03B8   (0x0050)  
...
public:
	...
	// bool IsPreventTinyTrianglesEnabled();                                                                                    // [0x5490910] Native|Protected|Const 
	// Function /Script/MeshModelingToolsExp.MeshConstraintProperties.IsPreventNormalFlipsEnabled
	// bool IsPreventNormalFlipsEnabled();                                                                                      // [0x5369410] Native|Protected|Const 
};
...
public:
	...
	// void ResetAxis();                                                                                                        // [0x8a26dc0] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetMapPreviewNamesFunc();                                                                                // [0x8a26d60] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetTargetUVLayerNamesFunc();                                                                             // [0x8a26d90] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1129) /* TArray<TWeakObjectPtr<UPrimitiveComponent*>> */ __um(Inputs);                        // 0x00B0   (0x0010)  
...
public:
	...
	// TArray<FString> GetGroupOptionsList();                                                                                   // [0x82f4c30] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0x8a78310] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetMaterialIDsFunc();                                                                                    // [0x8a78190] Final|Native|Public  
};
...
public:
	...
	// void DiscardAttributes();                                                                                                // [0x8a78090] Final|Native|Public  
};
...
public:
	...
	// void SelectAll();                                                                                                        // [0x8ae9e60] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.HoleFillToolActions.Clear
	// void Clear();                                                                                                            // [0x8ae9470] Final|Native|Public  
};
...
public:
	...
	// void Constrain();                                                                                                        // [0x8ae9640] Final|Native|Public  
	// Function /Script/MeshModelingToolsExp.LatticeDeformerToolProperties.ClearConstraints
	// void ClearConstraints();                                                                                                 // [0x8ae9590] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetAttributeNames();                                                                                     // [0x842b170] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                                 // [0x842b140] Final|Native|Public|Const 
};
...
public:
	...
	// void ShiftToCenter();                                                                                                    // [0x8ae9f80] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetLODNamesFunc();                                                                                       // [0x8ae9b50] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.MeshVertexPaintToolUtilityActions.ApplySelectedOperation
	// void ApplySelectedOperation();                                                                                           // [0x8ae93c0] Final|Native|Public  
};
...
public:
	...
	// void FlipPlane();                                                                                                        // [0x8b321a0] Final|Native|Protected 
	// Function /Script/MeshModelingToolsExp.PlaneCutTool.Cut
	// void Cut();                                                                                                              // [0x8b32090] Final|Native|Protected 
};
...
public:
	...
	// TArray<FString> GetTargetLODNamesFunc();                                                                                 // [0x8b321c0] Final|Native|Public|Const 
	// Function /Script/MeshModelingToolsExp.TransferMeshToolProperties.GetSourceLODNamesFunc
	// TArray<FString> GetSourceLODNamesFunc();                                                                                 // [0x8a26d60] Final|Native|Public|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1130) /* TArray<TWeakObjectPtr<AActor*>> */ __um(ActorsWithSplines);                          // 0x00C8   (0x0010)  
...
static_assert(sizeof(UExtrudeMeshSelectionTool) == 0x0868); // 2152 bytes (0x000120 - 0x000868)
...
static_assert(sizeof(UVertexColorBaseBrushOpProps) == 0x00B8); // 184 bytes (0x0000A8 - 0x0000B8)
static_assert(sizeof(UVertexColorPaintBrushOpProps) == 0x00C8); // 200 bytes (0x0000B8 - 0x0000C8)
static_assert(sizeof(UVertexColorSoftenBrushOpProps) == 0x00B8); // 184 bytes (0x0000B8 - 0x0000B8)
static_assert(sizeof(UVertexColorSmoothBrushOpProps) == 0x00B8); // 184 bytes (0x0000B8 - 0x0000B8)
...
static_assert(sizeof(UOffsetMeshSelectionTool) == 0x0858); // 2136 bytes (0x000120 - 0x000858)
static_assert(sizeof(UPatternToolBuilder) == 0x0030); // 48 bytes (0x000028 - 0x000030)
...
static_assert(sizeof(URevolveSplineToolProperties) == 0x0168); // 360 bytes (0x000118 - 0x000168)
static_assert(sizeof(URevolveSplineToolActionPropertySet) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(URevolveSplineTool) == 0x0178); // 376 bytes (0x000098 - 0x000178)
static_assert(sizeof(URevolveSplineToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UBakeMeshAttributeTool) == 0x01A8); // 424 bytes (0x0000B8 - 0x0001A8)
static_assert(sizeof(UBakeMeshAttributeMapsToolBase) == 0x0320); // 800 bytes (0x0001A8 - 0x000320)
static_assert(sizeof(UBakeMeshAttributeMapsTool) == 0x0390); // 912 bytes (0x000320 - 0x000390)
...
static_assert(sizeof(UBakeMeshAttributeVertexTool) == 0x02A8); // 680 bytes (0x0001A8 - 0x0002A8)
...
static_assert(sizeof(UBakeMultiMeshAttributeMapsTool) == 0x03C8); // 968 bytes (0x000320 - 0x0003C8)
...
static_assert(sizeof(UBakeTransformTool) == 0x00D8); // 216 bytes (0x0000B8 - 0x0000D8)
...
static_assert(sizeof(UConvertMeshesTool) == 0x00C8); // 200 bytes (0x000098 - 0x0000C8)
...
static_assert(sizeof(UConvertToPolygonsTool) == 0x01B8); // 440 bytes (0x000120 - 0x0001B8)
...
static_assert(sizeof(UDeformMeshPolygonsTool) == 0x1800); // 6144 bytes (0x000100 - 0x001800)
...
static_assert(sizeof(UDisplaceMeshTool) == 0x0460); // 1120 bytes (0x0000B0 - 0x000460)
static_assert(sizeof(UDrawPolyPathToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UDynamicMeshBrushTool) == 0x02E0); // 736 bytes (0x000298 - 0x0002E0)
...
static_assert(sizeof(UDynamicMeshSculptTool) == 0x1020); // 4128 bytes (0x000100 - 0x001020)
...
static_assert(sizeof(UEditNormalsTool) == 0x02C0); // 704 bytes (0x0000B8 - 0x0002C0)
...
static_assert(sizeof(UEditPivotTool) == 0x0240); // 576 bytes (0x0000B8 - 0x000240)
...
static_assert(sizeof(UHoleFillTool) == 0x0240); // 576 bytes (0x0000B0 - 0x000240)
static_assert(sizeof(ULatticeDeformerToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(ULatticeDeformerToolProperties) == 0x00C8); // 200 bytes (0x0000A8 - 0x0000C8)
static_assert(sizeof(ULatticeDeformerOperatorFactory) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(ULatticeDeformerTool) == 0x0160); // 352 bytes (0x0000B0 - 0x000160)
...
static_assert(sizeof(UMeshAttributePaintTool) == 0x0800); // 2048 bytes (0x0002E0 - 0x000800)
static_assert(sizeof(UMeshBoundaryToolBase) == 0x01A0); // 416 bytes (0x0000B0 - 0x0001A0)
...
static_assert(sizeof(UMeshSculptToolBase) == 0x0BA0); // 2976 bytes (0x000100 - 0x000BA0)
static_assert(sizeof(UMeshGroupPaintTool) == 0x0FE0); // 4064 bytes (0x000BA0 - 0x000FE0)
...
static_assert(sizeof(UMeshInspectorTool) == 0x0250); // 592 bytes (0x0000B0 - 0x000250)
...
static_assert(sizeof(UMeshSelectionTool) == 0x0728); // 1832 bytes (0x0002E0 - 0x000728)
...
static_assert(sizeof(UMeshSpaceDeformerTool) == 0x02C0); // 704 bytes (0x0000B0 - 0x0002C0)
static_assert(sizeof(UMeshVertexPaintToolBuilder) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UVertexPaintBasicProperties) == 0x00E0); // 224 bytes (0x0000A8 - 0x0000E0)
static_assert(sizeof(UVertexPaintBrushFilterProperties) == 0x00C0); // 192 bytes (0x0000A8 - 0x0000C0)
static_assert(sizeof(UMeshVertexPaintToolActionPropertySet) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(UMeshVertexPaintToolQuickActions) == 0x00B0); // 176 bytes (0x0000B0 - 0x0000B0)
static_assert(sizeof(UMeshVertexPaintToolUtilityActions) == 0x0100); // 256 bytes (0x0000B0 - 0x000100)
static_assert(sizeof(UMeshVertexPaintTool) == 0x1140); // 4416 bytes (0x000BA0 - 0x001140)
...
static_assert(sizeof(UVertexBrushAlphaProperties) == 0x00C8); // 200 bytes (0x0000A8 - 0x0000C8)
static_assert(sizeof(UMeshSymmetryProperties) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(UMeshVertexSculptTool) == 0x1500); // 5376 bytes (0x000BA0 - 0x001500)
...
static_assert(sizeof(UMirrorToolActionPropertySet) == 0x00B8); // 184 bytes (0x0000A8 - 0x0000B8)
static_assert(sizeof(UMirrorTool) == 0x0178); // 376 bytes (0x0000B8 - 0x000178)
...
static_assert(sizeof(UCollisionGeometryVisualizationProperties) == 0x00D8); // 216 bytes (0x0000A8 - 0x0000D8)
...
static_assert(sizeof(UExtractCollisionGeometryTool) == 0x0328); // 808 bytes (0x0000B0 - 0x000328)
static_assert(sizeof(UPhysicsInspectorToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UPhysicsInspectorTool) == 0x00F8); // 248 bytes (0x0000B8 - 0x0000F8)
static_assert(sizeof(USetCollisionGeometryToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(USetCollisionGeometryToolProperties) == 0x0110); // 272 bytes (0x0000A8 - 0x000110)
static_assert(sizeof(USetCollisionGeometryTool) == 0x0380); // 896 bytes (0x0000B8 - 0x000380)
static_assert(sizeof(USimpleCollisionEditorToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(USimpleCollisionEditorToolActionProperties) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(USimpleCollisionEditorTool) == 0x00E0); // 224 bytes (0x0000B0 - 0x0000E0)
...
static_assert(sizeof(UPlaneCutTool) == 0x0190); // 400 bytes (0x0000B8 - 0x000190)
...
static_assert(sizeof(URevolveBoundaryTool) == 0x0210); // 528 bytes (0x0001A0 - 0x000210)
...
static_assert(sizeof(USeamSculptTool) == 0x03E0); // 992 bytes (0x0002E0 - 0x0003E0)
static_assert(sizeof(USelfUnionMeshesToolProperties) == 0x00B8); // 184 bytes (0x0000A8 - 0x0000B8)
static_assert(sizeof(USelfUnionMeshesTool) == 0x0150); // 336 bytes (0x000108 - 0x000150)
...
static_assert(sizeof(UTransformMeshesTool) == 0x01A0); // 416 bytes (0x0000B8 - 0x0001A0)
static_assert(sizeof(UTriangulateSplinesToolProperties) == 0x00E0); // 224 bytes (0x0000A8 - 0x0000E0)
static_assert(sizeof(UTriangulateSplinesTool) == 0x00F8); // 248 bytes (0x000098 - 0x0000F8)
static_assert(sizeof(UTriangulateSplinesToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UVolumeToMeshTool) == 0x0300); // 768 bytes (0x000098 - 0x000300)
static_assert(sizeof(UVoxelBlendMeshesToolProperties) == 0x00C8); // 200 bytes (0x0000A8 - 0x0000C8)
static_assert(sizeof(UVoxelBlendMeshesTool) == 0x0128); // 296 bytes (0x000120 - 0x000128)
...
static_assert(sizeof(UVoxelMorphologyMeshesTool) == 0x0128); // 296 bytes (0x000120 - 0x000128)
...
static_assert(sizeof(UVoxelSolidifyMeshesTool) == 0x0128); // 296 bytes (0x000120 - 0x000128)
...
static_assert(sizeof(UWeldMeshEdgesToolProperties) == 0x00D0); // 208 bytes (0x0000A8 - 0x0000D0)
static_assert(sizeof(UWeldMeshEdgesOperatorFactory) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UWeldMeshEdgesTool) == 0x00E0); // 224 bytes (0x0000B0 - 0x0000E0)
...
static_assert(offsetof(UExtrudeMeshSelectionTool, ExtrudeProperties) == 0x0120);
static_assert(offsetof(UExtrudeMeshSelectionTool, SourcePreview) == 0x0848);
static_assert(offsetof(UExtrudeMeshSelectionTool, EditCompute) == 0x0850);
static_assert(offsetof(UExtrudeMeshSelectionTool, TransformGizmo) == 0x0858);
static_assert(offsetof(UExtrudeMeshSelectionTool, TransformProxy) == 0x0860);
...
static_assert(offsetof(UVertexColorBaseBrushOpProps, BlendMode) == 0x00B0);
static_assert(offsetof(UVertexColorPaintBrushOpProps, Color) == 0x00B8);
static_assert(offsetof(UOffsetMeshSelectionToolProperties, Direction) == 0x00B0);
static_assert(offsetof(UOffsetMeshSelectionTool, OffsetProperties) == 0x0120);
static_assert(offsetof(UOffsetMeshSelectionTool, SourcePreview) == 0x0848);
static_assert(offsetof(UOffsetMeshSelectionTool, EditCompute) == 0x0850);
static_assert(offsetof(UPatternToolSettings, Shape) == 0x00B7);
static_assert(offsetof(UPatternToolSettings, SingleAxis) == 0x00B8);
static_assert(offsetof(UPatternToolSettings, SinglePlane) == 0x00B9);
...
static_assert(offsetof(URevolveSplineToolProperties, SampleMode) == 0x0118);
static_assert(offsetof(URevolveSplineToolProperties, CapFillMode) == 0x0130);
static_assert(offsetof(URevolveSplineToolProperties, AxisOrigin) == 0x0138);
static_assert(offsetof(URevolveSplineToolProperties, AxisOrientation) == 0x0150);
static_assert(offsetof(URevolveSplineTool, Settings) == 0x00A8);
static_assert(offsetof(URevolveSplineTool, MaterialProperties) == 0x00B0);
static_assert(offsetof(URevolveSplineTool, OutputTypeProperties) == 0x00B8);
static_assert(offsetof(URevolveSplineTool, ToolActions) == 0x00C0);
static_assert(offsetof(URevolveSplineTool, Preview) == 0x00C8);
static_assert(offsetof(URevolveSplineTool, PlaneMechanic) == 0x00D0);
...
static_assert(offsetof(UBakeMeshAttributeTool, OcclusionSettings) == 0x00C8);
static_assert(offsetof(UBakeMeshAttributeTool, CurvatureSettings) == 0x00D0);
static_assert(offsetof(UBakeMeshAttributeTool, TextureSettings) == 0x00D8);
static_assert(offsetof(UBakeMeshAttributeTool, MultiTextureSettings) == 0x00E0);
static_assert(offsetof(UBakeMeshAttributeTool, WorkingPreviewMaterial) == 0x00E8);
static_assert(offsetof(UBakeMeshAttributeTool, ErrorPreviewMaterial) == 0x00F0);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, VisualizationProps) == 0x01B0);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, PreviewMesh) == 0x01B8);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, PreviewMaterial) == 0x01C0);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, BentNormalPreviewMaterial) == 0x01C8);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, CachedMaps) == 0x0220);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyNormalMap) == 0x0308);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapBlack) == 0x0310);
static_assert(offsetof(UBakeMeshAttributeMapsToolBase, EmptyColorMapWhite) == 0x0318);
static_assert(offsetof(UBakeMeshAttributeMapsTool, InputMeshSettings) == 0x0320);
static_assert(offsetof(UBakeMeshAttributeMapsTool, Settings) == 0x0328);
static_assert(offsetof(UBakeMeshAttributeMapsTool, ResultSettings) == 0x0330);
...
static_assert(offsetof(UBakeMeshAttributeVertexTool, InputMeshSettings) == 0x01B0);
static_assert(offsetof(UBakeMeshAttributeVertexTool, Settings) == 0x01B8);
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewMesh) == 0x01C0);
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewMaterial) == 0x01C8);
static_assert(offsetof(UBakeMeshAttributeVertexTool, PreviewAlphaMaterial) == 0x01D0);
...
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, Settings) == 0x0320);
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, InputMeshSettings) == 0x0328);
static_assert(offsetof(UBakeMultiMeshAttributeMapsTool, ResultSettings) == 0x0330);
static_assert(offsetof(UBakeTransformToolProperties, BakeScale) == 0x00AA);
static_assert(offsetof(UBakeTransformTool, BasicProperties) == 0x00C0);
static_assert(offsetof(UConvertMeshesTool, BasicProperties) == 0x00A0);
static_assert(offsetof(UConvertMeshesTool, OutputTypeProperties) == 0x00A8);
...
static_assert(offsetof(UConvertToPolygonsTool, Settings) == 0x0120);
static_assert(offsetof(UConvertToPolygonsTool, CopyFromLayerProperties) == 0x0128);
static_assert(offsetof(UConvertToPolygonsTool, OutputProperties) == 0x0130);
static_assert(offsetof(UConvertToPolygonsTool, PreviewCompute) == 0x0138);
static_assert(offsetof(UConvertToPolygonsTool, PreviewGeometry) == 0x0140);
static_assert(offsetof(UConvertToPolygonsTool, UnmodifiedAreaPreviewMesh) == 0x0148);
...
static_assert(offsetof(UCubeGridTool, MaterialProperties) == 0x0110);
static_assert(offsetof(UCubeGridTool, OutputTypeProperties) == 0x0118);
static_assert(offsetof(UCubeGridTool, Target) == 0x0120);
static_assert(offsetof(UCubeGridTool, Preview) == 0x02A8);
...
static_assert(offsetof(UDeformMeshPolygonsTool, PreviewMeshActor) == 0x0110);
static_assert(offsetof(UDeformMeshPolygonsTool, DynamicMeshComponent) == 0x0118);
static_assert(offsetof(UDeformMeshPolygonsTool, TransformProps) == 0x0120);
...
static_assert(offsetof(UDisplaceMeshTool, CommonProperties) == 0x00B0);
static_assert(offsetof(UDisplaceMeshTool, DirectionalFilterProperties) == 0x00B8);
static_assert(offsetof(UDisplaceMeshTool, TextureMapProperties) == 0x00C0);
static_assert(offsetof(UDisplaceMeshTool, NoiseProperties) == 0x00C8);
static_assert(offsetof(UDisplaceMeshTool, SineWaveProperties) == 0x00D0);
static_assert(offsetof(UDisplaceMeshTool, SelectiveTessellationProperties) == 0x00D8);
static_assert(offsetof(UDisplaceMeshTool, ActiveContrastCurveTarget) == 0x00E0);
static_assert(offsetof(UDisplaceMeshTool, MeshStatistics) == 0x00E8);
...
static_assert(offsetof(UDynamicMeshBrushTool, PreviewMesh) == 0x0298);
...
static_assert(offsetof(UDynamicMeshSculptTool, PreviewMeshActor) == 0x01B8);
static_assert(offsetof(UDynamicMeshSculptTool, DynamicMeshComponent) == 0x01C0);
static_assert(offsetof(UDynamicMeshSculptTool, ActiveOverrideMaterial) == 0x01C8);
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformGizmo) == 0x1008);
static_assert(offsetof(UDynamicMeshSculptTool, PlaneTransformProxy) == 0x1010);
...
static_assert(offsetof(UEditNormalsTool, BasicProperties) == 0x00C0);
...
static_assert(offsetof(UEditNormalsTool, GeometrySelectionVizProperties) == 0x0150);
static_assert(offsetof(UEditNormalsTool, GeometrySelectionViz) == 0x0158);
static_assert(offsetof(UEditPivotToolProperties, RotationMode) == 0x00AA);
...
static_assert(offsetof(UEditPivotTool, TransformProps) == 0x00C8);
static_assert(offsetof(UEditPivotTool, EditPivotActions) == 0x00D0);
static_assert(offsetof(UEditPivotTool, ActiveGizmos) == 0x01B0);
static_assert(offsetof(UEditPivotTool, DragAlignmentMechanic) == 0x01C0);
static_assert(offsetof(UEditUVIslandsTool, MaterialSettings) == 0x0108);
static_assert(offsetof(UEditUVIslandsTool, CheckerMaterial) == 0x0110);
static_assert(offsetof(UEditUVIslandsTool, PreviewMeshActor) == 0x0118);
static_assert(offsetof(UEditUVIslandsTool, DynamicMeshComponent) == 0x0120);
static_assert(offsetof(UEditUVIslandsTool, SelectionMechanic) == 0x0128);
static_assert(offsetof(UEditUVIslandsTool, TransformGizmo) == 0x0138);
static_assert(offsetof(UEditUVIslandsTool, TransformProxy) == 0x0140);
...
static_assert(offsetof(UHoleFillTool, SmoothHoleFillProperties) == 0x00B0);
static_assert(offsetof(UHoleFillTool, Properties) == 0x00B8);
static_assert(offsetof(UHoleFillTool, Actions) == 0x00C0);
static_assert(offsetof(UHoleFillTool, Statistics) == 0x00C8);
static_assert(offsetof(UHoleFillTool, Preview) == 0x00D0);
static_assert(offsetof(UHoleFillTool, SelectionMechanic) == 0x00D8);
static_assert(offsetof(ULatticeDeformerToolProperties, InterpolationType) == 0x00C0);
static_assert(offsetof(ULatticeDeformerToolProperties, GizmoCoordinateSystem) == 0x00C3);
...
static_assert(offsetof(UMeshAttributePaintTool, BrushActionProps) == 0x02E8);
static_assert(offsetof(UMeshAttributePaintTool, AttribProps) == 0x02F0);
static_assert(offsetof(UMeshBoundaryToolBase, SelectionMechanic) == 0x0190);
...
static_assert(offsetof(UMeshGroupPaintTool, PolygroupLayerProperties) == 0x0BA0);
static_assert(offsetof(UMeshGroupPaintTool, FilterProperties) == 0x0BA8);
static_assert(offsetof(UMeshGroupPaintTool, PaintBrushOpProperties) == 0x0BB0);
static_assert(offsetof(UMeshGroupPaintTool, EraseBrushOpProperties) == 0x0BB8);
static_assert(offsetof(UMeshGroupPaintTool, FreezeActions) == 0x0BC0);
static_assert(offsetof(UMeshGroupPaintTool, PolyLassoMechanic) == 0x0BD0);
static_assert(offsetof(UMeshGroupPaintTool, PreviewMeshActor) == 0x0BD8);
static_assert(offsetof(UMeshGroupPaintTool, DynamicMeshComponent) == 0x0BE0);
static_assert(offsetof(UMeshGroupPaintTool, MeshElementsDisplay) == 0x0BE8);
...
static_assert(offsetof(UMeshSelectionTool, SelectionProps) == 0x02E8);
static_assert(offsetof(UMeshSelectionTool, SelectionActions) == 0x02F0);
static_assert(offsetof(UMeshSelectionTool, EditActions) == 0x02F8);
static_assert(offsetof(UMeshSelectionTool, MeshStatisticsProperties) == 0x0300);
static_assert(offsetof(UMeshSelectionTool, MeshElementsDisplay) == 0x0308);
static_assert(offsetof(UMeshSelectionTool, UVChannelProperties) == 0x0310);
static_assert(offsetof(UMeshSelectionTool, PolygroupLayerProperties) == 0x0318);
static_assert(offsetof(UMeshSelectionTool, Selection) == 0x0378);
static_assert(offsetof(UMeshSelectionTool, SpawnedActors) == 0x0380);
...
static_assert(offsetof(UVertexPaintBasicProperties, PrimaryBrushType) == 0x00A8);
static_assert(offsetof(UVertexPaintBasicProperties, SubToolType) == 0x00A9);
static_assert(offsetof(UVertexPaintBasicProperties, PaintColor) == 0x00AC);
static_assert(offsetof(UVertexPaintBasicProperties, BlendMode) == 0x00BC);
static_assert(offsetof(UVertexPaintBasicProperties, SecondaryActionType) == 0x00BD);
static_assert(offsetof(UVertexPaintBasicProperties, EraseColor) == 0x00C0);
static_assert(offsetof(UVertexPaintBasicProperties, ChannelFilter) == 0x00D4);
static_assert(offsetof(UVertexPaintBrushFilterProperties, BrushAreaMode) == 0x00A8);
static_assert(offsetof(UVertexPaintBrushFilterProperties, VisibilityFilter) == 0x00B2);
static_assert(offsetof(UVertexPaintBrushFilterProperties, MaterialMode) == 0x00B8);
static_assert(offsetof(UVertexPaintBrushFilterProperties, CurrentSubToolType) == 0x00BA);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, Operation) == 0x00B0);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, SourceChannel) == 0x00B4);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, WeightMap) == 0x00BC);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, WeightMapsList) == 0x00C8);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, TargetChannels) == 0x00D8);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, TargetChannel) == 0x00DC);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, CopyToLODName) == 0x00E0);
static_assert(offsetof(UMeshVertexPaintToolUtilityActions, LODNamesList) == 0x00F0);
static_assert(offsetof(UMeshVertexPaintTool, PolygroupLayerProperties) == 0x0BA8);
static_assert(offsetof(UMeshVertexPaintTool, BasicProperties) == 0x0BB0);
static_assert(offsetof(UMeshVertexPaintTool, FilterProperties) == 0x0BB8);
static_assert(offsetof(UMeshVertexPaintTool, PaintBrushOpProperties) == 0x0BC0);
static_assert(offsetof(UMeshVertexPaintTool, EraseBrushOpProperties) == 0x0BC8);
static_assert(offsetof(UMeshVertexPaintTool, QuickActions) == 0x0BD0);
static_assert(offsetof(UMeshVertexPaintTool, UtilityActions) == 0x0BD8);
static_assert(offsetof(UMeshVertexPaintTool, PolyLassoMechanic) == 0x0BE8);
static_assert(offsetof(UMeshVertexPaintTool, PreviewMeshActor) == 0x0BF0);
static_assert(offsetof(UMeshVertexPaintTool, DynamicMeshComponent) == 0x0BF8);
static_assert(offsetof(UMeshVertexPaintTool, MeshElementsDisplay) == 0x0C00);
...
static_assert(offsetof(UVertexBrushAlphaProperties, Tool) == 0x00BC);
static_assert(offsetof(UMeshVertexSculptTool, SculptProperties) == 0x0BA8);
static_assert(offsetof(UMeshVertexSculptTool, AlphaProperties) == 0x0BB0);
static_assert(offsetof(UMeshVertexSculptTool, BrushAlpha) == 0x0BB8);
static_assert(offsetof(UMeshVertexSculptTool, SymmetryProperties) == 0x0BC0);
static_assert(offsetof(UMeshVertexSculptTool, PreviewMeshActor) == 0x0BE0);
static_assert(offsetof(UMeshVertexSculptTool, DynamicMeshComponent) == 0x0BE8);
static_assert(offsetof(UMirrorToolProperties, OperationMode) == 0x00A8);
static_assert(offsetof(UMirrorToolProperties, WriteTo) == 0x00BA);
static_assert(offsetof(UMirrorOperatorFactory, MirrorTool) == 0x0030);
static_assert(offsetof(UMirrorTool, Settings) == 0x00C0);
static_assert(offsetof(UMirrorTool, OutputTypeProperties) == 0x00C8);
static_assert(offsetof(UMirrorTool, HandleSourcesProperties) == 0x00D0);
static_assert(offsetof(UMirrorTool, ToolActions) == 0x00D8);
static_assert(offsetof(UMirrorTool, MeshesToMirror) == 0x00E0);
static_assert(offsetof(UMirrorTool, Previews) == 0x00F0);
static_assert(offsetof(UMirrorTool, PlaneMechanic) == 0x0130);
...
static_assert(offsetof(UCollisionGeometryVisualizationProperties, Color) == 0x00B4);
static_assert(offsetof(UCollisionGeometryVisualizationProperties, LineMaterial) == 0x00B8);
static_assert(offsetof(UCollisionGeometryVisualizationProperties, LineMaterialShowingHidden) == 0x00C0);
static_assert(offsetof(UCollisionGeometryVisualizationProperties, TriangleMaterial) == 0x00C8);
static_assert(offsetof(UExtractCollisionToolProperties, CollisionType) == 0x00A8);
static_assert(offsetof(UExtractCollisionGeometryTool, OutputTypeProperties) == 0x00B0);
static_assert(offsetof(UExtractCollisionGeometryTool, Settings) == 0x00B8);
static_assert(offsetof(UExtractCollisionGeometryTool, VizSettings) == 0x00C0);
static_assert(offsetof(UExtractCollisionGeometryTool, ObjectProps) == 0x00C8);
static_assert(offsetof(UExtractCollisionGeometryTool, PreviewElements) == 0x00D0);
static_assert(offsetof(UExtractCollisionGeometryTool, PreviewMesh) == 0x00D8);
static_assert(offsetof(UPhysicsInspectorTool, VizSettings) == 0x00C0);
static_assert(offsetof(UPhysicsInspectorTool, ObjectData) == 0x00C8);
...
static_assert(offsetof(USetCollisionGeometryToolProperties, InputMode) == 0x00B0);
static_assert(offsetof(USetCollisionGeometryToolProperties, SweepAxis) == 0x0100);
static_assert(offsetof(USetCollisionGeometryToolProperties, SetCollisionType) == 0x0108);
static_assert(offsetof(USetCollisionGeometryTool, Settings) == 0x00C8);
static_assert(offsetof(USetCollisionGeometryTool, PolygroupLayerProperties) == 0x00D0);
static_assert(offsetof(USetCollisionGeometryTool, VizSettings) == 0x00D8);
static_assert(offsetof(USetCollisionGeometryTool, CollisionProps) == 0x00E0);
static_assert(offsetof(USetCollisionGeometryTool, PreviewGeom) == 0x00F0);
static_assert(offsetof(USetCollisionGeometryTool, GeometrySelectionVizProperties) == 0x0370);
static_assert(offsetof(USetCollisionGeometryTool, GeometrySelectionViz) == 0x0378);
static_assert(offsetof(USimpleCollisionEditorTool, ActionProperties) == 0x00B8);
...
static_assert(offsetof(UPlaneCutTool, Previews) == 0x00C0);
static_assert(offsetof(UPlaneCutTool, MeshesToCut) == 0x00D0);
static_assert(offsetof(UPlaneCutTool, PlaneMechanic) == 0x00E0);
...
static_assert(offsetof(URevolveBoundaryTool, OutputTypeProperties) == 0x01B8);
static_assert(offsetof(URevolveBoundaryTool, Settings) == 0x01C0);
static_assert(offsetof(URevolveBoundaryTool, MaterialProperties) == 0x01C8);
static_assert(offsetof(URevolveBoundaryTool, PlaneMechanic) == 0x01D0);
static_assert(offsetof(URevolveBoundaryTool, Preview) == 0x01D8);
...
static_assert(offsetof(USeamSculptTool, Settings) == 0x02E8);
static_assert(offsetof(USeamSculptTool, PreviewGeom) == 0x02F0);
static_assert(offsetof(USelfUnionMeshesTool, Properties) == 0x0108);
static_assert(offsetof(USelfUnionMeshesTool, DrawnLineSet) == 0x0110);
static_assert(offsetof(USmoothMeshToolProperties, SmoothingType) == 0x00A8);
static_assert(offsetof(USmoothMeshTool, SmoothProperties) == 0x0408);
static_assert(offsetof(USmoothMeshTool, IterativeProperties) == 0x0410);
static_assert(offsetof(USmoothMeshTool, DiffusionProperties) == 0x0418);
static_assert(offsetof(USmoothMeshTool, ImplicitProperties) == 0x0420);
static_assert(offsetof(USmoothMeshTool, WeightMapProperties) == 0x0428);
...
static_assert(offsetof(UTransformMeshesTool, TransformProps) == 0x00C8);
static_assert(offsetof(UTransformMeshesTool, ActiveGizmos) == 0x00D0);
static_assert(offsetof(UTransformMeshesTool, DragAlignmentMechanic) == 0x00E0);
static_assert(offsetof(UTriangulateSplinesToolProperties, FlattenMethod) == 0x00B0);
static_assert(offsetof(UTriangulateSplinesToolProperties, CombineMethod) == 0x00B1);
static_assert(offsetof(UTriangulateSplinesToolProperties, OpenCurves) == 0x00C1);
static_assert(offsetof(UTriangulateSplinesToolProperties, OffsetClosedCurves) == 0x00D0);
static_assert(offsetof(UTriangulateSplinesToolProperties, EndShapes) == 0x00D1);
static_assert(offsetof(UTriangulateSplinesToolProperties, JoinMethod) == 0x00D2);
static_assert(offsetof(UTriangulateSplinesTool, TriangulateProperties) == 0x00A8);
static_assert(offsetof(UTriangulateSplinesTool, OutputTypeProperties) == 0x00B0);
static_assert(offsetof(UTriangulateSplinesTool, Preview) == 0x00B8);
static_assert(offsetof(UTriangulateSplinesTool, TargetWorld) == 0x00C0);
...
static_assert(offsetof(UVolumeToMeshTool, VolumeEdgesSet) == 0x00C8);
static_assert(offsetof(UVoxelBlendMeshesToolProperties, Operation) == 0x00B8);
static_assert(offsetof(UVoxelBlendMeshesTool, BlendProperties) == 0x0120);
static_assert(offsetof(UVoxelMorphologyMeshesToolProperties, Operation) == 0x00A8);
static_assert(offsetof(UVoxelMorphologyMeshesTool, MorphologyProperties) == 0x0120);
static_assert(offsetof(UVoxelSolidifyMeshesTool, SolidifyProperties) == 0x0120);
static_assert(offsetof(UWeldMeshEdgesToolProperties, AttrWeldingMode) == 0x00B8);
static_assert(offsetof(UWeldMeshEdgesOperatorFactory, WeldMeshEdgesTool) == 0x0030);
static_assert(offsetof(UWeldMeshEdgesTool, Settings) == 0x00B0);
static_assert(offsetof(UWeldMeshEdgesTool, PreviewCompute) == 0x00B8);
static_assert(offsetof(UWeldMeshEdgesTool, MeshElementsDisplay) == 0x00C0);
static_assert(offsetof(UWeldMeshEdgesTool, OperatorFactory) == 0x00C8);
