...
public:
	...
	// bool ScriptedFilePickerForTranslatorType(EInterchangeTranslatorType TranslatorType, FInterchangeFilePickerParameters& Parameters, TArray<FString>& OutFilenames); // [0x886b560] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/InterchangeEngine.InterchangeFilePickerBase.ScriptedFilePickerForTranslatorAssetType
	// bool ScriptedFilePickerForTranslatorAssetType(EInterchangeTranslatorAssetType TranslatorAssetType, FInterchangeFilePickerParameters& Parameters, TArray<FString>& OutFilenames); // [0x886b390] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// EInterchangePipelineConfigurationDialogResult ScriptedShowScenePipelineConfigurationDialog(TArray<FInterchangeStackInfo>& PipelineStacks, TArray<UInterchangePipelineBase*>& OutPipelines, class UInterchangeSourceData* SourceData, class UInterchangeTranslatorBase* Translator, class UInterchangeBaseNodeContainer* BaseNodeContainer); // [0x886bc50] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/InterchangeEngine.InterchangePipelineConfigurationBase.ScriptedShowReimportPipelineConfigurationDialog
	// EInterchangePipelineConfigurationDialogResult ScriptedShowReimportPipelineConfigurationDialog(TArray<FInterchangeStackInfo>& PipelineStacks, TArray<UInterchangePipelineBase*>& OutPipelines, class UInterchangeSourceData* SourceData, class UInterchangeTranslatorBase* Translator, class UInterchangeBaseNodeContainer* BaseNodeContainer, class UObject* ReimportAsset); // [0x886b990] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/InterchangeEngine.InterchangePipelineConfigurationBase.ScriptedShowPipelineConfigurationDialog
	// EInterchangePipelineConfigurationDialogResult ScriptedShowPipelineConfigurationDialog(TArray<FInterchangeStackInfo>& PipelineStacks, TArray<UInterchangePipelineBase*>& OutPipelines, class UInterchangeSourceData* SourceData, class UInterchangeTranslatorBase* Translator, class UInterchangeBaseNodeContainer* BaseNodeContainer); // [0x886b730] RequiredAPI|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetTranslatorSettings(class UInterchangeTranslatorSettings* TranslatorSettings);                                    // [0x886c160] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.SetPipelines
	// void SetPipelines(TArray<UObject*>& InPipelines);                                                                        // [0x886c0b0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.SetNodeContainer
	// void SetNodeContainer(class UInterchangeBaseNodeContainer* InNodeContainer);                                             // [0x886beb0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.ScriptGetFirstFilename
	// FString ScriptGetFirstFilename();                                                                                        // [0x5ab8a60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.ScriptExtractFilenames
	// TArray<FString> ScriptExtractFilenames();                                                                                // [0x886b300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.ScriptExtractDisplayLabels
	// TArray<FString> ScriptExtractDisplayLabels();                                                                            // [0x886b300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetTranslatorSettings
	// class UInterchangeTranslatorSettings* GetTranslatorSettings();                                                           // [0x886adb0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetStoredNode
	// class UInterchangeBaseNode* GetStoredNode(FString InNodeUniqueId);                                                       // [0x886acf0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetStoredFactoryNode
	// class UInterchangeFactoryBaseNode* GetStoredFactoryNode(FString InNodeUniqueId);                                         // [0x886ac30] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetPipelines
	// TArray<UObject*> GetPipelines();                                                                                         // [0x886aa80] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetNumberOfPipelines
	// int32_t GetNumberOfPipelines();                                                                                          // [0x886aa40] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeAssetImportData.GetNodeContainer
	// class UInterchangeBaseNodeContainer* GetNodeContainer();                                                                 // [0x886aa00] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void AddPythonPipeline(class UInterchangePythonPipelineBase* PipelineBase);                                              // [0x886a720] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangePipelineStackOverride.AddPipeline
	// void AddPipeline(class UInterchangePipelineBase* PipelineBase);                                                          // [0x886a720] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangePipelineStackOverride.AddBlueprintPipeline
	// void AddBlueprintPipeline(class UInterchangeBlueprintPipelineBase* PipelineBase);                                        // [0x886a720] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(80,1120) /* TSet<UClass*> */         __um(RegisteredTranslatorsClass);                           // 0x01A0   (0x0050)  
	...
	// bool ImportScene(FString ContentPath, class UInterchangeSourceData* SourceData, FImportAssetParameters& ImportAssetParameters); // [0x886b080] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangeManager.ImportAsset
	// bool ImportAsset(FString ContentPath, class UInterchangeSourceData* SourceData, FImportAssetParameters& ImportAssetParameters); // [0x886adf0] Final|RequiredAPI|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangeManager.GetRegisteredFactoryClass
	// class UClass* GetRegisteredFactoryClass(class UClass* ClassToMake);                                                      // [0x886ab90] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/InterchangeEngine.InterchangeManager.GetInterchangeManagerScripted
	// class UInterchangeManager* GetInterchangeManagerScripted();                                                              // [0x886a9d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangeManager.ExportScene
	// bool ExportScene(class UObject* World, bool bIsAutomated);                                                               // [0x886a910] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangeManager.ExportAsset
	// bool ExportAsset(class UObject* Asset, bool bIsAutomated);                                                               // [0x886a910] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/InterchangeEngine.InterchangeManager.CreateSourceData
	// class UInterchangeSourceData* CreateSourceData(FString InFilename);                                                      // [0x886a870] Final|RequiredAPI|Native|Static|Public|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(16,1121) /* FDelegateProperty */     __um(OnAssetDone);                                          // 0x003C   (0x0010)  
	unsigned char                                      UnknownData02_6[0x14];                                      // 0x004C   (0x0014)  MISSED
	SDK_UNDEFINED(16,1122) /* FDelegateProperty */     __um(OnAssetsImportDone);                                   // 0x0060   (0x0010)  
	unsigned char                                      UnknownData03_6[0x10];                                      // 0x0070   (0x0010)  MISSED
	SDK_UNDEFINED(16,1123) /* FDelegateProperty */     __um(OnSceneObjectDone);                                    // 0x0080   (0x0010)  
	unsigned char                                      UnknownData04_6[0x10];                                      // 0x0090   (0x0010)  MISSED
	SDK_UNDEFINED(16,1124) /* FDelegateProperty */     __um(OnSceneImportDone);                                    // 0x00A0   (0x0010)  
...
static_assert(sizeof(UInterchangeBlueprintPipelineBase) == 0x00A8); // 168 bytes (0x0000A8 - 0x0000A8)
static_assert(sizeof(UInterchangeFilePickerBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UInterchangePipelineConfigurationBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FInterchangeTranslatorPipelines) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FInterchangePipelineStack) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FInterchangeImportSettings) == 0x0088); // 136 bytes (0x000000 - 0x000088)
static_assert(sizeof(FInterchangePerTranslatorDialogOverride) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FInterchangeDialogOverride) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FInterchangeContentImportSettings) == 0x0128); // 296 bytes (0x000088 - 0x000128)
static_assert(sizeof(UInterchangeProjectSettings) == 0x0240); // 576 bytes (0x000038 - 0x000240)
static_assert(sizeof(UInterchangePythonPipelineBase) == 0x0108); // 264 bytes (0x000108 - 0x000108)
static_assert(sizeof(UInterchangePythonPipelineAsset) == 0x0068); // 104 bytes (0x000028 - 0x000068)
static_assert(sizeof(UInterchangeSceneImportAsset) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UInterchangeAssetImportData) == 0x00D8); // 216 bytes (0x000028 - 0x0000D8)
static_assert(sizeof(UInterchangeAssetImportDataConverterBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UInterchangePipelineStackOverride) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UInterchangeManager) == 0x0350); // 848 bytes (0x000028 - 0x000350)
static_assert(sizeof(UInterchangeMeshUtilities) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FInterchangeFilePickerParameters) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FInterchangeStackInfo) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(offsetof(FInterchangeTranslatorPipelines, Pipelines) == 0x0028);
...
static_assert(offsetof(FInterchangeImportSettings, ImportDialogClass) == 0x0058);
static_assert(offsetof(FInterchangePerTranslatorDialogOverride, Translator) == 0x0000);
static_assert(offsetof(FInterchangeDialogOverride, PerTranslatorImportDialogOverride) == 0x0008);
static_assert(offsetof(FInterchangeContentImportSettings, DefaultPipelineStackOverride) == 0x0088);
static_assert(offsetof(FInterchangeContentImportSettings, ShowImportDialogOverride) == 0x00D8);
static_assert(offsetof(UInterchangeProjectSettings, ContentImportSettings) == 0x0038);
static_assert(offsetof(UInterchangeProjectSettings, SceneImportSettings) == 0x0160);
static_assert(offsetof(UInterchangeProjectSettings, FilePickerClass) == 0x01E8);
static_assert(offsetof(UInterchangeProjectSettings, GenericPipelineClass) == 0x0218);
static_assert(offsetof(UInterchangePythonPipelineAsset, PythonClass) == 0x0028);
static_assert(offsetof(UInterchangePythonPipelineAsset, GeneratedPipeline) == 0x0050);
static_assert(offsetof(UInterchangePythonPipelineAsset, JsonDefaultProperties) == 0x0058);
static_assert(offsetof(UInterchangeAssetImportData, SceneImportAsset) == 0x0028);
static_assert(offsetof(UInterchangeAssetImportData, NodeUniqueID) == 0x0048);
static_assert(offsetof(UInterchangeAssetImportData, NodeContainer) == 0x0058);
static_assert(offsetof(UInterchangeAssetImportData, Pipelines) == 0x0060);
static_assert(offsetof(UInterchangeAssetImportData, TransientNodeContainer) == 0x0070);
static_assert(offsetof(UInterchangeAssetImportData, TransientPipelines) == 0x0078);
static_assert(offsetof(UInterchangeAssetImportData, TransientTranslatorSettings) == 0x0088);
static_assert(offsetof(UInterchangePipelineStackOverride, OverridePipelines) == 0x0028);
static_assert(offsetof(UInterchangeManager, RegisteredFactoryClasses) == 0x01F0);
static_assert(offsetof(UInterchangeManager, RegisteredWriters) == 0x0240);
static_assert(offsetof(UInterchangeManager, RegisteredConverters) == 0x0290);
static_assert(offsetof(FInterchangeFilePickerParameters, Title) == 0x0008);
static_assert(offsetof(FInterchangeFilePickerParameters, DefaultPath) == 0x0018);
static_assert(offsetof(FInterchangeStackInfo, StackName) == 0x0000);
static_assert(offsetof(FInterchangeStackInfo, Pipelines) == 0x0008);
...
static_assert(offsetof(FImportAssetParameters, ImportLevel) == 0x0020);
static_assert(offsetof(FImportAssetParameters, DestinationName) == 0x0028);
