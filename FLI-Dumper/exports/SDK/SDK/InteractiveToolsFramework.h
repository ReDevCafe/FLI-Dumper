...
public:
	...
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x81b6340] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x81b6150] Final|Native|Public  
};
...
public:
	...
	SDK_UNDEFINED(16,1090) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,1091) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00E0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1092) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0110   (0x0010)  
	SDK_UNDEFINED(16,1093) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0120   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x88];                                      // 0x0048   (0x0088)  MISSED
	SDK_UNDEFINED(16,1094) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,1095) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00E0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1098) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1099) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	...
	SDK_UNDEFINED(16,1100) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,1101) /* TScriptInterface<Class> */ __um(TransformSource);                                    // 0x00A0   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,1102) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1103) /* TScriptInterface<Class> */ __um(AngleSource);                                        // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,1104) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,1105) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,1106) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1107) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	class UGizmoViewContext*                           GizmoViewContext;                                           // 0x0068   (0x0008)  
	SDK_UNDEFINED(16,1108) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0070   (0x0010)  
	SDK_UNDEFINED(16,1109) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0080   (0x0010)  
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x81b5e10] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x81b5c40] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x81b5cd0] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x81b5b50] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x81b5aa0] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x81b5a60] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting);                                                                          // [0x81b62b0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x81b60c0] Native|Public        
};
...
public:
	...
	// void UpdateInteractingState(bool bInteracting, uint32_t InPartIdentifier);                                               // [0x81b61e0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHoverState
	// void UpdateHoverState(bool bHovering, uint32_t InPartIdentifier);                                                        // [0x81b5ff0] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoClickMultiTarget.UpdateHittableState
	// void UpdateHittableState(bool bHittable, uint32_t InPartIdentifier);                                                     // [0x81b5f20] Native|Public        
};
...
public:
	...
	// void UpdateVisibilityState(bool bVisible, uint32_t InPartIdentifier);                                                    // [0x81b5ff0] Native|Public        
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x81b5a20] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x42141e0] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x81b5d80] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x81b5b10] Native|Public|HasDefaults|Const 
...
{ 
public:
	SDK_UNDEFINED(16,1110) /* TScriptInterface<Class> */ __um(FloatParameterSource);                               // 0x0048   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,1111) /* TScriptInterface<Class> */ __um(AxisSource);                                         // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1112) /* TScriptInterface<Class> */ __um(ParameterSource);                                    // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,1113) /* TScriptInterface<Class> */ __um(HitTarget);                                          // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,1114) /* TScriptInterface<Class> */ __um(StateTarget);                                        // 0x0078   (0x0010)  
	class UClickDragInputBehavior*                     MouseBehavior;                                              // 0x0088   (0x0008)  
...
public:
	...
	SDK_UNDEFINED(16,1115) /* TScriptInterface<Class> */ __um(TransactionManager);                                 // 0x0048   (0x0010)  
};
...
public:
	unsigned char                                      UnknownData00_8[0x20];                                      // 0x0028   (0x0020)  MISSED
	SDK_UNDEFINED(16,1116) /* TScriptInterface<Class> */ __um(TransactionManager);                                 // 0x0048   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1117) /* TScriptInterface<Class> */ __um(ChildTransformSource);                               // 0x0048   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,1118) /* TScriptInterface<Class> */ __um(ScaledTransformSource);                              // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,1119) /* TScriptInterface<Class> */ __um(UnscaledTransformSource);                            // 0x0058   (0x0010)  
};
...
static_assert(sizeof(UGizmoBaseComponent) == 0x0548); // 1352 bytes (0x000518 - 0x000548)
...
static_assert(sizeof(UInteractiveToolEditorGizmoAPI) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UInteractiveToolManageGeometrySelectionAPI) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UGizmoArrowComponent) == 0x0570); // 1392 bytes (0x000548 - 0x000570)
static_assert(sizeof(UGizmoBoxComponent) == 0x05A0); // 1440 bytes (0x000548 - 0x0005A0)
static_assert(sizeof(UGizmoCircleComponent) == 0x0570); // 1392 bytes (0x000548 - 0x000570)
...
static_assert(sizeof(UGizmoElementLineStrip) == 0x01C8); // 456 bytes (0x000158 - 0x0001C8)
static_assert(sizeof(UGizmoElementRectangle) == 0x01B0); // 432 bytes (0x000158 - 0x0001B0)
static_assert(sizeof(UGizmoElementSphere) == 0x0128); // 296 bytes (0x000108 - 0x000128)
static_assert(sizeof(UGizmoElementTorus) == 0x01D8); // 472 bytes (0x0001C8 - 0x0001D8)
static_assert(sizeof(UGizmoElementTriangleList) == 0x0170); // 368 bytes (0x000108 - 0x000170)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x0590); // 1424 bytes (0x000548 - 0x000590)
static_assert(sizeof(UGizmoRectangleComponent) == 0x05A0); // 1440 bytes (0x000548 - 0x0005A0)
...
static_assert(sizeof(FBrushStampData) == 0x0138); // 312 bytes (0x000000 - 0x000138)
static_assert(sizeof(UBaseBrushTool) == 0x0298); // 664 bytes (0x000100 - 0x000298)
...
static_assert(sizeof(UInteractiveToolManager) == 0x01B0); // 432 bytes (0x000028 - 0x0001B0)
...
static_assert(sizeof(FDeviceButtonState) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FKeyboardInputDeviceState) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FMouseInputDeviceState) == 0x00B8); // 184 bytes (0x000000 - 0x0000B8)
static_assert(sizeof(FInputDeviceState) == 0x00E0); // 224 bytes (0x000000 - 0x0000E0)
static_assert(sizeof(FInputDeviceRay) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0518);
static_assert(offsetof(UGizmoBaseComponent, GizmoViewContext) == 0x0538);
...
static_assert(offsetof(UCombinedTransformGizmo, CurrentCoordinateSystem) == 0x0082);
static_assert(offsetof(UCombinedTransformGizmo, ActiveGizmoMode) == 0x0084);
...
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0548);
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0548);
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x0560);
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x0580);
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0548);
...
static_assert(offsetof(UGizmoElementLineStrip, Vertices) == 0x0158);
static_assert(offsetof(UGizmoElementLineStrip, base) == 0x0168);
static_assert(offsetof(UGizmoElementLineStrip, UpDirection) == 0x0180);
static_assert(offsetof(UGizmoElementLineStrip, SideDirection) == 0x0198);
...
static_assert(offsetof(UGizmoElementSphere, Center) == 0x0108);
static_assert(offsetof(UGizmoElementTriangleList, Vertices) == 0x0108);
static_assert(offsetof(UGizmoElementTriangleList, base) == 0x0118);
static_assert(offsetof(UGizmoElementTriangleList, UpDirection) == 0x0130);
static_assert(offsetof(UGizmoElementTriangleList, SideDirection) == 0x0148);
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0548);
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x0568);
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0548);
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x0560);
...
static_assert(offsetof(UScalableSphereGizmo, ActiveTarget) == 0x00A0);
static_assert(offsetof(UScalableSphereGizmo, ActiveAxis) == 0x00A8);
static_assert(offsetof(UScalableSphereGizmo, DragStartWorldPosition) == 0x00C0);
static_assert(offsetof(UScalableSphereGizmo, DragCurrentPositionProjected) == 0x00D8);
...
static_assert(offsetof(UBaseBrushTool, PropertyClass) == 0x0258);
static_assert(offsetof(UBaseBrushTool, BrushStampIndicator) == 0x0280);
...
static_assert(offsetof(UInteractiveToolManager, ToolBuilders) == 0x0100);
...
static_assert(offsetof(FDeviceButtonState, Button) == 0x0000);
static_assert(offsetof(FKeyboardInputDeviceState, ActiveKey) == 0x0000);
static_assert(offsetof(FMouseInputDeviceState, Left) == 0x0000);
static_assert(offsetof(FMouseInputDeviceState, Middle) == 0x0020);
static_assert(offsetof(FMouseInputDeviceState, Right) == 0x0040);
static_assert(offsetof(FMouseInputDeviceState, Position2D) == 0x0068);
static_assert(offsetof(FMouseInputDeviceState, Delta2D) == 0x0078);
static_assert(offsetof(FMouseInputDeviceState, WorldRay) == 0x0088);
static_assert(offsetof(FInputDeviceState, InputDevice) == 0x0000);
static_assert(offsetof(FInputDeviceState, Keyboard) == 0x0008);
static_assert(offsetof(FInputDeviceState, Mouse) == 0x0028);
