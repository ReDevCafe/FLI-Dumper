...
static_assert(sizeof(UImGuiInputHandler) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(FImGuiKeyInfo) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FImGuiCanvasSizeInfo) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FImGuiDPIScaleInfo) == 0x0098); // 152 bytes (0x000000 - 0x000098)
static_assert(sizeof(UImGuiSettings) == 0x0118); // 280 bytes (0x000028 - 0x000118)
static_assert(offsetof(FImGuiKeyInfo, Key) == 0x0000);
static_assert(offsetof(FImGuiKeyInfo, Shift) == 0x0018);
static_assert(offsetof(FImGuiKeyInfo, Ctrl) == 0x0019);
static_assert(offsetof(FImGuiKeyInfo, Alt) == 0x001A);
static_assert(offsetof(FImGuiKeyInfo, Cmd) == 0x001B);
static_assert(offsetof(FImGuiCanvasSizeInfo, SizeType) == 0x0000);
static_assert(offsetof(FImGuiDPIScaleInfo, ScalingMethod) == 0x0000);
static_assert(offsetof(FImGuiDPIScaleInfo, DPICurve) == 0x0008);
static_assert(offsetof(UImGuiSettings, ImGuiInputHandlerClass) == 0x0028);
static_assert(offsetof(UImGuiSettings, ToggleInput) == 0x0050);
static_assert(offsetof(UImGuiSettings, CanvasSize) == 0x0070);
static_assert(offsetof(UImGuiSettings, DPIScale) == 0x0080);
