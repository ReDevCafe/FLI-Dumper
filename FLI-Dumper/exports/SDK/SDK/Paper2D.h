...
public:
	...
	// bool IsValidKeyFrameIndex(int32_t Index);                                                                                // [0x8673750] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetTotalDuration
	// float GetTotalDuration();                                                                                                // [0x8673660] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtTime
	// class UPaperSprite* GetSpriteAtTime(float Time, bool bClampToEnds);                                                      // [0x8672c60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtFrame
	// class UPaperSprite* GetSpriteAtFrame(int32_t FrameIndex);                                                                // [0x8672ba0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumKeyFrames
	// int32_t GetNumKeyFrames();                                                                                               // [0x5a044c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetNumFrames
	// int32_t GetNumFrames();                                                                                                  // [0x8672ad0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbook.GetKeyFrameIndexAtTime
	// int32_t GetKeyFrameIndexAtTime(float Time, bool bClampToEnds);                                                           // [0x86727d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(16,1189) /* FMulticastInlineDelegate */ __um(OnFinishedPlaying);                                 // 0x0588   (0x0010)  
	unsigned char                                      UnknownData01_7[0x8];                                       // 0x0598   (0x0008)  MISSED


	/// Functions
	// Function /Script/Paper2D.PaperFlipbookComponent.Stop
	// void Stop();                                                                                                             // [0x86752b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetSpriteColor
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0x8674b40] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlayRate
	// void SetPlayRate(float NewRate);                                                                                         // [0x86748d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPositionInFrames
	// void SetPlaybackPositionInFrames(int32_t NewFramePosition, bool bFireEvents);                                            // [0x8674a30] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPosition
	// void SetPlaybackPosition(float newPosition, bool bFireEvents);                                                           // [0x8674950] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetNewTime
	// void SetNewTime(float NewTime);                                                                                          // [0x8674830] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetLooping
	// void SetLooping(bool bNewLooping);                                                                                       // [0x8674790] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.SetFlipbook
	// bool SetFlipbook(class UPaperFlipbook* NewFlipbook);                                                                     // [0x58b7780] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.ReverseFromEnd
	// void ReverseFromEnd();                                                                                                   // [0x86742a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Reverse
	// void Reverse();                                                                                                          // [0x8674260] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.PlayFromStart
	// void PlayFromStart();                                                                                                    // [0x8673ff0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.Play
	// void Play();                                                                                                             // [0x8673fa0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperFlipbookComponent.OnRep_SourceFlipbook
	// void OnRep_SourceFlipbook(class UPaperFlipbook* OldFlipbook);                                                            // [0x8673eb0] Final|Native|Protected 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsReversing
	// bool IsReversing();                                                                                                      // [0x8673720] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x86736f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.IsLooping
	// bool IsLooping();                                                                                                        // [0x86736c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetSpriteColor
	// FLinearColor GetSpriteColor();                                                                                           // [0x8672d70] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlayRate
	// float GetPlayRate();                                                                                                     // [0x8672b00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPositionInFrames
	// int32_t GetPlaybackPositionInFrames();                                                                                   // [0x8672b20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetPlaybackPosition
	// float GetPlaybackPosition();                                                                                             // [0x8672620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLengthInFrames
	// int32_t GetFlipbookLengthInFrames();                                                                                     // [0x86725d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookLength
	// float GetFlipbookLength();                                                                                               // [0x8672550] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbookFramerate
	// float GetFlipbookFramerate();                                                                                            // [0x8672510] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperFlipbookComponent.GetFlipbook
	// class UPaperFlipbook* GetFlipbook();                                                                                     // [0x86724e0] Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// bool UpdateInstanceTransform(int32_t InstanceIndex, FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport); // [0x86753f0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.UpdateInstanceColor
	// bool UpdateInstanceColor(int32_t InstanceIndex, FLinearColor NewInstanceColor, bool bMarkRenderStateDirty);              // [0x86752d0] Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.SortInstancesAlongAxis
	// void SortInstancesAlongAxis(FVector WorldSpaceSortAxis);                                                                 // [0x8675220] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.RemoveInstance
	// bool RemoveInstance(int32_t InstanceIndex);                                                                              // [0x86740c0] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceTransform
	// bool GetInstanceTransform(int32_t InstanceIndex, FTransform& OutInstanceTransform, bool bWorldSpace);                    // [0x8672640] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceCount
	// int32_t GetInstanceCount();                                                                                              // [0x8672620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.ClearInstances
	// void ClearInstances();                                                                                                   // [0x8672280] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.AddInstance
	// int32_t AddInstance(FTransform& Transform, class UPaperSprite* Sprite, bool bWorldSpace, FLinearColor Color);            // [0x8671d90] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// FSlateBrush MakeBrushFromSprite(class UPaperSprite* Sprite, int32_t Width, int32_t Height);                              // [0x86737f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetSpriteColor(FLinearColor NewColor);                                                                              // [0x8674c70] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.SetSprite
	// bool SetSprite(class UPaperSprite* NewSprite);                                                                           // [0x58b7780] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperSpriteComponent.GetSprite
	// class UPaperSprite* GetSprite();                                                                                         // [0x86724e0] Native|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetTileMapColor(FLinearColor NewColor);                                                                             // [0x86751a0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTileMap
	// bool SetTileMap(class UPaperTileMap* NewTileMap);                                                                        // [0x58b7780] Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetTile
	// void SetTile(int32_t X, int32_t Y, int32_t Layer, FPaperTileInfo NewValue);                                              // [0x8674fe0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerColor
	// void SetLayerColor(FLinearColor NewColor, int32_t Layer);                                                                // [0x8674690] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerCollision
	// void SetLayerCollision(int32_t Layer, bool bHasCollision, bool bOverrideThickness, float CustomThickness, bool bOverrideOffset, float CustomOffset, bool bRebuildCollision); // [0x8674450] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.SetDefaultCollisionThickness
	// void SetDefaultCollisionThickness(float Thickness, bool bRebuildCollision);                                              // [0x8674330] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.ResizeMap
	// void ResizeMap(int32_t NewWidthInTiles, int32_t NewHeightInTiles);                                                       // [0x8674160] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.RebuildCollision
	// void RebuildCollision();                                                                                                 // [0x8674060] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.OwnsTileMap
	// bool OwnsTileMap();                                                                                                      // [0x8673f60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.MakeTileMapEditable
	// void MakeTileMapEditable();                                                                                              // [0x8673e30] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTilePolygon
	// void GetTilePolygon(int32_t TileX, int32_t TileY, TArray<FVector>& Points, int32_t layerIndex, bool bWorldSpace);        // [0x86732a0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileMapColor
	// FLinearColor GetTileMapColor();                                                                                          // [0x8673270] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCornerPosition
	// FVector GetTileCornerPosition(int32_t TileX, int32_t TileY, int32_t layerIndex, bool bWorldSpace);                       // [0x86730e0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCenterPosition
	// FVector GetTileCenterPosition(int32_t TileX, int32_t TileY, int32_t layerIndex, bool bWorldSpace);                       // [0x8672f50] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTile
	// FPaperTileInfo GetTile(int32_t X, int32_t Y, int32_t Layer);                                                             // [0x8672da0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetMapSize
	// void GetMapSize(int32_t& MapWidth, int32_t& MapHeight, int32_t& NumLayers);                                              // [0x8672960] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.GetLayerColor
	// FLinearColor GetLayerColor(int32_t Layer);                                                                               // [0x86728a0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.CreateNewTileMap
	// void CreateNewTileMap(int32_t MapWidth, int32_t MapHeight, int32_t TileWidth, int32_t TileHeight, float PixelsPerUnrealUnit, bool bCreateLayer); // [0x86722a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Paper2D.PaperTileMapComponent.AddNewLayer
	// class UPaperTileLayer* AddNewLayer();                                                                                    // [0x8671f90] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetTerrainColor(FLinearColor NewColor);                                                                             // [0x8674da0] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// FPaperTileInfo MakeTile(int32_t TileIndex, class UPaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD);         // [0x8673c00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileUserData
	// FName GetTileUserData(FPaperTileInfo tile);                                                                              // [0x8673560] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileTransform
	// FTransform GetTileTransform(FPaperTileInfo tile);                                                                        // [0x8673470] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/Paper2D.TileMapBlueprintLibrary.BreakTile
	// void BreakTile(FPaperTileInfo tile, int32_t& TileIndex, class UPaperTileSet*& TileSet, bool& bFlipH, bool& bFlipV, bool& bFlipD); // [0x8672020] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(APaperCharacter) == 0x0670); // 1648 bytes (0x000668 - 0x000670)
...
static_assert(sizeof(APaperFlipbookActor) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(sizeof(UPaperFlipbookComponent) == 0x05A0); // 1440 bytes (0x000550 - 0x0005A0)
static_assert(sizeof(APaperGroupedSpriteActor) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(sizeof(FSpriteInstanceData) == 0x0090); // 144 bytes (0x000000 - 0x000090)
static_assert(sizeof(UPaperGroupedSpriteComponent) == 0x0580); // 1408 bytes (0x000550 - 0x000580)
...
static_assert(sizeof(UPaperSprite) == 0x00B8); // 184 bytes (0x000028 - 0x0000B8)
static_assert(sizeof(APaperSpriteActor) == 0x0298); // 664 bytes (0x000290 - 0x000298)
...
static_assert(sizeof(UPaperSpriteComponent) == 0x0570); // 1392 bytes (0x000550 - 0x000570)
static_assert(sizeof(FPaperTileInfo) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(UPaperTileLayer) == 0x0090); // 144 bytes (0x000028 - 0x000090)
static_assert(sizeof(UPaperTileMap) == 0x00A8); // 168 bytes (0x000028 - 0x0000A8)
static_assert(sizeof(APaperTileMapActor) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(sizeof(UPaperTileMapComponent) == 0x05A0); // 1440 bytes (0x000550 - 0x0005A0)
...
static_assert(sizeof(UMaterialExpressionSpriteTextureSampler) == 0x0238); // 568 bytes (0x000220 - 0x000238)
static_assert(sizeof(APaperTerrainActor) == 0x02A8); // 680 bytes (0x000290 - 0x0002A8)
static_assert(sizeof(UPaperTerrainComponent) == 0x0570); // 1392 bytes (0x000518 - 0x000570)
...
static_assert(sizeof(UPaperTerrainSplineComponent) == 0x0630); // 1584 bytes (0x000620 - 0x000630)
...
static_assert(offsetof(APaperCharacter, Sprite) == 0x0668);
...
static_assert(offsetof(APaperFlipbookActor, RenderComponent) == 0x0290);
static_assert(offsetof(UPaperFlipbookComponent, SourceFlipbook) == 0x0550);
static_assert(offsetof(UPaperFlipbookComponent, Material) == 0x0558);
static_assert(offsetof(UPaperFlipbookComponent, SpriteColor) == 0x0570);
static_assert(offsetof(UPaperFlipbookComponent, CachedBodySetup) == 0x0580);
static_assert(offsetof(APaperGroupedSpriteActor, RenderComponent) == 0x0290);
...
static_assert(offsetof(UPaperGroupedSpriteComponent, InstanceMaterials) == 0x0550);
static_assert(offsetof(UPaperGroupedSpriteComponent, PerInstanceSpriteData) == 0x0560);
...
static_assert(offsetof(UPaperSprite, BakedSourceDimension) == 0x0058);
static_assert(offsetof(UPaperSprite, BakedSourceTexture) == 0x0068);
static_assert(offsetof(UPaperSprite, DefaultMaterial) == 0x0070);
static_assert(offsetof(UPaperSprite, AlternateMaterial) == 0x0078);
static_assert(offsetof(UPaperSprite, Sockets) == 0x0080);
static_assert(offsetof(UPaperSprite, SpriteCollisionDomain) == 0x0090);
static_assert(offsetof(UPaperSprite, BodySetup) == 0x0098);
static_assert(offsetof(UPaperSprite, BakedRenderData) == 0x00A8);
static_assert(offsetof(APaperSpriteActor, RenderComponent) == 0x0290);
static_assert(offsetof(UPaperSpriteComponent, SourceSprite) == 0x0550);
static_assert(offsetof(UPaperSpriteComponent, MaterialOverride) == 0x0558);
static_assert(offsetof(UPaperSpriteComponent, SpriteColor) == 0x0560);
static_assert(offsetof(FPaperTileInfo, TileSet) == 0x0000);
static_assert(offsetof(UPaperTileLayer, LayerName) == 0x0028);
static_assert(offsetof(UPaperTileLayer, LayerColor) == 0x004C);
static_assert(offsetof(UPaperTileLayer, AllocatedCells) == 0x0068);
static_assert(offsetof(UPaperTileLayer, TileSet) == 0x0078);
static_assert(offsetof(UPaperTileLayer, AllocatedGrid) == 0x0080);
...
static_assert(offsetof(APaperTileMapActor, RenderComponent) == 0x0290);
static_assert(offsetof(UPaperTileMapComponent, DefaultLayerTileSet) == 0x0560);
static_assert(offsetof(UPaperTileMapComponent, Material) == 0x0568);
static_assert(offsetof(UPaperTileMapComponent, TileLayers) == 0x0570);
static_assert(offsetof(UPaperTileMapComponent, TileMapColor) == 0x0580);
static_assert(offsetof(UPaperTileMapComponent, TileMap) == 0x0598);
...
static_assert(offsetof(UMaterialExpressionSpriteTextureSampler, SlotDisplayName) == 0x0228);
static_assert(offsetof(APaperTerrainActor, DummyRoot) == 0x0290);
static_assert(offsetof(APaperTerrainActor, SplineComponent) == 0x0298);
static_assert(offsetof(APaperTerrainActor, RenderComponent) == 0x02A0);
static_assert(offsetof(UPaperTerrainComponent, TerrainMaterial) == 0x0518);
static_assert(offsetof(UPaperTerrainComponent, AssociatedSpline) == 0x0528);
static_assert(offsetof(UPaperTerrainComponent, TerrainColor) == 0x0538);
static_assert(offsetof(UPaperTerrainComponent, SpriteCollisionDomain) == 0x054C);
static_assert(offsetof(UPaperTerrainComponent, CachedBodySetup) == 0x0558);
