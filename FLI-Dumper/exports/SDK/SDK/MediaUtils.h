...
static_assert(sizeof(FMediaPlayerOptions) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(offsetof(FMediaPlayerOptions, Tracks) == 0x0000);
static_assert(offsetof(FMediaPlayerOptions, TrackSelection) == 0x001C);
static_assert(offsetof(FMediaPlayerOptions, SeekTime) == 0x0020);
static_assert(offsetof(FMediaPlayerOptions, SeekTimeType) == 0x0028);
static_assert(offsetof(FMediaPlayerOptions, PlayOnOpen) == 0x0029);
static_assert(offsetof(FMediaPlayerOptions, Loop) == 0x002A);
