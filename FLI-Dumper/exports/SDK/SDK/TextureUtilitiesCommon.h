...
static_assert(sizeof(UTextureImportSettings) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(offsetof(UTextureImportSettings, CompressedFormatForFloatTextures) == 0x003E);
static_assert(offsetof(UTextureImportSettings, PNGInfill) == 0x003F);
