...
public:
	...
	// void SelectAll();                                                                                                        // [0x8264d50] Final|Native|Public  
	// Function /Script/ModelingComponents.MeshTopologySelectionMechanicProperties.InvertSelection
	// void InvertSelection();                                                                                                  // [0x8264d30] Final|Native|Public  
};
...
public:
	...
	// void SetDynamicMesh(class UDynamicMesh* NewMesh);                                                                        // [0x8264d70] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool SetPointSetVisibility(FString PointSetIdentifier, bool bVisible);                                                   // [0x82b7590] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetPointSetMaterial
	// bool SetPointSetMaterial(FString PointSetIdentifier, class UMaterialInterface* NewMaterial);                             // [0x82b7410] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetVisibility
	// bool SetLineSetVisibility(FString LineSetIdentifier, bool bVisible);                                                     // [0x82b72b0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetLineSetMaterial
	// bool SetLineSetMaterial(FString LineSetIdentifier, class UMaterialInterface* NewMaterial);                               // [0x82b7160] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllPointSetsMaterial
	// void SetAllPointSetsMaterial(class UMaterialInterface* Material);                                                        // [0x82b70d0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.SetAllLineSetsMaterial
	// void SetAllLineSetsMaterial(class UMaterialInterface* Material);                                                         // [0x82b7040] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveTriangleSet
	// bool RemoveTriangleSet(FString TriangleSetIdentifier, bool bDestroy);                                                    // [0x82b6ed0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemovePointSet
	// bool RemovePointSet(FString PointSetIdentifier, bool bDestroy);                                                          // [0x82b6d50] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveLineSet
	// bool RemoveLineSet(FString LineSetIdentifier, bool bDestroy);                                                            // [0x82b6bd0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllTriangleSets
	// void RemoveAllTriangleSets(bool bDestroy);                                                                               // [0x82b6b40] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllPointSets
	// void RemoveAllPointSets(bool bDestroy);                                                                                  // [0x82b6ab0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.RemoveAllLineSets
	// void RemoveAllLineSets(bool bDestroy);                                                                                   // [0x82b6a20] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.GetActor
	// class APreviewGeometryActor* GetActor();                                                                                 // [0x60b8170] Final|Native|Public|Const 
	// Function /Script/ModelingComponents.PreviewGeometry.FindTriangleSet
	// class UTriangleSetComponent* FindTriangleSet(FString TriangleSetIdentifier);                                             // [0x82b6930] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.FindPointSet
	// class UPointSetComponent* FindPointSet(FString PointSetIdentifier);                                                      // [0x82b6830] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.FindLineSet
	// class ULineSetComponent* FindLineSet(FString LineSetIdentifier);                                                         // [0x82b6730] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.Disconnect
	// void Disconnect();                                                                                                       // [0x82b66e0] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.CreateInWorld
	// void CreateInWorld(class UWorld* World, FTransform& WithTransform);                                                      // [0x82b60f0] Final|Native|Public|HasOutParms|HasDefaults 
	// Function /Script/ModelingComponents.PreviewGeometry.AddTriangleSet
	// class UTriangleSetComponent* AddTriangleSet(FString TriangleSetIdentifier);                                              // [0x82b6040] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.AddPointSet
	// class UPointSetComponent* AddPointSet(FString PointSetIdentifier);                                                       // [0x82b5f90] Final|Native|Public  
	// Function /Script/ModelingComponents.PreviewGeometry.AddLineSet
	// class ULineSetComponent* AddLineSet(FString LineSetIdentifier);                                                          // [0x82b5ee0] Final|Native|Public  
};
...
public:
	...
	// FCreateTextureObjectResult CreateTextureObject(FCreateTextureObjectParams& CreateTexParams);                             // [0x82b65e0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateNewActor
	// FCreateActorResult CreateNewActor(FCreateActorParams& CreateActorParams);                                                // [0x82b6480] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateMeshObject
	// FCreateMeshObjectResult CreateMeshObject(FCreateMeshObjectParams& CreateMeshParams);                                     // [0x82b6340] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/ModelingComponents.ModelingObjectsCreationAPI.CreateMaterialObject
	// FCreateMaterialObjectResult CreateMaterialObject(FCreateMaterialObjectParams& CreateMaterialParams);                     // [0x82b6240] Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool ShouldShowPropertySet();                                                                                            // [0x82f4e40] Final|Native|Public|Const 
	// Function /Script/ModelingComponents.CreateMeshObjectTypeProperties.GetOutputTypeNamesFunc
	// TArray<FString> GetOutputTypeNamesFunc();                                                                                // [0x82f4db0] Final|Native|Public  
	// Function /Script/ModelingComponents.CreateMeshObjectTypeProperties.GetCurrentCreateMeshType
	// ECreateObjectTypeHint GetCurrentCreateMeshType();                                                                        // [0x82f4b20] Final|Native|Public|Const 
};
...
public:
	...
	// TArray<FString> GetGroupLayersFunc();                                                                                    // [0x82f4c30] Final|Native|Public  
};
...
public:
	...
	// TArray<FString> GetWeightMapsFunc();                                                                                     // [0x82f4c30] Final|Native|Public  
};
...
static_assert(sizeof(UMeshTopologySelectionMechanic) == 0x0B30); // 2864 bytes (0x000030 - 0x000B30)
static_assert(sizeof(UBoundarySelectionMechanic) == 0x0B30); // 2864 bytes (0x000B30 - 0x000B30)
...
static_assert(sizeof(UGeometrySelectionVisualizationProperties) == 0x0108); // 264 bytes (0x0000A8 - 0x000108)
...
static_assert(sizeof(UToolHostCustomizationAPI) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UBaseCreateFromSelectedCollisionProperties) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
...
static_assert(sizeof(UBaseCreateFromSelectedTool) == 0x0108); // 264 bytes (0x0000B8 - 0x000108)
...
static_assert(sizeof(UBaseVoxelTool) == 0x0120); // 288 bytes (0x000108 - 0x000120)
...
static_assert(sizeof(USingleSelectionMeshEditingTool) == 0x00B0); // 176 bytes (0x0000A8 - 0x0000B0)
static_assert(sizeof(USingleTargetWithSelectionToolBuilder) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(USingleTargetWithSelectionTool) == 0x0120); // 288 bytes (0x0000A8 - 0x000120)
static_assert(sizeof(UDynamicMeshReplacementChangeTarget) == 0x0058); // 88 bytes (0x000028 - 0x000058)
static_assert(sizeof(UOctreeDynamicMeshComponent) == 0x06D0); // 1744 bytes (0x0005C0 - 0x0006D0)
static_assert(sizeof(ULineSetComponent) == 0x05D0); // 1488 bytes (0x000550 - 0x0005D0)
static_assert(sizeof(UMeshElementsVisualizerProperties) == 0x00D8); // 216 bytes (0x0000A8 - 0x0000D8)
static_assert(sizeof(UPreviewGeometry) == 0x0120); // 288 bytes (0x000028 - 0x000120)
static_assert(sizeof(UMeshElementsVisualizer) == 0x0148); // 328 bytes (0x000120 - 0x000148)
static_assert(sizeof(UMeshWireframeComponent) == 0x0600); // 1536 bytes (0x000550 - 0x000600)
static_assert(sizeof(UPointSetComponent) == 0x05D0); // 1488 bytes (0x000550 - 0x0005D0)
static_assert(sizeof(UPreviewMesh) == 0x0140); // 320 bytes (0x000028 - 0x000140)
static_assert(sizeof(UPolyEditPreviewMesh) == 0x0480); // 1152 bytes (0x000140 - 0x000480)
static_assert(sizeof(APreviewGeometryActor) == 0x0298); // 664 bytes (0x000298 - 0x000298)
static_assert(sizeof(UTriangleSetComponent) == 0x0650); // 1616 bytes (0x000550 - 0x000650)
static_assert(sizeof(UUVLayoutPreviewProperties) == 0x00D0); // 208 bytes (0x0000A8 - 0x0000D0)
static_assert(sizeof(UUVLayoutPreview) == 0x0170); // 368 bytes (0x000028 - 0x000170)
static_assert(sizeof(UCollectSurfacePathMechanic) == 0x05C0); // 1472 bytes (0x000030 - 0x0005C0)
static_assert(sizeof(UCollisionPrimitivesMechanic) == 0x0570); // 1392 bytes (0x000030 - 0x000570)
...
static_assert(sizeof(UDragAlignmentMechanic) == 0x0280); // 640 bytes (0x000030 - 0x000280)
static_assert(sizeof(UDragAlignmentInteraction) == 0x02E0); // 736 bytes (0x000028 - 0x0002E0)
static_assert(sizeof(ULatticeControlPointsMechanic) == 0x0510); // 1296 bytes (0x000030 - 0x000510)
static_assert(sizeof(UPlaneDistanceFromHitMechanic) == 0x0520); // 1312 bytes (0x000030 - 0x000520)
...
static_assert(sizeof(UGeometrySelectionManager) == 0x02C0); // 704 bytes (0x000028 - 0x0002C0)
static_assert(sizeof(UPolygonSelectionMechanicProperties) == 0x00C0); // 192 bytes (0x0000C0 - 0x0000C0)
static_assert(sizeof(UPolygonSelectionMechanic) == 0x0B40); // 2880 bytes (0x000B30 - 0x000B40)
...
static_assert(sizeof(FModelingToolsColorChannelFilter) == 0x0004); // 4 bytes (0x000000 - 0x000004)
...
static_assert(sizeof(FCreateMeshObjectParams) == 0x0670); // 1648 bytes (0x000000 - 0x000670)
...
static_assert(sizeof(FCreateMaterialObjectParams) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FCreateMaterialObjectResult) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FCreateActorParams) == 0x0090); // 144 bytes (0x000000 - 0x000090)
static_assert(sizeof(FCreateActorResult) == 0x0010); // 16 bytes (0x000000 - 0x000010)
...
static_assert(offsetof(UMeshTopologySelectionMechanic, MarqueeSelectionUpdateType) == 0x00F8);
static_assert(offsetof(UMeshTopologySelectionMechanic, PreviewGeometryActor) == 0x0700);
static_assert(offsetof(UMeshTopologySelectionMechanic, DrawnTriangleSetComponent) == 0x0708);
static_assert(offsetof(UMeshTopologySelectionMechanic, HighlightedFaceMaterial) == 0x0760);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, SelectionElementType) == 0x00AA);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, SelectionTopologyType) == 0x00AB);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, FaceColor) == 0x00BC);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, LineColor) == 0x00C0);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, PointColor) == 0x00C4);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, TriangleROIBorderColor) == 0x00C8);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, TriangleMaterial) == 0x00D0);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, LineMaterial) == 0x00D8);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, PointMaterial) == 0x00E0);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, TriangleMaterialShowingHidden) == 0x00E8);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, LineMaterialShowingHidden) == 0x00F0);
static_assert(offsetof(UGeometrySelectionVisualizationProperties, PointMaterialShowingHidden) == 0x00F8);
...
static_assert(offsetof(UBaseCreateFromSelectedTool, CollisionProperties) == 0x00D8);
static_assert(offsetof(UBaseCreateFromSelectedTool, Preview) == 0x00E0);
static_assert(offsetof(UBaseCreateFromSelectedTool, TransformProxies) == 0x00E8);
static_assert(offsetof(UBaseCreateFromSelectedTool, TransformGizmos) == 0x00F8);
static_assert(offsetof(UBaseMeshProcessingTool, Preview) == 0x00C8);
static_assert(offsetof(UBaseVoxelTool, VoxProperties) == 0x0108);
...
static_assert(offsetof(USingleTargetWithSelectionTool, GeometrySelectionVizProperties) == 0x0110);
static_assert(offsetof(USingleTargetWithSelectionTool, GeometrySelectionViz) == 0x0118);
static_assert(offsetof(UOctreeDynamicMeshComponent, MeshObject) == 0x0610);
static_assert(offsetof(ULineSetComponent, LineMaterial) == 0x0550);
static_assert(offsetof(ULineSetComponent, Bounds) == 0x0558);
...
static_assert(offsetof(UMeshElementsVisualizerProperties, TangentSeamColor) == 0x00C4);
static_assert(offsetof(UMeshElementsVisualizerProperties, ColorSeamColor) == 0x00C8);
static_assert(offsetof(UPreviewGeometry, ParentActor) == 0x0028);
static_assert(offsetof(UPreviewGeometry, TriangleSets) == 0x0030);
static_assert(offsetof(UPreviewGeometry, LineSets) == 0x0080);
static_assert(offsetof(UPreviewGeometry, PointSets) == 0x00D0);
static_assert(offsetof(UMeshElementsVisualizer, Settings) == 0x0120);
static_assert(offsetof(UMeshElementsVisualizer, WireframeComponent) == 0x0128);
static_assert(offsetof(UMeshWireframeComponent, WireframeColor) == 0x0560);
static_assert(offsetof(UMeshWireframeComponent, BoundaryEdgeColor) == 0x056C);
static_assert(offsetof(UMeshWireframeComponent, UVSeamColor) == 0x0578);
static_assert(offsetof(UMeshWireframeComponent, NormalSeamColor) == 0x0584);
static_assert(offsetof(UMeshWireframeComponent, TangentSeamColor) == 0x0590);
static_assert(offsetof(UMeshWireframeComponent, ColorSeamColor) == 0x059C);
static_assert(offsetof(UMeshWireframeComponent, LineMaterial) == 0x05A8);
static_assert(offsetof(UMeshWireframeComponent, LocalBounds) == 0x05B0);
static_assert(offsetof(UPointSetComponent, PointMaterial) == 0x0550);
static_assert(offsetof(UPointSetComponent, Bounds) == 0x0558);
static_assert(offsetof(UPreviewMesh, DynamicMeshComponent) == 0x0050);
static_assert(offsetof(UTriangleSetComponent, Bounds) == 0x0550);
...
static_assert(offsetof(UUVLayoutPreview, MeshElementsVisualizer) == 0x0038);
static_assert(offsetof(UUVLayoutPreview, TriangleComponent) == 0x0040);
static_assert(offsetof(UUVLayoutPreview, BackingRectangleMaterial) == 0x0050);
static_assert(offsetof(UCollisionPrimitivesMechanic, PreviewGeometry) == 0x0240);
static_assert(offsetof(UCollisionPrimitivesMechanic, DrawnPrimitiveEdges) == 0x0248);
static_assert(offsetof(UCollisionPrimitivesMechanic, TranslateTransformProxy) == 0x03A0);
static_assert(offsetof(UCollisionPrimitivesMechanic, SphereTransformProxy) == 0x03A8);
static_assert(offsetof(UCollisionPrimitivesMechanic, BoxTransformProxy) == 0x03B0);
static_assert(offsetof(UCollisionPrimitivesMechanic, CapsuleTransformProxy) == 0x03B8);
static_assert(offsetof(UCollisionPrimitivesMechanic, FullTransformProxy) == 0x03C0);
static_assert(offsetof(UCollisionPrimitivesMechanic, CurrentActiveProxy) == 0x03C8);
static_assert(offsetof(UCollisionPrimitivesMechanic, TranslateTransformGizmo) == 0x03D0);
static_assert(offsetof(UCollisionPrimitivesMechanic, SphereTransformGizmo) == 0x03D8);
static_assert(offsetof(UCollisionPrimitivesMechanic, BoxTransformGizmo) == 0x03E0);
static_assert(offsetof(UCollisionPrimitivesMechanic, CapsuleTransformGizmo) == 0x03E8);
static_assert(offsetof(UCollisionPrimitivesMechanic, FullTransformGizmo) == 0x03F0);
static_assert(offsetof(UCollisionPrimitivesMechanic, MarqueeMechanic) == 0x0448);
...
static_assert(offsetof(UModelingComponentsSettings, CollisionMode) == 0x003C);
...
static_assert(offsetof(FCreateMeshObjectParams, NaniteSettings) == 0x0130);
...
static_assert(offsetof(FCreateMaterialObjectParams, TargetWorld) == 0x0000);
static_assert(offsetof(FCreateMaterialObjectParams, StoreRelativeToObject) == 0x0008);
static_assert(offsetof(FCreateMaterialObjectParams, BaseName) == 0x0010);
static_assert(offsetof(FCreateMaterialObjectParams, MaterialToDuplicate) == 0x0020);
static_assert(offsetof(FCreateMaterialObjectResult, ResultCode) == 0x0000);
static_assert(offsetof(FCreateMaterialObjectResult, NewAsset) == 0x0008);
static_assert(offsetof(FCreateActorParams, TargetWorld) == 0x0000);
static_assert(offsetof(FCreateActorParams, BaseName) == 0x0008);
static_assert(offsetof(FCreateActorParams, Transform) == 0x0020);
static_assert(offsetof(FCreateActorParams, TemplateActor) == 0x0080);
static_assert(offsetof(FCreateActorParams, TemplateAsset) == 0x0088);
static_assert(offsetof(FCreateActorResult, ResultCode) == 0x0000);
static_assert(offsetof(FCreateActorResult, NewActor) == 0x0008);
