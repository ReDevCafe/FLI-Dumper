...
static_assert(sizeof(UNiagaraDataInterfaceAtomPlayer) == 0x0070); // 112 bytes (0x000038 - 0x000070)
static_assert(offsetof(UNiagaraDataInterfaceAtomPlayer, SoundToPlay) == 0x0038);
static_assert(offsetof(UNiagaraDataInterfaceAtomPlayer, Attenuation) == 0x0040);
static_assert(offsetof(UNiagaraDataInterfaceAtomPlayer, Concurrency) == 0x0048);
static_assert(offsetof(UNiagaraDataInterfaceAtomPlayer, ParameterNames) == 0x0050);
