...
static_assert(sizeof(UInterchangeResultMeshWarning) == 0x0080); // 128 bytes (0x000070 - 0x000080)
static_assert(sizeof(UInterchangeResultTextureWarning) == 0x0080); // 128 bytes (0x000070 - 0x000080)
static_assert(sizeof(UInterchangeResultMeshError) == 0x0080); // 128 bytes (0x000070 - 0x000080)
static_assert(sizeof(UInterchangeResultMeshWarning_Generic) == 0x0090); // 144 bytes (0x000080 - 0x000090)
static_assert(sizeof(UInterchangeResultMeshError_Generic) == 0x0090); // 144 bytes (0x000080 - 0x000090)
static_assert(sizeof(UInterchangeResultMeshWarning_TooManyUVs) == 0x0088); // 136 bytes (0x000080 - 0x000088)
static_assert(sizeof(UInterchangeResultTextureWarning_TextureFileDoNotExist) == 0x00A0); // 160 bytes (0x000080 - 0x0000A0)
static_assert(offsetof(UInterchangeResultMeshWarning, MeshName) == 0x0070);
static_assert(offsetof(UInterchangeResultTextureWarning, TextureName) == 0x0070);
static_assert(offsetof(UInterchangeResultMeshError, MeshName) == 0x0070);
static_assert(offsetof(UInterchangeResultMeshWarning_Generic, Text) == 0x0080);
static_assert(offsetof(UInterchangeResultMeshError_Generic, Text) == 0x0080);
static_assert(offsetof(UInterchangeResultTextureWarning_TextureFileDoNotExist, Text) == 0x0080);
static_assert(offsetof(UInterchangeResultTextureWarning_TextureFileDoNotExist, MaterialName) == 0x0090);
