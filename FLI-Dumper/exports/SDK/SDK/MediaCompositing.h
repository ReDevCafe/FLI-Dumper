...
static_assert(sizeof(UMovieSceneMediaSection) == 0x0258); // 600 bytes (0x0000F0 - 0x000258)
...
static_assert(offsetof(UMovieSceneMediaSection, ChannelCanPlayerBeOpen) == 0x0138);
static_assert(offsetof(UMovieSceneMediaSection, MediaSourceProxyBindingID) == 0x0240);
