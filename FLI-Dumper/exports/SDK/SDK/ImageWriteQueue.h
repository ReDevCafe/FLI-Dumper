...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& OPTIONS);                               // [0x43211b0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(16,1089) /* FDelegateProperty */     __um(OnComplete);                                           // 0x0004   (0x0010)  
