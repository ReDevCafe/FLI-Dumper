...
public:
	...
	// TArray<FString> GetDatasmithUserDataValuesForKey(class UObject* Object, FName Key, bool bPartialMatchKey);               // [0x87a0a80] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey
	// FString GetDatasmithUserDataValueForKey(class UObject* Object, FName Key, bool bPartialMatchKey);                        // [0x87a05b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue
	// void GetDatasmithUserDataKeysAndValuesForValue(class UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0x87a00e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	// class UDatasmithAssetUserData* GetDatasmithUserData(class UObject* Object);                                              // [0x87a0050] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void PlayLevelSequence(class ULevelSequence* SequenceToPlay);                                                            // [0x5032900] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(ADatasmithAreaLightActor) == 0x0308); // 776 bytes (0x000290 - 0x000308)
static_assert(sizeof(UDatasmithAreaLightActorTemplate) == 0x00C0); // 192 bytes (0x000030 - 0x0000C0)
...
static_assert(sizeof(UDatasmithDecalComponentTemplate) == 0x0058); // 88 bytes (0x000030 - 0x000058)
static_assert(sizeof(ADatasmithImportedSequencesActor) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
...
static_assert(sizeof(UDatasmithImportOptions) == 0x0090); // 144 bytes (0x000028 - 0x000090)
...
static_assert(sizeof(ADatasmithSceneActor) == 0x02E8); // 744 bytes (0x000290 - 0x0002E8)
static_assert(sizeof(UDatasmithSceneComponentTemplate) == 0x0120); // 288 bytes (0x000030 - 0x000120)
...
static_assert(sizeof(FDatasmithImportInfo) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(sizeof(FDatasmithRetessellationOptions) == 0x0014); // 20 bytes (0x000010 - 0x000014)
static_assert(offsetof(ADatasmithAreaLightActor, Mobility) == 0x0290);
static_assert(offsetof(ADatasmithAreaLightActor, LightType) == 0x0291);
static_assert(offsetof(ADatasmithAreaLightActor, LightShape) == 0x0292);
static_assert(offsetof(ADatasmithAreaLightActor, Dimensions) == 0x0298);
static_assert(offsetof(ADatasmithAreaLightActor, IntensityUnits) == 0x02AC);
static_assert(offsetof(ADatasmithAreaLightActor, Color) == 0x02B0);
static_assert(offsetof(ADatasmithAreaLightActor, IESTexture) == 0x02C8);
static_assert(offsetof(ADatasmithAreaLightActor, Rotation) == 0x02D8);
...
static_assert(offsetof(UDatasmithAreaLightActorTemplate, Dimensions) == 0x0038);
static_assert(offsetof(UDatasmithAreaLightActorTemplate, Color) == 0x0048);
static_assert(offsetof(UDatasmithAreaLightActorTemplate, IntensityUnits) == 0x005C);
static_assert(offsetof(UDatasmithAreaLightActorTemplate, IESTexture) == 0x0068);
static_assert(offsetof(UDatasmithAreaLightActorTemplate, Rotation) == 0x0098);
...
static_assert(offsetof(FDatasmithPostProcessSettingsTemplate, ColorSaturation) == 0x0010);
...
static_assert(offsetof(UDatasmithDecalComponentTemplate, DecalSize) == 0x0038);
static_assert(offsetof(UDatasmithDecalComponentTemplate, Material) == 0x0050);
static_assert(offsetof(ADatasmithImportedSequencesActor, ImportedSequences) == 0x0290);
...
static_assert(offsetof(UDatasmithImportOptions, SourceUri) == 0x0068);
...
static_assert(offsetof(ADatasmithSceneActor, Scene) == 0x0290);
static_assert(offsetof(UDatasmithSceneComponentTemplate, RelativeTransform) == 0x0030);
static_assert(offsetof(UDatasmithSceneComponentTemplate, Mobility) == 0x0090);
static_assert(offsetof(UDatasmithSceneComponentTemplate, AttachParent) == 0x0098);
