...
public:
	...
	// bool NotEqual_DataRegistryType(FDataRegistryType A, FDataRegistryType B);                                                // [0x54274a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.NotEqual_DataRegistryId
	// bool NotEqual_DataRegistryId(FDataRegistryId A, FDataRegistryId B);                                                      // [0x5ad2760] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.IsValidDataRegistryType
	// bool IsValidDataRegistryType(FDataRegistryType DataRegistryType);                                                        // [0x5426120] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.IsValidDataRegistryId
	// bool IsValidDataRegistryId(FDataRegistryId DataRegistryId);                                                              // [0x5abdb70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.GetCachedItemFromLookupBP
	// bool GetCachedItemFromLookupBP(FDataRegistryId ItemId, FDataRegistryLookup& ResolvedLookup, FTableRowBase& OutItem);     // [0x650e7a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.GetCachedItemBP
	// bool GetCachedItemBP(FDataRegistryId ItemId, FTableRowBase& OutItem);                                                    // [0x650e580] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.FindCachedItemBP
	// void FindCachedItemBP(FDataRegistryId ItemId, EDataRegistrySubsystemGetItemResult& OutResult, FTableRowBase& OutItem);   // [0x650e320] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EvaluateDataRegistryCurve
	// void EvaluateDataRegistryCurve(FDataRegistryId ItemId, float InputValue, float DefaultValue, EDataRegistrySubsystemGetItemResult& OutResult, float& OutValue); // [0x650e090] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EqualEqual_DataRegistryType
	// bool EqualEqual_DataRegistryType(FDataRegistryType A, FDataRegistryType B);                                              // [0x54249e0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.EqualEqual_DataRegistryId
	// bool EqualEqual_DataRegistryId(FDataRegistryId A, FDataRegistryId B);                                                    // [0x5aac660] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.Conv_DataRegistryTypeToString
	// FString Conv_DataRegistryTypeToString(FDataRegistryType DataRegistryType);                                               // [0x5425270] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.Conv_DataRegistryIdToString
	// FString Conv_DataRegistryIdToString(FDataRegistryId DataRegistryId);                                                     // [0x650df00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/DataRegistry.DataRegistrySubsystem.AcquireItemBP
	// bool AcquireItemBP(FDataRegistryId ItemId, FDelegateProperty AcquireCallback);                                           // [0x650de00] Final|Native|Static|Public|BlueprintCallable 
};
...
static_assert(sizeof(UDataRegistrySubsystem) == 0x00E0); // 224 bytes (0x000030 - 0x0000E0)
