...
static_assert(sizeof(FMovieSceneNiagaraCacheParams) == 0x0088); // 136 bytes (0x000020 - 0x000088)
static_assert(sizeof(UMovieSceneNiagaraCacheSection) == 0x0188); // 392 bytes (0x0000F8 - 0x000188)
static_assert(sizeof(UMovieSceneNiagaraCacheTrack) == 0x00C8); // 200 bytes (0x000098 - 0x0000C8)
static_assert(sizeof(FMovieSceneNiagaraSectionTemplateParameter) == 0x0098); // 152 bytes (0x000000 - 0x000098)
static_assert(sizeof(FMovieSceneNiagaraCacheSectionTemplate) == 0x0020); // 32 bytes (0x000010 - 0x000020)
static_assert(offsetof(FMovieSceneNiagaraCacheParams, CacheParameters) == 0x0020);
static_assert(offsetof(FMovieSceneNiagaraCacheParams, SimCache) == 0x0078);
static_assert(offsetof(FMovieSceneNiagaraCacheParams, RecordQualityLevel) == 0x0082);
static_assert(offsetof(FMovieSceneNiagaraCacheParams, CacheReplayPlayMode) == 0x0083);
static_assert(offsetof(FMovieSceneNiagaraCacheParams, SectionStretchMode) == 0x0084);
static_assert(offsetof(UMovieSceneNiagaraCacheSection, Params) == 0x00F8);
static_assert(offsetof(UMovieSceneNiagaraCacheTrack, AnimationSections) == 0x00B0);
static_assert(offsetof(FMovieSceneNiagaraSectionTemplateParameter, SectionRange) == 0x0000);
static_assert(offsetof(FMovieSceneNiagaraSectionTemplateParameter, Params) == 0x0010);
static_assert(offsetof(FMovieSceneNiagaraCacheSectionTemplate, CacheSections) == 0x0010);
