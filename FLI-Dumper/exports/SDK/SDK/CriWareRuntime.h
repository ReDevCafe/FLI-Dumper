...
public:
	...
	// void SetHandle(class UAtom3dRegionHandle* InHandle);                                                                     // [0x675cc20] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.Atom3dRegion.GetHandle
	// class UAtom3dRegionHandle* GetHandle();                                                                                  // [0x675cbf0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetRegion(class UAtom3dRegion* InRegion);                                                                           // [0x675d2b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetPriority(float NewPriority);                                                                                     // [0x675dac0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.SetEnabled
	// void SetEnabled(bool bNewEnabled);                                                                                       // [0x675da30] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.OnRep_bEnabled
	// void OnRep_bEnabled();                                                                                                   // [0x675da10] Final|Native|Private 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.GetPriority
	// float GetPriority();                                                                                                     // [0x675d9f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.GetEnabled
	// bool GetEnabled();                                                                                                       // [0x675d9c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.DestroySounds
	// void DestroySounds();                                                                                                    // [0x675d9a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAreaSoundVolume.CreateSounds
	// TArray<UAtomComponent*> CreateSounds(FVector listener_location);                                                         // [0x675d8b0] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetEffectBypass(FString BusName, FString EffectName, bool Bypasses);                                                // [0x675ed20] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.SetBusVolumeByName
	// void SetBusVolumeByName(FString BusName, float Volume);                                                                  // [0x675ebe0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.SetBusSendLevelByName
	// void SetBusSendLevelByName(FString SourceBusName, FString DestBusName, float Level);                                     // [0x675ea20] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.SetAisacControlByName
	// void SetAisacControlByName(FString control_name, float control_value);                                                   // [0x675e8e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.IsEnabledBinauralizer
	// bool IsEnabledBinauralizer();                                                                                            // [0x675e8b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.GetDefaultAsrRack
	// class UAtomAsrRack* GetDefaultAsrRack();                                                                                 // [0x675e880] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.GetCurrentAppliedSnapshot
	// FString GetCurrentAppliedSnapshot(int32_t AsrRackID);                                                                    // [0x675e7a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.GetBusAnalyzerInfo
	// bool GetBusAnalyzerInfo(FString DspBusName, int32_t& num_channels, TArray<float>& rms_levels, TArray<float>& peak_levels, TArray<float>& peak_hold_levels); // [0x675e530] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.GetAsrRack
	// class UAtomAsrRack* GetAsrRack(int32_t AsrRackID);                                                                       // [0x675e4a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.EnableBinauralizer
	// void EnableBinauralizer(bool bIsEnabled);                                                                                // [0x675e420] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.DetachDspBusSetting
	// void DetachDspBusSetting();                                                                                              // [0x675e400] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.ConnectToPadVibrator
	// void ConnectToPadVibrator(int32_t UserIndex);                                                                            // [0x675e370] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.ConnectToPadSpeaker
	// void ConnectToPadSpeaker(int32_t UserIndex);                                                                             // [0x675e2e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.AttachDspBusSetting
	// void AttachDspBusSetting(FString SettingName);                                                                           // [0x675e1f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.AssociateOutputPort
	// bool AssociateOutputPort(FString OutputPortName);                                                                        // [0x675e140] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAsrRack.ApplyDspBusSnapshot
	// void ApplyDspBusSnapshot(FString SnapshotName, int32_t Milliseconds);                                                    // [0x675e010] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetPriority(float NewPriority);                                                                                     // [0x67607b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomEntranceVolume.SetEnabled
	// void SetEnabled(bool bNewEnabled);                                                                                       // [0x67606a0] Final|Native|Public|BlueprintCallable 
...
public:
	...
	// void SetReverbSettings(FSnapshotSwitchSettings& NewReverbSettings);                                                      // [0x6760830] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAudioVolume.SetPriority
	// void SetPriority(float NewPriority);                                                                                     // [0x6760730] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomAudioVolume.SetEnabled
	// void SetEnabled(bool bNewEnabled);                                                                                       // [0x6760610] Final|Native|Public|BlueprintCallable 
	...
	// void EnableAllAudioVolume(bool bEnable);                                                                                 // [0x6760590] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void StopRecordedSoundWithoutReleaseTime();                                                                              // [0x67611e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.StopRecordedSound
	// void StopRecordedSound();                                                                                                // [0x67611c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.StartRecording
	// void StartRecording(float InExpectedDuration, int32_t InAsrRack, FString InBusName, bool BusOutput);                     // [0x6761010] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.ResumeRecording
	// void ResumeRecording();                                                                                                  // [0x6760ff0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.PlayRecordedSound
	// void PlayRecordedSound(int32_t Milliseconds);                                                                            // [0x6760f60] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.PauseRecording
	// void PauseRecording();                                                                                                   // [0x6760f40] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.PauseRecordedSound
	// void PauseRecordedSound(bool bPause);                                                                                    // [0x6760eb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.OnRecordingStarted__DelegateSignature
	// void OnRecordingStarted__DelegateSignature();                                                                            // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomBusSampler.OnRecordingFinished__DelegateSignature
	// void OnRecordingFinished__DelegateSignature();                                                                           // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomBusSampler.IsRecording
	// bool IsRecording();                                                                                                      // [0x6760e80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomBusSampler.IsPlayingRecordedSound
	// bool IsPlayingRecordedSound();                                                                                           // [0x6760e50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomBusSampler.IsPausedRecordedSound
	// bool IsPausedRecordedSound();                                                                                            // [0x6760e20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomBusSampler.FinishRecording
	// void FinishRecording();                                                                                                  // [0x6760e00] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomBusSampler.CanRecord
	// bool CanRecord();                                                                                                        // [0x6760dd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomBusSampler.CanPlayRecordedSound
	// bool CanPlayRecordedSound();                                                                                             // [0x6760da0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void NativeBreakAtomSequenceInfo(FAtomSequenceInfo& SequenceInfo, float& Time, FString& TagName, EAtomSequenceEventType& EventType, int32_t& CallbackID); // [0x6761a30] Final|Native|Static|Private|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/CriWareRuntime.AtomCallbackManager.NativeBreakAtomBeatSyncInfo
	// void NativeBreakAtomBeatSyncInfo(FAtomBeatSyncInfo& BeatSyncInfo, int32_t& BarCnt, int32_t& BeatCnt, float& BeatProgress, float& Bpm, int32_t& Offset, int32_t& NumBeats); // [0x67617a0] Final|Native|Static|Private|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void StopByName(FString CategoryName);                                                                                   // [0x67630e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.SetVolumeByName
	// void SetVolumeByName(FString CategoryName, float Volume);                                                                // [0x6762fb0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.SetMute
	// void SetMute(FString CategoryName, bool IsMute);                                                                         // [0x6762e80] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.SetAisacControlByName
	// void SetAisacControlByName(FString CategoryName, FString AisacName, float Value);                                        // [0x6762cd0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.ResetAllAisacControlByName
	// bool ResetAllAisacControlByName(FString CategoryName);                                                                   // [0x6762be0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.ResetAllAisacControlById
	// bool ResetAllAisacControlById(int32_t categoryID);                                                                       // [0x6762b50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.PauseByName
	// void PauseByName(FString CategoryName, bool bPause);                                                                     // [0x6762a20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.IsPausedByName
	// bool IsPausedByName(FString CategoryName);                                                                               // [0x6762930] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetVolumeByName
	// float GetVolumeByName(FString CategoryName);                                                                             // [0x6762840] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetNumAttachedAisacsByName
	// int32_t GetNumAttachedAisacsByName(FString CategoryName);                                                                // [0x6762750] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetNumAttachedAisacsById
	// int32_t GetNumAttachedAisacsById(int32_t categoryID);                                                                    // [0x67626c0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetCurrentAisacControlValueByName
	// float GetCurrentAisacControlValueByName(FString CategoryName, FString AisacControlName);                                 // [0x6762540] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetCurrentAisacControlValueById
	// float GetCurrentAisacControlValueById(int32_t categoryID, int32_t AisacControlID);                                       // [0x6762470] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetAttachedAisacInfoByName
	// void GetAttachedAisacInfoByName(FString CategoryName, int32_t AisacAttachedIndex, bool& isSuccess, FAtomAisacInfo& AisacInfo); // [0x6762270] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCategory.GetAttachedAisacInfoById
	// void GetAttachedAisacInfoById(int32_t categoryID, int32_t AisacAttachedIndex, bool& isSuccess, FAtomAisacInfo& AisacInfo); // [0x67620e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void StopWithoutReleaseTime();                                                                                           // [0x6768780] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.Stop
	// void Stop();                                                                                                             // [0x6768760] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetVolume
	// void SetVolume(float Volume);                                                                                            // [0x67686e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetSoundObject
	// void SetSoundObject(class UAtomSoundObject* InSoundObject);                                                              // [0x6768650] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetSound
	// void SetSound(class USoundAtomCue* NewSound);                                                                            // [0x67685c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetSelectorLabel
	// void SetSelectorLabel(FString Selector, FString Label);                                                                  // [0x6768440] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetRegion
	// void SetRegion(class UAtom3dRegion* InRegion);                                                                           // [0x67683b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetPreferredOutputPort
	// void SetPreferredOutputPort(FString port_name);                                                                          // [0x67682c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetPitchMultiplier
	// void SetPitchMultiplier(float NewPitchMultiplier);                                                                       // [0x6768240] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetPitch
	// void SetPitch(float Pitch);                                                                                              // [0x67681c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetOutputPort
	// void SetOutputPort(FString port_name);                                                                                   // [0x67680d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetNextBlockIndex
	// void SetNextBlockIndex(int32_t BlockIndex);                                                                              // [0x6768040] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetDefaultAttenuationEnable
	// void SetDefaultAttenuationEnable(bool bEnable);                                                                          // [0x6767fd0] Final|Native|Static|Public 
	// Function /Script/CriWareRuntime.AtomComponent.SetBusSendLevelOffsetByName
	// void SetBusSendLevelOffsetByName(FString BusName, float LevelOffset);                                                    // [0x6767e90] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetBusSendLevelOffset
	// void SetBusSendLevelOffset(int32_t BusId, float LevelOffset);                                                            // [0x6767dc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetBusSendLevelByName
	// void SetBusSendLevelByName(FString BusName, float Level);                                                                // [0x6767c80] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetBusSendLevel
	// void SetBusSendLevel(int32_t BusId, float Level);                                                                        // [0x6767bb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetAsrRackIdArray
	// void SetAsrRackIdArray(TArray<int32_t> AsrRackIDs);                                                                      // [0x6767ac0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetAsrRackID
	// void SetAsrRackID(int32_t asr_rack_id);                                                                                  // [0x6767a30] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.SetAisacByName
	// void SetAisacByName(FString ControlName, float ControlValue);                                                            // [0x67678f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.RemovePreferredOutputPort
	// void RemovePreferredOutputPort(FString port_name);                                                                       // [0x6767800] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.RemoveOutputPort
	// void RemoveOutputPort(FString port_name);                                                                                // [0x6767710] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.Play
	// void Play(float StartTime);                                                                                              // [0x6767690] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.Pause
	// void Pause(bool bPause);                                                                                                 // [0x6767600] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.OnStatusChanged__DelegateSignature
	// void OnStatusChanged__DelegateSignature(EAtomComponentStatus Status, class UAtomComponent* AtomComponent);               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomComponent.OnAudioVolumeChanged__DelegateSignature
	// void OnAudioVolumeChanged__DelegateSignature(EAtomAudioVolumeType Type, class AAtomAudioVolume* AtomAudioVolume, bool bIsCalledFromTick); // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomComponent.OnAudioFinished__DelegateSignature
	// void OnAudioFinished__DelegateSignature();                                                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomComponent.OnAtomSoundCueBlockIndexChanged__DelegateSignature
	// void OnAtomSoundCueBlockIndexChanged__DelegateSignature(int32_t BlockIndex);                                             // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomComponent.IsReducingTickFrequency
	// bool IsReducingTickFrequency();                                                                                          // [0x6767540] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x67675d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.IsPaused
	// bool IsPaused();                                                                                                         // [0x67675a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.IsLoop
	// bool IsLoop();                                                                                                           // [0x6767570] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.HasBeenEconomicTick
	// bool HasBeenEconomicTick();                                                                                              // [0x6767540] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetVolume
	// float GetVolume();                                                                                                       // [0x6767510] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.GetVelocity
	// FVector GetVelocity();                                                                                                   // [0x67674e0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetTime
	// float GetTime();                                                                                                         // [0x67674b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetStatus
	// EAtomComponentStatus GetStatus();                                                                                        // [0x6767480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetSequencePosition
	// float GetSequencePosition();                                                                                             // [0x6767450] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetNumQueuedSounds
	// int32_t GetNumQueuedSounds();                                                                                            // [0x6767420] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetNumPlayedSamples
	// void GetNumPlayedSamples(int64_t& NumSamples, int32_t& SamplingRate);                                                    // [0x6767330] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetMaxAttenuationDistance
	// float GetMaxAttenuationDistance();                                                                                       // [0x6767300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetEconomicTickFrequency
	// float GetEconomicTickFrequency();                                                                                        // [0x6767250] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetEconomicTickDistanceMargin
	// float GetEconomicTickDistanceMargin();                                                                                   // [0x6767280] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetEconomicTickDistance
	// float GetEconomicTickDistance();                                                                                         // [0x6767220] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetDefaultAttenuationEnable
	// bool GetDefaultAttenuationEnable();                                                                                      // [0x67672e0] Final|Native|Static|Public 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentMaxAttenuationDistance
	// float GetCurrentMaxAttenuationDistance();                                                                                // [0x67672b0] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentEconomicTickMarginDistance
	// float GetCurrentEconomicTickMarginDistance();                                                                            // [0x6767280] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentEconomicTickFrequency
	// float GetCurrentEconomicTickFrequency();                                                                                 // [0x6767250] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentEconomicTickBoundaryDistance
	// float GetCurrentEconomicTickBoundaryDistance();                                                                          // [0x6767220] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentCullingMarginDistance
	// float GetCurrentCullingMarginDistance();                                                                                 // [0x67670f0] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentCullingBoundaryDistance
	// float GetCurrentCullingBoundaryDistance();                                                                               // [0x67670c0] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentBlockIndex
	// int32_t GetCurrentBlockIndex();                                                                                          // [0x67671f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCurrentBelongingAudioVolume
	// class AAtomAudioVolume* GetCurrentBelongingAudioVolume(EAtomAudioVolumeType Type, bool IsNeighbor);                      // [0x6767120] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCullDistanceMargin
	// float GetCullDistanceMargin();                                                                                           // [0x67670f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCullDistance
	// float GetCullDistance();                                                                                                 // [0x67670c0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetCueName
	// FString GetCueName();                                                                                                    // [0x6766ff0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetAudioVolumeValueMap
	// TMap<FString, float> GetAudioVolumeValueMap(EAtomAudioVolumeType Type);                                                  // [0x6766eb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.GetAtomComponentID
	// int32_t GetAtomComponentID();                                                                                            // [0x6766e90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomComponent.GetAtomComponentFromID
	// class UAtomComponent* GetAtomComponentFromID(int32_t TargetID);                                                          // [0x6766e00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.GetAtomAppliedValueParam
	// FAtomAppliedValueParam GetAtomAppliedValueParam();                                                                       // [0x6766da0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.FadeOut
	// void FadeOut(float FadeOutDuration);                                                                                     // [0x6766d20] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.FadeIn
	// void FadeIn(float FadeInDuration, float FadeVolumeLevel, float StartTime);                                               // [0x6766c00] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.EnqueueSound
	// void EnqueueSound(class USoundAtomCue* NewSound);                                                                        // [0x6766b70] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.DestroyComponentByID
	// void DestroyComponentByID(int32_t TargetID);                                                                             // [0x6766af0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.ClearSelectorLabels
	// void ClearSelectorLabels();                                                                                              // [0x6766ad0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.ClearPreferredOutputPort
	// void ClearPreferredOutputPort();                                                                                         // [0x6766ab0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.ClearOutputPort
	// void ClearOutputPort();                                                                                                  // [0x6766a90] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.BP_GetAttenuationSettingsToApply
	// bool BP_GetAttenuationSettingsToApply(FSoundAttenuationSettings& OutAttenuationSettings);                                // [0x67669c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.AttachAreaSoundVolume
	// void AttachAreaSoundVolume(class AAtomAreaSoundVolume* sound_shape_volume);                                              // [0x6766930] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomComponent.AtomSequenceCallbackDelegate__DelegateSignature
	// void AtomSequenceCallbackDelegate__DelegateSignature(class UAtomComponent* AtomComponent, FAtomSequenceInfo& SequenceInfo); // [0x3618b30] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/CriWareRuntime.AtomComponent.AtomBeatSyncCallbackDelegate__DelegateSignature
	// void AtomBeatSyncCallbackDelegate__DelegateSignature(class UAtomComponent* AtomComponent, FAtomBeatSyncInfo& BeatSyncInfo); // [0x3618b30] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/CriWareRuntime.AtomComponent.AdjustAttenuation
	// void AdjustAttenuation(FSoundAttenuationSettings& InAttenuationSettings);                                                // [0x6766860] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void OnLoadError__DelegateSignature();                                                                                   // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.OnLoadCompleted__DelegateSignature
	// void OnLoadCompleted__DelegateSignature();                                                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.OnAtomCueSheetLoaded__DelegateSignature
	// void OnAtomCueSheetLoaded__DelegateSignature(class USoundAtomCueSheet* Loaded);                                          // [0x3618b30] Public|Delegate      
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.LoadAtomCueSheet
	// void LoadAtomCueSheet(class UObject* WorldContextObject, TWeakObjectPtr<USoundAtomCueSheet*> Asset, FDelegateProperty OnLoaded, FLatentActionInfo LatentInfo); // [0x6768e20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.Load
	// void Load();                                                                                                             // [0x6768e00] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.GetStatus
	// EAtomCueSheetLoaderComponentStatus GetStatus();                                                                          // [0x6768de0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomCueSheetLoaderComponent.GetAtomCueSheet
	// class USoundAtomCueSheet* GetAtomCueSheet();                                                                             // [0x6768db0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnDeviceUpdated__DelegateSignature();                                                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.AtomDeviceWatcher.GetDeviceName
	// FString GetDeviceName();                                                                                                 // [0x676bc00] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomDeviceWatcher.GetDeviceChannelCount
	// int32_t GetDeviceChannelCount();                                                                                         // [0x676bbd0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// TArray<FAtomProfileItem> CriWareAdx2ProfileDataUpdate(class UObject* WorldContextObject);                                // [0x676cb90] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomProfileData.CriWareAdx2ProfileDataSort
	// void CriWareAdx2ProfileDataSort(TArray<FAtomProfileItem> original_item, EAtomProfileSortType sort_type, EAtomSortOrderType order_type, TArray<FAtomProfileItem>& sorted_item); // [0x676c940] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void GetLevelsDB(float display_range, TArray<float>& spectra);                                                           // [0x676d630] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomSpectrumAnalyzer.GetLevels
	// void GetLevels(TArray<float>& spectra);                                                                                  // [0x676d590] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomSpectrumAnalyzer.DestroyDspSpectra
	// void DestroyDspSpectra();                                                                                                // [0x676d570] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomSpectrumAnalyzer.CreateDspSpectra
	// void CreateDspSpectra(class UAtomAsrRack* asr_rack, FString bus_name, int32_t num_bands);                                // [0x676d410] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UAtomComponent* SpawnSound2D(class UObject* WorldContextObject, class USoundAtomCue* sound, float PitchMultiplier, float StartTime, bool bPersistAcrossLevelTransition, bool bAutoDestroy); // [0x6771350] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSoundAttachedByName
	// class UAtomComponent* SpawnAtomSoundAttachedByName(class USoundAtomCueSheet* CueSheet, FString CueName, class USceneComponent* AttachToComponent, FAtomComponentParams& Params, FName AttachPointName, FVector Location, TEnumAsByte<EAttachLocation> LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoDestroy); // [0x6770f50] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSoundAttached
	// class UAtomComponent* SpawnAtomSoundAttached(class USoundAtomCue* sound, class USceneComponent* AttachToComponent, FAtomComponentParams& Params, FName AttachPointName, FVector Location, TEnumAsByte<EAttachLocation> LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoDestroy); // [0x6770c40] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSoundAtLocationByName
	// class UAtomComponent* SpawnAtomSoundAtLocationByName(class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, FString CueName, FVector Location, FAtomComponentParams& Params, bool bAutoDestroy); // [0x6770950] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSoundAtLocation
	// class UAtomComponent* SpawnAtomSoundAtLocation(class UObject* WorldContextObject, class USoundAtomCue* sound, FVector Location, FAtomComponentParams& Params, bool bAutoDestroy); // [0x6770720] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSound2DByName
	// class UAtomComponent* SpawnAtomSound2DByName(class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, FString CueName, FAtomComponentParams& Params, bool bPersistAcrossLevelTransition, bool bAutoDestroy); // [0x6770450] Final|BlueprintCosmetic|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SpawnAtomSound2D
	// class UAtomComponent* SpawnAtomSound2D(class UObject* WorldContextObject, class USoundAtomCue* sound, FAtomComponentParams& Params, bool bPersistAcrossLevelTransition, bool bAutoDestroy); // [0x6770220] Final|BlueprintCosmetic|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerRegion
	// void SetListenerRegion(class UAtom3dRegion* Region, int32_t playerIndex);                                                // [0x6770160] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerFocusPointTargetComponent
	// void SetListenerFocusPointTargetComponent(class USceneComponent* TargetComponent, int32_t playerIndex);                  // [0x67700a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerFocusPointTargetActor
	// void SetListenerFocusPointTargetActor(class AActor* TargetActor, int32_t playerIndex);                                   // [0x676ffe0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerFocusPointInfo
	// void SetListenerFocusPointInfo(FAtomListenerFocusPointInfo FocusPointInfo, int32_t playerIndex);                         // [0x676fef0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerFocusPointDistanceLevel
	// void SetListenerFocusPointDistanceLevel(float DistanceLevel, int32_t playerIndex);                                       // [0x676fe30] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetListenerFocusPointDirectionLevel
	// void SetListenerFocusPointDirectionLevel(float DirectionLevel, int32_t playerIndex);                                     // [0x676fd70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.SetAtomGameVariable
	// void SetAtomGameVariable(FString GameVariableName, float Value);                                                         // [0x676fbd0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlaySoundForAnimNotify
	// class UAtomComponent* PlaySoundForAnimNotify(class USoundAtomCue* sound, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, bool bStopWhenAttachedToDestroyed, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings, bool bFollow); // [0x676f8d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlaySoundAttached
	// class UAtomComponent* PlaySoundAttached(class USoundAtomCue* sound, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, bool bStopWhenAttachedToDestroyed, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings); // [0x676f620] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlaySoundAtLocation
	// void PlaySoundAtLocation(class UObject* WorldContextObject, class USoundAtomCue* sound, FVector Location, FRotator Rotation, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings, class USoundConcurrency* ConcurrencySettings); // [0x676f360] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlayAtomSoundForAnimNotify
	// class UAtomComponent* PlayAtomSoundForAnimNotify(class USoundAtomCue* sound, FAtomComponentParams& Params, class USceneComponent* AttachToComponent, FName AttachPointName, FVector Location, bool bStopWhenAttachedToDestroyed, float VolumeMultiplier, float PitchMultiplier, float StartTime, class USoundAttenuation* AttenuationSettings, bool bFollow); // [0x676ef70] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlayAtomSoundAtLocationByName
	// void PlayAtomSoundAtLocationByName(class UObject* WorldContextObject, class USoundAtomCueSheet* CueSheet, FString CueName, FVector Location, FAtomComponentParams& Params); // [0x676ecd0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PlayAtomSoundAtLocation
	// void PlayAtomSoundAtLocation(class UObject* WorldContextObject, class USoundAtomCue* sound, FVector Location, FAtomComponentParams& Params); // [0x676eaf0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.PauseAudioOutput
	// void PauseAudioOutput(bool bPause);                                                                                      // [0x676ea70] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.LoadAtomConfig
	// bool LoadAtomConfig(class USoundAtomConfig* AcfObject);                                                                  // [0x676e9e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.GetListeningPoint
	// FVector GetListeningPoint(int32_t playerIndex);                                                                          // [0x676e940] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/CriWareRuntime.AtomStatics.GetListenerRegion
	// class UAtom3dRegion* GetListenerRegion(int32_t playerIndex);                                                             // [0x676e8b0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.GetListenerFocusPointInfo
	// FAtomListenerFocusPointInfo GetListenerFocusPointInfo(int32_t playerIndex);                                              // [0x676e810] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/CriWareRuntime.AtomStatics.GetAudioVolumeAffectingListener
	// class AAtomAudioVolume* GetAudioVolumeAffectingListener(int32_t playerIndex, EAtomAudioVolumeType TypeNum);              // [0x676e740] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/CriWareRuntime.AtomStatics.GetAtomGameVariable
	// float GetAtomGameVariable(FString GameVariableName);                                                                     // [0x676e5e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.CreateRootedAtomComponent
	// class UAtomComponent* CreateRootedAtomComponent(class UObject* WorldContextObject, bool bAutoDestroy);                   // [0x676e510] Final|BlueprintCosmetic|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomStatics.AddToAtomComponentIds
	// void AddToAtomComponentIds(class UObject* AtomPlayGateRef, class UObject* SkeltalMeshComponentRef, int32_t AtomComponentID); // [0x676e410] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool GetDataTableRowFromName(class UDataTable* Table, FName RowName, FAtomTriggerRow& OutRow);                           // [0x6771fa0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void StopDelayed(float delayTime);                                                                                       // [0x6772d70] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.Stop
	// void Stop();                                                                                                             // [0x6772d50] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.SetWave
	// void SetWave(class USoundAtomCue* InCue);                                                                                // [0x6772cc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.SetPaused
	// void SetPaused(bool bPause);                                                                                             // [0x6772c30] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.SetLooping
	// bool SetLooping(bool Looping);                                                                                           // [0x6772bb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.Play
	// void Play(float StartTime);                                                                                              // [0x6772b30] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.AtomWavePlayer.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x6772b00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.IsPaused
	// bool IsPaused();                                                                                                         // [0x6772ad0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.IsLooping
	// bool IsLooping();                                                                                                        // [0x6772aa0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.HasError
	// bool HasError();                                                                                                         // [0x6772a70] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.GetWaveInfo
	// FAtomWaveInfo GetWaveInfo();                                                                                             // [0x6772a40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.GetTime
	// FTimespan GetTime();                                                                                                     // [0x6772a20] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.GetPlayState
	// EAtomWavePlayState GetPlayState();                                                                                       // [0x67729f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.GetCue
	// class USoundAtomCue* GetCue();                                                                                           // [0x67729d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.AtomWavePlayer.AdjustVolume
	// void AdjustVolume(float AdjustVolumeDuration, float AdjustVolumeLevel);                                                  // [0x6772900] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void Stop();                                                                                                             // [0x6773190] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriFsBinderComponent.OnBindError__DelegateSignature
	// void OnBindError__DelegateSignature();                                                                                   // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.CriFsBinderComponent.OnBindCompleted__DelegateSignature
	// void OnBindCompleted__DelegateSignature();                                                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.CriFsBinderComponent.GetStatus
	// ECriFsBinderStatus GetStatus();                                                                                          // [0x6773160] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriFsBinderComponent.Bind
	// void Bind();                                                                                                             // [0x6773140] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void Load();                                                                                                             // [0x6773730] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriFsLoaderComponent.GetStatus
	// ECriFsLoaderStatus GetStatus();                                                                                          // [0x6773700] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriFsLoaderComponent.GetDataArray
	// TArray<char> GetDataArray();                                                                                             // [0x6773670] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void OnCriWareError__DelegateSignature(FCriWareErrorInfo& ErrorInfo);                                                    // [0x3618b30] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/CriWareRuntime.CriWareError.GetCriWareError
	// class UCriWareError* GetCriWareError();                                                                                  // [0x6773db0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// void SetSpeakerAngleArray(ECriWareSpeakerSystem SpeakerSystem, TArray<float>& Angles);                                   // [0x6774380] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriWareFunctionLibrary.SetGlobalLabelToSelectorByName
	// void SetGlobalLabelToSelectorByName(FString SelectorName, FString LabelName);                                            // [0x6774210] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriWareFunctionLibrary.SetGameVariableByName
	// void SetGameVariableByName(FString GameVariableName, float Value);                                                       // [0x67740e0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.CriWareFunctionLibrary.SearchAtomCuesInAssetRegistry
	// TArray<USoundAtomCue*> SearchAtomCuesInAssetRegistry(class USoundAtomCueSheet* CueSheet);                                // [0x6774010] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool ToIndex(int32_t Index);                                                                                             // [0x6777490] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Stop
	// void Stop();                                                                                                             // [0x6777470] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetVolume
	// void SetVolume(float Volume);                                                                                            // [0x67773f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetTexture
	// void SetTexture(class UManaTexture* Texture);                                                                            // [0x6777360] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetSubVolume
	// void SetSubVolume(float Volume);                                                                                         // [0x67772e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetSubAudioTrack
	// void SetSubAudioTrack(int32_t Track);                                                                                    // [0x6777250] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetSubAudioSendLevel
	// void SetSubAudioSendLevel(int32_t Channel, EAtomSpeakerID SpeakerId, float Volume);                                      // [0x6777140] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetSubAudioCategory
	// void SetSubAudioCategory(FString CategoryName);                                                                          // [0x67770a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetPlaybackTimer
	// void SetPlaybackTimer(EManaPlaybackTimer InPlaybackTimer);                                                               // [0x6777020] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetMovie
	// void SetMovie(class UManaMovie* InMovie);                                                                                // [0x6776f90] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetMaxDropFrames
	// void SetMaxDropFrames(EManaMaxFrameDrop InMaxDropFrames);                                                                // [0x6776f10] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetFile
	// void SetFile(FString MovieFilePath);                                                                                     // [0x6776e70] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetExtraVolume
	// void SetExtraVolume(float Volume);                                                                                       // [0x6776df0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetExtraAudioTrack
	// void SetExtraAudioTrack(int32_t Track);                                                                                  // [0x6776d60] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetExtraAudioCategory
	// void SetExtraAudioCategory(FString CategoryName);                                                                        // [0x6776cc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetEndFrameAction
	// void SetEndFrameAction(EManaFrameAction InFrameAction);                                                                  // [0x6776c40] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetAudioTrack
	// void SetAudioTrack(int32_t Track);                                                                                       // [0x6776bb0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetAudioCategory
	// void SetAudioCategory(FString CategoryName);                                                                             // [0x6776b10] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SetAlphaTrack
	// void SetAlphaTrack(int32_t Track);                                                                                       // [0x6776a80] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.SeekToPosition
	// void SeekToPosition(int32_t FrameNumber);                                                                                // [0x67769f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Seek
	// void Seek(FTimespan Time);                                                                                               // [0x6776960] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.RemoveSubAudioCategory
	// void RemoveSubAudioCategory();                                                                                           // [0x6776940] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.RemoveExtraAudioCategory
	// void RemoveExtraAudioCategory();                                                                                         // [0x6776920] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.RemoveAudioCategory
	// void RemoveAudioCategory();                                                                                              // [0x6776900] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Previous
	// bool Previous();                                                                                                         // [0x67768d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.PreparePlaylistIndex
	// void PreparePlaylistIndex(int32_t Index);                                                                                // [0x6776840] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Prepare
	// void Prepare();                                                                                                          // [0x6776820] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Play
	// void Play();                                                                                                             // [0x6776800] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Pause
	// void Pause(bool bPause);                                                                                                 // [0x6776770] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.OnTrackChanged__DelegateSignature
	// void OnTrackChanged__DelegateSignature(int32_t TrackNumber, class UManaComponent* ManaComponent);                        // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnSubtitleChanged__DelegateSignature
	// void OnSubtitleChanged__DelegateSignature(FText Subtitle);                                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnStatusChanged__DelegateSignature
	// void OnStatusChanged__DelegateSignature(EManaComponentStatus Status, class UManaComponent* ManaComponent);               // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnSeekCompleted__DelegateSignature
	// void OnSeekCompleted__DelegateSignature(int32_t FrameNumber, class UManaComponent* ManaComponent);                       // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnRequestData__DelegateSignature
	// void OnRequestData__DelegateSignature(class UManaComponent* ManaComponent);                                              // [0x3618b30] Public|Delegate      
	// Function /Script/CriWareRuntime.ManaComponent.OnPlayerDestroyed__DelegateSignature
	// void OnPlayerDestroyed__DelegateSignature(class UManaComponent* ManaComponent);                                          // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnMovieChanged__DelegateSignature
	// void OnMovieChanged__DelegateSignature(class UManaMovie* Movie, class UManaComponent* ManaComponent);                    // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnFrameOnTime__DelegateSignature
	// void OnFrameOnTime__DelegateSignature(int32_t FrameNumber, class UManaComponent* ManaComponent);                         // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.OnEventPoint__DelegateSignature
	// void OnEventPoint__DelegateSignature(FManaEventPointInfo EventPointInfo);                                                // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.ManaComponent.Next
	// bool Next();                                                                                                             // [0x6776740] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.Loop
	// void Loop(bool bInLoop);                                                                                                 // [0x67766b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.IsReady
	// bool IsReady();                                                                                                          // [0x6776680] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.IsPreparing
	// bool IsPreparing();                                                                                                      // [0x6776650] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x6776620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.IsPaused
	// bool IsPaused();                                                                                                         // [0x67765f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.IsLooping
	// bool IsLooping();                                                                                                        // [0x67765d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetVolume
	// float GetVolume();                                                                                                       // [0x67765a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetTime
	// FTimespan GetTime();                                                                                                     // [0x6776560] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetTexture
	// class UManaTexture* GetTexture();                                                                                        // [0x6776530] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetSubVolume
	// float GetSubVolume();                                                                                                    // [0x6776500] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetStatus
	// EManaComponentStatus GetStatus();                                                                                        // [0x67764d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetSource
	// class UManaMovie* GetSource();                                                                                           // [0x67764a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetPosition
	// int32_t GetPosition();                                                                                                   // [0x6776470] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetMovieTime
	// FTimespan GetMovieTime();                                                                                                // [0x6776430] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetFrameNumber
	// int32_t GetFrameNumber();                                                                                                // [0x6776400] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.GetExtraVolume
	// float GetExtraVolume();                                                                                                  // [0x67763d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaComponent.EnableSubtitles
	// void EnableSubtitles(bool bEnable);                                                                                      // [0x6776340] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.EnableSeamless
	// void EnableSeamless(bool bEnable);                                                                                       // [0x67762b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.ChangeSubtitlesEncoding
	// void ChangeSubtitlesEncoding(EManaSubtitlesEncoding Encoding);                                                           // [0x6776230] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.ChangeSubtitlesChannel
	// void ChangeSubtitlesChannel(int32_t Channel);                                                                            // [0x67761a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaComponent.AdvanceTime
	// void AdvanceTime(FTimespan DeltaTime);                                                                                   // [0x6776110] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// bool Validate();                                                                                                         // [0x6778af0] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaMovie.GetUrl
	// FString GetUrl();                                                                                                        // [0x6778920] Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetFilePath(FString Path);                                                                                          // [0x6778a50] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetDataArray(TArray<char>& InDataArray);                                                                            // [0x67789a0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.DataManaMovie.GetDataArray
	// TArray<char> GetDataArray();                                                                                             // [0x6778890] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool SetVolume(float Volume, EManaPlayerTrack TrackType);                                                                // [0x677b640] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SetTrackFormat
	// bool SetTrackFormat(EManaPlayerTrack TrackType, int32_t TrackIndex, int32_t FormatIndex);                                // [0x677b530] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SetTimeSyncedSource
	// void SetTimeSyncedSource(class UAtomComponent* SyncedSource);                                                            // [0x677b4a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SetTexture
	// void SetTexture(class UManaTexture* InManaTexture);                                                                      // [0x677b410] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SetRate
	// bool SetRate(float Rate);                                                                                                // [0x677b390] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SetLooping
	// bool SetLooping(bool Looping);                                                                                           // [0x677b2f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.SelectTrack
	// bool SelectTrack(EManaPlayerTrack TrackType, int32_t TrackIndex);                                                        // [0x677b220] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Seek
	// bool Seek(FTimespan Time);                                                                                               // [0x677b180] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Rewind
	// bool Rewind();                                                                                                           // [0x677b150] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Reopen
	// bool Reopen();                                                                                                           // [0x677b120] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Previous
	// bool Previous();                                                                                                         // [0x677b0e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.PlayAndSeek
	// void PlayAndSeek();                                                                                                      // [0x677b0c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Play
	// bool Play();                                                                                                             // [0x677b090] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Pause
	// bool Pause();                                                                                                            // [0x677b060] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.OpenSourceWithOptions
	// bool OpenSourceWithOptions(class UManaSource* ManaSource, FManaPlayerOptions& PlayerOptions);                            // [0x677af50] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.OpenPlaylistIndex
	// bool OpenPlaylistIndex(class UManaPlaylist* InPlaylist, int32_t Index);                                                  // [0x677ae80] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.OpenPlaylist
	// bool OpenPlaylist(class UManaPlaylist* InPlaylist);                                                                      // [0x677ade0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.OpenMovieSource
	// void OpenMovieSource(class UManaMovie* InManaMovie);                                                                     // [0x677ad50] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.OnFrameUpdatedDelegate__DelegateSignature
	// void OnFrameUpdatedDelegate__DelegateSignature(int32_t FrameNumber);                                                     // [0x3618b30] Public|Delegate      
	// Function /Script/CriWareRuntime.ManaPlayer.Next
	// bool Next();                                                                                                             // [0x677ad10] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.IsSeeking
	// bool IsSeeking();                                                                                                        // [0x677acf0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsReady
	// bool IsReady();                                                                                                          // [0x677aca0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsPreparing
	// bool IsPreparing();                                                                                                      // [0x677ac50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsPlaying
	// bool IsPlaying();                                                                                                        // [0x677abe0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsPaused
	// bool IsPaused();                                                                                                         // [0x677ab90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsLooping
	// bool IsLooping();                                                                                                        // [0x677ab60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.IsClosed
	// bool IsClosed();                                                                                                         // [0x677ab30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.HasError
	// bool HasError();                                                                                                         // [0x677aad0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentSubtitleChanged
	// void HandleManaComponentSubtitleChanged(FText Subtitle);                                                                 // [0x677aa20] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentStatusChanged
	// void HandleManaComponentStatusChanged(EManaComponentStatus Status, class UManaComponent* InManaComponent);               // [0x677a950] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentSeekCompleted
	// void HandleManaComponentSeekCompleted(int32_t InFrameNumber, class UManaComponent* InManaComponent);                     // [0x677a880] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentPlayerDestroyed
	// void HandleManaComponentPlayerDestroyed(class UManaComponent* InManaComponent);                                          // [0x677a7f0] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentMovieChanged
	// void HandleManaComponentMovieChanged(class UManaMovie* InManaMovie, class UManaComponent* InManaComponent);              // [0x677a720] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentFrameOnTime
	// void HandleManaComponentFrameOnTime(int32_t InFrameNumber, class UManaComponent* InManaComponent);                       // [0x677a650] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.HandleManaComponentEventPoint
	// void HandleManaComponentEventPoint(FManaEventPointInfo EventPointInfo);                                                  // [0x677a550] Final|Native|Private 
	// Function /Script/CriWareRuntime.ManaPlayer.GetVolume
	// float GetVolume(EManaPlayerTrack TrackType);                                                                             // [0x677a4c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTrackLanguage
	// FString GetTrackLanguage(EManaPlayerTrack TrackType, int32_t TrackIndex);                                                // [0x677a3b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTrackFormat
	// int32_t GetTrackFormat(EManaPlayerTrack TrackType, int32_t TrackIndex);                                                  // [0x677a2e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTrackDisplayName
	// FText GetTrackDisplayName(EManaPlayerTrack TrackType, int32_t TrackIndex);                                               // [0x677a1f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTimeSyncedSource
	// class UAtomComponent* GetTimeSyncedSource();                                                                             // [0x677a1b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTime
	// FTimespan GetTime();                                                                                                     // [0x677a170] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetTexture
	// class UManaTexture* GetTexture();                                                                                        // [0x677a150] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetSubtitleTrackEncoding
	// EManaSubtitlesEncoding GetSubtitleTrackEncoding(int32_t TrackIndex);                                                     // [0x677a0b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.GetStatus
	// EManaComponentStatus GetStatus();                                                                                        // [0x677a060] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetSelectedTrack
	// int32_t GetSelectedTrack(EManaPlayerTrack TrackType);                                                                    // [0x6779fd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetRate
	// float GetRate();                                                                                                         // [0x6779f60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetPlaylistIndex
	// int32_t GetPlaylistIndex();                                                                                              // [0x6779f30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetNumTracks
	// int32_t GetNumTracks(EManaPlayerTrack TrackType);                                                                        // [0x6779ea0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetNumTrackFormats
	// int32_t GetNumTrackFormats(EManaPlayerTrack TrackType, int32_t TrackIndex);                                              // [0x6779dd0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetMovieTime
	// FTimespan GetMovieTime();                                                                                                // [0x6779d90] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetMovieSource
	// class UManaMovie* GetMovieSource();                                                                                      // [0x6779d30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetMovieFrames
	// int32_t GetMovieFrames();                                                                                                // [0x6779c90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetFrames
	// int32_t GetFrames();                                                                                                     // [0x6779c50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.GetDuration
	// FTimespan GetDuration();                                                                                                 // [0x6779c10] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.ManaPlayer.DisableTrack
	// bool DisableTrack(EManaPlayerTrack TrackType);                                                                           // [0x6779b80] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.Close
	// void Close();                                                                                                            // [0x6779b60] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlayer.BindOnFrameUpdated
	// void BindOnFrameUpdated(FDelegateProperty& Event);                                                                       // [0x6779ab0] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RemoveAt(int32_t Index);                                                                                            // [0x677c2e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.Remove
	// void Remove(class UManaMovie* ManaMovie);                                                                                // [0x677c250] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.Num
	// int32_t Num();                                                                                                           // [0x677c230] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.IsSeamless
	// bool IsSeamless();                                                                                                       // [0x677c210] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.IsMixedTypes
	// bool IsMixedTypes();                                                                                                     // [0x677c1f0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.IsAlpha
	// bool IsAlpha();                                                                                                          // [0x677c1d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.Insert
	// void Insert(class UManaMovie* ManaMovie, int32_t Index);                                                                 // [0x677c100] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.GetRandom
	// class UManaMovie* GetRandom(int32_t& InOutIndex);                                                                        // [0x677c050] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.GetPrevious
	// class UManaMovie* GetPrevious(int32_t& InOutIndex);                                                                      // [0x677bfa0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.GetNext
	// class UManaMovie* GetNext(int32_t& InOutIndex);                                                                          // [0x677bef0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.Get
	// class UManaMovie* Get(int32_t Index);                                                                                    // [0x677be50] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaPlaylist.Add
	// void Add(class UManaMovie* ManaMovie);                                                                                   // [0x677bdc0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetManaPlayer(class UManaPlayer* NewManaPlayer);                                                                    // [0x677c890] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaSoundComponent.SetAudioTrackCategory
	// void SetAudioTrackCategory(EManaPlayerTrack Track, FString CategoryName);                                                // [0x677c7b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaSoundComponent.RemoveAudioTrackCategory
	// void RemoveAudioTrackCategory(EManaPlayerTrack Track);                                                                   // [0x677c730] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaSoundComponent.GetManaPlayer
	// class UManaPlayer* GetManaPlayer();                                                                                      // [0x677c700] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetMovieSource(class UManaSource* InSource);                                                                        // [0x677cde0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.ManaTexture.OnTextureUpdated__DelegateSignature
	// void OnTextureUpdated__DelegateSignature(class UManaTexture* ManaTexture);                                               // [0x3618b30] MulticastDelegate|Public|Delegate 
};
...
public:
	...
	// TArray<FAtomCategoryInfoParam> GetCategoryInfoArray();                                                                   // [0x677d730] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool Validate();                                                                                                         // [0x677e0a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.IsLooping
	// bool IsLooping();                                                                                                        // [0x677e070] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.IsEconomicTickEnabled
	// bool IsEconomicTickEnabled();                                                                                            // [0x677e040] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetMaxAttenuationDistanceToUse
	// float GetMaxAttenuationDistanceToUse();                                                                                  // [0x677e010] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetMaxAttenuationDistanceToApply
	// float GetMaxAttenuationDistanceToApply();                                                                                // [0x677e010] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickMarginDistanceToUse
	// float GetEconomicTickMarginDistanceToUse();                                                                              // [0x677dfb0] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickFrequencyToUse
	// float GetEconomicTickFrequencyToUse();                                                                                   // [0x677dfe0] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickFrequencyToApply
	// float GetEconomicTickFrequencyToApply();                                                                                 // [0x677dfe0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickDistanceMarginToApply
	// float GetEconomicTickDistanceMarginToApply();                                                                            // [0x677dfb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickDistance
	// float GetEconomicTickDistance();                                                                                         // [0x677df80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetEconomicTickBoundaryDistanceToUse
	// float GetEconomicTickBoundaryDistanceToUse();                                                                            // [0x677df80] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetCullingMarginDistanceToUse
	// float GetCullingMarginDistanceToUse();                                                                                   // [0x677df50] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetCullingBoundaryDistanceToUse
	// float GetCullingBoundaryDistanceToUse();                                                                                 // [0x677df20] Final|Native|Public|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetCullDistanceMarginToApply
	// float GetCullDistanceMarginToApply();                                                                                    // [0x677df50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.GetCullDistance
	// float GetCullDistance();                                                                                                 // [0x677df20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCue.BP_GetCueInfo
	// bool BP_GetCueInfo(FAtomCueInfo& CueInfo);                                                                               // [0x677dde0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void ReleaseAcb(FName AcbName);                                                                                          // [0x677f6a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.OnLoadCompleted_BP__DelegateSignature
	// void OnLoadCompleted_BP__DelegateSignature(class USoundAtomCueSheet* AtomCueSheet);                                      // [0x3618b30] MulticastDelegate|Public|Delegate 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.LoadAtomCueSheet
	// class USoundAtomCueSheet* LoadAtomCueSheet(class USoundAtomCueSheet* CueSheet, bool bAddToLevel);                        // [0x677f5d0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.LoadAcb
	// class USoundAtomCueSheet* LoadAcb(FName AcbName, bool bAddToLevel);                                                      // [0x677f500] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.IsRawAcbDataAvailable
	// bool IsRawAcbDataAvailable();                                                                                            // [0x677f4d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.IsLoaded
	// bool IsLoaded();                                                                                                         // [0x677f4d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.GetNumCues
	// int32_t GetNumCues();                                                                                                    // [0x677f470] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.GetAtomCueByName
	// class USoundAtomCue* GetAtomCueByName(FString CueName);                                                                  // [0x677f370] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.GetAtomCueByIndex
	// class USoundAtomCue* GetAtomCueByIndex(int32_t CueIndex);                                                                // [0x677f2d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.GetAtomCueById
	// class USoundAtomCue* GetAtomCueById(int32_t CueId);                                                                      // [0x677f230] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.DetachDspBusSetting
	// void DetachDspBusSetting();                                                                                              // [0x677f210] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.BP_GetCueInfoFromName
	// bool BP_GetCueInfoFromName(FString Name, FAtomCueInfo& CueInfo);                                                         // [0x677f100] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.BP_GetCueInfoFromIndex
	// bool BP_GetCueInfoFromIndex(int32_t Index, FAtomCueInfo& CueInfo);                                                       // [0x677eff0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.BP_GetCueInfoFromId
	// bool BP_GetCueInfoFromId(int32_t ID, FAtomCueInfo& CueInfo);                                                             // [0x677eee0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.AttachDspBusSetting
	// void AttachDspBusSetting(FString SettingName);                                                                           // [0x677ee00] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.AsyncLoadCueSheet
	// void AsyncLoadCueSheet();                                                                                                // [0x677ede0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareRuntime.SoundAtomCueSheet.ApplyDspBusSnapshot
	// void ApplyDspBusSnapshot(FString SnapshotName, int32_t Milliseconds);                                                    // [0x677ecb0] Final|Native|Static|Public|BlueprintCallable 
};
...
static_assert(sizeof(UAtom3dRegionHandle) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(UAtom3dRegion) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(UAtom3dSourceBaseComponent) == 0x02C8); // 712 bytes (0x000230 - 0x0002C8)
static_assert(sizeof(UAtom3dTransceiverComponent) == 0x02F0); // 752 bytes (0x0002C8 - 0x0002F0)
static_assert(sizeof(AAtomAreaSoundVolume) == 0x0308); // 776 bytes (0x0002C8 - 0x000308)
static_assert(sizeof(UAtomAsrRack) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(AAtomEntranceVolume) == 0x02E8); // 744 bytes (0x0002C8 - 0x0002E8)
static_assert(sizeof(FSnapshotSwitchSettings) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FBusSendInterpolationSettings) == 0x0048); // 72 bytes (0x000000 - 0x000048)
static_assert(sizeof(FAisacControlInterpolationSettings) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomAudioVolumeParameters) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(AAtomAudioVolume) == 0x0350); // 848 bytes (0x0002C8 - 0x000350)
static_assert(sizeof(UAtomAudioVolumeSettings) == 0x0068); // 104 bytes (0x000028 - 0x000068)
static_assert(sizeof(UAtomBusSampler) == 0x0070); // 112 bytes (0x000028 - 0x000070)
static_assert(sizeof(UAtomCallback) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UAtomCallbackManager) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UAtomCategory) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FAtomAisacControlParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomSelectorParam) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FAtomAisacControlWithVelocityParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(UAtomComponent) == 0x1300); // 4864 bytes (0x000230 - 0x001300)
static_assert(sizeof(UAtomComponentPool) == 0x0068); // 104 bytes (0x000028 - 0x000068)
static_assert(sizeof(UAtomCueSheetLoaderComponent) == 0x02E0); // 736 bytes (0x000230 - 0x0002E0)
static_assert(sizeof(UAtomDeviceWatcher) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(AAtomDisposer) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
static_assert(sizeof(UAtomListenerFocusPoint) == 0x0240); // 576 bytes (0x000230 - 0x000240)
static_assert(sizeof(UAtomParameterComponent) == 0x00B0); // 176 bytes (0x0000A0 - 0x0000B0)
static_assert(sizeof(UAtomProfileData) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(AAtomSound) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(sizeof(AAtomSoundData) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
static_assert(sizeof(UAtomSoundObject) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(UAtomSpectrumAnalyzer) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UAtomStatics) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UAtomTriggerTableFunctionLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UAtomUnrealSoundRenderer) == 0x84C0); // 33984 bytes (0x000470 - 0x0084C0)
static_assert(sizeof(FAtomWaveInfo) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(UAtomWavePlayer) == 0x0120); // 288 bytes (0x000028 - 0x000120)
static_assert(sizeof(UCriFsBinderComponent) == 0x0290); // 656 bytes (0x000230 - 0x000290)
static_assert(sizeof(ACriFsLoader) == 0x0298); // 664 bytes (0x000290 - 0x000298)
static_assert(sizeof(UCriFsLoaderComponent) == 0x02B0); // 688 bytes (0x000230 - 0x0002B0)
static_assert(sizeof(UCriWareError) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UCriWareFunctionLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UCriWareInitializer) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FAtomAsrRackConfigUI) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAtomAsrRackConfig) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(UCriWarePluginSettings) == 0x0558); // 1368 bytes (0x000028 - 0x000558)
static_assert(sizeof(UManaComponent) == 0x0298); // 664 bytes (0x0000A0 - 0x000298)
static_assert(sizeof(UManaComponentTexture) == 0x0188); // 392 bytes (0x000130 - 0x000188)
static_assert(sizeof(UManaSource) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FManaVideoTrackInfo) == 0x001C); // 28 bytes (0x000000 - 0x00001C)
static_assert(sizeof(FManaAudioTrackInfo) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FManaEventPointInfo) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FManaSubtitleTrackInfo) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(UManaMovie) == 0x00A0); // 160 bytes (0x000028 - 0x0000A0)
static_assert(sizeof(UFileManaMovie) == 0x00B8); // 184 bytes (0x0000A0 - 0x0000B8)
static_assert(sizeof(UDataManaMovie) == 0x00A8); // 168 bytes (0x0000A0 - 0x0000A8)
static_assert(sizeof(UStreamManaMovie) == 0x00B0); // 176 bytes (0x0000A0 - 0x0000B0)
static_assert(sizeof(UManaPlayer) == 0x01C0); // 448 bytes (0x000028 - 0x0001C0)
static_assert(sizeof(UManaPlaylist) == 0x0040); // 64 bytes (0x000028 - 0x000040)
static_assert(sizeof(UManaSoundComponent) == 0x02E0); // 736 bytes (0x000230 - 0x0002E0)
static_assert(sizeof(UManaTexture) == 0x0228); // 552 bytes (0x000130 - 0x000228)
static_assert(sizeof(UMaterialExpressionManaColorSpaceConverter) == 0x0180); // 384 bytes (0x0000B0 - 0x000180)
static_assert(sizeof(UMaterialExpressionManaMovieFormatSwitch) == 0x0188); // 392 bytes (0x0000B0 - 0x000188)
static_assert(sizeof(UPlatformManaMovie) == 0x00A8); // 168 bytes (0x0000A0 - 0x0000A8)
static_assert(sizeof(USoundAtomConfig) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(USoundAtomCue) == 0x00D8); // 216 bytes (0x000028 - 0x0000D8)
static_assert(sizeof(FAtomAttenuationDistanceParam) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FAtomCueInfo) == 0x0060); // 96 bytes (0x000000 - 0x000060)
static_assert(sizeof(USoundAtomCueSheet) == 0x0150); // 336 bytes (0x000028 - 0x000150)
static_assert(sizeof(FAtomBeatSyncInfo) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FAtomSequenceInfo) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FBusSendLevelParam) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FBusSendLevelByNameParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FBusSendLevelOffsetParam) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FBusSendLevelOffsetByNameParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomAppliedValueParam) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(sizeof(FCriWareErrorInfo) == 0x0028); // 40 bytes (0x000000 - 0x000028)
static_assert(sizeof(FManaPlayerTrackOptions) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FManaPlayerOptions) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomAisacInfo) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomStringWithComment) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAtomSelectorSettingsParam) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomAisacControlSettingsParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomGameVariableParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomGlobalAisacSettingsParam) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAtomCategoryParam) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomDspBusSettingsParam) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FAtomConfigDataTable) == 0x00B8); // 184 bytes (0x000008 - 0x0000B8)
static_assert(sizeof(FAcfDataTable) == 0x00B8); // 184 bytes (0x0000B8 - 0x0000B8)
static_assert(sizeof(FAtomCueInfoCategoryParam) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAtomCueInfoSelectorParam) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FAtomCueInfoTrackParam) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(FAtomCueInfoBusSendParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomCueInfoBlocksParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomCueInfoAttachedSelectorParam) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FAtomCueInfoAttachedAisacControlParam) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomOutputPortDataTable) == 0x0020); // 32 bytes (0x000008 - 0x000020)
static_assert(sizeof(FAtomCueInfoDataTable) == 0x0100); // 256 bytes (0x000008 - 0x000100)
static_assert(sizeof(FAtomCueSheetDataTable) == 0x0070); // 112 bytes (0x000008 - 0x000070)
static_assert(sizeof(FAtomListenerFocusPointInfo) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(FAtomProfileItem) == 0x0088); // 136 bytes (0x000000 - 0x000088)
static_assert(sizeof(FAtomSoundManager) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(sizeof(FAtomComponentParams) == 0x0070); // 112 bytes (0x000000 - 0x000070)
static_assert(sizeof(FAtomTriggerRow) == 0x0020); // 32 bytes (0x000008 - 0x000020)
static_assert(sizeof(FManaPlayerFacade) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FAtomCategoryInfoParam) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(offsetof(UAtom3dRegion, Handle) == 0x0040);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultRegion) == 0x0238);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultDistanceAisacControls) == 0x0258);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultOutputBasedAzimuthAngleAisacControls) == 0x0268);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultOutputBasedElevationAngleAisacControls) == 0x0278);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultListenerBasedAzimuthAngleAisacControls) == 0x0288);
static_assert(offsetof(UAtom3dSourceBaseComponent, DefaultListenerBasedElevationAngleAisacControls) == 0x0298);
static_assert(offsetof(UAtom3dTransceiverComponent, InputPoint) == 0x02C8);
static_assert(offsetof(UAtom3dTransceiverComponent, DefaultGlobalAisacs) == 0x02D0);
static_assert(offsetof(AAtomAreaSoundVolume, CollisionProfile) == 0x02D0);
static_assert(offsetof(AAtomAreaSoundVolume, AtomComponents) == 0x02E8);
static_assert(offsetof(AAtomAreaSoundVolume, Sounds) == 0x02F8);
static_assert(offsetof(FSnapshotSwitchSettings, DspBusSettingsName) == 0x0008);
static_assert(offsetof(FSnapshotSwitchSettings, SnapshotName) == 0x0020);
static_assert(offsetof(FBusSendInterpolationSettings, DspBusSettingsName) == 0x0008);
static_assert(offsetof(FBusSendInterpolationSettings, BusName) == 0x0020);
static_assert(offsetof(FAisacControlInterpolationSettings, AisacControlName) == 0x0008);
static_assert(offsetof(FAtomAudioVolumeParameters, SnapshotSwitchSettings) == 0x0010);
static_assert(offsetof(FAtomAudioVolumeParameters, BusSendInterpolateSettings) == 0x0020);
static_assert(offsetof(FAtomAudioVolumeParameters, AisacControlInterpolateSettings) == 0x0030);
static_assert(offsetof(AAtomAudioVolume, CollisionProfile) == 0x02D0);
static_assert(offsetof(AAtomAudioVolume, AudioVolumeTags) == 0x02E0);
static_assert(offsetof(AAtomAudioVolume, AtomAudioVolumeSettings) == 0x02F8);
static_assert(offsetof(AAtomAudioVolume, AtomAudioVolumeSettingsOverrides) == 0x0300);
static_assert(offsetof(AAtomAudioVolume, EntranceVolumes) == 0x0340);
static_assert(offsetof(UAtomAudioVolumeSettings, AtomAudioVolumeParameters) == 0x0028);
static_assert(offsetof(FAtomAisacControlParam, Name) == 0x0000);
static_assert(offsetof(FAtomSelectorParam, Selector) == 0x0000);
static_assert(offsetof(FAtomSelectorParam, Label) == 0x0010);
static_assert(offsetof(FAtomAisacControlWithVelocityParam, AisacControlName) == 0x0000);
static_assert(offsetof(UAtomComponent, sound) == 0x0238);
static_assert(offsetof(UAtomComponent, Region) == 0x0240);
static_assert(offsetof(UAtomComponent, SoundObject) == 0x0258);
static_assert(offsetof(UAtomComponent, DefaultAisacControl) == 0x0268);
static_assert(offsetof(UAtomComponent, DefaultSelectorLabel) == 0x0278);
static_assert(offsetof(UAtomComponent, OverrideAisacControlSettingsWithVelocity) == 0x0290);
static_assert(offsetof(UAtomComponent, LoopSetting) == 0x02A0);
static_assert(offsetof(UAtomComponent, PlayWorld) == 0x02E8);
static_assert(offsetof(UAtomComponent, GameViewport) == 0x02F0);
static_assert(offsetof(UAtomComponent, DefaultSoundObject) == 0x0320);
static_assert(offsetof(UAtomComponent, AttenuationSettings) == 0x0330);
static_assert(offsetof(UAtomComponent, AttenuationOverrides) == 0x0338);
static_assert(offsetof(UAtomComponent, CueSheet) == 0x1210);
static_assert(offsetof(UAtomComponent, AppliedSoundObject) == 0x1228);
static_assert(offsetof(UAtomComponentPool, Pool) == 0x0028);
static_assert(offsetof(UAtomCueSheetLoaderComponent, CueSheetReference) == 0x0230);
static_assert(offsetof(UAtomCueSheetLoaderComponent, BinderComponent) == 0x0250);
static_assert(offsetof(UAtomCueSheetLoaderComponent, CueSheet) == 0x02A8);
static_assert(offsetof(UAtomParameterComponent, SoundObject) == 0x00A0);
static_assert(offsetof(UAtomParameterComponent, Region) == 0x00A8);
static_assert(offsetof(AAtomSound, AtomComponent) == 0x0290);
static_assert(offsetof(AAtomSoundData, CueSheet) == 0x0290);
static_assert(offsetof(FAtomWaveInfo, Format) == 0x0000);
static_assert(offsetof(UAtomWavePlayer, SoundAtomCue) == 0x0090);
static_assert(offsetof(UAtomWavePlayer, WaveInfo) == 0x0098);
static_assert(offsetof(UCriFsBinderComponent, FilePath) == 0x0230);
static_assert(offsetof(ACriFsLoader, LoaderComponent) == 0x0290);
static_assert(offsetof(UCriFsLoaderComponent, FilePath) == 0x0230);
static_assert(offsetof(FAtomAsrRackConfigUI, SoundRendererTypeUI) == 0x0000);
static_assert(offsetof(UCriWarePluginSettings, NonAssetContentDir) == 0x0030);
static_assert(offsetof(UCriWarePluginSettings, ContentDir) == 0x0040);
static_assert(offsetof(UCriWarePluginSettings, AwbRootDirectory) == 0x00C0);
static_assert(offsetof(UCriWarePluginSettings, AwbRoot) == 0x00D0);
static_assert(offsetof(UCriWarePluginSettings, AtomConfig) == 0x0148);
static_assert(offsetof(UCriWarePluginSettings, AcfFileName) == 0x0188);
static_assert(offsetof(UCriWarePluginSettings, AtomConfigDataTable) == 0x0198);
static_assert(offsetof(UCriWarePluginSettings, AtomOutputPortDataTable) == 0x01D8);
static_assert(offsetof(UCriWarePluginSettings, SoundRendererTypeUI) == 0x0220);
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfigUI) == 0x0230);
static_assert(offsetof(UCriWarePluginSettings, AsrRackConfig) == 0x0240);
static_assert(offsetof(UCriWarePluginSettings, Hardware1) == 0x0260);
static_assert(offsetof(UCriWarePluginSettings, Hardware2) == 0x0270);
static_assert(offsetof(UCriWarePluginSettings, Hardware3) == 0x0280);
static_assert(offsetof(UCriWarePluginSettings, Hardware4) == 0x0290);
static_assert(offsetof(UCriWarePluginSettings, StartupMovies) == 0x03E8);
static_assert(offsetof(UManaComponent, Movie) == 0x00A0);
static_assert(offsetof(UManaComponent, Playlist) == 0x0190);
static_assert(offsetof(UManaComponent, AudioCategoryName) == 0x01B8);
static_assert(offsetof(UManaComponent, SubAudioCategoryName) == 0x01C8);
static_assert(offsetof(UManaComponent, ExtraAudioCategoryName) == 0x01D8);
static_assert(offsetof(UManaComponent, SubtitlesEncoding) == 0x01F0);
static_assert(offsetof(UManaComponent, EndFrameAction) == 0x01F1);
static_assert(offsetof(UManaComponent, PlaybackTimer) == 0x01F2);
static_assert(offsetof(UManaComponent, MaxFrameDrop) == 0x01F3);
static_assert(offsetof(UManaComponentTexture, Format) == 0x0138);
static_assert(offsetof(UManaComponentTexture, ComponentType) == 0x0139);
static_assert(offsetof(UManaComponentTexture, AddressX) == 0x013A);
static_assert(offsetof(UManaComponentTexture, AddressY) == 0x013B);
static_assert(offsetof(FManaVideoTrackInfo, TextureDimensions) == 0x0000);
static_assert(offsetof(FManaVideoTrackInfo, DisplayDimensions) == 0x0008);
static_assert(offsetof(FManaVideoTrackInfo, Type) == 0x0019);
static_assert(offsetof(FManaAudioTrackInfo, Type) == 0x000D);
static_assert(offsetof(FManaEventPointInfo, Name) == 0x0000);
static_assert(offsetof(FManaEventPointInfo, Parameter) == 0x0018);
static_assert(offsetof(FManaSubtitleTrackInfo, Name) == 0x0000);
static_assert(offsetof(FManaSubtitleTrackInfo, Language) == 0x0010);
static_assert(offsetof(FManaSubtitleTrackInfo, Encoding) == 0x0020);
static_assert(offsetof(UManaMovie, VideoTracks) == 0x0030);
static_assert(offsetof(UManaMovie, AlphaTracks) == 0x0040);
static_assert(offsetof(UManaMovie, AudioTracks) == 0x0050);
static_assert(offsetof(UManaMovie, EventPoints) == 0x0060);
static_assert(offsetof(UManaMovie, SubtitleTracks) == 0x0070);
static_assert(offsetof(UFileManaMovie, FilePath) == 0x00A8);
static_assert(offsetof(UStreamManaMovie, StreamUrl) == 0x00A0);
static_assert(offsetof(UManaPlayer, MaxFrameDrop) == 0x0040);
static_assert(offsetof(UManaPlayer, ManaTexture) == 0x00E8);
static_assert(offsetof(UManaPlayer, ManaMovie) == 0x00F0);
static_assert(offsetof(UManaPlayer, Playlist) == 0x00F8);
static_assert(offsetof(UManaPlayer, ManaComponent) == 0x0108);
static_assert(offsetof(UManaPlaylist, Movies) == 0x0028);
static_assert(offsetof(UManaSoundComponent, AisacControls) == 0x0248);
static_assert(offsetof(UManaSoundComponent, AttachedAisacs) == 0x0258);
static_assert(offsetof(UManaSoundComponent, AudioTrackCategory) == 0x0268);
static_assert(offsetof(UManaSoundComponent, SubAudioTrackCategory) == 0x0278);
static_assert(offsetof(UManaSoundComponent, ExtraAudioTrackCategory) == 0x0288);
static_assert(offsetof(UManaSoundComponent, ManaPlayer) == 0x0298);
static_assert(offsetof(UManaTexture, MovieSource) == 0x0138);
static_assert(offsetof(UManaTexture, MovieFilePath) == 0x0140);
static_assert(offsetof(UManaTexture, AddressX) == 0x015C);
static_assert(offsetof(UManaTexture, AddressY) == 0x015D);
static_assert(offsetof(UManaTexture, ClearColor) == 0x0160);
static_assert(offsetof(UManaTexture, TargetDimensions) == 0x0174);
static_assert(offsetof(UManaTexture, OverrideFormat) == 0x017C);
static_assert(offsetof(UManaTexture, ComponentTextures) == 0x0190);
static_assert(offsetof(UManaTexture, AlphaComponentTextures) == 0x01A0);
static_assert(offsetof(UManaTexture, ManaPlayer) == 0x01B0);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, Luma) == 0x00B0);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, ChromaB) == 0x00D8);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, ChromaR) == 0x0100);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, Alpha) == 0x0128);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, Gamma) == 0x0150);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, MovieType) == 0x0179);
static_assert(offsetof(UMaterialExpressionManaColorSpaceConverter, ColorSpace) == 0x017A);
static_assert(offsetof(UMaterialExpressionManaMovieFormatSwitch, Inputs) == 0x00B0);
static_assert(offsetof(UPlatformManaMovie, ManaMovie) == 0x00A0);
static_assert(offsetof(USoundAtomConfig, AcfFilePath) == 0x0028);
static_assert(offsetof(USoundAtomCue, CueSheet) == 0x0030);
static_assert(offsetof(USoundAtomCue, CueName) == 0x0038);
static_assert(offsetof(USoundAtomCue, LoopSetting) == 0x0048);
static_assert(offsetof(USoundAtomCue, AttenuationSettings) == 0x0058);
static_assert(offsetof(USoundAtomCue, Region) == 0x0070);
static_assert(offsetof(USoundAtomCue, AisacControlSettings) == 0x0080);
static_assert(offsetof(USoundAtomCue, DefaultAttenuation) == 0x00C0);
static_assert(offsetof(FAtomCueInfo, Name) == 0x0008);
static_assert(offsetof(FAtomCueInfo, Duration) == 0x0018);
static_assert(offsetof(FAtomCueInfo, UserData) == 0x0020);
static_assert(offsetof(FAtomCueInfo, CategoryNames) == 0x0030);
static_assert(offsetof(FAtomCueInfo, AisacControlNames) == 0x0040);
static_assert(offsetof(FAtomCueInfo, AttenuationDistance) == 0x0050);
static_assert(offsetof(USoundAtomCueSheet, AcbFilePath) == 0x0030);
static_assert(offsetof(USoundAtomCueSheet, CueSheetName) == 0x0040);
static_assert(offsetof(USoundAtomCueSheet, AwbDirectory) == 0x0058);
static_assert(offsetof(USoundAtomCueSheet, AdditionalData) == 0x0068);
static_assert(offsetof(USoundAtomCueSheet, CueInfos) == 0x0070);
static_assert(offsetof(FBusSendLevelByNameParam, Name) == 0x0000);
static_assert(offsetof(FBusSendLevelOffsetByNameParam, Name) == 0x0000);
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelParam) == 0x0018);
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelByNameParams) == 0x0020);
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelOffsetParam) == 0x0030);
static_assert(offsetof(FAtomAppliedValueParam, BusSendLevelOffsetByNameParams) == 0x0038);
static_assert(offsetof(FAtomAppliedValueParam, AtomSelectorParam) == 0x0050);
static_assert(offsetof(FAtomAppliedValueParam, AsrRackIDs) == 0x0070);
static_assert(offsetof(FCriWareErrorInfo, ErrorID) == 0x0000);
static_assert(offsetof(FCriWareErrorInfo, ErrorType) == 0x0010);
static_assert(offsetof(FCriWareErrorInfo, Message) == 0x0018);
static_assert(offsetof(FManaPlayerOptions, Tracks) == 0x0000);
static_assert(offsetof(FManaPlayerOptions, SeekTime) == 0x0018);
static_assert(offsetof(FManaPlayerOptions, PlayOnOpen) == 0x0020);
static_assert(offsetof(FManaPlayerOptions, Loop) == 0x0021);
static_assert(offsetof(FManaPlayerOptions, PlaybackTimer) == 0x0022);
static_assert(offsetof(FManaPlayerOptions, MaxFrameDrop) == 0x0023);
static_assert(offsetof(FManaPlayerOptions, EndFrameAction) == 0x0024);
static_assert(offsetof(FManaPlayerOptions, TimeSyncedSource) == 0x0028);
static_assert(offsetof(FAtomAisacInfo, Name) == 0x0000);
static_assert(offsetof(FAtomAisacInfo, ControlName) == 0x0020);
static_assert(offsetof(FAtomStringWithComment, Name) == 0x0000);
static_assert(offsetof(FAtomSelectorSettingsParam, Name) == 0x0000);
static_assert(offsetof(FAtomSelectorSettingsParam, DefaultSelectorLabel) == 0x0010);
static_assert(offsetof(FAtomSelectorSettingsParam, Labels) == 0x0020);
static_assert(offsetof(FAtomAisacControlSettingsParam, Name) == 0x0008);
static_assert(offsetof(FAtomGameVariableParam, Name) == 0x0000);
static_assert(offsetof(FAtomGlobalAisacSettingsParam, AisacControl) == 0x0000);
static_assert(offsetof(FAtomCategoryParam, Name) == 0x0008);
static_assert(offsetof(FAtomCategoryParam, Group) == 0x0018);
static_assert(offsetof(FAtomDspBusSettingsParam, BusSettingsName) == 0x0000);
static_assert(offsetof(FAtomDspBusSettingsParam, Snapshot) == 0x0010);
static_assert(offsetof(FAtomDspBusSettingsParam, Bus) == 0x0020);
static_assert(offsetof(FAtomConfigDataTable, BuildDate) == 0x0008);
static_assert(offsetof(FAtomConfigDataTable, Selector) == 0x0048);
static_assert(offsetof(FAtomConfigDataTable, AisacControl) == 0x0058);
static_assert(offsetof(FAtomConfigDataTable, GameVariable) == 0x0068);
static_assert(offsetof(FAtomConfigDataTable, GlobalAisac) == 0x0078);
static_assert(offsetof(FAtomConfigDataTable, Category) == 0x0088);
static_assert(offsetof(FAtomConfigDataTable, DspBusSettings) == 0x0098);
static_assert(offsetof(FAtomConfigDataTable, React) == 0x00A8);
static_assert(offsetof(FAtomCueInfoCategoryParam, Name) == 0x0000);
static_assert(offsetof(FAtomCueInfoSelectorParam, Name) == 0x0000);
static_assert(offsetof(FAtomCueInfoSelectorParam, Label) == 0x0010);
static_assert(offsetof(FAtomCueInfoTrackParam, Name) == 0x0008);
static_assert(offsetof(FAtomCueInfoTrackParam, Selector) == 0x0018);
static_assert(offsetof(FAtomCueInfoBusSendParam, Name) == 0x0000);
static_assert(offsetof(FAtomCueInfoBlocksParam, Name) == 0x0000);
static_assert(offsetof(FAtomCueInfoAttachedSelectorParam, Name) == 0x0000);
static_assert(offsetof(FAtomCueInfoAttachedAisacControlParam, Name) == 0x0000);
static_assert(offsetof(FAtomOutputPortDataTable, OutputPortName) == 0x0008);
static_assert(offsetof(FAtomOutputPortDataTable, SpeakerType) == 0x001C);
static_assert(offsetof(FAtomCueInfoDataTable, Name) == 0x0008);
static_assert(offsetof(FAtomCueInfoDataTable, CueType) == 0x0020);
static_assert(offsetof(FAtomCueInfoDataTable, DefaultSelectorLabel) == 0x0030);
static_assert(offsetof(FAtomCueInfoDataTable, CategoryCuePriorityType) == 0x0060);
static_assert(offsetof(FAtomCueInfoDataTable, CuePriorityType) == 0x0078);
static_assert(offsetof(FAtomCueInfoDataTable, Category) == 0x00A0);
static_assert(offsetof(FAtomCueInfoDataTable, Track) == 0x00B0);
static_assert(offsetof(FAtomCueInfoDataTable, BusSend) == 0x00C0);
static_assert(offsetof(FAtomCueInfoDataTable, Blocks) == 0x00D0);
static_assert(offsetof(FAtomCueInfoDataTable, AttachedSelector) == 0x00E0);
static_assert(offsetof(FAtomCueInfoDataTable, AttachedAisacControl) == 0x00F0);
static_assert(offsetof(FAtomCueSheetDataTable, Name) == 0x0008);
static_assert(offsetof(FAtomCueSheetDataTable, BuildDate) == 0x0018);
static_assert(offsetof(FAtomCueSheetDataTable, WorkUnit) == 0x0028);
static_assert(offsetof(FAtomCueSheetDataTable, PriorityType) == 0x0048);
static_assert(offsetof(FAtomCueSheetDataTable, Cue) == 0x0060);
static_assert(offsetof(FAtomListenerFocusPointInfo, TargetActor) == 0x0000);
static_assert(offsetof(FAtomListenerFocusPointInfo, TargetComponent) == 0x0008);
static_assert(offsetof(FAtomProfileItem, AtomCueName) == 0x0008);
static_assert(offsetof(FAtomProfileItem, AtomComponentLocation) == 0x0018);
static_assert(offsetof(FAtomProfileItem, PlayerState) == 0x0040);
static_assert(offsetof(FAtomProfileItem, ConcurrencyName) == 0x0058);
static_assert(offsetof(FAtomComponentParams, SoundObject) == 0x0018);
static_assert(offsetof(FAtomComponentParams, AttenuationSettings) == 0x0020);
static_assert(offsetof(FAtomComponentParams, DefaultAisacControl) == 0x0030);
static_assert(offsetof(FAtomComponentParams, DefaultSelectorLabel) == 0x0040);
static_assert(offsetof(FAtomComponentParams, LoopSetting) == 0x0050);
static_assert(offsetof(FAtomComponentParams, Rotation) == 0x0058);
static_assert(offsetof(FAtomTriggerRow, bone) == 0x000C);
static_assert(offsetof(FAtomTriggerRow, Cue) == 0x0018);
static_assert(offsetof(FManaPlayerFacade, ManaComponent) == 0x0000);
static_assert(offsetof(FAtomCategoryInfoParam, Name) == 0x0000);
