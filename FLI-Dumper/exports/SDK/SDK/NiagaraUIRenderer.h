...
public:
	...
	// void UpdateTickWhenPaused(bool NewTickWhenPaused);                                                                       // [0x7f9ce00] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.UpdateNiagaraSystemReference
	// void UpdateNiagaraSystemReference(class UNiagaraSystem* NewNiagaraSystem);                                               // [0x7f9cd70] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetRemapMaterial
	// void SetRemapMaterial(class UMaterialInterface* OriginalMaterial, class UMaterialInterface* RemapMaterial);              // [0x7f9cca0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetDesiredWidgetSize
	// void SetDesiredWidgetSize(FVector2D NewDesiredSize);                                                                     // [0x7f9cc10] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.SetColorAndOpacity
	// void SetColorAndOpacity(FLinearColor InColorAndOpacity);                                                                 // [0x7f9cb80] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.GetRemapMaterial
	// class UMaterialInterface* GetRemapMaterial(class UMaterialInterface* OriginalMaterial);                                  // [0x7f9cae0] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.GetNiagaraComponent
	// class UNiagaraUIComponent* GetNiagaraComponent();                                                                        // [0x7f9cab0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.DeactivateSystem
	// void DeactivateSystem();                                                                                                 // [0x7f9ca90] Final|Native|Public|BlueprintCallable 
	// Function /Script/NiagaraUIRenderer.NiagaraSystemWidget.ActivateSystem
	// void ActivateSystem(bool Reset);                                                                                         // [0x7f9ca00] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UNiagaraSystemWidget) == 0x0228); // 552 bytes (0x000178 - 0x000228)
static_assert(sizeof(ANiagaraUIActor) == 0x0290); // 656 bytes (0x000290 - 0x000290)
static_assert(sizeof(UNiagaraUIComponent) == 0x0780); // 1920 bytes (0x000778 - 0x000780)
static_assert(offsetof(UNiagaraSystemWidget, NiagaraSystemReference) == 0x0178);
static_assert(offsetof(UNiagaraSystemWidget, MaterialRemapList) == 0x0180);
static_assert(offsetof(UNiagaraSystemWidget, DesiredWidgetSize) == 0x01D8);
static_assert(offsetof(UNiagaraSystemWidget, ColorAndOpacity) == 0x01E8);
static_assert(offsetof(UNiagaraSystemWidget, NiagaraActor) == 0x0218);
static_assert(offsetof(UNiagaraSystemWidget, NiagaraComponent) == 0x0220);
