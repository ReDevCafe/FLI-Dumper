...
public:
	...
	// void ResetToDefault();                                                                                                   // [0x87d6a30] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool ExportToGLTF(class UObject* Object, FString FilePath, class UGLTFExportOptions* OPTIONS, TSet<AActor*>& SelectedActors, FGLTFExportMessages& OutMessages); // [0x87d6700] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void ResetToDefault();                                                                                                   // [0x87d6ac0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(FGLTFMaterialBakeSize) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FGLTFOverrideMaterialBakeSettings) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(UGLTFExportOptions) == 0x00B0); // 176 bytes (0x000028 - 0x0000B0)
static_assert(sizeof(UGLTFExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFAnimSequenceExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFLevelExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFLevelSequenceExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFLevelVariantSetsExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFMaterialExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFSkeletalMeshExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFStaticMeshExporter) == 0x0078); // 120 bytes (0x000078 - 0x000078)
static_assert(sizeof(UGLTFProxyOptions) == 0x0090); // 144 bytes (0x000028 - 0x000090)
static_assert(sizeof(UGLTFMaterialExportOptions) == 0x0098); // 152 bytes (0x000028 - 0x000098)
static_assert(sizeof(FGLTFExportMessages) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(offsetof(FGLTFOverrideMaterialBakeSettings, Size) == 0x0004);
static_assert(offsetof(FGLTFOverrideMaterialBakeSettings, Filter) == 0x0011);
static_assert(offsetof(FGLTFOverrideMaterialBakeSettings, Tiling) == 0x0013);
static_assert(offsetof(UGLTFExportOptions, BakeMaterialInputs) == 0x0037);
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeSize) == 0x0038);
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeFilter) == 0x0044);
static_assert(offsetof(UGLTFExportOptions, DefaultMaterialBakeTiling) == 0x0045);
static_assert(offsetof(UGLTFExportOptions, DefaultInputBakeSettings) == 0x0048);
static_assert(offsetof(UGLTFExportOptions, TextureImageFormat) == 0x00A2);
static_assert(offsetof(UGLTFExportOptions, ExportMaterialVariants) == 0x00AD);
static_assert(offsetof(UGLTFProxyOptions, DefaultMaterialBakeSize) == 0x002C);
static_assert(offsetof(UGLTFProxyOptions, DefaultMaterialBakeFilter) == 0x0038);
static_assert(offsetof(UGLTFProxyOptions, DefaultMaterialBakeTiling) == 0x0039);
static_assert(offsetof(UGLTFProxyOptions, DefaultInputBakeSettings) == 0x0040);
static_assert(offsetof(UGLTFMaterialExportOptions, Proxy) == 0x0028);
static_assert(offsetof(UGLTFMaterialExportOptions, Default) == 0x0030);
static_assert(offsetof(UGLTFMaterialExportOptions, Inputs) == 0x0048);
