...
static_assert(sizeof(FPBIKSolverSettings) == 0x0040); // 64 bytes (0x000000 - 0x000040)
static_assert(sizeof(FPBIKSolver) == 0x0058); // 88 bytes (0x000000 - 0x000058)
...
static_assert(sizeof(FPBIKWorkData) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(sizeof(FRigUnit_PBIK) == 0x02E0); // 736 bytes (0x0001D0 - 0x0002E0)
...
static_assert(offsetof(FPBIKSolverSettings, RootBehavior) == 0x000D);
static_assert(offsetof(FPBIKSolverSettings, PrePullRootSettings) == 0x0010);
static_assert(offsetof(FPBIKEffector, bone) == 0x0000);
static_assert(offsetof(FPBIKEffector, Transform) == 0x0010);
static_assert(offsetof(FPBIKWorkData, BoneSettingToSolverBoneIndex) == 0x0008);
static_assert(offsetof(FPBIKWorkData, SolverBoneToElementIndex) == 0x0018);
static_assert(offsetof(FPBIKWorkData, Solver) == 0x0028);
static_assert(offsetof(FRigUnit_PBIK, Root) == 0x01D0);
static_assert(offsetof(FRigUnit_PBIK, Effectors) == 0x01D8);
static_assert(offsetof(FRigUnit_PBIK, EffectorSolverIndices) == 0x01E8);
static_assert(offsetof(FRigUnit_PBIK, BoneSettings) == 0x01F8);
static_assert(offsetof(FRigUnit_PBIK, ExcludedBones) == 0x0208);
static_assert(offsetof(FRigUnit_PBIK, Settings) == 0x0218);
static_assert(offsetof(FRigUnit_PBIK, Debug) == 0x0258);
static_assert(offsetof(FRigUnit_PBIK, WorkData) == 0x0260);
