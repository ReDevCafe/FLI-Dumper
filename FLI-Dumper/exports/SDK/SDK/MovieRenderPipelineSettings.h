...
public:
	...
	// void OnOutputFrameStarted(class UMoviePipeline* ForPipeline);                                                            // [0x3618b30] Event|Public|BlueprintEvent 
};
...
{ 
public:
	SDK_UNDEFINED(16,1147) /* TArray<TScriptInterface<Class>> */ __um(ConsoleVariablePresets);                     // 0x0048   (0x0010)  
	...
	// bool UpdateConsoleVariableEnableState(FString Name, bool bIsEnabled);                                                    // [0x7f6e340] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.RemoveConsoleVariable
	// bool RemoveConsoleVariable(FString Name, bool bRemoveAllInstances);                                                      // [0x7f6e1e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.GetConsoleVariables
	// TArray<FMoviePipelineConsoleVariableEntry> GetConsoleVariables();                                                        // [0x7f6e040] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.AddOrUpdateConsoleVariable
	// bool AddOrUpdateConsoleVariable(FString Name, float Value);                                                              // [0x7f6de60] Final|Native|Public|BlueprintCallable 
	// Function /Script/MovieRenderPipelineSettings.MoviePipelineConsoleVariableSetting.AddConsoleVariable
	// bool AddConsoleVariable(FString Name, float Value);                                                                      // [0x7f6dcc0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UMoviePipelineBurnInWidget) == 0x02E0); // 736 bytes (0x0002E0 - 0x0002E0)
static_assert(sizeof(UMoviePipelineBurnInSetting) == 0x00B0); // 176 bytes (0x000048 - 0x0000B0)
static_assert(sizeof(FMoviePipelineConsoleVariableEntry) == 0x0018); // 24 bytes (0x000000 - 0x000018)
static_assert(sizeof(UMoviePipelineConsoleVariableSetting) == 0x00F8); // 248 bytes (0x000048 - 0x0000F8)
...
static_assert(offsetof(UMoviePipelineBurnInSetting, BurnInWidgetInstances) == 0x00A0);
static_assert(offsetof(FMoviePipelineConsoleVariableEntry, Name) == 0x0000);
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, ConsoleVariables) == 0x0058);
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, StartConsoleCommands) == 0x00A8);
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, EndConsoleCommands) == 0x00B8);
static_assert(offsetof(UMoviePipelineConsoleVariableSetting, CVars) == 0x00C8);
