...
public:
	...
	// void StopSequence();                                                                                                     // [0x8be9180] Final|Native|Public|BlueprintCallable 
	// Function /Script/ActorSequence.ActorSequenceComponent.PlaySequence
	// void PlaySequence();                                                                                                     // [0x8be9150] Final|Native|Public|BlueprintCallable 
	// Function /Script/ActorSequence.ActorSequenceComponent.PauseSequence
	// void PauseSequence();                                                                                                    // [0x8be9120] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UActorSequenceComponent) == 0x00D8); // 216 bytes (0x0000A0 - 0x0000D8)
static_assert(sizeof(UActorSequencePlayer) == 0x0460); // 1120 bytes (0x000460 - 0x000460)
