...
public:
	...
	// int32_t GetNumCenterFrequencies();                                                                                       // [0x8c762d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.ConstantQAnalyzer.GetCenterFrequencies
	// void GetCenterFrequencies(TArray<float>& OutCenterFrequencies);                                                          // [0x8c75410] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void GetNormalizedChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ);               // [0x8c75cb0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.ConstantQNRT.GetChannelConstantQAtTime
	// void GetChannelConstantQAtTime(float InSeconds, int32_t InChannel, TArray<float>& OutConstantQ);                         // [0x8c75650] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void GetNormalizedLoudnessAtTime(float InSeconds, float& OutLoudness);                                                   // [0x8c761e0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetNormalizedChannelLoudnessAtTime
	// void GetNormalizedChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness);                         // [0x8c75df0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetLoudnessAtTime
	// void GetLoudnessAtTime(float InSeconds, float& OutLoudness);                                                             // [0x8c75bc0] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.LoudnessNRT.GetChannelLoudnessAtTime
	// void GetChannelLoudnessAtTime(float InSeconds, int32_t InChannel, float& OutLoudness);                                   // [0x8c75820] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void GetNormalizedChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths); // [0x8c75f10] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.OnsetNRT.GetChannelOnsetsBetweenTimes
	// void GetChannelOnsetsBetweenTimes(float InStartSeconds, float InEndSeconds, int32_t InChannel, TArray<float>& OutOnsetTimestamps, TArray<float>& OutOnsetStrengths); // [0x8c75940] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// int32_t GetNumCenterFrequencies();                                                                                       // [0x8c76300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioSynesthesia.SynesthesiaSpectrumAnalyzer.GetCenterFrequencies
	// void GetCenterFrequencies(float InSampleRate, TArray<float>& OutCenterFrequencies);                                      // [0x8c75560] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
static_assert(sizeof(UConstantQSettings) == 0x0048); // 72 bytes (0x000028 - 0x000048)
static_assert(sizeof(UConstantQAnalyzer) == 0x00F8); // 248 bytes (0x0000A0 - 0x0000F8)
...
static_assert(sizeof(ULoudnessAnalyzer) == 0x00E8); // 232 bytes (0x0000A0 - 0x0000E8)
...
static_assert(sizeof(UMeterAnalyzer) == 0x0148); // 328 bytes (0x0000A0 - 0x000148)
...
static_assert(sizeof(USynesthesiaSpectrumAnalyzer) == 0x00F8); // 248 bytes (0x0000A0 - 0x0000F8)
static_assert(sizeof(FConstantQResults) == 0x0018); // 24 bytes (0x000000 - 0x000018)
...
static_assert(offsetof(UConstantQSettings, FFTSize) == 0x0039);
static_assert(offsetof(UConstantQSettings, windowType) == 0x003A);
static_assert(offsetof(UConstantQSettings, SpectrumType) == 0x003B);
static_assert(offsetof(UConstantQSettings, CQTNormalization) == 0x0040);
static_assert(offsetof(UConstantQAnalyzer, Settings) == 0x00A0);
...
static_assert(offsetof(ULoudnessAnalyzer, Settings) == 0x00A0);
...
static_assert(offsetof(UMeterAnalyzer, Settings) == 0x00A0);
...
static_assert(offsetof(USynesthesiaSpectrumAnalyzer, Settings) == 0x00A0);
static_assert(offsetof(FConstantQResults, SpectrumValues) == 0x0008);
