...
static_assert(sizeof(UUdpMessagingSettings) == 0x00B8); // 184 bytes (0x000028 - 0x0000B8)
...
static_assert(offsetof(UUdpMessagingSettings, ExcludedEndpoints) == 0x0070);
static_assert(offsetof(UUdpMessagingSettings, TunnelUnicastEndpoint) == 0x0088);
static_assert(offsetof(UUdpMessagingSettings, TunnelMulticastEndpoint) == 0x0098);
static_assert(offsetof(UUdpMessagingSettings, RemoteTunnelEndpoints) == 0x00A8);
