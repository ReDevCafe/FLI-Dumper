...
public:
	...
	// void AddIKGoals(TMap<FName, FIKRigGoal>& OutGoals);                                                                      // [0x86d2fa0] Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void SetIKRigGoalTransform(FName GoalName, FTransform Transform, float PositionAlpha, float RotationAlpha);              // [0x86d5220] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/IKRig.IKRigComponent.SetIKRigGoalPositionAndRotation
	// void SetIKRigGoalPositionAndRotation(FName GoalName, FVector Position, FQuat Rotation, float PositionAlpha, float RotationAlpha); // [0x86d4fc0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/IKRig.IKRigComponent.SetIKRigGoal
	// void SetIKRigGoal(FIKRigGoal& Goal);                                                                                     // [0x86d4ea0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRigComponent.ClearAllGoals
	// void ClearAllGoals();                                                                                                    // [0x86d30e0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetRootSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FTargetRootSettings& RootSettings);             // [0x86d5490] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.SetGlobalSettingsInRetargetProfile
	// void SetGlobalSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FRetargetGlobalSettings& GlobalSettings);     // [0x86d4d20] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.SetChainSpeedPlantSettingsInRetargetProfile
	// void SetChainSpeedPlantSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FTargetChainSpeedPlantSettings& SpeedPlantSettings, FName TargetChainName); // [0x86d4ae0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.SetChainSettingsInRetargetProfile
	// void SetChainSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FTargetChainSettings& ChainSettings, FName TargetChainName); // [0x86d48a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.SetChainIKSettingsInRetargetProfile
	// void SetChainIKSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FTargetChainIKSettings& IKSettings, FName TargetChainName); // [0x86d45e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.SetChainFKSettingsInRetargetProfile
	// void SetChainFKSettingsInRetargetProfile(FRetargetProfile& RetargetProfile, FTargetChainFKSettings& FKSettings, FName TargetChainName); // [0x86d4390] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/IKRig.IKRetargeter.HasTargetIKRig
	// bool HasTargetIKRig();                                                                                                   // [0x86d42e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/IKRig.IKRetargeter.HasSourceIKRig
	// bool HasSourceIKRig();                                                                                                   // [0x86d4230] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/IKRig.IKRetargeter.GetRootSettingsFromRetargetProfile
	// FTargetRootSettings GetRootSettingsFromRetargetProfile(FRetargetProfile& RetargetProfile);                               // [0x86d40f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetRootSettingsFromRetargetAsset
	// void GetRootSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, FName OptionalProfileName, FTargetRootSettings& OutSettings); // [0x86d3e00] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetGlobalSettingsFromRetargetProfile
	// FRetargetGlobalSettings GetGlobalSettingsFromRetargetProfile(FRetargetProfile& RetargetProfile);                         // [0x86d3d00] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetGlobalSettingsFromRetargetAsset
	// void GetGlobalSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, FName OptionalProfileName, FRetargetGlobalSettings& OutSettings); // [0x86d3b10] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetChainUsingGoalFromRetargetAsset
	// FTargetChainSettings GetChainUsingGoalFromRetargetAsset(class UIKRetargeter* RetargetAsset, FName IKGoalName);           // [0x86d37c0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetChainSettingsFromRetargetProfile
	// FTargetChainSettings GetChainSettingsFromRetargetProfile(FRetargetProfile& RetargetProfile, FName TargetChainName);      // [0x86d3500] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/IKRig.IKRetargeter.GetChainSettingsFromRetargetAsset
	// FTargetChainSettings GetChainSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, FName TargetChainName, FName OptionalProfileName); // [0x86d3110] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(URetargetOpBase) == 0x0030); // 48 bytes (0x000028 - 0x000030)
static_assert(sizeof(FCurveRemapPair) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(UCurveRemapOp) == 0x0048); // 72 bytes (0x000030 - 0x000048)
static_assert(sizeof(URetargetOpStack) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(UIKGoalCreatorInterface) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FPinBoneData) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(sizeof(UPinBoneOp) == 0x0110); // 272 bytes (0x000030 - 0x000110)
static_assert(sizeof(URootMotionGeneratorOp) == 0x0250); // 592 bytes (0x000030 - 0x000250)
static_assert(sizeof(UIKRigComponent) == 0x00B8); // 184 bytes (0x0000A0 - 0x0000B8)
static_assert(sizeof(FTargetChainFKSettings) == 0x001C); // 28 bytes (0x000000 - 0x00001C)
...
static_assert(sizeof(URetargetChainSettings) == 0x00E8); // 232 bytes (0x000028 - 0x0000E8)
...
static_assert(sizeof(UIKRetargetGlobalSettings) == 0x0050); // 80 bytes (0x000028 - 0x000050)
...
static_assert(sizeof(FIKRetargetPose) == 0x0070); // 112 bytes (0x000000 - 0x000070)
static_assert(sizeof(UIKRetargeter) == 0x0218); // 536 bytes (0x000028 - 0x000218)
static_assert(sizeof(UIKRetargetProcessor) == 0x03A0); // 928 bytes (0x000028 - 0x0003A0)
...
static_assert(sizeof(UIKRigDefinition) == 0x0100); // 256 bytes (0x000028 - 0x000100)
...
static_assert(sizeof(UIKRig_FBIKEffector) == 0x0050); // 80 bytes (0x000028 - 0x000050)
static_assert(sizeof(UIKRig_FBIKBoneSettings) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(UIKRigFBIKSolver) == 0x00F0); // 240 bytes (0x000030 - 0x0000F0)
...
static_assert(offsetof(FCurveRemapPair, SourceCurve) == 0x0000);
static_assert(offsetof(FCurveRemapPair, TargetCurve) == 0x0008);
static_assert(offsetof(UCurveRemapOp, CurvesToRemap) == 0x0030);
static_assert(offsetof(URetargetOpStack, RetargetOps) == 0x0028);
static_assert(offsetof(FPinBoneData, BoneToPin) == 0x0000);
static_assert(offsetof(FPinBoneData, BoneToPinTo) == 0x0008);
static_assert(offsetof(UPinBoneOp, BonesToPin) == 0x0030);
static_assert(offsetof(UPinBoneOp, PinTo) == 0x0040);
static_assert(offsetof(UPinBoneOp, PinType) == 0x0041);
static_assert(offsetof(UPinBoneOp, GlobalOffset) == 0x0050);
static_assert(offsetof(UPinBoneOp, LocalOffset) == 0x00B0);
static_assert(offsetof(URootMotionGeneratorOp, SourceRootBone) == 0x0030);
static_assert(offsetof(URootMotionGeneratorOp, TargetRootBone) == 0x0038);
static_assert(offsetof(URootMotionGeneratorOp, TargetPelvisBone) == 0x0040);
static_assert(offsetof(URootMotionGeneratorOp, RootMotionSource) == 0x0048);
static_assert(offsetof(URootMotionGeneratorOp, RootHeightSource) == 0x0049);
static_assert(offsetof(URootMotionGeneratorOp, GlobalOffset) == 0x0050);
...
static_assert(offsetof(FTargetChainSettings, IK) == 0x0020);
static_assert(offsetof(FTargetChainSettings, SpeedPlanting) == 0x0098);
...
static_assert(offsetof(FRetargetGlobalSettings, DirectionSource) == 0x0008);
static_assert(offsetof(FRetargetGlobalSettings, ForwardDirection) == 0x000C);
static_assert(offsetof(FRetargetGlobalSettings, DirectionChain) == 0x0010);
...
static_assert(offsetof(UIKRetargeter, ChainMapping) == 0x0080);
static_assert(offsetof(UIKRetargeter, ChainSettings) == 0x0090);
static_assert(offsetof(UIKRetargeter, RootSettings) == 0x00A0);
static_assert(offsetof(UIKRetargeter, GlobalSettings) == 0x00A8);
static_assert(offsetof(UIKRetargeter, OpStack) == 0x00B0);
...
static_assert(offsetof(UIKRetargetProcessor, IKRigProcessor) == 0x0188);
static_assert(offsetof(UIKRetargetProcessor, OpStack) == 0x0388);
...
static_assert(offsetof(UIKRigDefinition, Skeleton) == 0x0058);
static_assert(offsetof(UIKRigDefinition, Goals) == 0x00C8);
static_assert(offsetof(UIKRigDefinition, Solvers) == 0x00D8);
static_assert(offsetof(UIKRigDefinition, RetargetDefinition) == 0x00E8);
...
static_assert(offsetof(UIKRigFBIKSolver, RootBehavior) == 0x0045);
static_assert(offsetof(UIKRigFBIKSolver, PrePullRootSettings) == 0x0048);
