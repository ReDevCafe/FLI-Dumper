...
public:
	...
	// void SetTriggerParameter(FName InName);                                                                                  // [0x4214c60] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetStringParameter
	// void SetStringParameter(FName InName, FString InValue);                                                                  // [0x4214b80] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetStringArrayParameter
	// void SetStringArrayParameter(FName InName, TArray<FString>& InValue);                                                    // [0x4214a60] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetParameters_Blueprint
	// void SetParameters_Blueprint(TArray<FAudioParameter>& InParameters);                                                     // [0x4214900] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetObjectParameter
	// void SetObjectParameter(FName InName, class UObject* InValue);                                                           // [0x4214830] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetObjectArrayParameter
	// void SetObjectArrayParameter(FName InName, TArray<UObject*>& InValue);                                                   // [0x4214740] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetIntParameter
	// void SetIntParameter(FName InName, int32_t inInt);                                                                       // [0x4214670] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetIntArrayParameter
	// void SetIntArrayParameter(FName InName, TArray<int32_t>& InValue);                                                       // [0x4214580] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetFloatParameter
	// void SetFloatParameter(FName InName, float InFloat);                                                                     // [0x42144b0] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetFloatArrayParameter
	// void SetFloatArrayParameter(FName InName, TArray<float>& InValue);                                                       // [0x42143c0] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetBoolParameter
	// void SetBoolParameter(FName InName, bool InBool);                                                                        // [0x42142f0] Native|Public|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.SetBoolArrayParameter
	// void SetBoolArrayParameter(FName InName, TArray<bool>& InValue);                                                         // [0x4214200] Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioExtensions.AudioParameterControllerInterface.ResetParameters
	// void ResetParameters();                                                                                                  // [0x42141e0] Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UAudioPropertiesBindings) == 0x0078); // 120 bytes (0x000028 - 0x000078)
static_assert(sizeof(UAudioPropertiesSheetAssetBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(UAudioPropertySheetBaseAsset) == 0x0028); // 40 bytes (0x000028 - 0x000028)
...
static_assert(sizeof(FSoundWaveCloudStreamingPlatformProjectSettings) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(sizeof(FSoundWaveCloudStreamingPlatformSettings) == 0x0001); // 1 bytes (0x000000 - 0x000001)
static_assert(sizeof(FSoundGeneratorOutput) == 0x0008); // 8 bytes (0x000000 - 0x000008)
static_assert(sizeof(FAudioParameter) == 0x00A0); // 160 bytes (0x000000 - 0x0000A0)
static_assert(offsetof(UAudioPropertiesBindings, ObjectPropertyToSheetPropertyMap) == 0x0028);
...
static_assert(offsetof(FSoundWaveCloudStreamingPlatformProjectSettings, EnablementSetting) == 0x0000);
static_assert(offsetof(FSoundWaveCloudStreamingPlatformSettings, EnablementSetting) == 0x0000);
