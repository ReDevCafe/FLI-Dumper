...
public:
	...
	// bool IsLooping();                                                                                                        // [0x8642960] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
...
static_assert(sizeof(UMovieSceneAtomSection) == 0x0498); // 1176 bytes (0x0000F0 - 0x000498)
static_assert(sizeof(UMovieSceneAtomTrack) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(UMovieSceneManaSection) == 0x0120); // 288 bytes (0x0000F0 - 0x000120)
static_assert(sizeof(UMovieSceneManaTrack) == 0x00D8); // 216 bytes (0x000098 - 0x0000D8)
static_assert(sizeof(FMovieSceneAtomSectionTemplate) == 0x0028); // 40 bytes (0x000020 - 0x000028)
static_assert(sizeof(FMovieSceneManaSectionParams) == 0x0030); // 48 bytes (0x000000 - 0x000030)
static_assert(sizeof(FMovieSceneManaSectionTemplate) == 0x0058); // 88 bytes (0x000020 - 0x000058)
static_assert(offsetof(UMovieSceneAtomSection, sound) == 0x00F0);
static_assert(offsetof(UMovieSceneAtomSection, StartFrameOffset) == 0x00F8);
static_assert(offsetof(UMovieSceneAtomSection, SoundVolume) == 0x0100);
static_assert(offsetof(UMovieSceneAtomSection, PitchMultiplier) == 0x0210);
static_assert(offsetof(UMovieSceneAtomSection, AttachActorData) == 0x0320);
static_assert(offsetof(UMovieSceneAtomSection, ScalarParameterNamesAndCurves) == 0x0440);
static_assert(offsetof(UMovieSceneAtomSection, AttenuationSettings) == 0x0458);
static_assert(offsetof(UMovieSceneAtomSection, AsrRackIDs) == 0x0468);
static_assert(offsetof(UMovieSceneAtomSection, SelectorLabels) == 0x0478);
static_assert(offsetof(UMovieSceneAtomTrack, AtomSections) == 0x00A0);
static_assert(offsetof(UMovieSceneManaSection, ManaSource) == 0x00F0);
static_assert(offsetof(UMovieSceneManaSection, StartFrameOffset) == 0x00FC);
static_assert(offsetof(UMovieSceneManaSection, ManaTexture) == 0x0100);
static_assert(offsetof(UMovieSceneManaSection, AtomComponent) == 0x0108);
static_assert(offsetof(UMovieSceneManaSection, ExternalManaPlayer) == 0x0118);
static_assert(offsetof(UMovieSceneManaTrack, ManaSections) == 0x00A0);
static_assert(offsetof(UMovieSceneManaTrack, SyncedAtomTrack) == 0x00B0);
static_assert(offsetof(FMovieSceneAtomSectionTemplate, AtomSection) == 0x0020);
static_assert(offsetof(FMovieSceneManaSectionParams, AtomComponent) == 0x0000);
static_assert(offsetof(FMovieSceneManaSectionParams, ManaSource) == 0x0008);
static_assert(offsetof(FMovieSceneManaSectionParams, ManaTexture) == 0x0010);
static_assert(offsetof(FMovieSceneManaSectionParams, ManaPlayer) == 0x0018);
static_assert(offsetof(FMovieSceneManaSectionParams, SectionStartFrame) == 0x0020);
static_assert(offsetof(FMovieSceneManaSectionParams, SectionEndFrame) == 0x0024);
static_assert(offsetof(FMovieSceneManaSectionParams, StartFrameOffset) == 0x002C);
static_assert(offsetof(FMovieSceneManaSectionTemplate, Params) == 0x0020);
