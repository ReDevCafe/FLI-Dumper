...
public:
	...
	// void RegenerateExtraCorners();                                                                                           // [0x842b560] Final|Native|Public  
};
...
public:
	...
	// void Poke();                                                                                                             // [0x842b440] Final|Native|Public  
...
public:
	...
	// void PlanarProjection();                                                                                                 // [0x842b3e0] Final|Native|Public  
};
...
public:
	...
	// void Collapse();                                                                                                         // [0x842ad20] Final|Native|Public  
...
public:
	...
	// TArray<FString> GetUVChannelNamesFunc();                                                                                 // [0x842b170] Final|Native|Public|Const 
};
...
static_assert(sizeof(UPolyEditExtrudeEdgeActivityProperties) == 0x00C0); // 192 bytes (0x0000A8 - 0x0000C0)
static_assert(sizeof(UPolyEditExtrudeEdgeActivity) == 0x02D0); // 720 bytes (0x000030 - 0x0002D0)
...
static_assert(sizeof(UCSGMeshesTool) == 0x0160); // 352 bytes (0x000108 - 0x000160)
...
static_assert(sizeof(UCutMeshWithMeshTool) == 0x0380); // 896 bytes (0x000108 - 0x000380)
...
static_assert(sizeof(UEditMeshPolygonsTool) == 0x0900); // 2304 bytes (0x000120 - 0x000900)
...
static_assert(sizeof(URecomputeUVsTool) == 0x0118); // 280 bytes (0x0000B0 - 0x000118)
static_assert(sizeof(UPolyEditBevelEdgeProperties) == 0x00C0); // 192 bytes (0x0000A8 - 0x0000C0)
...
static_assert(sizeof(UUVLayoutTool) == 0x0170); // 368 bytes (0x0000B8 - 0x000170)
...
static_assert(sizeof(UUVProjectionTool) == 0x04D0); // 1232 bytes (0x000120 - 0x0004D0)
...
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, DirectionMode) == 0x00A8);
static_assert(offsetof(UPolyEditExtrudeEdgeActivityProperties, DistanceMode) == 0x00AC);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, Settings) == 0x0038);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, ActivityContext) == 0x0040);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, ExtrudeFrameProxy) == 0x0048);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, ExtrudeFrameGizmo) == 0x0050);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, SingleDirectionProxy) == 0x0058);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, SingleDirectionGizmo) == 0x0060);
static_assert(offsetof(UPolyEditExtrudeEdgeActivity, PreviewGeometry) == 0x0068);
...
static_assert(offsetof(UCSGMeshesTool, CSGProperties) == 0x0108);
static_assert(offsetof(UCSGMeshesTool, TrimProperties) == 0x0110);
static_assert(offsetof(UCSGMeshesTool, OriginalMeshPreviews) == 0x0128);
static_assert(offsetof(UCSGMeshesTool, PreviewsGhostMaterial) == 0x0138);
static_assert(offsetof(UCSGMeshesTool, DrawnLineSet) == 0x0140);
static_assert(offsetof(UCutMeshWithMeshTool, CutProperties) == 0x0108);
static_assert(offsetof(UCutMeshWithMeshTool, IntersectPreviewMesh) == 0x0110);
static_assert(offsetof(UCutMeshWithMeshTool, DrawnLineSet) == 0x0138);
...
static_assert(offsetof(UEditMeshPolygonsTool, Preview) == 0x0140);
static_assert(offsetof(UEditMeshPolygonsTool, CommonProps) == 0x0148);
static_assert(offsetof(UEditMeshPolygonsTool, EditActions) == 0x0150);
static_assert(offsetof(UEditMeshPolygonsTool, EditActions_Triangles) == 0x0158);
static_assert(offsetof(UEditMeshPolygonsTool, EditEdgeActions) == 0x0160);
static_assert(offsetof(UEditMeshPolygonsTool, EditEdgeActions_Triangles) == 0x0168);
static_assert(offsetof(UEditMeshPolygonsTool, EditUVActions) == 0x0170);
...
static_assert(offsetof(UEditMeshPolygonsTool, ExtrudeEdgeActivity) == 0x01B8);
static_assert(offsetof(UEditMeshPolygonsTool, ActivityContext) == 0x0298);
static_assert(offsetof(UEditMeshPolygonsTool, SelectionMechanic) == 0x02A0);
static_assert(offsetof(UEditMeshPolygonsTool, DragAlignmentMechanic) == 0x02A8);
static_assert(offsetof(UEditMeshPolygonsTool, TransformGizmo) == 0x02B0);
static_assert(offsetof(UEditMeshPolygonsTool, TransformProxy) == 0x02B8);
...
static_assert(offsetof(UPolyEditExtrudeProperties, DirectionMode) == 0x00B8);
static_assert(offsetof(UPolyEditExtrudeProperties, Direction) == 0x00BC);
static_assert(offsetof(UPolyEditExtrudeProperties, MeasureDirection) == 0x00CC);
...
static_assert(offsetof(UPolyEditPushPullProperties, SingleDirection) == 0x00BC);
...
static_assert(offsetof(UUVLayoutTool, UVChannelProperties) == 0x00C0);
static_assert(offsetof(UUVLayoutTool, BasicProperties) == 0x00C8);
static_assert(offsetof(UUVLayoutTool, MaterialSettings) == 0x00D0);
static_assert(offsetof(UUVLayoutTool, Previews) == 0x00D8);
static_assert(offsetof(UUVLayoutTool, Factories) == 0x00E8);
static_assert(offsetof(UUVLayoutTool, UVLayoutView) == 0x0160);
...
static_assert(offsetof(UUVProjectionTool, UVChannelProperties) == 0x0120);
static_assert(offsetof(UUVProjectionTool, BasicProperties) == 0x0128);
static_assert(offsetof(UUVProjectionTool, EditActions) == 0x0130);
static_assert(offsetof(UUVProjectionTool, MaterialSettings) == 0x0138);
static_assert(offsetof(UUVProjectionTool, Preview) == 0x0140);
static_assert(offsetof(UUVProjectionTool, CheckerMaterial) == 0x0148);
static_assert(offsetof(UUVProjectionTool, TransformGizmo) == 0x0150);
static_assert(offsetof(UUVProjectionTool, TransformProxy) == 0x0158);
static_assert(offsetof(UUVProjectionTool, OperatorFactory) == 0x0160);
static_assert(offsetof(UUVProjectionTool, EdgeRenderer) == 0x0168);
static_assert(offsetof(UUVProjectionTool, ClickToSetPlaneBehavior) == 0x04B8);
