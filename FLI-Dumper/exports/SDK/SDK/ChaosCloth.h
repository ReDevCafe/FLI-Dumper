...
public:
	...
	// void SetWind(FVector2D Drag, FVector2D Lift, float AirDensity, FVector WindVelocity);                                    // [0x873a9f0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetVelocityScale
	// void SetVelocityScale(FVector LinearVelocityScale, float AngularVelocityScale, float FictitiousAngularScale);            // [0x873a800] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetPressure
	// void SetPressure(FVector2D Pressure);                                                                                    // [0x873a6e0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetMaterialLinear
	// void SetMaterialLinear(float EdgeStiffness, float BendingStiffness, float AreaStiffness);                                // [0x873a470] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetMaterial
	// void SetMaterial(FVector2D EdgeStiffness, FVector2D BendingStiffness, FVector2D AreaStiffness);                          // [0x873a2a0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetLongRangeAttachmentLinear
	// void SetLongRangeAttachmentLinear(float TetherStiffness, float TetherScale);                                             // [0x873a0e0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetLongRangeAttachment
	// void SetLongRangeAttachment(FVector2D TetherStiffness, FVector2D TetherScale);                                           // [0x8739f60] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetGravity
	// void SetGravity(float GravityScale, bool bIsGravityOverridden, FVector GravityOverride);                                 // [0x8739d80] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetDamping
	// void SetDamping(float DampingCoefficient, float LocalDampingCoefficient);                                                // [0x8739c00] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetCollision
	// void SetCollision(float CollisionThickness, float FrictionCoefficient, bool bUseCCD, float SelfCollisionThickness);      // [0x87399e0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetBackstop
	// void SetBackstop(bool bEnabled);                                                                                         // [0x87398b0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAnimDriveLinear
	// void SetAnimDriveLinear(float AnimDriveStiffness);                                                                       // [0x8739830] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAnimDrive
	// void SetAnimDrive(FVector2D AnimDriveStiffness, FVector2D AnimDriveDamping);                                             // [0x87396b0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAerodynamics
	// void SetAerodynamics(float DragCoefficient, float LiftCoefficient, FVector WindVelocity);                                // [0x87394d0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/ChaosCloth.ChaosClothingInteractor.ResetAndTeleport
	// void ResetAndTeleport(bool bReset, bool bTeleport);                                                                      // [0x8739400] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UChaosClothConfig) == 0x0128); // 296 bytes (0x000028 - 0x000128)
...
static_assert(sizeof(UChaosClothingInteractor) == 0x0050); // 80 bytes (0x000030 - 0x000050)
static_assert(sizeof(UChaosClothingSimulationInteractor) == 0x00B0); // 176 bytes (0x000090 - 0x0000B0)
static_assert(offsetof(UChaosClothConfig, MassMode) == 0x0028);
static_assert(offsetof(UChaosClothConfig, EdgeStiffnessWeighted) == 0x003C);
static_assert(offsetof(UChaosClothConfig, BendingStiffnessWeighted) == 0x0044);
static_assert(offsetof(UChaosClothConfig, BucklingStiffnessWeighted) == 0x0054);
static_assert(offsetof(UChaosClothConfig, AreaStiffnessWeighted) == 0x005C);
static_assert(offsetof(UChaosClothConfig, TetherStiffness) == 0x0068);
static_assert(offsetof(UChaosClothConfig, TetherScale) == 0x0070);
static_assert(offsetof(UChaosClothConfig, Drag) == 0x00B4);
static_assert(offsetof(UChaosClothConfig, Lift) == 0x00BC);
static_assert(offsetof(UChaosClothConfig, Gravity) == 0x00D0);
static_assert(offsetof(UChaosClothConfig, Pressure) == 0x00E8);
static_assert(offsetof(UChaosClothConfig, AnimDriveStiffness) == 0x00F0);
static_assert(offsetof(UChaosClothConfig, AnimDriveDamping) == 0x00F8);
static_assert(offsetof(UChaosClothConfig, LinearVelocityScale) == 0x0100);
