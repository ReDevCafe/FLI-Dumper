...
public:
	...
	// void GetCachedAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, float& Progress); // [0x6689c70] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementBlueprintLibrary.GetCachedAchievementDescription
	// void GetCachedAchievementDescription(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementID, bool& bFoundID, FText& Title, FText& LockedDescription, FText& UnlockedDescription, bool& bHidden); // [0x6689980] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UAchievementQueryCallbackProxy* CacheAchievements(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x66854a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.AchievementQueryCallbackProxy.CacheAchievementDescriptions
	// class UAchievementQueryCallbackProxy* CacheAchievementDescriptions(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x66853b0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UAchievementWriteCallbackProxy* WriteAchievementProgress(class UObject* WorldContextObject, class APlayerController* PlayerController, FName AchievementName, float Progress, int32_t UserTag); // [0x668a8f0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UConnectionCallbackProxy* ConnectToService(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6685590] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UCreateSessionCallbackProxy* CreateSession(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t PublicConnections, bool bUseLAN, bool bUseLobbiesIfAvailable); // [0x6688b50] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UDestroySessionCallbackProxy* DestroySession(class UObject* WorldContextObject, class APlayerController* PlayerController); // [0x6688da0] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UEndTurnCallbackProxy* EndTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TScriptInterface<Class> TurnBasedMatchInterface); // [0x6689210] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// FString GetServerName(FBlueprintSessionResult& Result);                                                                  // [0x668a2e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetPingInMs
	// int32_t GetPingInMs(FBlueprintSessionResult& Result);                                                                    // [0x668a150] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetMaxPlayers
	// int32_t GetMaxPlayers(FBlueprintSessionResult& Result);                                                                  // [0x6689fc0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.GetCurrentPlayers
	// int32_t GetCurrentPlayers(FBlueprintSessionResult& Result);                                                              // [0x6689e30] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/OnlineSubsystemUtils.FindSessionsCallbackProxy.FindSessions
	// class UFindSessionsCallbackProxy* FindSessions(class UObject* WorldContextObject, class APlayerController* PlayerController, int32_t MaxResults, bool bUseLAN); // [0x6689490] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1165) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,1166) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0040   (0x0010)  
...
public:
	...
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseUnprocessedPurchases(class APlayerController* PlayerController); // [0x6687fc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchaseQueryOwned
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchaseQueryOwned(class APlayerController* PlayerController); // [0x6686e60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.InAppPurchaseCallbackProxy2.CreateProxyObjectForInAppPurchase
	// class UInAppPurchaseCallbackProxy2* CreateProxyObjectForInAppPurchase(class APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0x6685b20] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseCheckoutCallbackProxy* CreateProxyObjectForInAppPurchaseCheckout(class APlayerController* PlayerController, FInAppPurchaseProductRequest2& ProductRequest); // [0x6686130] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseFinalizeProxy* CreateProxyObjectForInAppPurchaseFinalize(FInAppPurchaseReceiptInfo2& InAppPurchaseReceipt, class APlayerController* PlayerController); // [0x66862d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseQueryCallbackProxy2* CreateProxyObjectForInAppPurchaseQuery(class APlayerController* PlayerController, TArray<FString>& ProductIdentifiers); // [0x66869f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseRestoreOwnedProducts(class APlayerController* PlayerController); // [0x6687b80] Final|Native|Static|Public|BlueprintCallable 
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseQueryOwnedProducts(class APlayerController* PlayerController); // [0x6687260] Final|Native|Static|Public|BlueprintCallable 
	...
	// class UInAppPurchaseReceiptsCallbackProxy* CreateProxyObjectForInAppPurchaseGetKnownReceipts(class APlayerController* PlayerController); // [0x66866b0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1175) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,1176) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0038   (0x0010)  
	...
	// class UInAppPurchaseRestoreCallbackProxy2* CreateProxyObjectForInAppPurchaseRestore(TArray<FInAppPurchaseProductRequest2>& ConsumableProductFlags, class APlayerController* PlayerController); // [0x66876a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1177) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0030   (0x0010)  
	SDK_UNDEFINED(16,1178) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0040   (0x0010)  
	...
	// class UJoinSessionCallbackProxy* JoinSession(class UObject* WorldContextObject, class APlayerController* PlayerController, FBlueprintSessionResult& SearchResult); // [0x668a4f0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool WriteLeaderboardInteger(class APlayerController* PlayerController, FName StatName, int32_t StatValue);              // [0x668aa80] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class ULeaderboardFlushCallbackProxy* CreateProxyObjectForFlush(class APlayerController* PlayerController, FName SessionName); // [0x66856f0] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,1181) /* FMulticastInlineDelegate */ __um(OnSuccess);                                         // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,1182) /* FMulticastInlineDelegate */ __um(OnFailure);                                         // 0x0038   (0x0010)  
	...
	// class ULeaderboardQueryCallbackProxy* CreateProxyObjectForIntQuery(class APlayerController* PlayerController, FName StatName); // [0x6688470] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class ULogoutCallbackProxy* Logout(class UObject* WorldContextObject, class APlayerController* PlayerController);        // [0x668a790] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void ClientOnConnected();                                                                                                // [0x5dd2b60] Final|Net|NetReliableNative|Event|Private|NetClient 
};
...
public:
	...
	// void ServerUpdateReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                             // [0x66a57b0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerReservationRequest
	// void ServerReservationRequest(FString SessionId, FPartyReservation Reservation);                                         // [0x66a52c0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerRemoveMemberFromReservationRequest
	// void ServerRemoveMemberFromReservationRequest(FString SessionId, FPartyReservation ReservationUpdate);                   // [0x66a5030] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl PartyLeader);                                                       // [0x66a4e80] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ServerAddOrUpdateReservationRequest
	// void ServerAddOrUpdateReservationRequest(FString SessionId, FPartyReservation Reservation);                              // [0x66a4bf0] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0x66a40f0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                        // [0x6583be0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                                // [0x66a3ff0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.PartyBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<EPartyReservationResult> ReservationResponse);                          // [0x66a3ef0] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// class UQuitMatchCallbackProxy* QuitMatch(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, TEnumAsByte<EMPMatchOutcome> Outcome, int32_t TurnTimeoutInSeconds); // [0x66a4770] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// class UShowLoginUICallbackProxy* ShowExternalLoginUI(class UObject* WorldContextObject, class APlayerController* InPlayerController); // [0x66a5a40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void ServerReservationRequest(FString SessionId, FSpectatorReservation Reservation);                                     // [0x66a5550] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ServerCancelReservationRequest
	// void ServerCancelReservationRequest(FUniqueNetIdRepl Spectator);                                                         // [0x66a4e80] Net|NetReliableNative|Event|Protected|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationUpdates
	// void ClientSendReservationUpdates(int32_t NumRemainingReservations);                                                     // [0x66a4180] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientSendReservationFull
	// void ClientSendReservationFull();                                                                                        // [0x58b2cb0] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientReservationResponse
	// void ClientReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                            // [0x66a4070] Net|NetReliableNative|Event|Public|NetClient 
	// Function /Script/OnlineSubsystemUtils.SpectatorBeaconClient.ClientCancelReservationResponse
	// void ClientCancelReservationResponse(TEnumAsByte<ESpectatorReservationResult> ReservationResponse);                      // [0x66a3f70] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// void ServerPong();                                                                                                       // [0x66a4fe0] Net|NetReliableNative|Event|Public|NetServer|NetValidate 
	// Function /Script/OnlineSubsystemUtils.TestBeaconClient.ClientPing
	// void ClientPing();                                                                                                       // [0x5b3c6e0] Net|NetReliableNative|Event|Public|NetClient 
};
...
public:
	...
	// void RegisterTurnBasedMatchInterfaceObject(class UObject* WorldContextObject, class APlayerController* PlayerController, class UObject* Object); // [0x66a4a20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetPlayerDisplayName
	// void GetPlayerDisplayName(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t playerIndex, FString& PlayerDisplayName); // [0x66a4570] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetMyPlayerIndex
	// void GetMyPlayerIndex(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, int32_t& playerIndex); // [0x66a43c0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/OnlineSubsystemUtils.TurnBasedBlueprintLibrary.GetIsMyTurn
	// void GetIsMyTurn(class UObject* WorldContextObject, class APlayerController* PlayerController, FString MatchID, bool& bIsMyTurn); // [0x66a4210] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// bool IsIdling();                                                                                                         // [0x66a6fc0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UInAppPurchaseCheckoutCallbackProxy) == 0x00A0); // 160 bytes (0x000028 - 0x0000A0)
static_assert(sizeof(UInAppPurchaseFinalizeProxy) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UInAppPurchaseQueryCallbackProxy2) == 0x0068); // 104 bytes (0x000028 - 0x000068)
static_assert(sizeof(UInAppPurchaseReceiptsCallbackProxy) == 0x0088); // 136 bytes (0x000028 - 0x000088)
static_assert(sizeof(UInAppPurchaseRestoreCallbackProxy2) == 0x00B0); // 176 bytes (0x000028 - 0x0000B0)
static_assert(sizeof(UIpConnection) == 0x1E90); // 7824 bytes (0x001E00 - 0x001E90)
static_assert(sizeof(UIpNetDriver) == 0x0978); // 2424 bytes (0x0008C8 - 0x000978)
...
static_assert(sizeof(UVoipListenerSynthComponent) == 0x08F0); // 2288 bytes (0x000890 - 0x0008F0)
static_assert(sizeof(FBlueprintSessionResult) == 0x0120); // 288 bytes (0x000000 - 0x000120)
static_assert(sizeof(FOnlineProxyStoreOffer) == 0x00E8); // 232 bytes (0x000000 - 0x0000E8)
...
static_assert(offsetof(FOnlineProxyStoreOffer, Description) == 0x0020);
static_assert(offsetof(FOnlineProxyStoreOffer, LongDescription) == 0x0030);
static_assert(offsetof(FOnlineProxyStoreOffer, RegularPriceText) == 0x0040);
static_assert(offsetof(FOnlineProxyStoreOffer, PriceText) == 0x0058);
static_assert(offsetof(FOnlineProxyStoreOffer, CurrencyCode) == 0x0070);
static_assert(offsetof(FOnlineProxyStoreOffer, ReleaseDate) == 0x0080);
static_assert(offsetof(FOnlineProxyStoreOffer, ExpirationDate) == 0x0088);
static_assert(offsetof(FOnlineProxyStoreOffer, DiscountType) == 0x0090);
static_assert(offsetof(FOnlineProxyStoreOffer, DynamicFields) == 0x0098);
