...
public:
	...
	// FTransform GetOffsetRootTransform(FAnimNodeReference& Node);                                                             // [0x7eb9680] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimationWarpingRuntime.AnimationWarpingLibrary.GetCurveValueFromAnimation
	// bool GetCurveValueFromAnimation(class UAnimSequenceBase* Animation, FName CurveName, float Time, float& OutValue);       // [0x7eb9430] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UAnimationWarpingLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(FFootPlacementInterpolationSettings) == 0x002C); // 44 bytes (0x000000 - 0x00002C)
...
static_assert(sizeof(FFootPlacementPelvisSettings) == 0x0024); // 36 bytes (0x000000 - 0x000024)
static_assert(sizeof(FFootPlacemenLegDefinition) == 0x004C); // 76 bytes (0x000000 - 0x00004C)
static_assert(sizeof(FFootPlacementPlantSettings) == 0x0034); // 52 bytes (0x000000 - 0x000034)
static_assert(sizeof(FAnimNode_FootPlacement) == 0x0430); // 1072 bytes (0x0000C8 - 0x000430)
static_assert(sizeof(FAnimNode_OffsetRootBone) == 0x0100); // 256 bytes (0x000010 - 0x000100)
static_assert(sizeof(FAnimNode_OrientationWarping) == 0x0220); // 544 bytes (0x0000C8 - 0x000220)
...
static_assert(sizeof(FAnimNode_Steering) == 0x01E0); // 480 bytes (0x0000C8 - 0x0001E0)
...
static_assert(offsetof(FFootPlacementPelvisSettings, DisablePelvisCurveName) == 0x001C);
...
static_assert(offsetof(FFootPlacemenLegDefinition, DisableLegCurveName) == 0x0044);
...
static_assert(offsetof(FAnimNode_FootPlacement, LegDefinitions) == 0x0110);
static_assert(offsetof(FAnimNode_FootPlacement, PlantSettings) == 0x0120);
static_assert(offsetof(FAnimNode_FootPlacement, InterpolationSettings) == 0x0154);
static_assert(offsetof(FAnimNode_FootPlacement, TraceSettings) == 0x0180);
static_assert(offsetof(FAnimNode_OffsetRootBone, Source) == 0x0010);
static_assert(offsetof(FAnimNode_OrientationWarping, Mode) == 0x00C8);
static_assert(offsetof(FAnimNode_OrientationWarping, LocomotionDirection) == 0x00D8);
static_assert(offsetof(FAnimNode_OrientationWarping, SpineBones) == 0x00F8);
static_assert(offsetof(FAnimNode_OrientationWarping, IKFootRootBone) == 0x0108);
static_assert(offsetof(FAnimNode_OrientationWarping, IKFootBones) == 0x0118);
static_assert(offsetof(FAnimNode_OrientationWarping, RotationAxis) == 0x0128);
static_assert(offsetof(FAnimNode_OrientationWarping, ManualRootMotionVelocity) == 0x0140);
static_assert(offsetof(FAnimNode_OrientationWarping, WarpingSpace) == 0x0158);
static_assert(offsetof(FAnimNode_OrientationWarping, WarpingSpaceTransform) == 0x0160);
...
static_assert(offsetof(FAnimNode_Steering, TargetOrientation) == 0x00D0);
static_assert(offsetof(FAnimNode_Steering, CurrentAnimAsset) == 0x0110);
