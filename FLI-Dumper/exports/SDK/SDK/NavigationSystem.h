...
public:
	...
	// bool IsValid();                                                                                                          // [0x684fdf0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsStringPulled
	// bool IsStringPulled();                                                                                                   // [0x5abd850] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.IsPartial
	// bool IsPartial();                                                                                                        // [0x684fdb0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathLength
	// double GetPathLength();                                                                                                  // [0x684f940] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetPathCost
	// double GetPathCost();                                                                                                    // [0x684f6d0] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.GetDebugString
	// FString GetDebugString();                                                                                                // [0x684f540] Final|RequiredAPI|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation
	// void EnableRecalculationOnInvalidation(TEnumAsByte<ENavigationOptionFlag> DoRecalculation);                              // [0x684ef30] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationPath.EnableDebugDrawing
	// void EnableDebugDrawing(bool bShouldDrawDebugData, FLinearColor PathColor);                                              // [0x684ed60] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void UnregisterNavigationInvoker(class AActor* Invoker);                                                                 // [0x6851440] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount
	// void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs);                                                 // [0x6851350] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode
	// void SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode);                                                      // [0x68512c0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount
	// void ResetMaxSimultaneousTileGenerationJobsCount();                                                                      // [0x68511d0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker
	// void RegisterNavigationInvoker(class AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius);              // [0x6851070] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated
	// void OnNavigationBoundsUpdated(class ANavMeshBoundsVolume* NavVolume);                                                   // [0x6850f20] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.NavigationRaycast
	// bool NavigationRaycast(class UObject* WorldContextObject, FVector& RayStart, FVector& RayEnd, FVector& HitLocation, class UClass* FilterClass, class AController* Querier); // [0x6850cc0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData
	// bool K2_ReplaceAreaInOctreeData(class UObject* Object, class UClass* OldArea, class UClass* NewArea);                    // [0x6850810] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation
	// bool K2_ProjectPointToNavigation(class UObject* WorldContextObject, FVector& Point, FVector& ProjectedLocation, class ANavigationData* NavData, class UClass* FilterClass, FVector QueryExtent); // [0x68505e0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius
	// bool K2_GetRandomReachablePointInRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x6850260] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius
	// bool K2_GetRandomPointInNavigableRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x6850020] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius
	// bool K2_GetRandomLocationInNavigableRadius(class UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, class ANavigationData* NavData, class UClass* FilterClass); // [0x684fe10] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked
	// bool IsNavigationBeingBuiltOrLocked(class UObject* WorldContextObject);                                                  // [0x684fcd0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt
	// bool IsNavigationBeingBuilt(class UObject* WorldContextObject);                                                          // [0x684fbf0] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathLength
	// TEnumAsByte<ENavigationQueryResult> GetPathLength(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, double& PathLength, class ANavigationData* NavData, class UClass* FilterClass); // [0x684f9d0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathCost
	// TEnumAsByte<ENavigationQueryResult> GetPathCost(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, double& PathCost, class ANavigationData* NavData, class UClass* FilterClass); // [0x684f720] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetNavigationSystem
	// class UNavigationSystemV1* GetNavigationSystem(class UObject* WorldContextObject);                                       // [0x684f620] Final|RequiredAPI|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously
	// class UNavigationPath* FindPathToLocationSynchronously(class UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, class AActor* PathfindingContext, class UClass* FilterClass); // [0x684f350] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously
	// class UNavigationPath* FindPathToActorSynchronously(class UObject* WorldContextObject, FVector& PathStart, class AActor* GoalActor, float TetherDistance, class AActor* PathfindingContext, class UClass* FilterClass); // [0x684efe0] Final|RequiredAPI|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetNavigationRelevancy(bool bRelevant);                                                                             // [0x689bb80] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool K2_ReplaceAreaInTileBounds(FBox Bounds, class UClass* OldArea, class UClass* NewArea, bool ReplaceLinks);           // [0x687bbf0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// void SetAreaClass(class UClass* NewAreaClass);                                                                           // [0x689ba30] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetAreaClass(class UClass* NewAreaClass);                                                                           // [0x689b8f0] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UNavigationGraphNodeComponent) == 0x0260); // 608 bytes (0x000230 - 0x000260)
static_assert(sizeof(UNavigationObjectRepository) == 0x0090); // 144 bytes (0x000030 - 0x000090)
...
static_assert(sizeof(ANavigationData) == 0x04A8); // 1192 bytes (0x000290 - 0x0004A8)
static_assert(sizeof(AAbstractNavData) == 0x04A8); // 1192 bytes (0x0004A8 - 0x0004A8)
...
static_assert(sizeof(UNavCollision) == 0x0108); // 264 bytes (0x000070 - 0x000108)
...
static_assert(sizeof(ANavigationGraph) == 0x04A8); // 1192 bytes (0x0004A8 - 0x0004A8)
...
static_assert(sizeof(UNavigationSystemV1) == 0x15B8); // 5560 bytes (0x000028 - 0x0015B8)
static_assert(sizeof(UNavigationSystemModuleConfig) == 0x0060); // 96 bytes (0x000058 - 0x000060)
static_assert(sizeof(ANavigationTestingActor) == 0x03C0); // 960 bytes (0x000290 - 0x0003C0)
static_assert(sizeof(UNavLinkComponent) == 0x0530); // 1328 bytes (0x000518 - 0x000530)
static_assert(sizeof(UNavRelevantComponent) == 0x00F0); // 240 bytes (0x0000A0 - 0x0000F0)
static_assert(sizeof(UNavLinkCustomComponent) == 0x01E0); // 480 bytes (0x0000F0 - 0x0001E0)
static_assert(sizeof(UNavLinkRenderingComponent) == 0x0520); // 1312 bytes (0x000518 - 0x000520)
static_assert(sizeof(ANavMeshBoundsVolume) == 0x02D0); // 720 bytes (0x0002C8 - 0x0002D0)
static_assert(sizeof(UNavMeshRenderingComponent) == 0x0580); // 1408 bytes (0x000568 - 0x000580)
...
static_assert(sizeof(ARecastNavMesh) == 0x0688); // 1672 bytes (0x0004A8 - 0x000688)
static_assert(sizeof(URecastNavMeshDataChunk) == 0x0040); // 64 bytes (0x000030 - 0x000040)
static_assert(sizeof(UNavModifierComponent) == 0x0190); // 400 bytes (0x0000F0 - 0x000190)
static_assert(sizeof(ANavModifierVolume) == 0x02E0); // 736 bytes (0x0002C8 - 0x0002E0)
static_assert(sizeof(ANavSystemConfigOverride) == 0x02A0); // 672 bytes (0x000290 - 0x0002A0)
static_assert(sizeof(USplineNavModifierComponent) == 0x01A0); // 416 bytes (0x000190 - 0x0001A0)
...
static_assert(offsetof(UNavigationGraphNodeComponent, Node) == 0x0230);
static_assert(offsetof(UNavigationGraphNodeComponent, NextNodeComponent) == 0x0248);
static_assert(offsetof(UNavigationGraphNodeComponent, PrevNodeComponent) == 0x0250);
...
static_assert(offsetof(ANavigationData, RuntimeGeneration) == 0x032C);
static_assert(offsetof(ANavigationData, SupportedAreas) == 0x0440);
...
static_assert(offsetof(UNavCollision, CylinderCollision) == 0x00B8);
static_assert(offsetof(UNavCollision, BoxCollision) == 0x00C8);
static_assert(offsetof(UNavCollision, AreaClass) == 0x00D8);
...
static_assert(offsetof(UNavigationInvokerComponent, Priority) == 0x00AC);
...
static_assert(offsetof(UNavigationSystemV1, OperationMode) == 0x0220);
...
static_assert(offsetof(ANavigationTestingActor, CostDisplayMode) == 0x033C);
...
static_assert(offsetof(UNavLinkComponent, Links) == 0x0520);
static_assert(offsetof(UNavRelevantComponent, CachedNavParent) == 0x00E8);
static_assert(offsetof(UNavLinkCustomComponent, CustomLinkId) == 0x0100);
static_assert(offsetof(UNavLinkCustomComponent, AuxiliaryCustomLinkId) == 0x0108);
static_assert(offsetof(UNavLinkCustomComponent, EnabledAreaClass) == 0x0110);
static_assert(offsetof(UNavLinkCustomComponent, DisabledAreaClass) == 0x0118);
static_assert(offsetof(UNavLinkCustomComponent, SupportedAgents) == 0x0120);
static_assert(offsetof(UNavLinkCustomComponent, LinkRelativeStart) == 0x0128);
static_assert(offsetof(UNavLinkCustomComponent, LinkRelativeEnd) == 0x0140);
static_assert(offsetof(UNavLinkCustomComponent, LinkDirection) == 0x0158);
static_assert(offsetof(UNavLinkCustomComponent, ObstacleOffset) == 0x0160);
static_assert(offsetof(UNavLinkCustomComponent, ObstacleExtent) == 0x0178);
static_assert(offsetof(UNavLinkCustomComponent, ObstacleAreaClass) == 0x0190);
static_assert(offsetof(UNavLinkCustomComponent, BroadcastChannel) == 0x01A0);
...
static_assert(offsetof(ARecastNavMesh, TileGenerationDebug) == 0x04B0);
static_assert(offsetof(ARecastNavMesh, NavMeshResolutionParams) == 0x04E0);
static_assert(offsetof(ARecastNavMesh, NavMeshOriginOffset) == 0x0540);
static_assert(offsetof(ARecastNavMesh, LedgeSlopeFilterMode) == 0x0564);
static_assert(offsetof(ARecastNavMesh, RegionPartitioning) == 0x0565);
static_assert(offsetof(ARecastNavMesh, LayerPartitioning) == 0x0566);
...
static_assert(offsetof(UNavModifierComponent, NavMeshResolution) == 0x0110);
