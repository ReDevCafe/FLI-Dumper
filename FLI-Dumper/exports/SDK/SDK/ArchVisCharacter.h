...
static_assert(sizeof(AArchVisCharacter) == 0x06D0); // 1744 bytes (0x000668 - 0x0006D0)
static_assert(sizeof(UArchVisCharMovementComponent) == 0x1010); // 4112 bytes (0x000F78 - 0x001010)
static_assert(offsetof(AArchVisCharacter, LookUpAxisName) == 0x0668);
static_assert(offsetof(AArchVisCharacter, LookUpAtRateAxisName) == 0x0678);
static_assert(offsetof(AArchVisCharacter, TurnAxisName) == 0x0688);
static_assert(offsetof(AArchVisCharacter, TurnAtRateAxisName) == 0x0698);
static_assert(offsetof(AArchVisCharacter, MoveForwardAxisName) == 0x06A8);
static_assert(offsetof(AArchVisCharacter, MoveRightAxisName) == 0x06B8);
static_assert(offsetof(UArchVisCharMovementComponent, RotationalAcceleration) == 0x0F78);
static_assert(offsetof(UArchVisCharMovementComponent, RotationalDeceleration) == 0x0F90);
static_assert(offsetof(UArchVisCharMovementComponent, MaxRotationalVelocity) == 0x0FA8);
