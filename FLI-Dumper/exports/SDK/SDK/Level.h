...
public:
	...
	// void ExecuteUbergraph_TitleLevel_GraphicSettingMap(int32_t EntryPoint);                                                  // [0x3618b30] Final|HasDefaults    
};

#pragma pack(pop)


static_assert(sizeof(ATitleLevel_GraphicSettingMap_C) == 0x02C0); // 704 bytes (0x000298 - 0x0002C0)
static_assert(offsetof(ATitleLevel_GraphicSettingMap_C, UberGraphFrame) == 0x0298);
static_assert(offsetof(ATitleLevel_GraphicSettingMap_C, DynamicLoadSubLevelPathArray) == 0x02A0);
static_assert(offsetof(ATitleLevel_GraphicSettingMap_C, LevelStreamingDynamicArray) == 0x02B0);
