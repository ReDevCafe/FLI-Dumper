...
static_assert(sizeof(FBMPChar) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FBMPKerning) == 0x000C); // 12 bytes (0x000000 - 0x00000C)
static_assert(sizeof(FBMPFontStyleInfo) == 0x00C0); // 192 bytes (0x000000 - 0x0000C0)
static_assert(sizeof(FBMPFontStyle) == 0x0060); // 96 bytes (0x000000 - 0x000060)
static_assert(sizeof(UL5BitmapFontAsset) == 0x0090); // 144 bytes (0x000028 - 0x000090)
static_assert(sizeof(FBMPWord) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(offsetof(FBMPFontStyleInfo, charInfos) == 0x0000);
static_assert(offsetof(FBMPFontStyleInfo, kernInfos) == 0x0050);
static_assert(offsetof(FBMPFontStyle, Textures) == 0x0000);
static_assert(offsetof(FBMPFontStyle, fontStyleInfos) == 0x0010);
static_assert(offsetof(UL5BitmapFontAsset, m_fontStyle) == 0x0028);
static_assert(offsetof(FBMPWord, charList) == 0x0000);
