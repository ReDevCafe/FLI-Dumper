...
public:
	...
	// void OnWarpUpdate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier);                // [0x3618b30] Event|Public|BlueprintEvent|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.OnWarpEnd
	// void OnWarpEnd(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier);                   // [0x3618b30] Event|Public|BlueprintEvent|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.OnWarpBegin
	// void OnWarpBegin(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier);                 // [0x3618b30] Event|Public|BlueprintEvent|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.OnRootMotionModifierUpdate
	// void OnRootMotionModifierUpdate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier);  // [0x662bfc0] Final|Native|Public|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.OnRootMotionModifierDeactivate
	// void OnRootMotionModifierDeactivate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier); // [0x662bec0] Final|Native|Public|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.OnRootMotionModifierActivate
	// void OnRootMotionModifierActivate(class UMotionWarpingComponent* MotionWarpingComp, class URootMotionModifier* Modifier); // [0x662bdc0] Final|Native|Public|Const 
	// Function /Script/MotionWarping.AnimNotifyState_MotionWarping.AddRootMotionModifier
	// class URootMotionModifier* AddRootMotionModifier(class UMotionWarpingComponent* MotionWarpingComp, class UAnimSequenceBase* Animation, float StartTime, float EndTime); // [0x662abe0] Native|Event|Public|BlueprintEvent|Const 
};
...
public:
	...
	// void GetMotionWarpingWindowsFromAnimation(class UAnimSequenceBase* Animation, TArray<FMotionWarpingWindowData>& OutWindows); // [0x662bbb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingUtilities.GetMotionWarpingWindowsForWarpTargetFromAnimation
	// void GetMotionWarpingWindowsForWarpTargetFromAnimation(class UAnimSequenceBase* Animation, FName WarpTargetName, TArray<FMotionWarpingWindowData>& OutWindows); // [0x662b8e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingUtilities.ExtractRootMotionFromAnimation
	// FTransform ExtractRootMotionFromAnimation(class UAnimSequenceBase* Animation, float StartTime, float EndTime);           // [0x662b770] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	// int32_t RemoveWarpTarget(FName WarpTargetName);                                                                          // [0x662c120] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.RemoveAllWarpTargets
	// int32_t RemoveAllWarpTargets();                                                                                          // [0x662c0c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.DisableAllRootMotionModifiers
	// void DisableAllRootMotionModifiers();                                                                                    // [0x662b6e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.AddOrUpdateWarpTargetFromTransform
	// void AddOrUpdateWarpTargetFromTransform(FName WarpTargetName, FTransform TargetTransform);                               // [0x662aa80] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.AddOrUpdateWarpTargetFromLocationAndRotation
	// void AddOrUpdateWarpTargetFromLocationAndRotation(FName WarpTargetName, FVector TargetLocation, FRotator TargetRotation); // [0x662a8e0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.AddOrUpdateWarpTargetFromLocation
	// void AddOrUpdateWarpTargetFromLocation(FName WarpTargetName, FVector TargetLocation);                                    // [0x662a7b0] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.AddOrUpdateWarpTargetFromComponent
	// void AddOrUpdateWarpTargetFromComponent(FName WarpTargetName, class USceneComponent* Component, FName BoneName, bool bFollowComponent, FVector LocationOffset, FRotator RotationOffset); // [0x662a570] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MotionWarping.MotionWarpingComponent.AddOrUpdateWarpTarget
	// void AddOrUpdateWarpTarget(FMotionWarpingTarget& WarpTarget);                                                            // [0x662a440] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class URootMotionModifier_Scale* AddRootMotionModifierScale(class UMotionWarpingComponent* InMotionWarpingComp, class UAnimSequenceBase* inAnimation, float InStartTime, float InEndTime, FVector InScale); // [0x662ad40] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
static_assert(sizeof(FMotionWarpingTarget) == 0x0080); // 128 bytes (0x000000 - 0x000080)
static_assert(sizeof(UMotionWarpingComponent) == 0x00E0); // 224 bytes (0x0000A0 - 0x0000E0)
static_assert(sizeof(URootMotionModifier) == 0x00E8); // 232 bytes (0x000028 - 0x0000E8)
static_assert(sizeof(URootMotionModifier_Warp) == 0x0260); // 608 bytes (0x0000E8 - 0x000260)
static_assert(sizeof(URootMotionModifier_SimpleWarp) == 0x0260); // 608 bytes (0x000260 - 0x000260)
static_assert(sizeof(URootMotionModifier_Scale) == 0x0100); // 256 bytes (0x0000E8 - 0x000100)
static_assert(sizeof(URootMotionModifier_AdjustmentBlendWarp) == 0x03C0); // 960 bytes (0x000260 - 0x0003C0)
static_assert(sizeof(URootMotionModifier_SkewWarp) == 0x0260); // 608 bytes (0x000260 - 0x000260)
...
static_assert(sizeof(FMotionDeltaTrack) == 0x0060); // 96 bytes (0x000000 - 0x000060)
...
static_assert(offsetof(FMotionWarpingTarget, Rotation) == 0x0020);
static_assert(offsetof(FMotionWarpingTarget, Component) == 0x0038);
static_assert(offsetof(FMotionWarpingTarget, BoneName) == 0x0040);
static_assert(offsetof(FMotionWarpingTarget, LocationOffset) == 0x0050);
static_assert(offsetof(FMotionWarpingTarget, RotationOffset) == 0x0068);
static_assert(offsetof(UMotionWarpingComponent, CharacterOwner) == 0x00B8);
static_assert(offsetof(UMotionWarpingComponent, Modifiers) == 0x00C0);
static_assert(offsetof(UMotionWarpingComponent, WarpTargets) == 0x00D0);
...
static_assert(offsetof(URootMotionModifier, State) == 0x00E4);
static_assert(offsetof(URootMotionModifier_Warp, WarpTargetName) == 0x00E8);
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimProvider) == 0x00F0);
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimTransform) == 0x0100);
static_assert(offsetof(URootMotionModifier_Warp, WarpPointAnimBoneName) == 0x0160);
static_assert(offsetof(URootMotionModifier_Warp, AddTranslationEasingFunc) == 0x016A);
static_assert(offsetof(URootMotionModifier_Warp, AddTranslationEasingCurve) == 0x0170);
static_assert(offsetof(URootMotionModifier_Warp, RotationType) == 0x0179);
static_assert(offsetof(URootMotionModifier_Warp, RotationMethod) == 0x017A);
static_assert(offsetof(URootMotionModifier_Warp, CachedTargetTransform) == 0x0190);
static_assert(offsetof(URootMotionModifier_Scale, Scale) == 0x00E8);
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, IKBones) == 0x0268);
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshTransform) == 0x0280);
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshRelativeTransform) == 0x02E0);
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedRootMotion) == 0x0340);
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, Result) == 0x03A0);
...
static_assert(offsetof(FMotionDeltaTrack, TotalRotation) == 0x0048);
