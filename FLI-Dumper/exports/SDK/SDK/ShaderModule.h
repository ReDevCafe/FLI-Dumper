...
static_assert(sizeof(FDioramaBlur_General_DetailedAdjustment) == 0x0006); // 6 bytes (0x000000 - 0x000006)
static_assert(sizeof(FDioramaBlur_General) == 0x0034); // 52 bytes (0x000000 - 0x000034)
static_assert(sizeof(FDioramaBlur_Depth) == 0x0020); // 32 bytes (0x000000 - 0x000020)
static_assert(sizeof(FDioramaBlur_BandBlur) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(FDioramaBlur_CircleMask) == 0x0088); // 136 bytes (0x000000 - 0x000088)
static_assert(sizeof(FDioramaBlur_PhotoAdjust) == 0x0044); // 68 bytes (0x000000 - 0x000044)
static_assert(sizeof(FPostProcessDioramaBlurParam) == 0x0148); // 328 bytes (0x000000 - 0x000148)
static_assert(offsetof(FDioramaBlur_General, detailedAdjustment) == 0x002C);
static_assert(offsetof(FDioramaBlur_CircleMask, CircleMaskCenter_Base) == 0x0000);
static_assert(offsetof(FPostProcessDioramaBlurParam, General) == 0x0004);
static_assert(offsetof(FPostProcessDioramaBlurParam, Depth) == 0x0038);
static_assert(offsetof(FPostProcessDioramaBlurParam, BandBlur) == 0x0058);
static_assert(offsetof(FPostProcessDioramaBlurParam, CircleMask) == 0x0070);
