...
public:
	...
	// void StopCapturingAudio();                                                                                               // [0x874b220] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.StartCapturingAudio
	// void StartCapturingAudio();                                                                                              // [0x874b1d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.IsCapturingAudio
	// bool IsCapturingAudio();                                                                                                 // [0x874b190] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCapture.GetAudioCaptureDeviceInfo
	// bool GetAudioCaptureDeviceInfo(FAudioCaptureDeviceInfo& OutInfo);                                                        // [0x874af50] Final|Native|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// class UAudioCapture* CreateAudioCapture();                                                                               // [0x874af20] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// void GetAvailableAudioInputDevices(class UObject* WorldContextObject, FDelegateProperty& OnObtainDevicesEvent);          // [0x874b0a0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioCapture.AudioCaptureBlueprintLibrary.Conv_AudioInputDeviceInfoToString
	// FString Conv_AudioInputDeviceInfoToString(FAudioInputDeviceInfo& Info);                                                  // [0x874adb0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
};
...
static_assert(sizeof(UAudioCaptureBlueprintLibrary) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UAudioCaptureComponent) == 0x0950); // 2384 bytes (0x000890 - 0x000950)
