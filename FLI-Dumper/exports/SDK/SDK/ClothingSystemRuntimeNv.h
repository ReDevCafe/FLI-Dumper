...
public:
	...
	// void SetAnimDriveDamperStiffness(float InStiffness);                                                                     // [0x56bf140] Final|RequiredAPI|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UClothConfigNv) == 0x01A0); // 416 bytes (0x000028 - 0x0001A0)
static_assert(sizeof(UClothingSimulationFactoryNv) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(UClothingSimulationInteractorNv) == 0x0090); // 144 bytes (0x000090 - 0x000090)
...
static_assert(offsetof(UClothConfigNv, LinearDrag) == 0x00A0);
static_assert(offsetof(UClothConfigNv, AngularDrag) == 0x00B8);
static_assert(offsetof(UClothConfigNv, LinearInertiaScale) == 0x00D0);
static_assert(offsetof(UClothConfigNv, AngularInertiaScale) == 0x00E8);
static_assert(offsetof(UClothConfigNv, CentrifugalInertiaScale) == 0x0100);
static_assert(offsetof(UClothConfigNv, GravityOverride) == 0x0128);
static_assert(offsetof(UClothConfigNv, WindMethod) == 0x0158);
static_assert(offsetof(UClothConfigNv, VerticalConstraintConfig) == 0x015C);
static_assert(offsetof(UClothConfigNv, HorizontalConstraintConfig) == 0x016C);
static_assert(offsetof(UClothConfigNv, BendConstraintConfig) == 0x017C);
static_assert(offsetof(UClothConfigNv, ShearConstraintConfig) == 0x018C);
