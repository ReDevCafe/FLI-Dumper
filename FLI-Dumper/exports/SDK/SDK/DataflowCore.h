...
static_assert(sizeof(FDataflowOverrideNode) == 0x0108); // 264 bytes (0x0000E8 - 0x000108)
...
static_assert(offsetof(FDataflowOverrideNode, Key) == 0x00E8);
static_assert(offsetof(FDataflowOverrideNode, Default) == 0x00F0);
