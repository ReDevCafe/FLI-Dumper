...
public:
	...
	// void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive);                                                          // [0x3618b30] Event|Public|BlueprintEvent 
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	// void OnMatchEnded(FString Match);                                                                                        // [0x3618b30] Event|Public|BlueprintEvent 
};
