...
static_assert(sizeof(UNetDriverEOS) == 0x0980); // 2432 bytes (0x000980 - 0x000980)
static_assert(sizeof(UEOSArtifactSettings) == 0x0030); // 48 bytes (0x000030 - 0x000030)
static_assert(sizeof(UEOSExternalAccessor) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(FArtifactSettings) == 0x0070); // 112 bytes (0x000000 - 0x000070)
static_assert(sizeof(UEOSSettings) == 0x00D0); // 208 bytes (0x000038 - 0x0000D0)
...
static_assert(offsetof(FArtifactSettings, ClientEncryptionKey) == 0x0060);
static_assert(offsetof(UEOSSettings, CacheDir) == 0x0038);
static_assert(offsetof(UEOSSettings, DefaultArtifactName) == 0x0048);
static_assert(offsetof(UEOSSettings, LiveArtifactName) == 0x0058);
static_assert(offsetof(UEOSSettings, RTCBackgroundMode) == 0x0068);
static_assert(offsetof(UEOSSettings, TitleStorageTags) == 0x0080);
static_assert(offsetof(UEOSSettings, Artifacts) == 0x0098);
static_assert(offsetof(UEOSSettings, AuthScopeFlags) == 0x00A8);
static_assert(offsetof(UEOSSettings, SteamTokenType) == 0x00C0);
