...
public:
	...
	// void SetSilenceThreshold(float VolumeDb);                                                                                // [0x67d3b20] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.SetSamplingRate
	// void SetSamplingRate(int32_t SamplingRateHz);                                                                            // [0x67d3a90] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.IsAtSilence
	// bool IsAtSilence();                                                                                                      // [0x67d3a60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.Init
	// void Init(int32_t MaxInputSamplingRate, ELipsAnalyzerDataReadoutMode dataReadoutMode);                                   // [0x67d3990] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetVolume
	// float GetVolume();                                                                                                       // [0x67d3950] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetSilenceThreshold
	// float GetSilenceThreshold();                                                                                             // [0x67d3910] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetMorphTargetBlendAmountAsJapanese
	// FCriLipsMorphTargetBlendAmountAsJapanese GetMorphTargetBlendAmountAsJapanese();                                          // [0x67d38b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetInfoAtSilence
	// FCriLipsMouthInfo GetInfoAtSilence();                                                                                    // [0x67d3850] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetInfo
	// FCriLipsMouthInfo GetInfo();                                                                                             // [0x67d37f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetReadoutOffset(int64_t offsetMs);                                                                                 // [0x67d40b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.IsAttached
	// bool IsAttached();                                                                                                       // [0x67d4070] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.GetReadoutStatus
	// ELipsAtomAnalyzerReadoutStatus GetReadoutStatus();                                                                       // [0x67d4040] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.GetProcessStatus
	// ELipsAtomAnalyzerProcessStatus GetProcessStatus();                                                                       // [0x67d4010] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.Detach
	// void Detach();                                                                                                           // [0x67d3ff0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.Attach
	// void Attach(class UAtomComponent* InAtomComponent);                                                                      // [0x67d3f60] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetStartOffset(FFrameNumber InStartOffset);                                                                         // [0x67d4670] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.MovieSceneLipSyncAtomSection.GetStartOffset
	// FFrameNumber GetStartOffset();                                                                                           // [0x67d4650] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(ULipsAnalyzerBase) == 0x0028); // 40 bytes (0x000028 - 0x000028)
static_assert(sizeof(ULipsAtomAnalyzer) == 0x0038); // 56 bytes (0x000028 - 0x000038)
static_assert(sizeof(FAtomLipSyncSectionParameter) == 0x0038); // 56 bytes (0x000000 - 0x000038)
static_assert(sizeof(UAtomLipSyncSectionParameterSettings) == 0x0060); // 96 bytes (0x000028 - 0x000060)
static_assert(sizeof(UMovieSceneLipSyncAtomSection) == 0x0748); // 1864 bytes (0x0000F0 - 0x000748)
static_assert(sizeof(UMovieSceneLipSyncAtomTrack) == 0x00B0); // 176 bytes (0x000098 - 0x0000B0)
static_assert(sizeof(FCriLipsMouthInfo) == 0x0010); // 16 bytes (0x000000 - 0x000010)
static_assert(sizeof(FCriLipsMorphTargetBlendAmountAsJapanese) == 0x0014); // 20 bytes (0x000000 - 0x000014)
static_assert(sizeof(FMovieSceneLipSyncAtomSectionTemplate) == 0x0028); // 40 bytes (0x000020 - 0x000028)
static_assert(offsetof(ULipsAtomAnalyzer, AtomComponent) == 0x0030);
static_assert(offsetof(FAtomLipSyncSectionParameter, LipSync_MorphTargetName_A) == 0x0008);
static_assert(offsetof(FAtomLipSyncSectionParameter, LipSync_MorphTargetName_I) == 0x0010);
static_assert(offsetof(FAtomLipSyncSectionParameter, LipSync_MorphTargetName_U) == 0x0018);
static_assert(offsetof(FAtomLipSyncSectionParameter, LipSync_MorphTargetName_E) == 0x0020);
static_assert(offsetof(FAtomLipSyncSectionParameter, LipSync_MorphTargetName_O) == 0x0028);
static_assert(offsetof(FAtomLipSyncSectionParameter, SocketNameForAttachingSound) == 0x0030);
static_assert(offsetof(UAtomLipSyncSectionParameterSettings, AtomLipSyncSectionParameter) == 0x0028);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, sound) == 0x00F0);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, StartFrameOffset) == 0x00F8);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, AtomLipSyncSectionParameterSettings) == 0x0100);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, AtomLipSyncSectionParameterOverrides) == 0x0108);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, SoundVolume) == 0x0140);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, PitchMultiplier) == 0x0250);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, AttenuationSettings) == 0x0368);
static_assert(offsetof(UMovieSceneLipSyncAtomSection, AttenuationOverrides) == 0x0370);
static_assert(offsetof(UMovieSceneLipSyncAtomTrack, AtomSections) == 0x00A0);
static_assert(offsetof(FMovieSceneLipSyncAtomSectionTemplate, AtomSection) == 0x0020);
