...
public:
	...
	// bool CheckPermission(FString permission);                                                                                // [0x8bfdbe0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AndroidPermission.AndroidPermissionFunctionLibrary.AcquirePermissions
	// class UAndroidPermissionCallbackProxy* AcquirePermissions(TArray<FString>& Permissions);                                 // [0x8bfdb20] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};

#pragma pack(pop)


static_assert(sizeof(UAndroidPermissionCallbackProxy) == 0x0050); // 80 bytes (0x000028 - 0x000050)
