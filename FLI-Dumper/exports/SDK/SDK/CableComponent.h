...
public:
	...
	// void SetAttachEndToComponent(class USceneComponent* Component, FName SocketName);                                        // [0x8c09c40] Final|Native|Public|BlueprintCallable 
	// Function /Script/CableComponent.CableComponent.SetAttachEndTo
	// void SetAttachEndTo(class AActor* Actor, FName ComponentProperty, FName SocketName);                                     // [0x8c09b30] Final|Native|Public|BlueprintCallable 
	// Function /Script/CableComponent.CableComponent.GetCableParticleLocations
	// void GetCableParticleLocations(TArray<FVector>& Locations);                                                              // [0x8c09a00] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CableComponent.CableComponent.GetAttachedComponent
	// class USceneComponent* GetAttachedComponent();                                                                           // [0x8c09970] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CableComponent.CableComponent.GetAttachedActor
	// class AActor* GetAttachedActor();                                                                                        // [0x8c09930] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
static_assert(sizeof(UCableComponent) == 0x0600); // 1536 bytes (0x000550 - 0x000600)
static_assert(offsetof(ACableActor, CableComponent) == 0x0290);
static_assert(offsetof(UCableComponent, AttachEndTo) == 0x0558);
static_assert(offsetof(UCableComponent, AttachEndToSocketName) == 0x0580);
static_assert(offsetof(UCableComponent, EndLocation) == 0x0588);
static_assert(offsetof(UCableComponent, CableForce) == 0x05C0);
